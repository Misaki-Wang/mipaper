# cs.CL Daily Paper Classification Report (2026-03-11)

- Source: https://papers.cool/arxiv/cs.CL?date=2026-03-11&show=1000
...
- Generative Foundations: 1 papers (1.52%)
- Multimodal Generative Modeling: 3 papers (4.55%)
- Multimodal Agents: 0 papers (0.00%)

## Topic Distribution Analysis

- Domain Applications: 13 papers (19.70%)
- Reasoning, Alignment, and Evaluation: 11 papers (16.67%)
- LLMs and Language: 10 papers (15.15%)
- Retrieval, Knowledge, and RAG: 8 papers (12.12%)
- Datasets and Benchmarks: 6 papers (9.09%)
- Learning, Optimization, and Theory: 6 papers (9.09%)
- Multimodal Understanding and Vision: 5 papers (7.58%)
- Agents and Planning: 3 papers (4.55%)
- Multimodal Generative Modeling: 3 papers (4.55%)
- Generative Foundations: 1 papers (1.52%)

### Brief Notes

- The largest topic today is “Domain Applications”, with 13 papers, accounting for 19.70%。
- The top 3 topics account for 51.52%，dispersed。
- Long-tail topics with only one paper: 1 items。

## Domain Applications (13 papers, 19.70%)

- [Beyond Fine-Tuning: Robust Food Entity Linking under Ontology Drift with FoodOntoRAG](https://arxiv.org/pdf/2603.09758)
...
- [Fusing Semantic, Lexical, and Domain Perspectives for Recipe Similarity Estimation](https://arxiv.org/pdf/2603.09688)
...
- [Automatic Cardiac Risk Management Classification using large-context Electronic Patients Health Records](https://arxiv.org/pdf/2603.09685)
...
- [Tracking Cancer Through Text: Longitudinal Extraction From Radiology Reports Using Open-Source Large Language Models](https://arxiv.org/pdf/2603.09638)
...
- [Build, Borrow, or Just Fine-Tune? A Political Scientist's Guide to Choosing NLP Models](https://arxiv.org/pdf/2603.09595)
...
- [Automated Thematic Analysis for Clinical Qualitative Data: Iterative Codebook Refinement with Full Provenance](https://arxiv.org/pdf/2603.08989)
...
- [Enhancing Debunking Effectiveness through LLM-based Personality Adaptation](https://arxiv.org/pdf/2603.09533)
...
- [CyberThreat-Eval: Can Large Language Models Automate Real-World Threat Research?](https://arxiv.org/pdf/2603.09452)
...
- [From Days to Minutes: An Autonomous AI Agent Achieves Reliable Clinical Triage in Remote Patient Monitoring](https://arxiv.org/pdf/2603.09052)
...
- [A Consensus-Driven Multi-LLM Pipeline for Missing-Person Investigations](https://arxiv.org/pdf/2603.08954)
...
- [PathoScribe: Transforming Pathology Data into a Living Library with a Unified LLM-Driven Framework for Semantic Retrieval and Clinical Integration](https://arxiv.org/pdf/2603.08935)
...
- [From Word2Vec to Transformers: Text-Derived Composition Embeddings for Filtering Combinatorial Electrocatalysts](https://arxiv.org/pdf/2603.08881)
...
- [Self-hosted Lecture-to-Quiz: Local LLM MCQ Generation with Deterministic Quality Control](https://arxiv.org/pdf/2603.08729)
...
- [CREATE: Testing LLMs for Associative Creativity](https://arxiv.org/pdf/2603.09970)
...
- [Thinking to Recall: How Reasoning Unlocks Parametric Knowledge in LLMs](https://arxiv.org/pdf/2603.09906)
...
- [Benchmarking Political Persuasion Risks Across Frontier Large Language Models](https://arxiv.org/pdf/2603.09884)
...
- [Common Sense vs. Morality: The Curious Case of Narrative Focus Bias in LLMs](https://arxiv.org/pdf/2603.09434)
...
- [Investigating Gender Stereotypes in Large Language Models via Social Determinants of Health](https://arxiv.org/pdf/2603.09416)
...
- [LLM as a Meta-Judge: Synthetic Data for NLP Evaluation Metric Validation](https://arxiv.org/pdf/2603.09403)
...
- [Bioalignment: Measuring and Improving LLM Disposition Toward Biological Systems for AI Safety](https://arxiv.org/pdf/2603.09154)
...
- [Learning When to Sample: Confidence-Aware Self-Consistency for Efficient LLM Chain-of-Thought Reasoning](https://arxiv.org/pdf/2603.08999)
...
- [Think Before You Lie: How Reasoning Improves Honesty](https://arxiv.org/pdf/2603.09957)
...
- [ActiveUltraFeedback: Efficient Preference Data Generation using Active Learning](https://arxiv.org/pdf/2603.09692)
...
- [The Reasoning Trap -- Logical Reasoning as a Mechanistic Pathway to Situational Awareness](https://arxiv.org/pdf/2603.09200)
...
- [Model Merging in the Era of Large Language Models: Methods, Applications, and Future Directions](https://arxiv.org/pdf/2603.09938)
...
- [N-gram-like Language Models Predict Reading Time Best](https://arxiv.org/pdf/2603.09872)
...
- [EPIC-EuroParl-UdS: Information-Theoretic Perspectives on Translation and Interpreting](https://arxiv.org/pdf/2603.09785)
...
- [RbtAct: Rebuttal as Supervision for Actionable Review Feedback Generation](https://arxiv.org/pdf/2603.09723)
...
- [ESAinsTOD: A Unified End-to-End Schema-Aware Instruction-Tuning Framework for Task-Oriented Dialog Modeling](https://arxiv.org/pdf/2603.09691)
...
- [You Didn't Have to Say It like That: Subliminal Learning from Faithful Paraphrases](https://arxiv.org/pdf/2603.09517)
...
- [Modelling the Diachronic Emergence of Phoneme Frequency Distributions](https://arxiv.org/pdf/2603.09503)
...
- [Emotion is Not Just a Label: Latent Emotional Factors in LLM Processing](https://arxiv.org/pdf/2603.09205)
...
- [One Language, Two Scripts: Probing Script-Invariance in LLM Concept Representations](https://arxiv.org/pdf/2603.08869)
...
- [VeriInteresting: An Empirical Study of Model Prompt Interactions in Verilog Code Generation](https://arxiv.org/pdf/2603.08715)
...
- [Evaluation of LLMs in retrieving food and nutritional context for RAG systems](https://arxiv.org/pdf/2603.09704)
...
- [Understanding the Interplay between LLMs' Utilisation of Parametric and Contextual Knowledge: A keynote at ECIR 2025](https://arxiv.org/pdf/2603.09654)
...
- [TaSR-RAG: Taxonomy-guided Structured Reasoning for Retrieval-Augmented Generation](https://arxiv.org/pdf/2603.09341)
...
- [LooComp: Leverage Leave-One-Out Strategy to Encoder-only Transformer for Efficient Query-aware Context Compression](https://arxiv.org/pdf/2603.09222)
...
- [DEO: Training-Free Direct Embedding Optimization for Negation-Aware Retrieval](https://arxiv.org/pdf/2603.09185)
...
- [MITRA: An AI Assistant for Knowledge Retrieval in Physics Collaborations](https://arxiv.org/pdf/2603.09800)
...
- [TA-Mem: Tool-Augmented Autonomous Memory Retrieval for LLM in Long-Term Conversational QA](https://arxiv.org/pdf/2603.09297)
...
- [Diagnosing and Repairing Citation Failures in Generative Engine Optimization](https://arxiv.org/pdf/2603.09296)
...
- [Do What I Say: A Spoken Prompt Dataset for Instruction-Following](https://arxiv.org/pdf/2603.09881)
...
- [Quantifying and extending the coverage of spatial categorization data sets](https://arxiv.org/pdf/2603.09373)
...
- [SciTaRC: Benchmarking QA on Scientific Tabular Data that Requires Language Reasoning and Complex Computation](https://arxiv.org/pdf/2603.08910)
...
- [MultiGraSCCo: A Multilingual Anonymization Benchmark with Annotations of Personal Identifiers](https://arxiv.org/pdf/2603.08879)
...
- [EXPLORE-Bench: Egocentric Scene Prediction with Long-Horizon Reasoning](https://arxiv.org/pdf/2603.09731)
...
- [VoxEmo: Benchmarking Speech Emotion Recognition with Speech LLMs](https://arxiv.org/pdf/2603.08936)
...
- [Surgical Repair of Collapsed Attention Heads in ALiBi Transformers](https://arxiv.org/pdf/2603.09616)
...
- [Reward Prediction with Factorized World States](https://arxiv.org/pdf/2603.09400)
...
- [MSSR: Memory-Aware Adaptive Replay for Continual LLM Fine-Tuning](https://arxiv.org/pdf/2603.09892)
...
- [Mousse: Rectifying the Geometry of Muon with Curvature-Aware Preconditioning](https://arxiv.org/pdf/2603.09697)
...
- [Exclusive Self Attention](https://arxiv.org/pdf/2603.09078)
...
- [BiCLIP: Domain Canonicalization via Structured Geometric Transformation](https://arxiv.org/pdf/2603.08942)
...
- [ALARM: Audio-Language Alignment for Reasoning Models](https://arxiv.org/pdf/2603.09556)
...
- [SPAR-K: Scheduled Periodic Alternating Early Exit for Spoken Language Models](https://arxiv.org/pdf/2603.09215)
...
- [Reading, Not Thinking: Understanding and Bridging the Modality Gap When Text Becomes Pixels in Multimodal LLMs](https://arxiv.org/pdf/2603.09095)
...
- [MUGEN: Evaluating and Improving Multi-audio Understanding of Large Audio-Language Models](https://arxiv.org/pdf/2603.09714)
...
- [X-GS: An Extensible Open Framework Unifying 3DGS Architectures with Downstream Multimodal Models](https://arxiv.org/pdf/2603.09632)
...
- [Chow-Liu Ordering for Long-Context Reasoning in Chain-of-Agents](https://arxiv.org/pdf/2603.09835)
...
- [One-Eval: An Agentic System for Automated and Traceable LLM Evaluation](https://arxiv.org/pdf/2603.09821)
...
- [MASEval: Extending Multi-Agent Evaluation from Models to Systems](https://arxiv.org/pdf/2603.08835)
...
- [DuplexCascade: Full-Duplex Speech-to-Speech Dialogue with VAD-Free Cascaded ASR-LLM-TTS Pipeline and Micro-Turn Optimization](https://arxiv.org/pdf/2603.09180)
...
- [How Contrastive Decoding Enhances Large Audio Language Models?](https://arxiv.org/pdf/2603.09232)
...
- [Fish Audio S2 Technical Report](https://arxiv.org/pdf/2603.08823)
...
- [ConFu: Contemplate the Future for Better Speculative Sampling](https://arxiv.org/pdf/2603.08899)
