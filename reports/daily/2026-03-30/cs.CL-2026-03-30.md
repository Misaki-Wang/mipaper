# cs.CL Daily Paper Classification Report (2026-03-30)

- Source: https://papers.cool/arxiv/cs.CL?date=2026-03-30&show=1000
...
- Multimodal Generative Modeling: 1 papers (1.82%)
- Multimodal Agents: 1 papers (1.82%)

## Topic Distribution Analysis

- LLMs and Language: 24 papers (43.64%)
- Other AI: 10 papers (18.18%)
- Reasoning, Alignment, and Evaluation: 5 papers (9.09%)
- Retrieval, Knowledge, and RAG: 4 papers (7.27%)
- Multimodal Understanding and Vision: 3 papers (5.45%)
- Agents and Planning: 2 papers (3.64%)
- Datasets and Benchmarks: 2 papers (3.64%)
- Domain Applications: 2 papers (3.64%)
- Learning, Optimization, and Theory: 1 papers (1.82%)
- Multimodal Agents: 1 papers (1.82%)
- Multimodal Generative Modeling: 1 papers (1.82%)

### Brief Notes

- The largest topic today is “LLMs and Language”, with 24 papers, accounting for 43.64%。
- The top 3 topics account for 70.91%，concentrated。
- Long-tail topics with only one paper: 3 items。

## LLMs and Language (24 papers, 43.64%)

- [Weight Tying Biases Token Embeddings Towards the Output Space](https://arxiv.org/pdf/2603.26663)
...
- [EnTaCs: Analyzing the Relationship Between Sentiment and Language Choice in English-Tamil Code-Switching](https://arxiv.org/pdf/2603.26587)
...
- [MemBoost: A Memory-Boosted Framework for Cost-Aware LLM Inference](https://arxiv.org/pdf/2603.26557)
...
- [Development of a European Union Time-Indexed Reference Dataset for Assessing the Performance of Signal Detection Methods in Pharmacovigilance using a Large Language Model](https://arxiv.org/pdf/2603.26544)
...
- [How Open Must Language Models be to Enable Reliable Scientific Inference?](https://arxiv.org/pdf/2603.26539)
...
- [ALBA: A European Portuguese Benchmark for Evaluating Language and Linguistic Dimensions in Generative LLMs](https://arxiv.org/pdf/2603.26516)
...
- [JAL-Turn: Joint Acoustic-Linguistic Modeling for Real-Time and Robust Turn-Taking Detection in Full-Duplex Spoken Dialogue Systems](https://arxiv.org/pdf/2603.26515)
...
- [AMALIA Technical Report: A Fully Open Source Large Language Model for European Portuguese](https://arxiv.org/pdf/2603.26511)
...
- [Clinical named entity recognition in the Portuguese language: a benchmark of modern BERT models and LLMs](https://arxiv.org/pdf/2603.26510)
...
- [Automating Clinical Information Retrieval from Finnish Electronic Health Records Using Large Language Models](https://arxiv.org/pdf/2603.26434)
...
- [Distilling Conversations: Abstract Compression of Conversational Audio Context for LLM-based ASR](https://arxiv.org/pdf/2603.26246)
...
- [A Universal Vibe? Finding and Controlling Language-Agnostic Informal Register with SAEs](https://arxiv.org/pdf/2603.26236)
...
- [Sparse Auto-Encoders and Holism about Large Language Models](https://arxiv.org/pdf/2603.26207)
...
- [IndoBERT-Relevancy: A Context-Conditioned Relevancy Classifier for Indonesian Text](https://arxiv.org/pdf/2603.26095)
...
- [AgentCollab: A Self-Evaluation-Driven Collaboration Paradigm for Efficient LLM Agents](https://arxiv.org/pdf/2603.26034)
...
- [Toward Culturally Grounded Natural Language Processing](https://arxiv.org/pdf/2603.26013)
...
- [MemoryCD: Benchmarking Long-Context User Memory of LLM Agents for Lifelong Cross-Domain Personalization](https://arxiv.org/pdf/2603.25973)
...
- [When Chain-of-Thought Backfires: Evaluating Prompt Sensitivity in Medical Language Models](https://arxiv.org/pdf/2603.25960)
...
- [Entanglement as Memory: Mechanistic Interpretability of Quantum Language Models](https://arxiv.org/pdf/2603.26494)
  - Authors: Nathan Roll
  - <details>
    <summary>Abstract</summary>
...
- [A Formal Framework for Uncertainty Analysis of Text Generation with Large Language Models](https://arxiv.org/pdf/2603.26363)
...
- [DataFlex: A Unified Framework for Data-Centric Dynamic Training of Large Language Models](https://arxiv.org/pdf/2603.26164)
...
- [Finding Distributed Object-Centric Properties in Self-Supervised Transformers](https://arxiv.org/pdf/2603.26127)
...
- [Selective Deficits in LLM Mental Self-Modeling in a Behavior-Based Test of Theory of Mind](https://arxiv.org/pdf/2603.26089)
...
- [H-Node Attack and Defense in Large Language Models](https://arxiv.org/pdf/2603.26045)
...
- [When Perplexity Lies: Generation-Focused Distillation of Hybrid Sequence Models](https://arxiv.org/pdf/2603.26556)
...
- [ClimateCheck 2026: Scientific Fact-Checking and Disinformation Narrative Classification of Climate-related Claims](https://arxiv.org/pdf/2603.26449)
...
- [Analysing Calls to Order in German Parliamentary Debates](https://arxiv.org/pdf/2603.26430)
...
- [SocialX: A Modular Platform for Multi-Source Big Data Research in Indonesia](https://arxiv.org/pdf/2603.26253)
  - Authors: Muhammad Apriandito Arya Saputra, Andry Alamsyah, Dian Puteri Ramadhani, Thomhert Suprapto Siadari, Hanif Fakhrurroja
  - <details>
    <summary>Abstract</summary>
...
- [Clash of the models: Comparing performance of BERT-based variants for generic news frame detection](https://arxiv.org/pdf/2603.26156)
...
- [I Want to Believe (but the Vocabulary Changed): Measuring the Semantic Structure and Evolution of Conspiracy Theories](https://arxiv.org/pdf/2603.26062)
...
- [Can Small Models Reason About Legal Documents? A Comparative Study](https://arxiv.org/pdf/2603.25944)
...
- [Working Notes on Late Interaction Dynamics: Analyzing Targeted Behaviors of Late Interaction Models](https://arxiv.org/pdf/2603.26259)
...
- [Do Neurons Dream of Primitive Operators? Wake-Sleep Compression Rediscovers Schank's Event Semantics](https://arxiv.org/pdf/2603.25975)
...
- [Word Alignment-Based Evaluation of Uniform Meaning Representations](https://arxiv.org/pdf/2603.26401)
...
- [CALRK-Bench: Evaluating Context-Aware Legal Reasoning in Korean Law](https://arxiv.org/pdf/2603.26332)
...
- [From Human Cognition to Neural Activations: Probing the Computational Primitives of Spatial Reasoning in LLMs](https://arxiv.org/pdf/2603.26323)
...
- [RealChart2Code: Advancing Chart-to-Code Generation with Real Data and Multi-Task Evaluation](https://arxiv.org/pdf/2603.25804)
...
- [Retrieval-Augmented Generation Based Nurse Observation Extraction](https://arxiv.org/pdf/2603.26046)
...
- [Methods for Knowledge Graph Construction from Text Collections: Development and Applications](https://arxiv.org/pdf/2603.25862)
...
- [Learning to Commit: Generating Organic Pull Requests via Online Repository Memory](https://arxiv.org/pdf/2603.26664)
...
- [Semi-Automated Knowledge Engineering and Process Mapping for Total Airport Management](https://arxiv.org/pdf/2603.26076)
...
- [findsylls: A Language-Agnostic Toolkit for Syllable-Level Speech Tokenization and Embedding](https://arxiv.org/pdf/2603.26292)
...
- [Automatic Speech Recognition for Documenting Endangered Languages: Case Study of Ikema Miyakoan](https://arxiv.org/pdf/2603.26248)
...
- [Gradient-Informed Training for Low-Resource Multilingual Speech Translation](https://arxiv.org/pdf/2603.25836)
...
- [Ask or Assume? Uncertainty-Aware Clarification-Seeking in Coding Agents](https://arxiv.org/pdf/2603.26233)
...
- [ClinicalAgents: Multi-Agent Orchestration for Clinical Decision Making with Dual-Memory](https://arxiv.org/pdf/2603.26182)
...
- [LLM Benchmark-User Need Misalignment for Climate Change](https://arxiv.org/pdf/2603.26106)
...
- [PerceptionComp: A Video Benchmark for Complex Perception-Centric Reasoning](https://arxiv.org/pdf/2603.26653)
...
- [GS-BrainText: A Multi-Site Brain Imaging Report Dataset from Generation Scotland for Clinical Natural Language Processing Development and Validation](https://arxiv.org/pdf/2603.26235)
...
- [Doctorina MedBench: End-to-End Evaluation of Agent-Based Medical AI](https://arxiv.org/pdf/2603.25821)
...
- [Switch Attention: Towards Dynamic and Fine-grained Hybrid Transformers](https://arxiv.org/pdf/2603.26380)
...
- [Policy-Guided World Model Planning for Language-Conditioned Visual Navigation](https://arxiv.org/pdf/2603.25981)
...
- [Relational graph-driven differential denoising and diffusion attention fusion for multimodal conversation emotion recognition](https://arxiv.org/pdf/2603.25752)
