...
- Agents and Planning: 4 papers (19.05%); representative paper: AREX: Towards a Recursively Self-Improving Agent for Deep Research.
- Datasets and Benchmarks: 3 papers (14.29%); representative paper: Tencent WorkBuddy Bench: A Multi-Domain Coding-Agent Benchmark with Contamination-Resistant Task Construction.
- LLMs and Language: 3 papers (14.29%); representative paper: Show, Don't Tell: Evaluating Spatial Cognition in Generative Pixels Rather Than LLM Text.
- Trend: Today's dominant clusters are Agents and Planning / Datasets and Benchmarks / LLMs and Language; this suggests that agent papers emphasize tool use, planning, and deployable workflows. The strongest visible attention is on “AREX: Towards a Recursively Self-Improving Agent for Deep Research” (115 upvotes).
...
- Agents and Planning: 4 papers (19.05%)
- Datasets and Benchmarks: 3 papers (14.29%)
- LLMs and Language: 3 papers (14.29%)
- Multimodal Understanding and Vision: 3 papers (14.29%)
- Other AI: 3 papers (14.29%)
- Learning, Optimization, and Theory: 2 papers (9.52%)
- Reasoning, Alignment, and Evaluation: 1 papers (4.76%)
- Retrieval, Knowledge, and RAG: 1 papers (4.76%)
...
- The top topic today is “Agents and Planning”, with 4 papers, accounting for 19.05%。
- The most active submitter is taesiri， with 5 papers。
- The highest-voted visible paper is “AREX: Towards a Recursively Self-Improving Agent for Deep Research”, currently at 115 votes.
- Today's dominant clusters are Agents and Planning / Datasets and Benchmarks / LLMs and Language; this suggests that agent papers emphasize tool use, planning, and deployable workflows. The strongest visible attention is on “AREX: Towards a Recursively Self-Improving Agent for Deep Research” (115 upvotes).

## Categorized Paper Briefs

### Agents and Planning (4 papers)

- [AREX: Towards a Recursively Self-Improving Agent for Deep Research](https://huggingface.co/papers/2607.21461) [Upvote: 115] Deep research requires agents to find answers that jointly satisfy multiple constraints. [Agents and Planning]
  ...
  - Submitted by: zhengliu | Upvotes: 115 | Comments: 1
...
- [NVIDIA-labs OO Agents: Native Python Object-Oriented Agents](https://huggingface.co/papers/2607.20709) [Upvote: 18] Traditional agent development is split across prompt templates, tool schemas, callback code, and workflow graphs. [Agents and Planning]
  ...
  - Submitted by: taesiri | Upvotes: 18 | Comments: 0
...
- [Streaming Multi-Agent Autoregressive Diffusion Model with World State Registers](https://huggingface.co/papers/2607.21594) [Upvote: 9] Multi-agent interactive world models should not only generate consistent observations, but also maintain world states that persist across agents and evolve across views. [Agents and Planning]
...
- [Sample-Efficient Learning from Agent Experience](https://huggingface.co/papers/2607.21051) [Upvote: 7] Real-world agent learning is often constrained by costly environment interactions, such as running time-consuming experiments or obtaining human feedback. [Agents and Planning]
  - Authors: Chenhui Gou, Haoqin Tu, Yunhao Fang, Jianfei Cai, Hamid Rezatofighi
  - Submitted by: Chenhui Gou | Upvotes: 7 | Comments: 1
...
- [Tencent WorkBuddy Bench: A Multi-Domain Coding-Agent Benchmark with Contamination-Resistant Task Construction](https://huggingface.co/papers/2607.20911) [Upvote: 17] We introduce Tencent WorkBuddy Bench, a multi-domain evaluation suite for coding agents; this report documents its construction methodology, scoring protocol, and a cross-model leaderboard. [Datasets and Benchmarks]
  ...
  - Submitted by: taesiri | Upvotes: 17 | Comments: 0
...
- [Dataset Distillation by Influence Matching](https://huggingface.co/papers/2607.16859) [Upvote: 0] We revisit dataset distillation from an outcome-centric perspective. [Datasets and Benchmarks]
  - Authors: Haoru Tan, Wang Wang, Sitong Wu, Xiuzhe Wu, Yangtian Sun, Chirui Chang, Shaofeng Zhang, Xiaojuan Qi
  - Submitted by: Haoru Tan | Upvotes: 0 | Comments: 1
...
- [Show, Don't Tell: Evaluating Spatial Cognition in Generative Pixels Rather Than LLM Text](https://huggingface.co/papers/2607.21072) [Upvote: 34] Spatial intelligence is essential for agents to move from static semantic understanding toward interacting with the physical world. [LLMs and Language]
  ...
  - Submitted by: Wenqi Zhang | Upvotes: 34 | Comments: 1
...
- [LLMs Get Lost in Evolving User Intent](https://huggingface.co/papers/2607.20734) [Upvote: 14] As LLMs become more capable, they are increasingly deployed as collaborative agents, taking on user-delegated tasks through iterative interaction. [LLMs and Language]
  - Authors: Jihoon Tack, Philippe Laban, Jennifer Neville
  - Submitted by: Jihoon Tack | Upvotes: 14 | Comments: 3
...
- [Predictive Divergence Masks for LLM RL](https://huggingface.co/papers/2607.10848) [Upvote: 8] Reinforcement learning for large language models (LLMs) typically relies on trust-region masks to stabilize off-policy updates. [LLMs and Language]
  ...
  - Submitted by: Jiarui Yao | Upvotes: 8 | Comments: 1
...
- [Visual Contrastive Self-Distillation](https://huggingface.co/papers/2607.21556) [Upvote: 39] On-policy self-distillation (OPSD) is promising as it removes the external teacher required by on-policy distillation (OPD), yet it still needs asymmetric information between teacher and student to ensure that the… [Multimodal Understanding and Vision]
  - Authors: Yijun Liang, Yunjie Tian, Yijiang Li, Yuqi Jia, Furong Huang, Tianyi Zhou, Di Fu
  - Submitted by: Yijun Liang | Upvotes: 39 | Comments: 1
...
- [SANA-Video 2.0: Hybrid Linear Attention with Attention Residuals for Efficient Video Generation](https://huggingface.co/papers/2607.21553) [Upvote: 13] We introduce SANA-Video 2.0, a hybrid video diffusion transformer instantiated at 5B and 14B scales under a unified architecture. [Multimodal Understanding and Vision]
  ...
  - Submitted by: Chen | Upvotes: 13 | Comments: 2
...
- [GraphVid: Interactive Graph-Controllable Video Generation](https://huggingface.co/papers/2607.21580) [Upvote: 2] Controllable video generation remains challenging due to the difficulty of specifying precise multi-object interactions using text prompts or motion-control inputs that primarily constrain pixel movement. [Multimodal Understanding and Vision]
  ...
  - Submitted by: Ismini Lourentzou | Upvotes: 2 | Comments: 1
...
- [Color Pass-Through via Camera-Display Coupling](https://huggingface.co/papers/2607.12746) [Upvote: 17] When a real-world scene is captured by a smartphone camera and viewed on its screen, the displayed image often differs noticeably from the original scene in color, brightness, and contrast. [Other AI]
  - Authors: Ruikang Li, Molin Li, Jiarui Wu, Zhe Wei, Pengpeng Liu, Tianfan Xue
  - Submitted by: Ruikang | Upvotes: 17 | Comments: 1
...
- [Multi-Turn On-Policy Distillation with Prefix Replay](https://huggingface.co/papers/2607.04763) [Upvote: 7] We study on-policy distillation (OPD) for agentic tasks, where an LLM agent interacts with an environment over multiple turns and a student imitates a teacher over these multi-turn interaction histories. [Other AI]
  - Authors: Baohao Liao, Hanze Dong, Christof Monz, Xinxing Xu, Li Dong, Furu Wei
  - Submitted by: Baohao Liao | Upvotes: 7 | Comments: 1
...
- [Self-Supervised Learning of Structured Dynamics from Videos](https://huggingface.co/papers/2607.21576) [Upvote: 13] Understanding motion in video is a fundamental challenge for visual learning, as frame-to-frame change entangles two sources of dynamics: camera motion and object motion. [Learning, Optimization, and Theory]
  - Authors: Lukas Knobel, Andrew Zisserman, Yuki M. Asano
  - Submitted by: Lukas Knobel | Upvotes: 13 | Comments: 1
...
- [Recurrent Sinusoidal INRs for Efficient High-Fidelity Representation](https://huggingface.co/papers/2607.21485) [Upvote: 6] We study sinusoidal recurrence as an iterative mechanism for harmonic spectral enrichment in implicit neural representations (INRs). [Learning, Optimization, and Theory]
  ...
  - Submitted by: Hyunmin Cho | Upvotes: 6 | Comments: 1
...
- [FinanceComplexQA: Benchmarking Agentic Reasoning on Industrial-grade Financial Documents](https://huggingface.co/papers/2607.19238) [Upvote: 4] Agentic Reasoning has become a transformative force in financial analysis due to its ability to integrate large-scale information and generate reliable and accurate content. [Reasoning, Alignment, and Evaluation]
  ...
  - Submitted by: Xianfu Cheng | Upvotes: 4 | Comments: 1
...
- [K12-KGraph: A Curriculum-Aligned Knowledge Graph for Benchmarking and Training Educational LLMs](https://huggingface.co/papers/2605.09635) [Upvote: 39] Large language models are increasingly used in K-12 education, but existing benchmarks mainly test exam question answering rather than understanding how curriculum knowledge is structured and visually presented. [Retrieval, Knowledge, and RAG]
  - Authors: Hao Liang, Qihan Lin, Zhaoyang Han, Xiaochen Ma, Zhen Hao Wong, Meiyi Qiang, Linzhuang Sun, Wentao Zhang
  - Submitted by: Hao Liang | Upvotes: 39 | Comments: 1
...
- [ReferTrack: Referring Then Tracking for Embodied Visual Tracking](https://huggingface.co/papers/2607.20061) [Upvote: 42] Embodied visual tracking (EVT) requires a mobile agent to continuously follow a specific target described in natural language using only onboard vision. [Robotics and Embodied AI]
  - Authors: Hanjing Ye, Tianle Zeng, Jiazhao Zhang, Shaoan Wang, Zibo Zhang, Weisi Situ, Yuchen Zhou, Yonggen Ling, Hong Zhang
  - Submitted by: tianlezeng | Upvotes: 42 | Comments: 10
