...
- The highest-voted visible paper is “TurboVLA: Real-Time Vision-Language-Action Model at 32 Hz on an RTX 4090 with <1 GB VRAM”, currently at 127 votes.
- Today's dominant clusters are Agents and Planning / LLMs and Language / Other AI; this suggests that agent papers emphasize tool use, planning, and deployable workflows. The strongest visible attention is on “TurboVLA: Real-Time Vision-Language-Action Model at 32 Hz on an RTX 4090 with <1 GB VRAM” (127 upvotes).
...
- [HumanCLAW: Can Vision-Language Models Act Through a Body?](https://huggingface.co/papers/2607.27180) [Upvote: 69] Evaluating whether a vision-language model (VLM) can act through a physical body is challenging. [LLMs and Language]
  ...
  - Submitted by: Jiawei Gu | Upvotes: 69 | Comments: 5
...
- [CAST: Game Solvers as Turn-Level Teachers for LLM Agents](https://huggingface.co/papers/2607.25308) [Upvote: 37] Training large language models (LLMs) to act in long-horizon games is a promising step toward generalist decision-making, yet reinforcement learning with verifiable rewards (RLVR) relies on sparse final rewards that… [LLMs and Language]
  ...
  - Submitted by: Yu Wang | Upvotes: 37 | Comments: 2
...
- [MindForge: Teaching Small Language Models Whole-Life-Cycle Software Engineering via Source-Free Program Synthesis](https://huggingface.co/papers/2607.27146) [Upvote: 22] Coding agents have made substantial progress on software engineering tasks that modify existing codebases, including bug fixing and feature implementation. [LLMs and Language]
  - Authors: Yihao Chen, Shi Chang, Khaled Chawa, Feng Lin, Boyuan Chen, Shaowei Wang, Ahmed E. Hassan
  - Submitted by: Boyuan Chen | Upvotes: 22 | Comments: 3
...
- [StatePlay: State-Aware Game World Models for Mechanics-Consistent Generation](https://huggingface.co/papers/2607.26754) [Upvote: 16] Recent game world models can generate visually realistic and interactive environments conditioned on player actions. [Other AI]
  - Authors: Zijun Lin, Zeqing Wang, Cheston Tan, Bihan Wen, Yeying Jin
  - Submitted by: ZIJUN LIN | Upvotes: 16 | Comments: 2
...
- [OVEarth-Bench: Evaluating Category Breadth and Query Diversity for Open-Vocabulary Earth Observation](https://huggingface.co/papers/2607.27278) [Upvote: 12] Open-vocabulary Earth observation (EO) aims to localize geospatial concepts specified in natural language rather than a fixed label set. [Other AI]
  ...
  - Submitted by: Kaiyu Li | Upvotes: 12 | Comments: 2
...
- [CoRT: Counterfactual Replay for Token-Level Rubric-Guided Policy Optimization](https://huggingface.co/papers/2607.25659) [Upvote: 80] Rubric-based reinforcement learning enriches language model training by evaluating model outputs against explicit criteria. [Learning, Optimization, and Theory]
  - Authors: Bo-Wen Zhang, Junwei He, Wen Wang, Song-Lin Lv, Wentao Ma, Rongyi Lin, Shuhan Zhong, Lan-Zhe Guo
  - Submitted by: quinn | Upvotes: 80 | Comments: 3
...
- [CLBench-V: Evaluating Multimodal Context Learning from Grounding to Knowledge Acquisition](https://huggingface.co/papers/2607.25294) [Upvote: 43] Real-world tasks often require models to learn from task-specific context rather than relying only on pre-trained knowledge. [Retrieval, Knowledge, and RAG]
  - Authors: Lai Wei, Chengqi Li, Jiapeng Li, Ruina Hu, Yue Wang, Weiran Huang
  - Submitted by: Lai Wei | Upvotes: 43 | Comments: 2
