...
- Multimodal Understanding and Vision: 8 papers (30.77%); representative paper: Mage-VL: An Efficient Codec-Native Streaming Multimodal Foundation Model.
- Agents and Planning: 5 papers (19.23%); representative paper: A New Role for Relevance: Guiding Corpus Interaction in Agentic Search.
- LLMs and Language: 4 papers (15.38%); representative paper: OmniDelta: Skill-Driven Budget Allocation for Token Compression in OmniLLMs.
- Trend: Today's dominant clusters are Multimodal Understanding and Vision / Agents and Planning / LLMs and Language; this suggests several parallel trends: multimodal work is moving from isolated perception toward generation, agents, and action; agent papers emphasize tool use, planning, and deployable workflows. The strongest visible attention is on “HiFi-UMI: Learning Deployable Manipulation Policies from High-Fidelity UMI Data Alone” (123 upvotes).
...
- Multimodal Understanding and Vision: 8 papers (30.77%)
- Agents and Planning: 5 papers (19.23%)
- LLMs and Language: 4 papers (15.38%)
- Other AI: 4 papers (15.38%)
- Learning, Optimization, and Theory: 3 papers (11.54%)
- Retrieval, Knowledge, and RAG: 1 papers (3.85%)
- Robotics and Embodied AI: 1 papers (3.85%)
...
- The top topic today is “Multimodal Understanding and Vision”, with 8 papers, accounting for 30.77%。
- The most active submitter is taesiri， with 5 papers。
- The highest-voted visible paper is “HiFi-UMI: Learning Deployable Manipulation Policies from High-Fidelity UMI Data Alone”, currently at 123 votes.
...
- [Mage-VL: An Efficient Codec-Native Streaming Multimodal Foundation Model](https://huggingface.co/papers/2607.24904) [Upvote: 22] Standard vision-language models (VLMs) suffer from Moravec's paradox: they excel at complex offline visual reasoning but struggle with simple streaming perception tasks and process them inefficiently. [Multimodal Understanding and Vision]
  ...
  - Submitted by: Senqiao Yang | Upvotes: 22 | Comments: 1
...
- [Novel Claim or Déjà Vu? Rethinking "Contamination-Free'' Dynamic Evaluation for Multimodal Automated Fact-Checking](https://huggingface.co/papers/2607.23514) [Upvote: 12] Multimodal automated fact-checking (MAFC) verifies claims by retrieving and reasoning over external evidence. [Multimodal Understanding and Vision]
  - Authors: Haorui He, Xinwen Chen, Dacheng Wen, Reynold Cheng, Francis C. M. Lau, Yupeng Li
  - Submitted by: HarryHe11 | Upvotes: 12 | Comments: 1
...
- [Wonder: Video World Model Done Better](https://huggingface.co/papers/2607.26037) [Upvote: 10] We present Wonder, a general-purpose video world model for real-time, camera-controllable world exploration. [Multimodal Understanding and Vision]
...
- [PerceptionBench: Evaluating Atomic Visual Perception in Multimodal Large Language Models](https://huggingface.co/papers/2607.24957) [Upvote: 9] We introduce PerceptionBench, a benchmark specifically designed to evaluate the atomic visual perception capabilities of Multimodal Large Language Models (MLLMs). [Multimodal Understanding and Vision]
...
- [Visual prompt engineering for video models](https://huggingface.co/papers/2607.25537) [Upvote: 8] In the age of foundation models, a model is only as good as its prompt. [Multimodal Understanding and Vision]
...
- [Parallel Decoding Distillation for Fast Image and Video Generation](https://huggingface.co/papers/2607.26004) [Upvote: 6] Generation in video diffusion or flow models is computationally expensive due to the slow and iterative sampling process. [Multimodal Understanding and Vision]
  - Authors: Neta Shaul, Chao Liu, Arash Vahdat, Julius Berner
  - Submitted by: Julius Berner | Upvotes: 6 | Comments: 1
...
- [OPERA: Offline Policy-guided Expert Routing and Adaptation for Universal Biomedical Image Analysis](https://huggingface.co/papers/2607.25108) [Upvote: 0] Biomedical image analysis spans diverse modalities and tasks, yet real-world deployment is hindered by severe distribution shifts across scanners, protocols, and patient populations. [Multimodal Understanding and Vision]
  - Authors: Zihan Li, Feiyang Liu, Dandan Shan, Ruibo Wang, Qingqi Hong
  - Submitted by: Zihan Li | Upvotes: 0 | Comments: 1
...
- [A New Role for Relevance: Guiding Corpus Interaction in Agentic Search](https://huggingface.co/papers/2607.24223) [Upvote: 79] Relevance is a query-dependent estimate of whether a document or excerpt contains useful evidence. [Agents and Planning]
  - Authors: Jiangnan Li, Yuqing Li, Mo Yu, Jinchao Zhang, Jie Zhou
  - Submitted by: Yuqing Li | Upvotes: 79 | Comments: 3
...
- [ReDesign: Recovering Editable Design Structures from Images via Agentic Decomposition](https://huggingface.co/papers/2607.25565) [Upvote: 54] Recovering an editable design file from a raster image is a common and costly bottleneck in modern design workflows, yet remains challenging since editability depends on recovering multi-modal attributes, such as… [Agents and Planning]
  - Authors: Jooyeol Yun, Jintae Park, Hyesu Lim, Junha Hyung, Hyungjin Chung, Jaegul Choo
  - Submitted by: Jooyeol Yun | Upvotes: 54 | Comments: 1
...
- [CodeNib: A Multi-View Data System for Serving Repository Context to Coding Agents](https://huggingface.co/papers/2607.25431) [Upvote: 34] Coding agents repeatedly search, navigate, and retain context from evolving repositories, but disconnected indexes, language servers, and task-local histories force repeated discovery and obscure lifecycle costs. [Agents and Planning]
  ...
  - Submitted by: Zhongming Yu | Upvotes: 34 | Comments: 1
...
- [Keep It InMind: Benchmarking the Implicit-Association Blind Spot in Agent Memory](https://huggingface.co/papers/2607.24368) [Upvote: 24] Long-term memory systems store what a user says in an external store and retrieve it when a related query arrives. [Agents and Planning]
  - Authors: Ruizhe Li, Mingxuan Du, Benfeng Xu, Zhendong Mao
  - Submitted by: Ruizhe Li | Upvotes: 24 | Comments: 1
...
- [Where Quality Breaks in Compressed Short-Text Generation: Staged Bottleneck Localization](https://huggingface.co/papers/2607.24176) [Upvote: 3] Compressed short-text generators can fail in two different places: the codec may discard information before generation starts, or the latent generator may produce weak codes. [LLMs and Language]
  - Authors: Alexey Gavrilov, Alan-Barsag Gazzaev, Sergey Muravyov
  - Submitted by: Alexey Gavrilov | Upvotes: 3 | Comments: 1
...
- [Mapping CVEs to MITRE ATT&CK Techniques: A Curated Gold-Set Classifier and the Limits of LLM-Assisted Label Expansion](https://huggingface.co/papers/2607.25572) [Upvote: 2] We present a reproducible pipeline for mapping Common Vulnerabilities and Exposures (CVEs) to MITRE ATT&CK Enterprise techniques from free-text vulnerability descriptions. [LLMs and Language]
  - Authors: Cédric Bonhomme, Alexandre Dulaunoy
  - Submitted by: Cédric | Upvotes: 2 | Comments: 1
...
- [Pass the Baton: Trajectory-Relayed On-Policy Distillation](https://huggingface.co/papers/2607.26057) [Upvote: 21] On-policy distillation (OPD) grounds token-level supervision in the student's own trajectory, yet suffers from prefix failure: once the student commits to a wrong reasoning direction, all subsequent generation builds… [Other AI]
  - Authors: Haolei Xu, Xiaowen Xu, Haiwen Hong, Zixuan Ni, Hongxing Li, Yiwen Qiu, Weiming Lu, Yongliang Shen
  - Submitted by: xhl | Upvotes: 21 | Comments: 1
...
- [Shieldstral](https://huggingface.co/papers/2607.25857) [Upvote: 10] We introduce Shieldstral, a 3B-parameter policy-adaptive multimodal safety classifier that matches or outperforms models nearly 7times its size on text safety benchmarks and sets a new state of the art on multimodal… [Other AI]
...
- [MODUS: Decoder-Only Any-to-Any Modeling of Diverse Modalities](https://huggingface.co/papers/2607.25948) [Upvote: 8] Any-to-any models predict any modality from any combination of others within a single network, a formulation used in multimodal vision and vision-language models, and increasingly in scientific domains such as ecology… [Other AI]
  ...
  - Submitted by: Mingqiao Ye | Upvotes: 8 | Comments: 1
...
- [Edge-Aware Thermal Infrared UAV Swarm Tracking](https://huggingface.co/papers/2607.12544) [Upvote: 0] Thermal infrared (TIR) imaging is essential for UAV swarm operations in visually degraded environments. [Other AI]
  - Authors: Yu-Hsi Chen
...
- [Reinforcement Learning for Code Optimization](https://huggingface.co/papers/2607.25970) [Upvote: 3] RL for code correctness is now established: have the model generate a program, run it against hidden test cases, and reward solutions that pass. [Learning, Optimization, and Theory]
  - Authors: Pierre Chambon, Kunhao Zheng, Juliette Decugis, Benoit Sagot, Gabriel Synnaeve
  - Submitted by: Pierre Chambon | Upvotes: 3 | Comments: 1
...
- [Temporal-Distance JEPA: Plan-Aware Representation Learning for Latent World Model Predictive Control](https://huggingface.co/papers/2607.25337) [Upvote: 1] Joint-Embedding Predictive Architectures (JEPAs) learn world models by predicting in representation space rather than reconstructing pixels, making them a natural backbone for latent model predictive control from… [Learning, Optimization, and Theory]
  - Authors: Jiaxin Bai, Jiaxuan Xiong
  - Submitted by: Jiaxin | Upvotes: 1 | Comments: 1
...
- [Projection Pursuit CPCANet for Domain Generalization](https://huggingface.co/papers/2607.22117) [Upvote: 0] Domain Generalization (DG) aims to learn representations robust to distribution shifts. [Learning, Optimization, and Theory]
...
- [Agent Retrieval Bench: Evaluating Repository Context Retrieval for Coding Agents](https://huggingface.co/papers/2607.24882) [Upvote: 2] Modern coding agents are usually evaluated by whether they eventually produce a correct patch, but patch generation depends on an earlier context-acquisition stage: finding the repository files needed for the task. [Retrieval, Knowledge, and RAG]
  - Authors: Bowen Qin, Yi Xie
  - Submitted by: Bowen Qin | Upvotes: 2 | Comments: 1
...
- [HiFi-UMI: Learning Deployable Manipulation Policies from High-Fidelity UMI Data Alone](https://huggingface.co/papers/2607.25895) [Upvote: 123] Learning deployable manipulation policies is bottlenecked by the scarcity of data that is both high-fidelity and scalable. [Robotics and Embodied AI]
  ...
  - Submitted by: Jiawei Wang | Upvotes: 123 | Comments: 1
