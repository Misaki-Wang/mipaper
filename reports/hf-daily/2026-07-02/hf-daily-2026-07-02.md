...
- The highest-voted visible paper is “PerceptionRubrics: Calibrating Multimodal Evaluation to Human Perception”, currently at 38 votes.
...
- [ELDR: Expert-Locality-Aware Decode Routing for PD-Disaggregated MoE Serving](https://huggingface.co/papers/2607.00466) [Upvote: 24] In prefill-decode (PD) disaggregated LLM serving, each request is assigned to a decode worker after prefill. [Other AI]
  - Authors: Sangjin Choi, Sukmin Cho, Yifan Xiong, Ziyue Yang, Youngjin Kwon, Peng Cheng
  - Submitted by: Sukmin Cho | Upvotes: 24 | Comments: 3
...
- [PerceptionRubrics: Calibrating Multimodal Evaluation to Human Perception](https://huggingface.co/papers/2606.28322) [Upvote: 38] We introduce PerceptionRubrics, a rubric-based evaluation framework that addresses the gap between saturated benchmark scores and real-world brittleness. [Multimodal Understanding and Vision]
  ...
  - Submitted by: Yana Wei | Upvotes: 38 | Comments: 3
...
- [When LLMs Read Tables Carelessly: Measuring and Reducing Data Referencing Errors](https://huggingface.co/papers/2606.32029) [Upvote: 7] While large language models (LLMs) perform well on table tasks, they still make data referencing errors (DREs), i.e., incorrectly citing or omitting table values, despite understanding the table structure. [LLMs and Language]
  - Authors: Yuqing Yang, Qi Zhu, Zhen Han, Boran Han, Zhengyuan Shen, Shuai Wang, Vassilis N. Ioannidis, Huzefa Rangwala
  - Submitted by: Yuqing Yang | Upvotes: 7 | Comments: 2
...
- [Graph-Native Reinforcement Learning Enables Traceable Scientific Hypothesis Generation through Conceptual Recombination](https://huggingface.co/papers/2607.00924) [Upvote: 9] Accelerating materials discovery requires AI systems that can generate scientifically valid hypotheses through multi-step, domain-grounded reasoning. [Learning, Optimization, and Theory]
  - Authors: Subhadeep Pal, Shashwat Sourav, Tirthankar Ghosal, Markus J. Buehler
  - Submitted by: Markus Buehler | Upvotes: 9 | Comments: 2
...
- [Perceive-to-Reason: Decoupling Perception and Reasoning for Fine-Grained Visual Reasoning](https://huggingface.co/papers/2607.01191) [Upvote: 13] Fine-grained visual reasoning remains challenging for vision-language models, especially when small but critical visual cues are buried in high-resolution images. [Reasoning, Alignment, and Evaluation]
  ...
  - Submitted by: Hongxing Li | Upvotes: 13 | Comments: 2
...
- [ASPIRE: Agentic /Skills Discovery for Robotics](https://huggingface.co/papers/2607.00272) [Upvote: 18] Traditional robot programming is challenging: it requires orchestrating multimodal perception, managing physical contact dynamics, and handling diverse configurations and execution failures. [Robotics and Embodied AI]
