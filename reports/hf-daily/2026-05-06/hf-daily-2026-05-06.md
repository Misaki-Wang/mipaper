# Hugging Face Daily Papers Report (2026-05-06)

- Source: https://huggingface.co/papers/date/2026-05-06
- Classifier: rule
- Total Papers: 20

## Today's Hotspots and Trend

- Agents and Planning: 6 papers (30.00%); representative paper: ARIS: Autonomous Research via Adversarial Multi-Agent Collaboration.
- Datasets and Benchmarks: 3 papers (15.00%); representative paper: PatRe: A Full-Stage Office Action and Rebuttal Generation Benchmark for Patent Examination.
- Learning, Optimization, and Theory: 3 papers (15.00%); representative paper: SplAttN: Bridging 2D and 3D with Gaussian Soft Splatting and Attention for Point Cloud Completion.
- Trend: Today's dominant clusters are Agents and Planning / Datasets and Benchmarks / Learning, Optimization, and Theory; this suggests that agent papers emphasize tool use, planning, and deployable workflows. The strongest visible attention is on “ARIS: Autonomous Research via Adversarial Multi-Agent Collaboration” (63 upvotes).
...
- Agents and Planning: 6 papers (30.00%)
- Datasets and Benchmarks: 3 papers (15.00%)
- Learning, Optimization, and Theory: 3 papers (15.00%)
- Multimodal Understanding and Vision: 3 papers (15.00%)
- Other AI: 3 papers (15.00%)
- Domain Applications: 1 papers (5.00%)
...
- LiXinran: 1 papers
- Mathsion Wong: 1 papers
- Minbyul Jeong: 1 papers
- PeiyangLiu: 1 papers

## Brief Notes

- The top topic today is “Agents and Planning”, with 6 papers, accounting for 30.00%。
- The most active submitter is taesiri， with 4 papers。
- The highest-voted visible paper is “ARIS: Autonomous Research via Adversarial Multi-Agent Collaboration”, currently at 63 votes.
- Today's dominant clusters are Agents and Planning / Datasets and Benchmarks / Learning, Optimization, and Theory; this suggests that agent papers emphasize tool use, planning, and deployable workflows. The strongest visible attention is on “ARIS: Autonomous Research via Adversarial Multi-Agent Collaboration” (63 upvotes).

## Categorized Paper Briefs

### Agents and Planning (6 papers)

- [ARIS: Autonomous Research via Adversarial Multi-Agent Collaboration](https://huggingface.co/papers/2605.03042) [Upvote: 63] This report describes ARIS (Auto-Research-in-sleep), an open-source research harness for autonomous research, including its architecture, assurance mechanisms, and early deployment experience. [Agents and Planning]
  - Authors: Ruofeng Yang, Yongcan Li, Shuai Li
  - Submitted by: Ruofeng Yang | Upvotes: 63 | Comments: 8
  - Links: [HF](https://huggingface.co/papers/2605.03042) / [arXiv](https://arxiv.org/pdf/2605.03042) / [Cool](https://papers.cool/arxiv/2605.03042)
  - <details>
...
- [OpenSeeker-v2: Pushing the Limits of Search Agents with Informative and High-Difficulty Trajectories](https://huggingface.co/papers/2605.04036) [Upvote: 27] Deep search capabilities have become an indispensable competency for frontier Large Language Model (LLM) agents, yet their development remains dominated by industrial giants. [Agents and Planning]
  - Authors: Yuwen Du, Rui Ye, Shuo Tang, Keduan Huang, Xinyu Zhu, Yuzhu Cai, Siheng Chen
  - Submitted by: taesiri | Upvotes: 27 | Comments: 0
  - Links: [HF](https://huggingface.co/papers/2605.04036) / [arXiv](https://arxiv.org/pdf/2605.04036) / [Cool](https://papers.cool/arxiv/2605.04036)
  - <details>
    <summary>Abstract</summary>
...
- [HeavySkill: Heavy Thinking as the Inner Skill in Agentic Harness](https://huggingface.co/papers/2605.02396) [Upvote: 9] Recent advances in agentic harness with orchestration frameworks that coordinate multiple agents with memory, skills, and tool use have achieved remarkable success in complex reasoning tasks. [Agents and Planning]
  ...
  - Submitted by: WangJianing | Upvotes: 9 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2605.02396) / [arXiv](https://arxiv.org/pdf/2605.02396) / [Cool](https://papers.cool/arxiv/2605.02396)
  - <details>
    <summary>Abstract</summary>
...
- [Reinforcement Learning for LLM-based Multi-Agent Systems through Orchestration Traces](https://huggingface.co/papers/2605.02801) [Upvote: 2] As large language model (LLM) agents evolve from isolated tool users into coordinated teams, reinforcement learning (RL) must optimize not only individual actions but also how work is spawned, delegated, communicated,… [Agents and Planning]
  - Authors: Chenchen Zhang
  - Submitted by: Chenchen Zhang | Upvotes: 2 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2605.02801) / [arXiv](https://arxiv.org/pdf/2605.02801) / [Cool](https://papers.cool/arxiv/2605.02801)
  - <details>
    <summary>Abstract</summary>
...
- [Workspace-Bench 1.0: Benchmarking AI Agents on Workspace Tasks with Large-Scale File Dependencies](https://huggingface.co/papers/2605.03596) [Upvote: 2] Workspace learning requires AI agents to identify, reason over, exploit, and update explicit and implicit dependencies among heterogeneous files in a worker's workspace, enabling them to complete both routine and… [Agents and Planning]
  ...
  - Links: [HF](https://huggingface.co/papers/2605.03596) / [arXiv](https://arxiv.org/pdf/2605.03596) / [Cool](https://papers.cool/arxiv/2605.03596)
  - <details>
    <summary>Abstract</summary>
...
- [SymptomAI: Towards a Conversational AI Agent for Everyday Symptom Assessment](https://huggingface.co/papers/2605.04012) [Upvote: 2] Language models excel at diagnostic assessments on currated medical case-studies and vignettes, performing on par with, or better than, clinical professionals. [Agents and Planning]
  ...
  - Submitted by: taesiri | Upvotes: 2 | Comments: 0
  - Links: [HF](https://huggingface.co/papers/2605.04012) / [arXiv](https://arxiv.org/pdf/2605.04012) / [Cool](https://papers.cool/arxiv/2605.04012)
  - <details>
    <summary>Abstract</summary>
...
- [PatRe: A Full-Stage Office Action and Rebuttal Generation Benchmark for Patent Examination](https://huggingface.co/papers/2605.03571) [Upvote: 4] Patent examination is a complex, multi-stage process requiring both technical expertise and legal reasoning, increasingly challenged by rising application volumes. [Datasets and Benchmarks]
  - Authors: Qiyao Wang, Xinyi Chen, Longze Chen, Hongbo Wang, Hamid Alinejad-Rokny, Yuan Lin, Min Yang
  - Submitted by: Mathsion Wong | Upvotes: 4 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2605.03571) / [arXiv](https://arxiv.org/pdf/2605.03571) / [Cool](https://papers.cool/arxiv/2605.03571)
  - <details>
    <summary>Abstract</summary>
...
- [ESARBench: A Benchmark for Agentic UAV Embodied Search and Rescue](https://huggingface.co/papers/2605.01371) [Upvote: 1] The rapid advancement of Multimodal Large Language Models (MLLMs) has empowered Unmanned Aerial Vehicle (UAV) with exceptional capabilities in spatial reasoning, semantic understanding, and complex decision-making,… [Datasets and Benchmarks]
  - Authors: Daoxuan Zhang, Ping Chen, Jianyi Zhou, Shuo Yang
  - Submitted by: 张道瑄 | Upvotes: 1 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2605.01371) / [arXiv](https://arxiv.org/pdf/2605.01371) / [Cool](https://papers.cool/arxiv/2605.01371)
  - <details>
    <summary>Abstract</summary>
...
- [A Benchmark for Interactive World Models with a Unified Action Generation Framework](https://huggingface.co/papers/2605.03941) [Upvote: 1] Achieving Artificial General Intelligence (AGI) requires agents that learn and interact adaptively, with interactive world models providing scalable environments for perception, reasoning, and action. [Datasets and Benchmarks]
  ...
  - Links: [HF](https://huggingface.co/papers/2605.03941) / [arXiv](https://arxiv.org/pdf/2605.03941) / [Cool](https://papers.cool/arxiv/2605.03941)
  - <details>
    <summary>Abstract</summary>
...
- [SplAttN: Bridging 2D and 3D with Gaussian Soft Splatting and Attention for Point Cloud Completion](https://huggingface.co/papers/2605.01466) [Upvote: 2] Although multi-modal learning has advanced point cloud completion, the theoretical mechanisms remain unclear. [Learning, Optimization, and Theory]
  - Authors: Zhaoyang Li, Zhichao You, Tianrui Li
  - Submitted by: Zhaoyang LI | Upvotes: 2 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2605.01466) / [arXiv](https://arxiv.org/pdf/2605.01466) / [Cool](https://papers.cool/arxiv/2605.01466)
  - <details>
    <summary>Abstract</summary>
...
- [StateSMix: Online Lossless Compression via Mamba State Space Models and Sparse N-gram Context Mixing](https://huggingface.co/papers/2605.02904) [Upvote: 1] We present StateSMix, a fully self-contained lossless compressor that couples an online-trained Mamba-style State Space Model (SSM) with sparse n-gram context mixing and arithmetic coding. [Learning, Optimization, and Theory]
  - Authors: Roberto Tacconelli
  - Submitted by: Roberto Tacconelli | Upvotes: 1 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2605.02904) / [arXiv](https://arxiv.org/pdf/2605.02904) / [Cool](https://papers.cool/arxiv/2605.02904)
  - <details>
    <summary>Abstract</summary>
...
- [Skills-Coach: A Self-Evolving Skill Optimizer via Training-Free GRPO](https://huggingface.co/papers/2604.27488) [Upvote: 0] We introduce Skills-Coach, a novel automated framework designed to significantly enhance the self-evolution of skills within Large Language Model (LLM)-based agents. [Learning, Optimization, and Theory]
  - Authors: Yu Tian, Jiawei Chen, Lifan Zheng, Mingxiang Tao, Xinyi Zeng, Zhaoxia Yin, Hang Su, Xian Sun
  - Submitted by: Yu Tian | Upvotes: 0 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2604.27488) / [arXiv](https://arxiv.org/pdf/2604.27488) / [Cool](https://papers.cool/arxiv/2604.27488)
  - <details>
    <summary>Abstract</summary>
...
- [Beyond SFT-to-RL: Pre-alignment via Black-Box On-Policy Distillation for Multimodal RL](https://huggingface.co/papers/2604.28123) [Upvote: 34] The standard post-training recipe for large multimodal models (LMMs) applies supervised fine-tuning (SFT) on curated demonstrations followed by reinforcement learning with verifiable rewards (RLVR). [Multimodal Understanding and Vision]
  ...
  - Submitted by: Sudong Wang | Upvotes: 34 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2604.28123) / [arXiv](https://arxiv.org/pdf/2604.28123) / [Cool](https://papers.cool/arxiv/2604.28123)
  - <details>
    <summary>Abstract</summary>
...
- [Video Generation with Predictive Latents](https://huggingface.co/papers/2605.02134) [Upvote: 5] Video Variational Autoencoder (VAE) enables latent video generative modeling by mapping the visual world into compact spatiotemporal latent spaces, improving training efficiency and stability. [Multimodal Understanding and Vision]
  - Authors: Yian Zhao, Feng Wang, Qiushan Guo, Chang Liu, Xiangyang Ji, Jian Zhang, Jie Chen
  - Submitted by: Zhao Yian | Upvotes: 5 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2605.02134) / [arXiv](https://arxiv.org/pdf/2605.02134) / [Cool](https://papers.cool/arxiv/2605.02134)
  - <details>
    <summary>Abstract</summary>
...
- [The TTS-STT Flywheel: Synthetic Entity-Dense Audio Closes the Indic ASR Gap Where Commercial and Open-Source Systems Fail](https://huggingface.co/papers/2605.03073) [Upvote: 1] Niche-domain Indic ASR -- digit strings, currency amounts, addresses, brand names, English/Indic codemix -- is under-served by both open-source SOTA and commercial systems. [Multimodal Understanding and Vision]
  - Authors: Venkata Pushpak Teja Menta
  - Submitted by: Venkata Pushpak Teja Menta | Upvotes: 1 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2605.03073) / [arXiv](https://arxiv.org/pdf/2605.03073) / [Cool](https://papers.cool/arxiv/2605.03073)
  - <details>
    <summary>Abstract</summary>
...
- [X2SAM: Any Segmentation in Images and Videos](https://huggingface.co/papers/2605.00891) [Upvote: 15] Multimodal Large Language Models (MLLMs) have demonstrated strong image-level visual understanding and reasoning, yet their pixel-level perception across both images and videos remains limited. [Other AI]
  - Authors: Hao Wang, Limeng Qiao, Chi Zhang, Lin Ma, Guanglu Wan, Xiangyuan Lan, Xiaodan Liang
  - Submitted by: wang | Upvotes: 15 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2605.00891) / [arXiv](https://arxiv.org/pdf/2605.00891) / [Cool](https://papers.cool/arxiv/2605.00891)
  - <details>
    <summary>Abstract</summary>
...
- [SVGS: Enhancing Gaussian Splatting Using Primitives with Spatially Varying Colors](https://huggingface.co/papers/2411.18966) [Upvote: 3] Gaussian Splatting demonstrates impressive results in multi-view reconstruction based on Gaussian explicit representations. [Other AI]
  - Authors: Rui Xu, Wenyue Chen, Jiepeng Wang, Yuan Liu, Peng Wang, Cheng Lin, Shiqing Xin, Xin Li, Wenping Wang, Taku Komura
  - Submitted by: Rui Xu | Upvotes: 3 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2411.18966) / [arXiv](https://arxiv.org/pdf/2411.18966) / [Cool](https://papers.cool/arxiv/2411.18966)
  - <details>
    <summary>Abstract</summary>
...
- [TCDA: Thread-Constrained Discourse-Aware Modeling for Conversational Sentiment Quadruple Analysis](https://huggingface.co/papers/2605.01717) [Upvote: 1] Conversational Aspect-based Sentiment Quadruple Analysis (DiaASQ) needs to capture the complex interrelationships in multiple rounds of dialogues. [Other AI]
  - Authors: Xinran Li, Xinze Che, Yifan Lyu, Zhiqi Huang, Xiujuan Xu
  - Submitted by: LiXinran | Upvotes: 1 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2605.01717) / [arXiv](https://arxiv.org/pdf/2605.01717) / [Cool](https://papers.cool/arxiv/2605.01717)
  - <details>
    <summary>Abstract</summary>
...
- [Healthcare AI GYM for Medical Agents](https://huggingface.co/papers/2605.02943) [Upvote: 1] Clinical reasoning demands multi-step interactions -- gathering patient history, ordering tests, interpreting results, and making safe treatment decisions -- yet a unified training environment provides the breadth of… [Domain Applications]
  - Authors: Minbyul Jeong
  - Submitted by: Minbyul Jeong | Upvotes: 1 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2605.02943) / [arXiv](https://arxiv.org/pdf/2605.02943) / [Cool](https://papers.cool/arxiv/2605.02943)
  - <details>
    <summary>Abstract</summary>
...
- [Chain of Evidence: Pixel-Level Visual Attribution for Iterative Retrieval-Augmented Generation](https://huggingface.co/papers/2605.01284) [Upvote: 0] Iterative Retrieval-Augmented Generation (iRAG) has emerged as a powerful paradigm for answering complex multi-hop questions by progressively retrieving and reasoning over external documents. [Retrieval, Knowledge, and RAG]
  - Authors: Peiyang Liu, Ziqiang Cui, Xi Wang, Di Liang, Wei Ye
  - Submitted by: PeiyangLiu | Upvotes: 0 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2605.01284) / [arXiv](https://arxiv.org/pdf/2605.01284) / [Cool](https://papers.cool/arxiv/2605.01284)
  - <details>
    <summary>Abstract</summary>
