...
- Agents and Planning: 2 papers (13.33%); representative paper: Automating the Design of Embodied Agent Architectures.
- Multimodal Understanding and Vision: 2 papers (13.33%); representative paper: OmniTacTune: Policy-Agnostic Real-World RL for Tactile Residual Adaptation of Visual Policies.
- Other AI: 2 papers (13.33%); representative paper: Infinite Worlds with Versatile Interactions.
- Trend: Today's dominant clusters are Agents and Planning / Multimodal Understanding and Vision / Other AI; this suggests several parallel trends: multimodal work is moving from isolated perception toward generation, agents, and action; agent papers emphasize tool use, planning, and deployable workflows. The strongest visible attention is on “Accurate, Interdisciplinary and Transparent Structure-property Understanding with Deep Native Structural Reasoning” (70 upvotes).
...
- Multimodal Understanding and Vision: 2 papers (13.33%)
- Other AI: 2 papers (13.33%)
- Reasoning, Alignment, and Evaluation: 2 papers (13.33%)
- Robotics and Embodied AI: 2 papers (13.33%)
- Domain Applications: 1 papers (6.67%)
- LLMs and Language: 1 papers (6.67%)
- Learning, Optimization, and Theory: 1 papers (6.67%)
- Multimodal Agents: 1 papers (6.67%)
- Retrieval, Knowledge, and RAG: 1 papers (6.67%)
...
- The top topic today is “Agents and Planning”, with 2 papers, accounting for 13.33%。
- The most active submitter is taesiri， with 3 papers。
- The highest-voted visible paper is “Accurate, Interdisciplinary and Transparent Structure-property Understanding with Deep Native Structural Reasoning”, currently at 70 votes.
...
- [Automating the Design of Embodied Agent Architectures](https://huggingface.co/papers/2606.30111) [Upvote: 4] Embodied agents are typically built as hand-designed compositions of perception, memory, planning, and action modules. [Agents and Planning]
  - Authors: Jian Zhou, Sihao Lin, Jin Li, Shuai Fu, Gengze Zhou, Qi Wu
  - Submitted by: Zhou | Upvotes: 4 | Comments: 1
...
- [AgentLens: Production-Assessed Trajectory Reviews for Coding Agent Evaluation](https://huggingface.co/papers/2607.06624) [Upvote: 3] We present AgentLens, a production-assessed benchmark for interactive code agents. [Agents and Planning]
  - Authors: Andrey Podivilov, Vadim Lomshakov, Sergey Savin, Matvei Startsev, Roman Pozharskiy, Maksim Parshin, Sergey Nikolenko
  - Submitted by: Vadim Lo | Upvotes: 3 | Comments: 1
...
- [Infinite Worlds with Versatile Interactions](https://huggingface.co/papers/2607.07534) [Upvote: 21] We present LingBot-World 2.0 (also known as LingBot-World-Infinity), an advanced iteration of LingBot-World featuring four distinct upgrades. (1) Our model achieves an unbounded interaction horizon while maintaining… [Other AI]
  ...
  - Submitted by: taesiri | Upvotes: 21 | Comments: 0
...
- [WildCity: A Real-World City-Scale Testbed for Rendering, Simulation, and Spatial Intelligence](https://huggingface.co/papers/2607.06838) [Upvote: 4] Humans can navigate an unfamiliar city and gradually form a coherent spatial mental map spanning tens of square kilometers. [Other AI]
...
- [Accurate, Interdisciplinary and Transparent Structure-property Understanding with Deep Native Structural Reasoning](https://huggingface.co/papers/2607.07708) [Upvote: 70] Structure-property relationships are foundational to biology, chemistry and materials science, where function, reactivity and physical response emerge from spatial, chemical and periodic organization. [Reasoning, Alignment, and Evaluation]
  ...
  - Submitted by: Jianyu Wu | Upvotes: 70 | Comments: 1
...
- [Wake up for Touch! Mask-isolated Tactile Alignment Learning in MLLMs](https://huggingface.co/papers/2607.00302) [Upvote: 0] Touch supplies the physical grounding needed to perceive intrinsic material properties, such as friction and compliance, that vision alone often cannot resolve. [Reasoning, Alignment, and Evaluation]
  - Authors: Yoonhyung Park, Minji Kim, Sungwon Moon, Jiyoung Lee
  - Submitted by: 김민지 | Upvotes: 0 | Comments: 1
...
- [Scaling Mixture-of-Experts Video Pretraining for Embodied Intelligence](https://huggingface.co/papers/2607.07675) [Upvote: 39] Despite the recent promise in robot control, video generative models suffer from a domain mismatch due to their primary focus on content creation. [Robotics and Embodied AI]
  ...
  - Submitted by: taesiri | Upvotes: 39 | Comments: 0
...
- [RoboDojo: A Unified Sim-and-Real Benchmark for Comprehensive Evaluation of Generalist Robot Manipulation Policies](https://huggingface.co/papers/2607.04434) [Upvote: 6] Generalist robot manipulation policies have advanced rapidly, yet existing benchmarks remain limited in systematically evaluating their capabilities. [Robotics and Embodied AI]
  ...
  - Submitted by: Tianxing Chen | Upvotes: 6 | Comments: 1
...
- [Imagined Rollouts are Kinematic, Not Dynamic: A Diagnosis of Long-Horizon World-Model Failure](https://huggingface.co/papers/2607.05966) [Upvote: 1] Long-horizon failure in world models is conventionally attributed to compounding error, a generic framing that does not distinguish what kind of error compounds. [Domain Applications]
  ...
  - Submitted by: Finn Rasmus Schäfer | Upvotes: 1 | Comments: 1
...
- [Teaching LLMs a Low-Resource Language: Enhancing Code Completion in Pharo](https://huggingface.co/papers/2607.04939) [Upvote: 2] Large Language Models (LLMs) unlocked new possibilities in automated code writing, becoming the backbone of most code completion tools. [LLMs and Language]
  ...
  - Submitted by: Alessandro | Upvotes: 2 | Comments: 1
...
- [Single-Rollout Asynchronous Optimization for Agentic Reinforcement Learning](https://huggingface.co/papers/2607.07508) [Upvote: 3] Reinforcement learning (RL) is becoming increasingly important for post-training large language models (LLMs). [Learning, Optimization, and Theory]
...
- [Sparse Delta Memory: Scaling the State of Linear RNNs through Sparsity](https://huggingface.co/papers/2607.07386) [Upvote: 4] Linear attention models allow a fixed state size and a fixed amount of compute per token. [Retrieval, Knowledge, and RAG]
  ...
  - Submitted by: Niels Rogge | Upvotes: 4 | Comments: 1
