...
- The highest-voted visible paper is “Vidu S1: A Real-Time Interactive Video Generation Model”, currently at 107 votes.
...
- [Vidu S1: A Real-Time Interactive Video Generation Model](https://huggingface.co/papers/2607.03118) [Upvote: 107] We introduce Vidu S1, a real-time interactive video generation model supporting voice control of digital characters. [Multimodal Understanding and Vision]
  ...
  - Submitted by: Jintao Zhang | Upvotes: 107 | Comments: 6
...
- [LongE2V: Long-Horizon Event-based Video Reconstruction, Prediction, and Frame Interpolation with Video Diffusion Models](https://huggingface.co/papers/2607.08770) [Upvote: 19] Recovering high-quality video from sparse event streams is a challenging task. [Multimodal Understanding and Vision]
  - Authors: Cheng-De Fan, Chun-Wei Tuan Mu, Chen-Wei Chang, Chin-Yang Lin, Kun-Ru Wu, Yu-Chee Tseng, Yu-Lun Liu
  - Submitted by: Yu-Lun Liu | Upvotes: 19 | Comments: 1
...
- [OpenCoF: Learning to Reason Through Video Generation](https://huggingface.co/papers/2607.08763) [Upvote: 6] Reasoning has become a core capability for large models, especially when reliable decisions require understanding logical consequences. [Multimodal Understanding and Vision]
...
- [A Quantized Native Runtime for On-Device Semantic Audio Generation](https://huggingface.co/papers/2607.08526) [Upvote: 1] Semantic audio applications increasingly require controllable generation on commodity and embedded hardware rather than through framework-heavy datacenter stacks. [Multimodal Understanding and Vision]
  - Authors: Matteo Spanio, Antonio Rodà
  - Submitted by: Matteo Spanio | Upvotes: 1 | Comments: 3
...
- [SAM-MT: Real-Time Interactive Multi-Target Video Segmentation](https://huggingface.co/papers/2607.08688) [Upvote: 0] Modern Video Object Segmentation (VOS) involves tracking and segmenting user-specified targets. [Multimodal Understanding and Vision]
  - Authors: Ruiqi Shen, Chang Liu, Henghui Ding
  - Submitted by: Henghui Ding | Upvotes: 0 | Comments: 1
...
- [ARDY: Autoregressive Diffusion with Hybrid Representation for Interactive Human Motion Generation](https://huggingface.co/papers/2607.08741) [Upvote: 0] Generating realistic 3D human motions in real-time within interactive applications is key for animation, simulation, and humanoid robotics. [Multimodal Understanding and Vision]
...
- [Why Can't I Open My Drawer? Mitigating Object-Driven Shortcuts in Zero-Shot Compositional Action Recognition](https://huggingface.co/papers/2601.16211) [Upvote: 41] Zero-Shot Compositional Action Recognition (ZS-CAR) requires recognizing novel verb-object combinations composed of previously observed primitives. [Other AI]
  - Authors: Geo Ahn, Inwoong Lee, Taeoh Kim, Minho Shim, Dongyoon Wee, Jinwoo Choi
  - Submitted by: Geo Ahn | Upvotes: 41 | Comments: 1
...
- [Jet-Long: Efficient Long-Context Extension with Dynamic Bifocal RoPE](https://huggingface.co/papers/2607.07740) [Upvote: 7] Modern LLMs are increasingly deployed in long-context applications such as retrieval-augmented generation, repository-level coding, and agentic workflows whose accumulated reasoning and tool traces routinely push the… [Other AI]
...
- [PAST-TIDE: Prototype-Anchored Statement Tuning with Topic-Invariant Normalization for Stance Detection](https://huggingface.co/papers/2607.04690) [Upvote: 0] We introduce PAST-TIDE, our stance detection system addressing both subtasks of the StanceNakba Shared Task at NakbaNLP@LREC-COLING 2026. [Other AI]
  - Authors: Md. Shakhoyat Rahman Shujon, MD Jahid Hasan Jim, Md. Milon Islam, Md Rezwanul Haque, Fakhri Karray
  - Submitted by: Md Rezwanul Haque | Upvotes: 0 | Comments: 2
...
- [Linear Attention Architectures: Mechanisms, Trade-offs, and Cross-Layer Routing](https://huggingface.co/papers/2607.07953) [Upvote: 5] Self-attention lets each token retrieve information from the full context, but its quadratic cost in sequence length limits training and inference at long context. [Learning, Optimization, and Theory]
  - Authors: Tommaso Cerruti, Tim Rieder, George Rowlands, Lingfeng Jin, Imanol Schlag
  - Submitted by: Tommaso Cerruti | Upvotes: 5 | Comments: 1
...
- [A Sparse and Truncated State Vector Simulator for Peaked Circuits](https://huggingface.co/papers/2607.07816) [Upvote: 1] In a class of quantum circuits known as peaked circuits, the goal is to predict the most probable bit string at the output of the circuit. [Learning, Optimization, and Theory]
  - Authors: Diogo R. Ferreira
  - Submitted by: Diogo R. Ferreira | Upvotes: 1 | Comments: 1
...
- [DrugGen 2: A disease-aware language model for enhancing drug discovery](https://huggingface.co/papers/2607.08404) [Upvote: 12] Current computational approaches for drug design typically focus on generating molecules conditioned on specific targets or general molecular properties, often neglecting the influence of disease context on target… [LLMs and Language]
  ...
  - Submitted by: Ali Motahharynia | Upvotes: 12 | Comments: 1
...
- [Can Dialects Be Steered Like Languages? Sparse Neurons and Distributed Directions in Arabic LLMs](https://huggingface.co/papers/2607.03936) [Upvote: 0] A key challenge in Arabic NLP is the scarcity of dialectal data relative to Modern Standard Arabic (MSA), causing LLMs to overproduce MSA and struggle with dialectally accurate generation. [LLMs and Language]
  - Authors: Kareem Elozeiri, Mervat Abassy, Omar Kallas, Fahim Dalvi, Preslav Nakov, Kentaro Inui, Nadir Durrani
  - Submitted by: Kareem Elozeiri | Upvotes: 0 | Comments: 1
...
- [Ideas Have Genomes: Benchmarking Scientific Lineage Reasoning and Lineage-Grounded Idea Generation](https://huggingface.co/papers/2607.08758) [Upvote: 20] Scientific ideas rarely start from a blank page. [Reasoning, Alignment, and Evaluation]
  ...
  - Submitted by: taesiri | Upvotes: 20 | Comments: 3
...
- [CausalDS: Benchmarking Causal Reasoning in Data-Science Agents](https://huggingface.co/papers/2607.08093) [Upvote: 1] Large language models (LLMs) increasingly act as integrated data-science agents, combining abstract reasoning with advanced tool use. [Reasoning, Alignment, and Evaluation]
  ...
  - Submitted by: Andrej Leban | Upvotes: 1 | Comments: 1
...
- [Remember When It Matters: Proactive Memory Agent for Long-Horizon Agents](https://huggingface.co/papers/2607.08716) [Upvote: 1] In long-horizon tasks, decision-relevant state is often scattered across an expanding trajectory, while the action agent must surface it and act. [Agents and Planning]
  - Authors: Yifan Wu, Lizhu Zhang, Yuhang Zhou, Mingyi Wang, Bo Peng, Serena Li, Xiangjun Fan, Zhuokai Zhao
  - Submitted by: Yifan Wu | Upvotes: 1 | Comments: 1
...
- [UniClawBench: A Universal Benchmark for Proactive Agents on Real-World Tasks](https://huggingface.co/papers/2607.08768) [Upvote: 21] The rapid development of large language models and multimodal large language models has accelerated the emergence of proactive agents capable of operating everyday tools and assisting users in real-world environments. [Datasets and Benchmarks]
  - Authors: Zhekai Chen, Chengqi Duan, Kaiyue Sun, Bohao Li, Yuqing Wang, Manyuan Zhang, Xihui Liu
  - Submitted by: zhekai chen | Upvotes: 21 | Comments: 1
...
- [CineMobile: On-Device Image-to-Video Diffusion for Cinematic Camera Motion Generation](https://huggingface.co/papers/2607.03803) [Upvote: 8] The growing demand for image-to-video creation on mobile devices has increasingly focused on cinematic motion effects like bullet time, dolly zoom, slow motion, etc. [Multimodal Generative Modeling]
  - Authors: Xuyao Huang, Zelai Deng, Xu Wang, Xizhong Xiao, Zhijie Deng
  - Submitted by: Huang Xuyao | Upvotes: 8 | Comments: 1
