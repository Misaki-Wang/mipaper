# Hugging Face Daily Papers Report (2026-07-10)
...
- The highest-voted visible paper is “Vidu S1: A Real-Time Interactive Video Generation Model”, currently at 115 votes.
...
- [Vidu S1: A Real-Time Interactive Video Generation Model](https://huggingface.co/papers/2607.03118) [Upvote: 115] We introduce Vidu S1, a real-time interactive video generation model supporting voice control of digital characters. [Multimodal Understanding and Vision]
  ...
  - Submitted by: Jintao Zhang | Upvotes: 115 | Comments: 7
...
- [LongE2V: Long-Horizon Event-based Video Reconstruction, Prediction, and Frame Interpolation with Video Diffusion Models](https://huggingface.co/papers/2607.08770) [Upvote: 24] Recovering high-quality video from sparse event streams is a challenging task. [Multimodal Understanding and Vision]
  - Authors: Cheng-De Fan, Chun-Wei Tuan Mu, Chen-Wei Chang, Chin-Yang Lin, Kun-Ru Wu, Yu-Chee Tseng, Yu-Lun Liu
  - Submitted by: Yu-Lun Liu | Upvotes: 24 | Comments: 2
...
- [OpenCoF: Learning to Reason Through Video Generation](https://huggingface.co/papers/2607.08763) [Upvote: 10] Reasoning has become a core capability for large models, especially when reliable decisions require understanding logical consequences. [Multimodal Understanding and Vision]
...
- [ARDY: Autoregressive Diffusion with Hybrid Representation for Interactive Human Motion Generation](https://huggingface.co/papers/2607.08741) [Upvote: 5] Generating realistic 3D human motions in real-time within interactive applications is key for animation, simulation, and humanoid robotics. [Multimodal Understanding and Vision]
...
- [A Quantized Native Runtime for On-Device Semantic Audio Generation](https://huggingface.co/papers/2607.08526) [Upvote: 3] Semantic audio applications increasingly require controllable generation on commodity and embedded hardware rather than through framework-heavy datacenter stacks. [Multimodal Understanding and Vision]
  ...
  - Submitted by: Matteo Spanio | Upvotes: 3 | Comments: 3
...
- [SAM-MT: Real-Time Interactive Multi-Target Video Segmentation](https://huggingface.co/papers/2607.08688) [Upvote: 3] Modern Video Object Segmentation (VOS) involves tracking and segmenting user-specified targets. [Multimodal Understanding and Vision]
  - Authors: Ruiqi Shen, Chang Liu, Henghui Ding
  - Submitted by: Henghui Ding | Upvotes: 3 | Comments: 2
...
- [Why Can't I Open My Drawer? Mitigating Object-Driven Shortcuts in Zero-Shot Compositional Action Recognition](https://huggingface.co/papers/2601.16211) [Upvote: 46] Zero-Shot Compositional Action Recognition (ZS-CAR) requires recognizing novel verb-object combinations composed of previously observed primitives. [Other AI]
  - Authors: Geo Ahn, Inwoong Lee, Taeoh Kim, Minho Shim, Dongyoon Wee, Jinwoo Choi
  - Submitted by: Geo Ahn | Upvotes: 46 | Comments: 2
...
- [Enhancing In-context Panoramic Generation via Geometric-aware Pretraining](https://huggingface.co/papers/2607.08765) [Upvote: 15] In this work, we present Canvas360, a two-stage framework for in-context panoramic generation that combines geometry-aware pretraining with downstream task-specific fine-tuning. [Other AI]
  - Authors: Haoran Feng, Ruiyang Zhang, Longyi Zhang, Dizhe Zhang, Lu Qi
  - Submitted by: Haoran Feng | Upvotes: 15 | Comments: 1
...
- [PAST-TIDE: Prototype-Anchored Statement Tuning with Topic-Invariant Normalization for Stance Detection](https://huggingface.co/papers/2607.04690) [Upvote: 1] We introduce PAST-TIDE, our stance detection system addressing both subtasks of the StanceNakba Shared Task at NakbaNLP@LREC-COLING 2026. [Other AI]
  ...
  - Submitted by: Md Rezwanul Haque | Upvotes: 1 | Comments: 2
...
- [Linear Attention Architectures: Mechanisms, Trade-offs, and Cross-Layer Routing](https://huggingface.co/papers/2607.07953) [Upvote: 9] Self-attention lets each token retrieve information from the full context, but its quadratic cost in sequence length limits training and inference at long context. [Learning, Optimization, and Theory]
  - Authors: Tommaso Cerruti, Tim Rieder, George Rowlands, Lingfeng Jin, Imanol Schlag
  - Submitted by: Tommaso Cerruti | Upvotes: 9 | Comments: 1
...
- [A Sparse and Truncated State Vector Simulator for Peaked Circuits](https://huggingface.co/papers/2607.07816) [Upvote: 4] In a class of quantum circuits known as peaked circuits, the goal is to predict the most probable bit string at the output of the circuit. [Learning, Optimization, and Theory]
  - Authors: Diogo R. Ferreira
  - Submitted by: Diogo R. Ferreira | Upvotes: 4 | Comments: 2
...
- [DrugGen 2: A disease-aware language model for enhancing drug discovery](https://huggingface.co/papers/2607.08404) [Upvote: 15] Current computational approaches for drug design typically focus on generating molecules conditioned on specific targets or general molecular properties, often neglecting the influence of disease context on target… [LLMs and Language]
  ...
  - Submitted by: Ali Motahharynia | Upvotes: 15 | Comments: 2
...
- [Ideas Have Genomes: Benchmarking Scientific Lineage Reasoning and Lineage-Grounded Idea Generation](https://huggingface.co/papers/2607.08758) [Upvote: 28] Scientific ideas rarely start from a blank page. [Reasoning, Alignment, and Evaluation]
  ...
  - Submitted by: taesiri | Upvotes: 28 | Comments: 4
...
- [CausalDS: Benchmarking Causal Reasoning in Data-Science Agents](https://huggingface.co/papers/2607.08093) [Upvote: 1] Large language models (LLMs) increasingly act as integrated data-science agents, combining abstract reasoning with advanced tool use. [Reasoning, Alignment, and Evaluation]
  - Authors: Andrej Leban, Yuekai Sun
  - Submitted by: Andrej Leban | Upvotes: 1 | Comments: 2
...
- [Remember When It Matters: Proactive Memory Agent for Long-Horizon Agents](https://huggingface.co/papers/2607.08716) [Upvote: 7] In long-horizon tasks, decision-relevant state is often scattered across an expanding trajectory, while the action agent must surface it and act. [Agents and Planning]
  - Authors: Yifan Wu, Lizhu Zhang, Yuhang Zhou, Mingyi Wang, Bo Peng, Serena Li, Xiangjun Fan, Zhuokai Zhao
  - Submitted by: Yifan Wu | Upvotes: 7 | Comments: 2
...
- [UniClawBench: A Universal Benchmark for Proactive Agents on Real-World Tasks](https://huggingface.co/papers/2607.08768) [Upvote: 26] The rapid development of large language models and multimodal large language models has accelerated the emergence of proactive agents capable of operating everyday tools and assisting users in real-world environments. [Datasets and Benchmarks]
  - Authors: Zhekai Chen, Chengqi Duan, Kaiyue Sun, Bohao Li, Yuqing Wang, Manyuan Zhang, Xihui Liu
  - Submitted by: zhekai chen | Upvotes: 26 | Comments: 2
...
- [CineMobile: On-Device Image-to-Video Diffusion for Cinematic Camera Motion Generation](https://huggingface.co/papers/2607.03803) [Upvote: 10] The growing demand for image-to-video creation on mobile devices has increasingly focused on cinematic motion effects like bullet time, dolly zoom, slow motion, etc. [Multimodal Generative Modeling]
  - Authors: Xuyao Huang, Zelai Deng, Xu Wang, Xizhong Xiao, Zhijie Deng
  - Submitted by: Huang Xuyao | Upvotes: 10 | Comments: 2
