# Hugging Face Daily Papers Report (2026-06-30)

- Source: https://huggingface.co/papers/date/2026-06-30
- Classifier: rule
- Total Papers: 26

## Today's Hotspots and Trend

- Agents and Planning: 7 papers (26.92%); representative paper: GBC: Gradient-Based Connections for Optimizing Multi-Agent Systems.
- LLMs and Language: 5 papers (19.23%); representative paper: Formalizing Latent Thoughts: Four Axioms of Thought Representation in LLMs.
- Multimodal Understanding and Vision: 3 papers (11.54%); representative paper: Qwen-Image-2.0-RL Technical Report.
- Trend: Today's dominant clusters are Agents and Planning / LLMs and Language / Multimodal Understanding and Vision; this suggests several parallel trends: multimodal work is moving from isolated perception toward generation, agents, and action; agent papers emphasize tool use, planning, and deployable workflows. The strongest visible attention is on “PhysisForcing: Physics Reinforced World Simulator for Robotic Manipulation” (38 upvotes).

## Focus Topics

- Generative Foundations: 0 papers (0.00%)
- Multimodal Generative Modeling: 0 papers (0.00%)
- Multimodal Agents: 1 papers (3.85%)

## Topic Distribution

- Agents and Planning: 7 papers (26.92%)
- LLMs and Language: 5 papers (19.23%)
- Multimodal Understanding and Vision: 3 papers (11.54%)
- Robotics and Embodied AI: 3 papers (11.54%)
- Datasets and Benchmarks: 2 papers (7.69%)
- Learning, Optimization, and Theory: 2 papers (7.69%)
- Other AI: 2 papers (7.69%)
- Multimodal Agents: 1 papers (3.85%)
...
- The top topic today is “Agents and Planning”, with 7 papers, accounting for 26.92%。
- The most active submitter is taesiri， with 4 papers。
- The highest-voted visible paper is “PhysisForcing: Physics Reinforced World Simulator for Robotic Manipulation”, currently at 38 votes.
- Today's dominant clusters are Agents and Planning / LLMs and Language / Multimodal Understanding and Vision; this suggests several parallel trends: multimodal work is moving from isolated perception toward generation, agents, and action; agent papers emphasize tool use, planning, and deployable workflows. The strongest visible attention is on “PhysisForcing: Physics Reinforced World Simulator for Robotic Manipulation” (38 upvotes).

## Categorized Paper Briefs

### Agents and Planning (7 papers)

- [GBC: Gradient-Based Connections for Optimizing Multi-Agent Systems](https://huggingface.co/papers/2606.28187) [Upvote: 7] Multi-agent systems (MAS) built on large language models (LLMs) provide a promising framework for solving complex tasks through role specialization and structured interaction. [Agents and Planning]
  - Authors: Xiaocheng Yang, Abdulrahman Alrabah, Dilek Hakkani-Tür, Gokhan Tur
  - Submitted by: Xiaocheng Yang | Upvotes: 7 | Comments: 1
...
- [Thinking While Speaking: Inference-Time Knowledge Transfer for Responsive and Intelligent Conversational Voice Agents](https://huggingface.co/papers/2511.07397) [Upvote: 4] Voice agents face a fundamental tension: the reasoning, retrieval, and tool use that make foundation models capable are iterative and slow, while conversational interaction demands responses on a millisecond timescale. [Agents and Planning]
  - Authors: Vidya Srinivas, Zachary Englhardt, Shwetak Patel, Vikram Iyer, Maximus Powers
  - Submitted by: Vidya Srinivas | Upvotes: 4 | Comments: 2
...
- [Towards Automating Scientific Review with Google's Paper Assistant Tool](https://huggingface.co/papers/2606.28277) [Upvote: 3] Artificial intelligence is driving a revolution in scientific discovery, accelerating everything from hypothesis generation to mathematical theorem proving. [Agents and Planning]
...
- [Qwen-RobotNav Technical Report: A Scalable Navigation Model Designed for an Agentic Navigation System](https://huggingface.co/papers/2606.18112) [Upvote: 1] Agentic navigation systems require a base navigation model whose observation strategy can be externally reconfigured at inference time, because instruction following, object search, target tracking, and autonomous… [Agents and Planning]
  ...
  - Submitted by: Xiong-Hui Chen | Upvotes: 1 | Comments: 1
...
- [How Much Static Structure Do Code Agents Need? A Study of Deterministic Anchoring](https://huggingface.co/papers/2606.26979) [Upvote: 0] LLM-based code agents navigate repositories through keyword search but miss the structural relationships, such as call graphs, inheritance hierarchies, and configuration dependencies, that define how software actually… [Agents and Planning]
  - Authors: Zhihao Lin, Mingyi Zhou, Yizhuo Yang, Li Li
  - Submitted by: Zhihao Lin | Upvotes: 0 | Comments: 1
...
- [Boundary-Aware Context Grounding for A Low-Channel EEG Agent](https://huggingface.co/papers/2606.26519) [Upvote: 0] Large language models (LLMs) can make scientific software easier to use. [Agents and Planning]
  - Authors: Zhiyuan Xu, Yueqing Dai, Junling Li, Junwen Luo
  - Submitted by: Junwen | Upvotes: 0 | Comments: 1
...
- [MultiHashFormer: Hash-based Generative Language Models](https://huggingface.co/papers/2606.28057) [Upvote: 16] Language models (LMs) represent tokens using embedding matrices that scale linearly with the vocabulary size. [LLMs and Language]
  - Authors: Huiyin Xue, Atsuki Yamaguchi, Nikolaos Aletras
  - Submitted by: Atsuki Yamaguchi | Upvotes: 16 | Comments: 1
...
- [The Tatoxa System for Text Detoxification in Low-Resource Languages: The Case of Tatar](https://huggingface.co/papers/2606.26015) [Upvote: 8] Text detoxification, the automated detection and mitigation of abusive and harmful content, is essential for ensuring the safety of online communities and protecting users. [LLMs and Language]
  ...
  - Submitted by: MW | Upvotes: 8 | Comments: 1
...
- [Cluster, Route, Escalate: Cascaded Framework for Cost-Aware LLM Serving](https://huggingface.co/papers/2606.27457) [Upvote: 2] Efficient deployment of large language models (LLMs) in production forces a trade-off between accuracy and cost. [LLMs and Language]
...
- [To Run or Not to Run: Analyzing the Cost-Effectiveness of Code Execution in LLM-Based Program Repair](https://huggingface.co/papers/2606.26978) [Upvote: 1] LLM-based agents for program repair are increasingly built on a "generate-run-revise" paradigm, iteratively executing tests to evaluate and refine patches. [LLMs and Language]
  - Authors: Zhihao Lin, Junhua Zhu, Mingyi Zhou, Xin Wang, Zhensu Sun, Renyu Yang, David Lo, Li Li
  - Submitted by: Zhihao Lin | Upvotes: 1 | Comments: 1
...
- [Qwen-Image-2.0-RL Technical Report](https://huggingface.co/papers/2606.27608) [Upvote: 25] We present Qwen-Image-2.0-RL, a post-training pipeline that applies reinforcement learning from human feedback (RLHF) and on-policy distillation (OPD) to improve both the visual quality and instruction-following… [Multimodal Understanding and Vision]
  ...
  - Submitted by: taesiri | Upvotes: 25 | Comments: 3
...
- [SingGuard: A Policy-Adaptive Multimodal LLM Guardrail with Dynamic Reasoning](https://huggingface.co/papers/2606.22873) [Upvote: 11] Vision-language models (VLMs) are increasingly deployed in consumer, medical, financial, and enterprise applications. [Multimodal Understanding and Vision]
  - Authors: SingGuard Team
  - Submitted by: echoxvf | Upvotes: 11 | Comments: 1
...
- [Parallel Rollout Approximation for Pixel-Space Autoregressive Image Generation](https://huggingface.co/papers/2606.27978) [Upvote: 4] Pixel-space continuous-token autoregressive (AR) generation directly models images as sequences of raw pixel patches, avoiding discrete tokenization or a separately pretrained tokenizer. [Multimodal Understanding and Vision]
  - Authors: Jiayi Xu, Di He, Guolin Ke
  - Submitted by: Jiayi Xu | Upvotes: 4 | Comments: 1
...
- [PhysisForcing: Physics Reinforced World Simulator for Robotic Manipulation](https://huggingface.co/papers/2606.28128) [Upvote: 38] Video generation models have emerged as a promising paradigm for embodied world simulation. [Robotics and Embodied AI]
  ...
  - Submitted by: taesiri | Upvotes: 38 | Comments: 0
...
- [Translation as a Bridging Action: Transferring Manipulation Skills from Humans to Robots](https://huggingface.co/papers/2606.28133) [Upvote: 32] We study whether we can learn novel manipulation skills from human actions to a bi-manual robot with parallel grippers. [Robotics and Embodied AI]
  - Authors: Sijin Chen, Kaixuan Jiang, Haixin Shi, Yanhui Wang, Weiheng Zhong, Haosheng Li, Bo Jiang, Yuxiao Liu, Xihui Liu
  - Submitted by: sijin | Upvotes: 32 | Comments: 1
...
- [The Galaxy's Guide to the Tokenizer: A Benchmark for Scientific Foundation Models](https://huggingface.co/papers/2606.25610) [Upvote: 1] Tokenization is central to adapting scientific data for transformer-based foundation models, yet its impact on learned representations remains poorly understood. [Datasets and Benchmarks]
  ...
  - Submitted by: Mike Smith | Upvotes: 1 | Comments: 1
...
- [Learning to Fold: prizewinning solution at LeHome Challenge 2026 (1st place online, 2nd offline)](https://huggingface.co/papers/2606.27163) [Upvote: 4] I describe my solution to the LeHome Challenge 2026, an ICRA 2026 competition on bimanual garment folding. [Learning, Optimization, and Theory]
  - Authors: Ilia Larchenko
  - Submitted by: Ilia Larchenko | Upvotes: 4 | Comments: 1
...
- [NormGuard: Reward-Preserving Norm Constraints in Flow-Matching Reinforcement Learning](https://huggingface.co/papers/2606.27771) [Upvote: 3] Reinforcement learning (RL) post-training improves the reward alignment of flow-based generators, but often degrades perceptual quality in ways that are not captured by the reward proxy. [Learning, Optimization, and Theory]
  - Authors: Tianlin Pan, Lianyu Pang, Cheng Da, Huan Yang, Changqian Yu, Kun Gai, Wenhan Luo
  - Submitted by: Tianlin Pan | Upvotes: 3 | Comments: 1
...
- [MemoBench: Benchmarking World Modeling in Dynamically Changing Environments](https://huggingface.co/papers/2606.27537) [Upvote: 1] Video generation models aspire to simulate dynamic environments, and several benchmarks now evaluate memory consistency across frames. [Other AI]
  ...
  - Submitted by: Haoyu Chen | Upvotes: 1 | Comments: 1
...
- [ProMSA:Progressive Multimodal Search Agents for Knowledge-Based Visual Question Answering](https://huggingface.co/papers/2606.27974) [Upvote: 7] Knowledge-based Visual Question Answering (KB-VQA) requires models to combine image understanding with external knowledge. [Multimodal Agents]
  ...
  - Submitted by: Wu Zhengxian | Upvotes: 7 | Comments: 1
...
- [SimFoundry: Modular and Automated Scene Generation for Policy Learning and Evaluation](https://huggingface.co/papers/2606.28276) [Upvote: 6] Training and evaluating robot policies in the real world is costly and difficult to scale. [Reasoning, Alignment, and Evaluation]
