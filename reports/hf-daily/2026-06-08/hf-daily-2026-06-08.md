...
- LLMs and Language: 16 papers (32.00%); representative paper: Code2LoRA: Hypernetwork-Generated Adapters for Code Language Models under Software Evolution.
- Multimodal Understanding and Vision: 7 papers (14.00%); representative paper: Complexity-Balanced Diffusion Splitting.
- Agents and Planning: 6 papers (12.00%); representative paper: ArcANE: Do Role-Playing Language Agents Stay in Character at the Right Time?.
- Trend: Today's dominant clusters are LLMs and Language / Multimodal Understanding and Vision / Agents and Planning; this suggests several parallel trends: multimodal work is moving from isolated perception toward generation, agents, and action; agent papers emphasize tool use, planning, and deployable workflows. The strongest visible attention is on “Code2LoRA: Hypernetwork-Generated Adapters for Code Language Models under Software Evolution” (69 upvotes).

## Focus Topics

- Generative Foundations: 0 papers (0.00%)
- Multimodal Generative Modeling: 1 papers (2.00%)
- Multimodal Agents: 2 papers (4.00%)

## Topic Distribution

- LLMs and Language: 16 papers (32.00%)
- Multimodal Understanding and Vision: 7 papers (14.00%)
- Agents and Planning: 6 papers (12.00%)
- Other AI: 5 papers (10.00%)
- Reasoning, Alignment, and Evaluation: 5 papers (10.00%)
- Learning, Optimization, and Theory: 3 papers (6.00%)
- Datasets and Benchmarks: 2 papers (4.00%)
- Multimodal Agents: 2 papers (4.00%)
- Domain Applications: 1 papers (2.00%)
- Multimodal Generative Modeling: 1 papers (2.00%)
- Retrieval, Knowledge, and RAG: 1 papers (2.00%)
- Robotics and Embodied AI: 1 papers (2.00%)

## Top Submitters

- taesiri: 5 papers
- BruceLyu: 2 papers
- Jongwon Lim: 2 papers
- Boxi Cao: 1 papers
- Dan Jacobellis: 1 papers
- Fabian Immel: 1 papers

## Brief Notes

- The top topic today is “LLMs and Language”, with 16 papers, accounting for 32.00%。
- The most active submitter is taesiri， with 5 papers。
- The highest-voted visible paper is “Code2LoRA: Hypernetwork-Generated Adapters for Code Language Models under Software Evolution”, currently at 69 votes.
- Today's dominant clusters are LLMs and Language / Multimodal Understanding and Vision / Agents and Planning; this suggests several parallel trends: multimodal work is moving from isolated perception toward generation, agents, and action; agent papers emphasize tool use, planning, and deployable workflows. The strongest visible attention is on “Code2LoRA: Hypernetwork-Generated Adapters for Code Language Models under Software Evolution” (69 upvotes).

## Categorized Paper Briefs

### LLMs and Language (16 papers)

- [Code2LoRA: Hypernetwork-Generated Adapters for Code Language Models under Software Evolution](https://huggingface.co/papers/2606.06492) [Upvote: 69] Code language models need repository-level context to resolve imports, APIs, and project conventions. [LLMs and Language]
  - Authors: Liliana Hotsko, Yinxi Li, Yuntian Deng, Pengyu Nie
  - Submitted by: Liliana | Upvotes: 69 | Comments: 3
  - Links: [HF](https://huggingface.co/papers/2606.06492) / [arXiv](https://arxiv.org/pdf/2606.06492) / [Cool](https://papers.cool/arxiv/2606.06492)
  - <details>
...
- [Rethinking Continual Experience Internalization for Self-Evolving LLM Agents](https://huggingface.co/papers/2606.04703) [Upvote: 19] Experience internalization converts contextual experience from past interactions into reusable parametric capability, offering a promising path toward continual learning in large language models (LLMs). [LLMs and Language]
  - Authors: Jingwen Chen, Wenkai Yang, Shengda Fan, Wenbo Nie, Chenxing Sun, Shaodong Zheng, Yangen Hu, Lu Pan, Ke Zeng, Yankai Lin
  - Submitted by: Wenkai Yang | Upvotes: 19 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2606.04703) / [arXiv](https://arxiv.org/pdf/2606.04703) / [Cool](https://papers.cool/arxiv/2606.04703)
  - <details>
    <summary>Abstract</summary>
...
- [MAOAM: Unified Object and Material Selection with Vision-Language Models](https://huggingface.co/papers/2606.04880) [Upvote: 9] Selection is a core operation in interactive image editing. [LLMs and Language]
  ...
  - Submitted by: Jaden Park | Upvotes: 9 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2606.04880) / [arXiv](https://arxiv.org/pdf/2606.04880) / [Cool](https://papers.cool/arxiv/2606.04880)
  - <details>
    <summary>Abstract</summary>
...
- [LLMs Can Leak Training Data But Do They Want To? A Propensity-Aware Evaluation of Memorization in LLMs](https://huggingface.co/papers/2606.06286) [Upvote: 8] Large language models can reproduce training data, but existing memorization evaluations mostly measure whether models can be forced to do so, rather than whether they do so under ordinary use. [LLMs and Language]
  - Authors: Gianluca Barmina, Peter Schneider-Kamp, Lukas Galke Poech
  - Submitted by: Gianluca Barmina | Upvotes: 8 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2606.06286) / [arXiv](https://arxiv.org/pdf/2606.06286) / [Cool](https://papers.cool/arxiv/2606.06286)
  - <details>
    <summary>Abstract</summary>
...
- [Meta-Cognitive Memory Policy Optimization for Long-Horizon LLM Agents](https://huggingface.co/papers/2605.30159) [Upvote: 6] Memory-augmented LLM agents tackle complex long-horizon tasks by recursively summarizing interaction trajectories into compact memory. [LLMs and Language]
  - Authors: Ziyan Liu, Zhezheng Hao, Yeqiu Chen, Hong Wang, Jingren Hou, Ruiyi Ding, Yongkang Yang, Wence Ji, Wei Xia, Feng Liu
  - Submitted by: liu | Upvotes: 6 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2605.30159) / [arXiv](https://arxiv.org/pdf/2605.30159) / [Cool](https://papers.cool/arxiv/2605.30159)
  - <details>
    <summary>Abstract</summary>
...
- [The Shape of Addition: Geometric Structures of Arithmetic in Large Language Models](https://huggingface.co/papers/2606.03645) [Upvote: 4] Large Language Models exhibit paradoxical fragility in fundamental arithmetic, implying a disconnect between internal computation and discrete output. [LLMs and Language]
  - Authors: Liuyuan Wen, Xun Zhu, Lihao Huang, Wenbin Li, Yang Gao
  - Submitted by: Liuyuan Wen | Upvotes: 4 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2606.03645) / [arXiv](https://arxiv.org/pdf/2606.03645) / [Cool](https://papers.cool/arxiv/2606.03645)
  - <details>
    <summary>Abstract</summary>
...
- [AdaCodec: A Predictive Visual Code for Video MLLMs](https://huggingface.co/papers/2606.02569) [Upvote: 4] Video is temporally redundant: adjacent frames usually share most objects, background, and layout. [LLMs and Language]
  ...
  - Submitted by: Jiaqi Wang | Upvotes: 4 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2606.02569) / [arXiv](https://arxiv.org/pdf/2606.02569) / [Cool](https://papers.cool/arxiv/2606.02569)
  - <details>
    <summary>Abstract</summary>
...
- [Learning Geometric Representations from Videos for Spatial Intelligent Multimodal Large Language Models](https://huggingface.co/papers/2606.05833) [Upvote: 3] Multimodal Large Language Models (MLLMs) excel at 2D semantic understanding but lack intrinsic 3D awareness, resulting in representations that fail to maintain geometric and spatial consistency across video frames. [LLMs and Language]
  - Authors: Haibo Wang, Lifu Huang
  - Submitted by: WANG HAIBO | Upvotes: 3 | Comments: 3
  - Links: [HF](https://huggingface.co/papers/2606.05833) / [arXiv](https://arxiv.org/pdf/2606.05833) / [Cool](https://papers.cool/arxiv/2606.05833)
  - <details>
    <summary>Abstract</summary>
...
- [Towards Truly Multilingual ASR: Generalizing Code-Switching ASR to Unseen Language Pairs](https://huggingface.co/papers/2606.05846) [Upvote: 3] Automatic Speech Recognition (ASR) has become a key technology for human--AI interaction. [LLMs and Language]
  - Authors: Gio Paik, Hyunseo Shin, Soungmin Lee
  - Submitted by: Gio Paik | Upvotes: 3 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2606.05846) / [arXiv](https://arxiv.org/pdf/2606.05846) / [Cool](https://papers.cool/arxiv/2606.05846)
  - <details>
    <summary>Abstract</summary>
...
- [Revising Context, Shifting Simulated Stance: Auditing LLM-Based Stance Simulation in Online Discussions](https://huggingface.co/papers/2606.06443) [Upvote: 2] Large language models are increasingly used to simulate social media users and infer how individuals may respond to online discussions. [LLMs and Language]
  - Authors: Xinnong Zhang, Wanting Shan, Hanjia Lyu, Zhongyu Wei, Jiebo Luo
  - Submitted by: BruceLyu | Upvotes: 2 | Comments: 3
  - Links: [HF](https://huggingface.co/papers/2606.06443) / [arXiv](https://arxiv.org/pdf/2606.06443) / [Cool](https://papers.cool/arxiv/2606.06443)
  - <details>
    <summary>Abstract</summary>
...
- [Absorbing Complexity: An Interaction-Native Knowledge Harness for Financial LLM Agents](https://huggingface.co/papers/2606.01886) [Upvote: 2] Financial AI agents often fail for a simple reason: they make users carry the complexity. [LLMs and Language]
  - Authors: Ailiya Borjigin, Igor Stadnyk, Ben Bilski, Maksym Chikita, Dmytro Kyrylenko, Sofiia Pidturkina, Julia Stadnyk
  - Submitted by: Sofia | Upvotes: 2 | Comments: 3
  - Links: [HF](https://huggingface.co/papers/2606.01886) / [arXiv](https://arxiv.org/pdf/2606.01886) / [Cool](https://papers.cool/arxiv/2606.01886)
  - <details>
    <summary>Abstract</summary>
...
- [LLM Anonymization Against Agentic Re-Identification](https://huggingface.co/papers/2605.30848) [Upvote: 1] Agentic LLMs with web search change the threat model for text anonymization: weak contextual cues can become cross-referenceable evidence for re-identification, yet those same details also carry downstream analytic… [LLMs and Language]
  - Authors: Ziwen Li, Jianing Wen, Tianshi Li
  - Submitted by: Ziwen Li | Upvotes: 1 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2605.30848) / [arXiv](https://arxiv.org/pdf/2605.30848) / [Cool](https://papers.cool/arxiv/2605.30848)
  - <details>
    <summary>Abstract</summary>
...
- [Combinatorial Synthesis: Scaling Code RLVR via Atomic Decomposition and Recombination](https://huggingface.co/papers/2605.31058) [Upvote: 1] Reinforcement Learning with Verifiable Rewards (RLVR) has recently emerged as the cornerstone for shaping the remarkable coding abilities of Large Language Models (LLMs). [LLMs and Language]
  - Authors: Jiasheng Zheng, Boxi Cao, Boxi Yu, Yuzhong Zhang, Jialun Cao, Yaojie Lu, Hongyu Lin, Xianpei Han, Le Sun
  - Submitted by: Boxi Cao | Upvotes: 1 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2605.31058) / [arXiv](https://arxiv.org/pdf/2605.31058) / [Cool](https://papers.cool/arxiv/2605.31058)
  - <details>
    <summary>Abstract</summary>
...
- [AURA: Intent-Directed Probing for Implicit-Need Surfacing in Situated LLM Agents](https://huggingface.co/papers/2606.05557) [Upvote: 1] A situated query like "where is Lin Wei?" often encodes more than its literal content: the user may also want to know whether Lin Wei is free, in a good mood, or worth interrupting now. [LLMs and Language]
  - Authors: Yang Li, Jiaxiang Liu, Jiang Cai, Mingkun Xu
  - Submitted by: Yang Lee | Upvotes: 1 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2606.05557) / [arXiv](https://arxiv.org/pdf/2606.05557) / [Cool](https://papers.cool/arxiv/2606.05557)
  - <details>
    <summary>Abstract</summary>
...
- [SABER: Benchmarking Operational Safety of LLM Coding Agents in Stateful Project Workspaces](https://huggingface.co/papers/2606.01317) [Upvote: 0] Large language models are increasingly deployed as coding agents, shifting safety from individual responses to action sequences. [LLMs and Language]
  - Authors: Qi Hu, Yifeng Tang, Qinghua Wang, Lanyang Zhao, Pengji Zhang, Yuhao Qing, Xin Yao, Dong Huang, Lin Zhang, Zhuoran Ji
  - Submitted by: Qi HU | Upvotes: 0 | Comments: 3
  - Links: [HF](https://huggingface.co/papers/2606.01317) / [arXiv](https://arxiv.org/pdf/2606.01317) / [Cool](https://papers.cool/arxiv/2606.01317)
  - <details>
    <summary>Abstract</summary>
...
- [ForeSci: Evaluating LLM Agents for Forward-Looking AI Research Judgment](https://huggingface.co/papers/2606.00644) [Upvote: 0] AI research often requires decisions before future evidence exists: which bottleneck to attack, which direction to pursue, or where a project should be positioned. [LLMs and Language]
  - Authors: Qiuyu Tian, Haojie Yin, Yingce Xia, Youyong Kong, Zequn Liu
  - Submitted by: BruceLyu | Upvotes: 0 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2606.00644) / [arXiv](https://arxiv.org/pdf/2606.00644) / [Cool](https://papers.cool/arxiv/2606.00644)
  - <details>
    <summary>Abstract</summary>
...
- [Complexity-Balanced Diffusion Splitting](https://huggingface.co/papers/2606.06477) [Upvote: 16] Standard continuous-time generative models rely on monolithic architectures that must navigate vastly different signal regimes, from isotropic noise to intricate data distributions. [Multimodal Understanding and Vision]
  - Authors: Noam Issachar, Dani Lischinski, Raanan Fattal
  - Submitted by: Noam Issachar | Upvotes: 16 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2606.06477) / [arXiv](https://arxiv.org/pdf/2606.06477) / [Cool](https://papers.cool/arxiv/2606.06477)
  - <details>
    <summary>Abstract</summary>
...
- [Imagine Before You Predict: Interleaved Latent Visual Reasoning for Video Event Prediction](https://huggingface.co/papers/2606.05769) [Upvote: 5] Video event prediction (VEP) requires models to infer unobserved future states from partial video evidence. [Multimodal Understanding and Vision]
  - Authors: Tianxiang Jiang, Linquan Wu, Sheng Xia, Songze Li, Ziang Yan, Haoyu Yang, Yu Qiao, Yi Wang
  - Submitted by: Tianxiang Jiang | Upvotes: 5 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2606.05769) / [arXiv](https://arxiv.org/pdf/2606.05769) / [Cool](https://papers.cool/arxiv/2606.05769)
  - <details>
    <summary>Abstract</summary>
...
- [MechVQA: Benchmarking and Enhancing Multimodal LLMs on Comprehensive Mechanical Drawing Understanding](https://huggingface.co/papers/2605.30794) [Upvote: 3] Multimodal Large Language Models (MLLMs) have demonstrated significant achievements in general visual question answering (VQA) tasks. [Multimodal Understanding and Vision]
  - Authors: Qian Kou, Xiaofeng Shi, Yulin Li, Xiaosong Qiu, Xinyang Wang, Hua Zhou, Cao Dongxing
  - Submitted by: XiaofengShi | Upvotes: 3 | Comments: 3
  - Links: [HF](https://huggingface.co/papers/2605.30794) / [arXiv](https://arxiv.org/pdf/2605.30794) / [Cool](https://papers.cool/arxiv/2605.30794)
  - <details>
    <summary>Abstract</summary>
...
- [Video2LoRA: Parametric Video Internalization for Vision-Language Models](https://huggingface.co/papers/2606.04351) [Upvote: 2] Processing video in vision-language models is expensive: each frame occupies hundreds of tokens, and inference cost scales with every frame and every repeated query. [Multimodal Understanding and Vision]
  - Authors: Manan Suri, Sarvesh Baskar, Dinesh Manocha
  - Submitted by: Manan Suri | Upvotes: 2 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2606.04351) / [arXiv](https://arxiv.org/pdf/2606.04351) / [Cool](https://papers.cool/arxiv/2606.04351)
  - <details>
    <summary>Abstract</summary>
...
- [Multimodal Music Recommendation System using LLMs](https://huggingface.co/papers/2606.00125) [Upvote: 1] Music recommendation systems typically treat songs as opaque tokens, relying on collaborative interaction histories which overlooks semantic or acoustic content. [Multimodal Understanding and Vision]
  ...
  - Submitted by: Franck Dernoncourt | Upvotes: 1 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2606.00125) / [arXiv](https://arxiv.org/pdf/2606.00125) / [Cool](https://papers.cool/arxiv/2606.00125)
  - <details>
    <summary>Abstract</summary>
...
- [BRepCLIP: Contrastive Multimodal Pretraining on BRep Primitives for CAD Understanding](https://huggingface.co/papers/2606.05515) [Upvote: 1] Learning representations of CAD models is a largely open problem. [Multimodal Understanding and Vision]
  - Authors: Muhammad Usama, Didier Stricker, Mohammad Sadil Khan, Muhammad Zeshan Afzal
  - Submitted by: Mohammad Sadil Khan | Upvotes: 1 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2606.05515) / [arXiv](https://arxiv.org/pdf/2606.05515) / [Cool](https://papers.cool/arxiv/2606.05515)
  - <details>
    <summary>Abstract</summary>
...
- [Discrete-WAM: Unified Discrete Vision-Action Token Editing for World-Policy Learning](https://huggingface.co/papers/2606.05645) [Upvote: 1] Autonomous driving requires reasoning about how ego actions shape the evolution of the surrounding world. [Multimodal Understanding and Vision]
  ...
  - Links: [HF](https://huggingface.co/papers/2606.05645) / [arXiv](https://arxiv.org/pdf/2606.05645) / [Cool](https://papers.cool/arxiv/2606.05645)
  - <details>
    <summary>Abstract</summary>
...
- [ArcANE: Do Role-Playing Language Agents Stay in Character at the Right Time?](https://huggingface.co/papers/2606.05553) [Upvote: 45] Role-playing language agents (RPLAs) should play characters whose values and behavior evolve as the story progresses, not maintain a fixed persona. [Agents and Planning]
  - Authors: Woojung Song, Nalim Kim, Sangjun Song, Chaewon Heo, Jongwon Lim, Yohan Jo
  - Submitted by: Jongwon Lim | Upvotes: 45 | Comments: 4
  - Links: [HF](https://huggingface.co/papers/2606.05553) / [arXiv](https://arxiv.org/pdf/2606.05553) / [Cool](https://papers.cool/arxiv/2606.05553)
  - <details>
    <summary>Abstract</summary>
...
- [AdaPlanBench: Evaluating Adaptive Planning in Large Language Model Agents under World and User Constraints](https://huggingface.co/papers/2606.05622) [Upvote: 37] Planning for real-world problems by language models often involves both world and user constraints, which may not be fully specified upfront and are progressively disclosed through interaction. [Agents and Planning]
  ...
  - Submitted by: Jeff | Upvotes: 37 | Comments: 4
  - Links: [HF](https://huggingface.co/papers/2606.05622) / [arXiv](https://arxiv.org/pdf/2606.05622) / [Cool](https://papers.cool/arxiv/2606.05622)
  - <details>
    <summary>Abstract</summary>
...
- [Personal AI Agent for Camera Roll VQA](https://huggingface.co/papers/2606.05275) [Upvote: 19] We study the personal camera roll visual question answering setting. [Agents and Planning]
  - Authors: Thao Nguyen, Krishna Kumar Singh, Donghyun Kim, Yong Jae Lee, Yuheng Li
  - Submitted by: Thao Nguyen | Upvotes: 19 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2606.05275) / [arXiv](https://arxiv.org/pdf/2606.05275) / [Cool](https://papers.cool/arxiv/2606.05275)
  - <details>
    <summary>Abstract</summary>
...
- [Unsupervised Skill Discovery for Agentic Data Analysis](https://huggingface.co/papers/2606.06416) [Upvote: 11] Inference-time skill augmentation provides a lightweight way to improve data-analytic agents by injecting reusable procedural knowledge without updating model parameters. [Agents and Planning]
  - Authors: Zhisong Qiu, Kangqi Song, Shengwei Tang, Shuofei Qiao, Lei Liang, Huajun Chen, Shumin Deng
  - Submitted by: Shumin Deng | Upvotes: 11 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2606.06416) / [arXiv](https://arxiv.org/pdf/2606.06416) / [Cool](https://papers.cool/arxiv/2606.06416)
  - <details>
    <summary>Abstract</summary>
...
- [SePO: Self-Evolving Prompt Agent for System Prompt Optimization](https://huggingface.co/papers/2606.04465) [Upvote: 4] System prompt optimization improves agent behavior without modifying the underlying model, yielding human-readable, model-agnostic instructions. [Agents and Planning]
  - Authors: Wangcheng Tao, Han Wu, Weng-Fai Wong
  - Submitted by: Tao Wangcheng | Upvotes: 4 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2606.04465) / [arXiv](https://arxiv.org/pdf/2606.04465) / [Cool](https://papers.cool/arxiv/2606.04465)
  - <details>
    <summary>Abstract</summary>
...
- [EvoDS: Self-Evolving Autonomous Data Science Agent with Skill Learning and Context Management](https://huggingface.co/papers/2606.03841) [Upvote: 2] Recent progress in Large Language Model (LLM) agents has enabled promising advances in automated data science. [Agents and Planning]
  - Authors: Zherui Yang, Fan Liu, Yansong Ning, Hao Liu
  - Submitted by: Zherui Yang | Upvotes: 2 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2606.03841) / [arXiv](https://arxiv.org/pdf/2606.03841) / [Cool](https://papers.cool/arxiv/2606.03841)
  - <details>
    <summary>Abstract</summary>
...
- [TIDE: Proactive Multi-Problem Discovery via Template-Guided Iteration](https://huggingface.co/papers/2606.04743) [Upvote: 38] Agents are widely deployed as assistants over documents, tools, and code. [Other AI]
  - Authors: Soyeong Jeong, Jinheon Baek, Minki Kang, Sung Ju Hwang
  - Submitted by: Soyeong | Upvotes: 38 | Comments: 5
  - Links: [HF](https://huggingface.co/papers/2606.04743) / [arXiv](https://arxiv.org/pdf/2606.04743) / [Cool](https://papers.cool/arxiv/2606.04743)
  - <details>
    <summary>Abstract</summary>
...
- [RobotValues: Evaluating Household Robots When Human Values Conflict](https://huggingface.co/papers/2606.03312) [Upvote: 24] While household robots are often evaluated based on task completion, everyday domestic environments involve value-conflicting situations in which robots are expected to choose actions that prioritize other values than… [Other AI]
  - Authors: Jongwook Han, Hyeongjin Kim, Yohan Jo
  - Submitted by: Jongwon Lim | Upvotes: 24 | Comments: 5
  - Links: [HF](https://huggingface.co/papers/2606.03312) / [arXiv](https://arxiv.org/pdf/2606.03312) / [Cool](https://papers.cool/arxiv/2606.03312)
  - <details>
    <summary>Abstract</summary>
...
- [Flash-WAM: Modality-Aware Distillation for World Action Models](https://huggingface.co/papers/2606.05254) [Upvote: 5] World-action models (WAMs) jointly generate future video and robot actions through iterative diffusion, achieving strong performance on manipulation benchmarks but requiring tens of denoising steps, a cost that… [Other AI]
  ...
  - Links: [HF](https://huggingface.co/papers/2606.05254) / [arXiv](https://arxiv.org/pdf/2606.05254) / [Cool](https://papers.cool/arxiv/2606.05254)
  - <details>
    <summary>Abstract</summary>
...
- [SEAOTTER: Sensor Embedded Autoencoding with One-Time Transcode for Efficient Reconstruction](https://huggingface.co/papers/2606.03940) [Upvote: 4] In robotics systems, vast amounts of visual data are easily captured at high resolution using low-cost, low-power hardware. [Other AI]
  - Authors: Dan Jacobellis, Neeraja J. Yadwadkar
  - Submitted by: Dan Jacobellis | Upvotes: 4 | Comments: 4
  - Links: [HF](https://huggingface.co/papers/2606.03940) / [arXiv](https://arxiv.org/pdf/2606.03940) / [Cool](https://papers.cool/arxiv/2606.03940)
  - <details>
    <summary>Abstract</summary>
...
- [Regret Minimization with Adaptive Opponents in Repeated Games](https://huggingface.co/papers/2606.06486) [Upvote: 1] In this paper, we study regret minimization in repeated games with adaptive opponents who can respond based on histories of play. [Other AI]
  - Authors: Mingyang Liu, Asuman Ozdaglar, Tiancheng Yu, Kaiqing Zhang
  - Submitted by: Mingyang Liu | Upvotes: 1 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2606.06486) / [arXiv](https://arxiv.org/pdf/2606.06486) / [Cool](https://papers.cool/arxiv/2606.06486)
  - <details>
    <summary>Abstract</summary>
...
- [VideoKR: Towards Knowledge- and Reasoning-Intensive Video Understanding](https://huggingface.co/papers/2606.05259) [Upvote: 34] We introduce VideoKR, the first large-scale training corpus specifically designed to strengthen knowledge- and reasoning-intensive video understanding. [Reasoning, Alignment, and Evaluation]
  - Authors: Lin Fu, Zheyuan Yang, Yang Wang, Tingyu Song, Arman Cohan, Yilun Zhao
  - Submitted by: Tingyu Song | Upvotes: 34 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2606.05259) / [arXiv](https://arxiv.org/pdf/2606.05259) / [Cool](https://papers.cool/arxiv/2606.05259)
  - <details>
    <summary>Abstract</summary>
...
- [The Shadow Price of Reasoning: Economic Perspective on Optimal Budget Allocation for LLMs](https://huggingface.co/papers/2606.03092) [Upvote: 7] Inference-time scaling has emerged as a critical avenue for enhancing Large Language Models' performance, yet real-world deployment is constrained by strict computational budgets. [Reasoning, Alignment, and Evaluation]
  - Authors: Xu Wan, Speed Zhu, Jianwei Cai, Guang Chen, XiMing Huang, Wiggin Zhou, Mingyang Sun
  - Submitted by: XuWan | Upvotes: 7 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2606.03092) / [arXiv](https://arxiv.org/pdf/2606.03092) / [Cool](https://papers.cool/arxiv/2606.03092)
  - <details>
    <summary>Abstract</summary>
...
- [World-Language-Action Model for Unified World Modeling, Language Reasoning, and Action Synthesis](https://huggingface.co/papers/2606.05979) [Upvote: 7] We propose world-language-action (WLA) models as a new class of embodied foundation models. [Reasoning, Alignment, and Evaluation]
  ...
  - Links: [HF](https://huggingface.co/papers/2606.05979) / [arXiv](https://arxiv.org/pdf/2606.05979) / [Cool](https://papers.cool/arxiv/2606.05979)
  - <details>
    <summary>Abstract</summary>
...
- [Latent Reasoning with Normalizing Flows](https://huggingface.co/papers/2606.06447) [Upvote: 6] Large language models often improve reasoning by generating explicit chain-of-thought (CoT), demonstrating the importance of intermediate computation. [Reasoning, Alignment, and Evaluation]
  - Authors: Guancheng Tu, Xiangjun Fu, Suhao Yu, Yao Tang, Haoqiang Kang, Lianhui Qin, Yizhe Zhang, Jiatao Gu
  - Submitted by: taesiri | Upvotes: 6 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2606.06447) / [arXiv](https://arxiv.org/pdf/2606.06447) / [Cool](https://papers.cool/arxiv/2606.06447)
  - <details>
    <summary>Abstract</summary>
...
- [Trust Region Q Adjoint Matching](https://huggingface.co/papers/2605.27079) [Upvote: 3] Off-policy reinforcement learning of pretrained flow policies remains challenging due to the instability of optimization arising from the multi-step sampling process. [Reasoning, Alignment, and Evaluation]
  - Authors: Yonghoon Dong, Kyungmin Lee, Changyeon Kim, Jaehyuk Kim, Jinwoo Shin
  - Submitted by: Yonghoon Dong | Upvotes: 3 | Comments: 3
  - Links: [HF](https://huggingface.co/papers/2605.27079) / [arXiv](https://arxiv.org/pdf/2605.27079) / [Cool](https://papers.cool/arxiv/2605.27079)
  - <details>
    <summary>Abstract</summary>
...
- [Reinforcement Learning Elicits Contextual Learning of Unseen Language Translation](https://huggingface.co/papers/2606.06428) [Upvote: 23] Prior work has shown that large language models (LLMs) can translate unseen or low-resource languages by undergoing continued training or even by encoding a grammar book in their context. [Learning, Optimization, and Theory]
  - Authors: Hanxu Hu, Zdeněk Šnajdr, Pinzhen Chen, Jannis Vamvas, Rico Sennrich
  - Submitted by: Hanxu Hu | Upvotes: 23 | Comments: 3
  - Links: [HF](https://huggingface.co/papers/2606.06428) / [arXiv](https://arxiv.org/pdf/2606.06428) / [Cool](https://papers.cool/arxiv/2606.06428)
  - <details>
    <summary>Abstract</summary>
...
- [MLEvolve: A Self-Evolving Framework for Automated Machine Learning Algorithm Discovery](https://huggingface.co/papers/2606.06473) [Upvote: 13] Large language model (LLM) agents are increasingly applied to long-horizon tasks such as scientific discovery and machine learning engineering (MLE), where sustained self-evolution becomes a key capability. [Learning, Optimization, and Theory]
  ...
  - Links: [HF](https://huggingface.co/papers/2606.06473) / [arXiv](https://arxiv.org/pdf/2606.06473) / [Cool](https://papers.cool/arxiv/2606.06473)
  - <details>
    <summary>Abstract</summary>
...
- [OPRD: On-Policy Representation Distillation](https://huggingface.co/papers/2606.06021) [Upvote: 7] On-policy distillation (OPD) supervises the student only in output space by matching next-token probabilities. [Learning, Optimization, and Theory]
  ...
  - Submitted by: Shenzhi Yang | Upvotes: 7 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2606.06021) / [arXiv](https://arxiv.org/pdf/2606.06021) / [Cool](https://papers.cool/arxiv/2606.06021)
  - <details>
    <summary>Abstract</summary>
...
- [Benchmark Everything Everywhere All at Once](https://huggingface.co/papers/2606.06462) [Upvote: 2] Benchmarks are fundamental for evaluating and advancing LLMs and MLLMs by providing standardized and explicit measures of performance. [Datasets and Benchmarks]
  - Authors: Shiyun Xiong, Dongming Wu, Peiwen Sun, Yuang Ai, Bokang Yang, Wencheng Han, Xiao-Hui Li, Xiangyu Yue
  - Submitted by: Shiyun Xiong | Upvotes: 2 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2606.06462) / [arXiv](https://arxiv.org/pdf/2606.06462) / [Cool](https://papers.cool/arxiv/2606.06462)
  - <details>
    <summary>Abstract</summary>
...
- [Is This Edit Correct? A Multi-Dimensional Benchmark for Reasoning-Aware Image Editing](https://huggingface.co/papers/2606.05172) [Upvote: 1] Diffusion-based image editing has achieved strong visual fidelity under natural language instructions, yet most existing systems still operate at the level of surface instruction following, without reasoning about the… [Datasets and Benchmarks]
  - Authors: Yixuan Ding, Wei Huang, Ruijie Quan, Xiaojuan Qi, Yi Yang
  - Submitted by: ding | Upvotes: 1 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2606.05172) / [arXiv](https://arxiv.org/pdf/2606.05172) / [Cool](https://papers.cool/arxiv/2606.05172)
  - <details>
    <summary>Abstract</summary>
...
- [The Road Ahead in Autonomous Driving: The KITScenes Multimodal Dataset](https://huggingface.co/papers/2606.02956) [Upvote: 15] Existing autonomous driving datasets have enabled major progress, but fall short in sensor fidelity, map completeness, or geographic diversity. [Multimodal Agents]
  ...
  - Submitted by: Fabian Immel | Upvotes: 15 | Comments: 3
  - Links: [HF](https://huggingface.co/papers/2606.02956) / [arXiv](https://arxiv.org/pdf/2606.02956) / [Cool](https://papers.cool/arxiv/2606.02956)
  - <details>
    <summary>Abstract</summary>
...
- [AffordanceVLA: A Vision-Language-Action Model Empowering Action Generation through Affordance-Aware Understanding](https://huggingface.co/papers/2606.06155) [Upvote: 10] Vision-Language-Action (VLA) models leverage the rich world knowledge of pretrained vision-language models (VLMs) to enable instruction-following robotic manipulation. [Multimodal Agents]
  ...
  - Submitted by: Qize Yu | Upvotes: 10 | Comments: 3
  - Links: [HF](https://huggingface.co/papers/2606.06155) / [arXiv](https://arxiv.org/pdf/2606.06155) / [Cool](https://papers.cool/arxiv/2606.06155)
  - <details>
    <summary>Abstract</summary>
...
- [Quality-Guided Semi-Supervised Learning for Medical Image Segmentation](https://huggingface.co/papers/2606.01753) [Upvote: 1] Training accurate medical image segmentation models requires large amounts of densely annotated data, which is costly and time-consuming to obtain. [Domain Applications]
  - Authors: Kumar Abhishek, Ghassan Hamarneh
  - Submitted by: Kumar Abhishek | Upvotes: 1 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2606.01753) / [arXiv](https://arxiv.org/pdf/2606.01753) / [Cool](https://papers.cool/arxiv/2606.01753)
  - <details>
    <summary>Abstract</summary>
...
- [LoomVideo: Unifying Multimodal Inputs into Video Generation and Editing](https://huggingface.co/papers/2606.06042) [Upvote: 21] Developing unified video generation and editing models capable of interpreting interleaved multimodal inputs is a promising yet challenging frontier field. [Multimodal Generative Modeling]
  ...
  - Submitted by: Jianzong Wu | Upvotes: 21 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2606.06042) / [arXiv](https://arxiv.org/pdf/2606.06042) / [Cool](https://papers.cool/arxiv/2606.06042)
  - <details>
    <summary>Abstract</summary>
...
- [Towards One-to-Many Temporal Grounding](https://huggingface.co/papers/2606.06294) [Upvote: 5] Temporal Grounding (TG) aims to localize video segments corresponding to a textual query. [Retrieval, Knowledge, and RAG]
  - Authors: Qi Xu, Yue Tan, Shihao Chen, Jiahao Meng, Anna Wang, Shunping Ji, Hao Fei, Jason Li
  - Submitted by: XuQi | Upvotes: 5 | Comments: 4
  - Links: [HF](https://huggingface.co/papers/2606.06294) / [arXiv](https://arxiv.org/pdf/2606.06294) / [Cool](https://papers.cool/arxiv/2606.06294)
  - <details>
    <summary>Abstract</summary>
...
- [Dream.exe: Can Video Generation Models Dream Executable Robot Manipulation?](https://huggingface.co/papers/2606.04811) [Upvote: 15] Video generation models have made impressive strides in synthesizing visually compelling content, yet their outputs remain confined to the virtual domain. [Robotics and Embodied AI]
  - Authors: Rui Zhao, Kaiming Yang, Jifeng Zhu, Siyang Chen, Ziqi Wang, Weijia Wu, Kevin Qinghong Lin, Heng Wang, Mike Zheng Shou
  - Submitted by: Rui Zhao | Upvotes: 15 | Comments: 3
  - Links: [HF](https://huggingface.co/papers/2606.04811) / [arXiv](https://arxiv.org/pdf/2606.04811) / [Cool](https://papers.cool/arxiv/2606.04811)
  - <details>
    <summary>Abstract</summary>
