# Hugging Face Daily Papers Report (2026-07-21)

- Source: https://huggingface.co/papers/date/2026-07-21
- Classifier: rule
- Total Papers: 22

## Today's Hotspots and Trend

- Other AI: 6 papers (27.27%); representative paper: Loop the Loopies!.
- Agents and Planning: 5 papers (22.73%); representative paper: Cura 1T: Specialized Model for Agentic Healthcare.
- Multimodal Agents: 3 papers (13.64%); representative paper: RESOURCE2SKILL: Distilling Executable Agent Skills from Human-Created Multimodal Resources.
- Trend: Today's dominant clusters are Other AI / Agents and Planning / Multimodal Agents; this suggests several parallel trends: multimodal work is moving from isolated perception toward generation, agents, and action; agent papers emphasize tool use, planning, and deployable workflows. The strongest visible attention is on “RESOURCE2SKILL: Distilling Executable Agent Skills from Human-Created Multimodal Resources” (111 upvotes).

## Focus Topics

- Generative Foundations: 1 papers (4.55%)
- Multimodal Generative Modeling: 0 papers (0.00%)
- Multimodal Agents: 3 papers (13.64%)

## Topic Distribution

- Other AI: 6 papers (27.27%)
...
- Reasoning, Alignment, and Evaluation: 2 papers (9.09%)
- Generative Foundations: 1 papers (4.55%)
- LLMs and Language: 1 papers (4.55%)
...
- The top topic today is “Other AI”, with 6 papers, accounting for 27.27%。
- The most active submitter is taesiri， with 4 papers。
- The highest-voted visible paper is “RESOURCE2SKILL: Distilling Executable Agent Skills from Human-Created Multimodal Resources”, currently at 111 votes.
...
- [Loop the Loopies!](https://huggingface.co/papers/2607.16051) [Upvote: 53] We present Loopie, the most powerful looped Transformer to date. [Other AI]
  - Authors: Zitian Gao, Yilong Chen, Yihao Xiao, Xinyu Yang, Ran Tao, Joey Zhou, Bryan Dai
  - Submitted by: taesiri | Upvotes: 53 | Comments: 0
...
- [xHC: Expanded Hyper-Connections](https://huggingface.co/papers/2607.14530) [Upvote: 45] Hyper-Connections (HC) expand the residual stream of Transformers into N parallel streams, providing a form of memory scaling beyond model width and depth. [Other AI]
  ...
  - Submitted by: Xiangdong Zhang | Upvotes: 45 | Comments: 1
...
- [RecGPT-V3 Technical Report](https://huggingface.co/papers/2607.15591) [Upvote: 25] Large language models (LLMs) are transforming recommender systems from matching co-occurrence patterns in historical behavior toward reasoning about the intent that drives it. [Other AI]
  ...
  - Submitted by: TangJiakai | Upvotes: 25 | Comments: 1
...
- [On-Policy Delta Distillation](https://huggingface.co/papers/2607.15161) [Upvote: 25] On-policy distillation is an alternative post-training method in reinforcement learning that alleviates the constraints imposed by reward models by providing token-level supervision from a teacher model. [Other AI]
  - Authors: Byeongho Heo, Jaehui Hwang, Sangdoo Yun, Dongyoon Han
  - Submitted by: Byeongho Heo | Upvotes: 25 | Comments: 1
...
- [Qwen-Music Technical Report](https://huggingface.co/papers/2607.11699) [Upvote: 17] In this report, we introduce Qwen-Music, a powerful music generation model capable of producing highly musical and high-fidelity songs with complete vocal singing. [Other AI]
  ...
  - Submitted by: Kangdi Wang | Upvotes: 17 | Comments: 2
...
- [Recursive Harness Self-Improvement](https://huggingface.co/papers/2607.15524) [Upvote: 13] Under model--harness co-evolution, harnesses are not merely inference-time scaffolds but data-generating components whose execution traces can shape future foundation models. [Other AI]
...
- [Cura 1T: Specialized Model for Agentic Healthcare](https://huggingface.co/papers/2607.15314) [Upvote: 38] Healthcare spans high-stakes communication, expert reasoning, and workflow execution, yet specialized LLMs that cover these use cases together remain limited. [Agents and Planning]
  ...
  - Submitted by: taesiri | Upvotes: 38 | Comments: 4
...
- [From Human-Centric to Agentic Code Review: The Impact of Different Generations of Generative AI Technology on Review Quality](https://huggingface.co/papers/2607.13196) [Upvote: 23] Code review helps maintain software quality before code integration, but it also imposes a substantial workload on human reviewers. [Agents and Planning]
  - Authors: Suzhen Zhong, Shayan Noei, Bram Adams, Ying Zou
  - Submitted by: Suzhen Zhong | Upvotes: 23 | Comments: 1
...
- [When Does Muon Help Agentic Reinforcement Learning?](https://huggingface.co/papers/2607.16169) [Upvote: 12] Muon is competitive with AdamW in large-scale pre-training, but its value for reinforcement-learning (RL) post-training remains unclear. [Agents and Planning]
  - Authors: Kai Ruan, Jinghao Lin, Zihe Huang, Ziqi Zhou, Qianshan Wei, Xuan Wang, Hao Sun
  - Submitted by: Kai Ruan | Upvotes: 12 | Comments: 1
...
- [DSWorld: A Data Science World Model for Efficient Autonomous Agents](https://huggingface.co/papers/2607.15901) [Upvote: 6] Despite strong capabilities in data understanding and decision-making, autonomous data science agents still heavily rely on trial-and-error workflows that involve expensive computation. [Agents and Planning]
  - Authors: Zherui Yang, Fan Liu, Hao Liu
  - Submitted by: Zherui Yang | Upvotes: 6 | Comments: 1
...
- [Behavioral Privacy Leakage in Agentic Negotiation: Formalizing and Mitigating Inference Attacks via Randomized Policies](https://huggingface.co/papers/2607.06815) [Upvote: 3] Autonomous negotiation agents are increasingly deployed in high-stakes settings such as insurance and procurement. [Agents and Planning]
  - Authors: Barkha Rani
  - Submitted by: Barkha Rani | Upvotes: 3 | Comments: 1
...
- [RESOURCE2SKILL: Distilling Executable Agent Skills from Human-Created Multimodal Resources](https://huggingface.co/papers/2606.29538) [Upvote: 111] Skills are a useful abstraction for software agents, turning human and agent experience into reusable procedural knowledge. [Multimodal Agents]
  - Authors: Yijia Fan, Zonglin Di, Zimo Wen, Yifan Yang, Mingxi Cheng, Qi Dai, Bei Liu, Kai Qiu, Yue Dong, Ji Li, Chong Luo
  - Submitted by: Yif Yang | Upvotes: 111 | Comments: 1
...
- [Xiaomi-Robotics-1: Scaling Vision-Language-Action Models with over 100K Hours of Real-World Trajectories](https://huggingface.co/papers/2607.15330) [Upvote: 52] We present Xiaomi-Robotics-1, a foundational vision-language-action (VLA) model capable of (1) following diverse language instructions to perform a wide range of mobile manipulation tasks in unseen environments… [Multimodal Agents]
  ...
  - Submitted by: yewen | Upvotes: 52 | Comments: 1
...
- [See like a Robot: Robot-Centric Pointmaps for Vision-Language-Action Models](https://huggingface.co/papers/2607.11498) [Upvote: 2] Vision-language-action (VLA) models predict robot actions from visual observations and language instructions. [Multimodal Agents]
  - Authors: Byungkun Lee, Dongyoon Hwang, Dongjin Kim, Hojoon Lee, Minho Park, Jaegul Choo
  - Submitted by: Dongyoon | Upvotes: 2 | Comments: 1
...
- [Beyond Entropy: Correctness-Aware Advantage Shaping via Contrastive Policy Optimization](https://huggingface.co/papers/2607.14614) [Upvote: 8] Reinforcement learning with verifiable rewards (RLVR) commonly uses entropy for advantage shaping. [Learning, Optimization, and Theory]
  - Authors: Weiwen Xu, Jia Liu, Hou Pong Chan, Long Li, Deng Cai, Min Chen, Hao Zhang
  - Submitted by: Xu Weiwen | Upvotes: 8 | Comments: 1
...
- [S1-Omni: A Unified Multimodal Reasoning Model for Scientific Understanding, Prediction, and Generation](https://huggingface.co/papers/2607.15686) [Upvote: 6] We present S1-Omni, a unified multimodal reasoning model for scientific understanding, prediction, and generation. [Multimodal Understanding and Vision]
  ...
  - Submitted by: Bing | Upvotes: 6 | Comments: 1
...
- [Understanding Reasoning from Pretraining to Post-Training](https://huggingface.co/papers/2607.16097) [Upvote: 17] Reinforcement learning (RL) has become central to improving large language models (LLMs) on complex reasoning tasks, yet RL post-training is largely studied in isolation from the pretraining that precedes it. [Reasoning, Alignment, and Evaluation]
  - Authors: Jingyan Shen, Ang Li, Salman Rahman, Yifan Sun, Micah Goldblum, Matus Telgarsky, Pavel Izmailov
  - Submitted by: Evangeline Shen | Upvotes: 17 | Comments: 1
...
- [Agon: Competitive Cross-Model RL with Implicit Rival Grading of Reasoning](https://huggingface.co/papers/2607.07690) [Upvote: 3] Reinforcement learning from verifiable rewards (e.g. [Reasoning, Alignment, and Evaluation]
  - Authors: Vladislav Beliaev
  - Submitted by: Владислав Беляев | Upvotes: 3 | Comments: 2
...
- [VideoRAE: Taming Video Foundation Models for Generative Modeling via Representation Autoencoders](https://huggingface.co/papers/2607.14088) [Upvote: 7] Video generative models commonly rely on latent spaces learned by 3D Variational Autoencoders (3D-VAEs). [Generative Foundations]
  - Authors: Zhihao Xie, Junfeng Wu, Xinting Hu, Junchao Huang, Li Jiang
  - Submitted by: Junfeng Wu | Upvotes: 7 | Comments: 1
...
- [RAGU: A Multi-Step GraphRAG Engine with a Compact Domain-Adapted LLM](https://huggingface.co/papers/2607.11683) [Upvote: 107] Graph retrieval-augmented generation (GraphRAG) enhances large language models with structured knowledge, yet existing systems construct knowledge graphs in a single extraction pass, producing noisy entities and… [LLMs and Language]
  ...
  - Submitted by: Ivan Bondarenko | Upvotes: 107 | Comments: 3
