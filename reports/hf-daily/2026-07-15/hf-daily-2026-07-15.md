...
- The highest-voted visible paper is “Function-Aware Fill-in-the-Middle as Mid-Training for Coding Agent Foundation Models”, currently at 99 votes.
...
- [What LLM Forecasters Know but Don't Say: Probing Internal Representations for Calibration and Faithfulness](https://huggingface.co/papers/2607.08046) [Upvote: 11] Large language models fine-tuned for forecasting can be accurate yet poorly calibrated, and their chain-of-thought (CoT) reasoning may not faithfully reflect the evidence behind a forecast. [LLMs and Language]
  - Authors: Raphaël Sarfati, Pratyush Ranjan Tiwari, Siddharth Boppana, Christopher J. Earls, Srikar Varadaraj, Eric Ho
  - Submitted by: Pratyush Ranjan Tiwari | Upvotes: 11 | Comments: 2
...
- [MAGIC: Transition-Aware Generation of Navigable Multi-Scene Game Worlds with Large Language Models](https://huggingface.co/papers/2607.11594) [Upvote: 5] Multi-scene navigation (clearing an objective in one bounded space and then crossing a portal into the next) is a defining feature of contemporary 3D games, but authoring it is laborious: every portal must have… [LLMs and Language]
  - Authors: Tsz Hei Fan, Choi Wing Fung, Yuxuan Wan, Shuqing Li, Michael R. Lyu
  - Submitted by: Yuxuan Wan | Upvotes: 5 | Comments: 2
...
- [Blind-Spots-Bench: Evaluating Blind Spots in Multimodal Models](https://huggingface.co/papers/2607.08317) [Upvote: 30] Modern AI models achieve strong performance on many established benchmarks, yet they still fail on tasks that humans find almost trivial, such as manipulating a string or drawing a dog with five legs. [Multimodal Understanding and Vision]
  - Authors: Matteo Santelmo, Xiuying Wei, Israa Fakih, Felix Bauer, Juan Garcia Giraldo, Chengkun Li, Etienne Bamas, Emmanuel Abbé
  - Submitted by: Chengkun Li | Upvotes: 30 | Comments: 2
...
- [MonkeyOCRv2: A Visual-Text Foundation Model for Document AI](https://huggingface.co/papers/2607.11562) [Upvote: 14] Mainstream visual encoders are pretrained on natural images and cannot be effectively applied to document images without document-oriented adaptation, as dense text and fine-grained character strokes demand… [Multimodal Understanding and Vision]
  ...
  - Submitted by: Niels Rogge | Upvotes: 14 | Comments: 2
...
- [Function-Aware Fill-in-the-Middle as Mid-Training for Coding Agent Foundation Models](https://huggingface.co/papers/2607.12463) [Upvote: 99] Coding agents must integrate external tool returns into ongoing reasoning - a capability that standard left-to-right pretraining on code exposes only in its forward direction. [Agents and Planning]
  - Authors: Yubo Wang, Jiarong Liang, Yuxuan Zhang, Xuye Liu, Cong Wei, Yuyu Zhang, Ping Nie, Wenhu Chen
  - Submitted by: Yubo Wang | Upvotes: 99 | Comments: 3
...
- [Navigating the Mirage: A Dual-Path Agentic Framework for Robust Misleading Chart Question Answering](https://huggingface.co/papers/2603.28583) [Upvote: 10] Despite the success of Vision-Language Models (VLMs), misleading charts remain a significant challenge due to their deceptive visual structures and distorted data representations. [Agents and Planning]
  - Authors: Yanjie Zhang, Yafei Li, Rui Sheng, Zixin Chen, Yanna Lin, Huamin Qu, Lei Chen, Yushi Sun
  - Submitted by: Yushi SUN | Upvotes: 10 | Comments: 2
...
- [SynthDocBench: Controlled Benchmark for Long-Context Visual Document Understanding](https://huggingface.co/papers/2607.10400) [Upvote: 68] Vision language models (VLMs) have achieved strong performance on visual document understanding benchmarks such as DocVQA, ChartQA, and MMLongBench-Doc. [Datasets and Benchmarks]
  ...
  - Submitted by: Amit Kumar Saha | Upvotes: 68 | Comments: 2
...
- [Search Beyond What Can Be Taught: Evolving the Knowledge Boundary in Agentic Visual Generation](https://huggingface.co/papers/2607.05382) [Upvote: 82] Visual generators excel at rendering, but they confidently fabricate what they do not know. [Retrieval, Knowledge, and RAG]
  ...
  - Submitted by: Cong Wei | Upvotes: 82 | Comments: 4
...
- [Know Before Fix: QA-Driven Repository Knowledge Acquisition for Software Issue Resolution](https://huggingface.co/papers/2607.11111) [Upvote: 14] LLM-based coding agents have significantly advanced automated software issue resolution, yet they remain highly prone to factual errors caused by insufficient repository understanding. [Retrieval, Knowledge, and RAG]
  ...
  - Submitted by: Silin Chen | Upvotes: 14 | Comments: 2
...
- [Towards Autonomous and Auditable Medical Imaging Model Development](https://huggingface.co/papers/2607.10522) [Upvote: 17] Large language model (LLM) agents are beginning to automate machine learning engineering (MLE) by coupling planning, code execution, debugging, and empirical feedback. [Domain Applications]
  ...
  - Submitted by: Shengyuan Liu | Upvotes: 17 | Comments: 2
...
- [MuScriptor: An Open Model for Multi-Instrument Music Transcription](https://huggingface.co/papers/2607.08168) [Upvote: 17] Existing methods for automatic music transcription are often limited to single-instrument recordings or fail on complex, real music mixes. [Other AI]
  - Authors: Simon Rouard, Michael Krause, Axel Roebel, Carl-Johann Simon-Gabriel, Alexandre Défossez
  - Submitted by: Amelie Royer | Upvotes: 17 | Comments: 3
...
- [Principled Analysis of Deep Reinforcement Learning Evaluation and Design Paradigms](https://huggingface.co/papers/2607.07769) [Upvote: 8] Starting from the utilization of deep neural networks to approximate the state-action value function that led to winning one of the most challenging games, to algorithmic advancements that allowed solving problems… [Reasoning, Alignment, and Evaluation]
  - Authors: Ezgi Korkmaz
  - Submitted by: Ezgi Korkmaz | Upvotes: 8 | Comments: 2
