# Hugging Face Daily Papers Report (2026-06-12)

- Source: https://huggingface.co/papers/date/2026-06-12
- Classifier: rule
- Total Papers: 38

## Today's Hotspots and Trend

- LLMs and Language: 11 papers (28.95%); representative paper: Agentic Environment Engineering for Large Language Models: A Survey of Environment Modeling, Synthesis, Evaluation, and Application.
- Learning, Optimization, and Theory: 7 papers (18.42%); representative paper: Redesign Mixture-of-Experts Routers with Manifold Power Iteration.
- Other AI: 5 papers (13.16%); representative paper: DeNovoSWE: Scaling Long-Horizon Environments for Generating Entire Repositories from Scratch.
- Trend: Today's dominant clusters are LLMs and Language / Learning, Optimization, and Theory / Other AI; this suggests that attention is spread across application adaptation, evaluation, and model reliability. The strongest visible attention is on “Redesign Mixture-of-Experts Routers with Manifold Power Iteration” (74 upvotes).
...
- LLMs and Language: 11 papers (28.95%)
- Learning, Optimization, and Theory: 7 papers (18.42%)
- Other AI: 5 papers (13.16%)
- Reasoning, Alignment, and Evaluation: 4 papers (10.53%)
- Agents and Planning: 3 papers (7.89%)
- Datasets and Benchmarks: 3 papers (7.89%)
- Multimodal Understanding and Vision: 2 papers (5.26%)
- Domain Applications: 1 papers (2.63%)
- Multimodal Agents: 1 papers (2.63%)
- Robotics and Embodied AI: 1 papers (2.63%)

## Top Submitters

- taesiri: 5 papers
- Amir El-Ghoussani: 1 papers
- Amirhossein Abaskohi: 1 papers
- Anamaria-Roberta Hartl: 1 papers
- Bharath Sivaram Narasimhan: 1 papers
- Changyue Wang: 1 papers

## Brief Notes

- The top topic today is “LLMs and Language”, with 11 papers, accounting for 28.95%。
- The most active submitter is taesiri， with 5 papers。
- The highest-voted visible paper is “Redesign Mixture-of-Experts Routers with Manifold Power Iteration”, currently at 74 votes.
- Today's dominant clusters are LLMs and Language / Learning, Optimization, and Theory / Other AI; this suggests that attention is spread across application adaptation, evaluation, and model reliability. The strongest visible attention is on “Redesign Mixture-of-Experts Routers with Manifold Power Iteration” (74 upvotes).

## Categorized Paper Briefs

### LLMs and Language (11 papers)

- [Agentic Environment Engineering for Large Language Models: A Survey of Environment Modeling, Synthesis, Evaluation, and Application](https://huggingface.co/papers/2606.12191) [Upvote: 55] Environments serve as interactive systems for large language model (LLM) based agents across diverse scenarios and play a crucial role in driving the continual evolution of model capabilities. [LLMs and Language]
  ...
  - Submitted by: Zhuoran Jin | Upvotes: 55 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2606.12191) / [arXiv](https://arxiv.org/pdf/2606.12191) / [Cool](https://papers.cool/arxiv/2606.12191)
  - <details>
...
- [Grammar-Constrained Decoding Can Jailbreak LLMs into Generating Malicious Code](https://huggingface.co/papers/2606.11817) [Upvote: 17] Large Language Models (LLMs) are increasingly used for code generation, raising concerns that they may be misused to produce malicious code. [LLMs and Language]
  - Authors: Yitong Zhang, Shiteng Lu, Jia Li
  - Submitted by: zhang | Upvotes: 17 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2606.11817) / [arXiv](https://arxiv.org/pdf/2606.11817) / [Cool](https://papers.cool/arxiv/2606.11817)
  - <details>
    <summary>Abstract</summary>
...
- [ICA Lens: Interpreting Language Models Without Training Another Dictionary](https://huggingface.co/papers/2606.11722) [Upvote: 14] Finding interpretable directions in language-model representations is critical for understanding and controlling model behavior. [LLMs and Language]
  - Authors: Sida Liu, Feijiang Han
  - Submitted by: Feijiang Han | Upvotes: 14 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2606.11722) / [arXiv](https://arxiv.org/pdf/2606.11722) / [Cool](https://papers.cool/arxiv/2606.11722)
  - <details>
    <summary>Abstract</summary>
...
- [Reroute, Don't Remove: Recoverable Visual Token Routing for Vision-Language Models](https://huggingface.co/papers/2606.12412) [Upvote: 13] Vision-language models (VLMs) project images into hundreds to thousands of visual tokens, making decoder inference expensive in both attention computation and KV-cache memory. [LLMs and Language]
  - Authors: Cheng-Yu Yang, Shao-Yuan Lo, Yu-Lun Liu
  - Submitted by: Yu-Lun Liu | Upvotes: 13 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2606.12412) / [arXiv](https://arxiv.org/pdf/2606.12412) / [Cool](https://papers.cool/arxiv/2606.12412)
  - <details>
    <summary>Abstract</summary>
...
- [POISE: Position-Aware Undetectable Skill Injection on LLM Agents](https://huggingface.co/papers/2606.07943) [Upvote: 4] Agent skills provide a lightweight mechanism for extending general-purpose agents, but their open format exposes them to skill-poisoning attacks. [LLMs and Language]
  - Authors: Haochang Hao, Dehai Min, Zhifang Zhang, Yunbei Zhang, Miao Xu, Yingqiang Ge, Lu Cheng
  - Submitted by: Haochang Hao | Upvotes: 4 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2606.07943) / [arXiv](https://arxiv.org/pdf/2606.07943) / [Cool](https://papers.cool/arxiv/2606.07943)
  - <details>
    <summary>Abstract</summary>
...
- [Large Language Models Are Overconfident in Their Own Responses](https://huggingface.co/papers/2606.03437) [Upvote: 3] Prior work has shown that instruction-tuned large language models (LLMs) are less well calibrated than their base pre-trained counterparts. [LLMs and Language]
  - Authors: Mario Sanz-Guerrero, Manuel Mager, Katharina von der Wense
  - Submitted by: Mario Sanz | Upvotes: 3 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2606.03437) / [arXiv](https://arxiv.org/pdf/2606.03437) / [Cool](https://papers.cool/arxiv/2606.03437)
  - <details>
    <summary>Abstract</summary>
...
- [DRIFT: A Residual Flow Adapter for Decoding Continuous Outputs in Vision-Language Models](https://huggingface.co/papers/2606.05758) [Upvote: 2] Many modern vision-language models (VLMs) build on autoregressive decoding of discrete tokens. [LLMs and Language]
  - Authors: Zhuoming Liu, Jinhong Lin, Kwan Man Cheng, Lin Zhang, Shayok Bagchi, Yin Li
  - Submitted by: Zhuoming Liu | Upvotes: 2 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2606.05758) / [arXiv](https://arxiv.org/pdf/2606.05758) / [Cool](https://papers.cool/arxiv/2606.05758)
  - <details>
    <summary>Abstract</summary>
...
- [Adaptive Multi-Resolution Procedural Knowledge Compression for Large Language Models](https://huggingface.co/papers/2606.12203) [Upvote: 2] Large language models (LLMs) are widely used to tackle complex tasks with autonomous workflows. [LLMs and Language]
  - Authors: Changyue Wang, Weihang Su, Qingyao Ai, Yichen Tang, Runzhong Qiao, Xuancheng Li, Min Zhang, Yiqun Liu
  - Submitted by: Changyue Wang | Upvotes: 2 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2606.12203) / [arXiv](https://arxiv.org/pdf/2606.12203) / [Cool](https://papers.cool/arxiv/2606.12203)
  - <details>
    <summary>Abstract</summary>
...
- [Which Models Are Our Models Built On? Auditing Invisible Dependencies in Modern LLMs](https://huggingface.co/papers/2606.12385) [Upvote: 1] Modern LLM training pipelines increasingly rely on other models to generate data, filter corpora, judge outputs, and guide development decisions. [LLMs and Language]
  - Authors: Sanjay Adhikesaven, Haoxiang Sun, Sewon Min
  - Submitted by: Haoxiang Sun | Upvotes: 1 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2606.12385) / [arXiv](https://arxiv.org/pdf/2606.12385) / [Cool](https://papers.cool/arxiv/2606.12385)
  - <details>
    <summary>Abstract</summary>
...
- [Towards Diverse Scientific Hypothesis Search with Large Language Models](https://huggingface.co/papers/2606.10587) [Upvote: 1] Large language models (LLMs) are on the rise for accelerating scientific discovery, most recently in advanced tasks such as generating valid scientific hypotheses. [LLMs and Language]
  ...
  - Submitted by: Parshin Shojaee | Upvotes: 1 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2606.10587) / [arXiv](https://arxiv.org/pdf/2606.10587) / [Cool](https://papers.cool/arxiv/2606.10587)
  - <details>
    <summary>Abstract</summary>
...
- [Distilling LLM Feedback for Lean Theorem Proving](https://huggingface.co/papers/2605.30861) [Upvote: 1] Post-training for reasoning models typically combines supervised fine-tuning with reinforcement learning from verifiable rewards, most commonly with GRPO. [LLMs and Language]
  - Authors: Gaetan Narozniak, Gérard Biau, Rémi Munos, Ahmad Rammal, Pierre Marion
  - Submitted by: N | Upvotes: 1 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2605.30861) / [arXiv](https://arxiv.org/pdf/2605.30861) / [Cool](https://papers.cool/arxiv/2605.30861)
  - <details>
    <summary>Abstract</summary>
...
- [Redesign Mixture-of-Experts Routers with Manifold Power Iteration](https://huggingface.co/papers/2606.12397) [Upvote: 74] Router is the cornerstone component to the Mixture-of-Experts models. [Learning, Optimization, and Theory]
  - Authors: Songhao Wu, Ang Lv, Ruobing Xie, Yankai Lin
  - Submitted by: Songhao Wu | Upvotes: 74 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2606.12397) / [arXiv](https://arxiv.org/pdf/2606.12397) / [Cool](https://papers.cool/arxiv/2606.12397)
  - <details>
    <summary>Abstract</summary>
...
- [Breaking Entropy Bounds: Accelerating RL Training via MTP with Rejection Sampling](https://huggingface.co/papers/2606.12370) [Upvote: 15] Reinforcement learning (RL) has become a key component in modern large language models, yet the rollout stage remains the key bottleneck in RL training pipelines. [Learning, Optimization, and Theory]
  ...
  - Submitted by: taesiri | Upvotes: 15 | Comments: 3
  - Links: [HF](https://huggingface.co/papers/2606.12370) / [arXiv](https://arxiv.org/pdf/2606.12370) / [Cool](https://papers.cool/arxiv/2606.12370)
  - <details>
    <summary>Abstract</summary>
...
- [EvoTrainer: Co-Evolving LLM Policies and Training Harnesses for Autonomous Agentic Reinforcement Learning](https://huggingface.co/papers/2606.03108) [Upvote: 9] Autonomous LLM training is often framed as recipe search, which leaves the training harness largely static. [Learning, Optimization, and Theory]
  - Authors: Guhong Chen, Yingcheng Shi, Yongbin Li, Binhua Li, Xander Xu, Hu Wei, Shiwen Ni, Min Yang, Jieping Ye
  - Submitted by: youyou | Upvotes: 9 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2606.03108) / [arXiv](https://arxiv.org/pdf/2606.03108) / [Cool](https://papers.cool/arxiv/2606.03108)
  - <details>
    <summary>Abstract</summary>
...
- [Breaking the Bubble: Asynchronous Pipeline Parallel Training with Bounded Weight Inconsistency](https://huggingface.co/papers/2606.07881) [Upvote: 6] Pipeline parallelism is essential for training large neural networks, but existing schedules trade off throughput, memory, and optimization consistency. [Learning, Optimization, and Theory]
  - Authors: Itay Elam, Eliron Rahimi, Avi Mendelson, Chaim Baskin
  - Submitted by: itay elam | Upvotes: 6 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2606.07881) / [arXiv](https://arxiv.org/pdf/2606.07881) / [Cool](https://papers.cool/arxiv/2606.07881)
  - <details>
    <summary>Abstract</summary>
...
- [World Model Self-Distillation: Training World Models to Solve General Tasks](https://huggingface.co/papers/2606.12072) [Upvote: 5] Pretrained video generators are promising visual world models that exhibit emergent task-solving abilities; however, their reliance on detailed textual descriptions limits their direct use for planning and… [Learning, Optimization, and Theory]
  - Authors: Sebastian Stapf, Pablo Acuaviva Huertos, Aram Davtyan, Paolo Favaro
  - Submitted by: taesiri | Upvotes: 5 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2606.12072) / [arXiv](https://arxiv.org/pdf/2606.12072) / [Cool](https://papers.cool/arxiv/2606.12072)
  - <details>
    <summary>Abstract</summary>
...
- [Fine-tuning Multi-modal LLMs with ART: Art-based Reinforcement Training](https://huggingface.co/papers/2606.11854) [Upvote: 3] There are two main Parameter-Efficient Fine-Tuning (PEFT) techniques for Large Language Models (LLMs). [Learning, Optimization, and Theory]
  - Authors: Michal Chudoba, Sergey Alyaev, Petra Galuscakova, Tomasz Wiktorski
  - Submitted by: jinymusim | Upvotes: 3 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2606.11854) / [arXiv](https://arxiv.org/pdf/2606.11854) / [Cool](https://papers.cool/arxiv/2606.11854)
  - <details>
    <summary>Abstract</summary>
...
- [SparDA: Sparse Decoupled Attention for Efficient Long-Context LLM Inference](https://huggingface.co/papers/2606.04511) [Upvote: 1] Sparse attention reduces compute and memory bandwidth for long-context LLM inference. [Learning, Optimization, and Theory]
  - Authors: Yaosheng Fu, Guangxuan Xiao, Xin Dong, Song Han, Oreste Villa
  - Submitted by: Yaosheng Fu | Upvotes: 1 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2606.04511) / [arXiv](https://arxiv.org/pdf/2606.04511) / [Cool](https://papers.cool/arxiv/2606.04511)
  - <details>
    <summary>Abstract</summary>
...
- [DeNovoSWE: Scaling Long-Horizon Environments for Generating Entire Repositories from Scratch](https://huggingface.co/papers/2606.10728) [Upvote: 27] As the capabilities of LLM-based code agents continue to advance, their expected role is expanding beyond localized bug fixing in existing codebases toward architecting and implementing complete software repositories… [Other AI]
  - Authors: Jiale Zhao, Guoxin Chen, Fanzhe Meng, Wayne Xin Zhao, Ruihua Song, Ji-Rong Wen, Kai Jia
  - Submitted by: Guoxin Chen | Upvotes: 27 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2606.10728) / [arXiv](https://arxiv.org/pdf/2606.10728) / [Cool](https://papers.cool/arxiv/2606.10728)
  - <details>
    <summary>Abstract</summary>
...
- [On Subquadratic Architectures: From Applications to Principles](https://huggingface.co/papers/2606.12364) [Upvote: 20] Transformers dominate modern sequence modeling, but their quadratic attention incurs substantial computational cost. [Other AI]
  ...
  - Submitted by: Anamaria-Roberta Hartl | Upvotes: 20 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2606.12364) / [arXiv](https://arxiv.org/pdf/2606.12364) / [Cool](https://papers.cool/arxiv/2606.12364)
  - <details>
    <summary>Abstract</summary>
...
- [Time-Series Foundation Model Embeddings for Remaining Useful Life Estimation](https://huggingface.co/papers/2606.11990) [Upvote: 3] Remaining Useful Life (RUL) prediction is essential for industrial predictive maintenance, yet many learning-based approaches rely on extensive feature engineering or large labeled datasets to train task-specific… [Other AI]
  - Authors: Amir El-Ghoussani, Michele De Vita, Ronald Naumann, Valiseios Belagiannis
  - Submitted by: Amir El-Ghoussani | Upvotes: 3 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2606.11990) / [arXiv](https://arxiv.org/pdf/2606.11990) / [Cool](https://papers.cool/arxiv/2606.11990)
  - <details>
    <summary>Abstract</summary>
...
- [Lius: Translation Model Based Instructional Lingustic Using Continual Instruction Tuning In Kupang Malay](https://huggingface.co/papers/2606.11786) [Upvote: 2] Large Language Models (LLMs) offer new potential for translation tasks but often experience performance degradation when handling low-resource languages. [Other AI]
  - Authors: Joanito Agili Lopo, Yunita Sari, Guntur Budi Herwanto
  - Submitted by: Joanito Agili Lopo | Upvotes: 2 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2606.11786) / [arXiv](https://arxiv.org/pdf/2606.11786) / [Cool](https://papers.cool/arxiv/2606.11786)
  - <details>
    <summary>Abstract</summary>
...
- [APEX: A Network-Native Time-Series Foundation Model for Forecasting and Anomaly Detection for Wireless Edge Operations](https://huggingface.co/papers/2606.11553) [Upvote: 1] Generic time-series foundation models transfer poorly to wireless network telemetry whose signals are bursty, zero-inflated, and coupled across protocol layers. [Other AI]
  - Authors: Swadhin Pradhan, Niloo Bahadori, Peiman Amini
  - Submitted by: Swadhin Pradhan | Upvotes: 1 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2606.11553) / [arXiv](https://arxiv.org/pdf/2606.11553) / [Cool](https://papers.cool/arxiv/2606.11553)
  - <details>
    <summary>Abstract</summary>
...
- [Beyond Scalar Rewards by Internalizing Reasoning into Score Distributions](https://huggingface.co/papers/2606.09076) [Upvote: 49] Reward models are central to text-to-image post-training, but visual preference is subjective and better represented as a distribution over rubric scores than as a deterministic scalar. [Reasoning, Alignment, and Evaluation]
  ...
  - Submitted by: Huanqia Cai | Upvotes: 49 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2606.09076) / [arXiv](https://arxiv.org/pdf/2606.09076) / [Cool](https://papers.cool/arxiv/2606.09076)
  - <details>
    <summary>Abstract</summary>
...
- [TRL-Bench: Standardizing Cross-Paradigm Representation-Level Evaluation of Tabular Encoders](https://huggingface.co/papers/2606.09323) [Upvote: 46] Tabular encoders are usually evaluated inside task-specific end-to-end pipelines, so models from different training paradigms are difficult to compare directly even when they operate on similar tabular signals. [Reasoning, Alignment, and Evaluation]
  ...
  - Submitted by: Wei Pang | Upvotes: 46 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2606.09323) / [arXiv](https://arxiv.org/pdf/2606.09323) / [Cool](https://papers.cool/arxiv/2606.09323)
  - <details>
    <summary>Abstract</summary>
...
- [Reason, Then Re-reason: Cross-view Revisiting Improves Spatial Reasoning](https://huggingface.co/papers/2606.11683) [Upvote: 27] Spatial reasoning from egocentric videos is inherently challenging because the observable evidence is constrained by the camera trajectory. [Reasoning, Alignment, and Evaluation]
  - Authors: Chaofan Ma, Zhenjie Mao, Yuhuan Yang, Fanqin Zeng, Yue Shi, Yingjie Zhou, Xiaofeng Cao, Jiangchao Yao
  - Submitted by: chaofanma | Upvotes: 27 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2606.11683) / [arXiv](https://arxiv.org/pdf/2606.11683) / [Cool](https://papers.cool/arxiv/2606.11683)
  - <details>
    <summary>Abstract</summary>
...
- [Verifiable Environments Are LEGO Bricks: Recursive Composition for Reasoning Generalization](https://huggingface.co/papers/2606.12373) [Upvote: 6] Reinforcement Learning (RL) with verifiable environments has emerged as a powerful approach for enhancing the reasoning capabilities of Large Language Models (LLMs). [Reasoning, Alignment, and Evaluation]
  - Authors: Hao Xiang, Qiaoyu Tang, Le Yu, Yaojie Lu, Xianpei Han, Ben He, Le Sun, Bowen Yu, Peng Wang, Hongyu Lin, Dayiheng Liu
  - Submitted by: xianghao | Upvotes: 6 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2606.12373) / [arXiv](https://arxiv.org/pdf/2606.12373) / [Cool](https://papers.cool/arxiv/2606.12373)
  - <details>
    <summary>Abstract</summary>
...
- [Toward Generalist Autonomous Research via Hypothesis-Tree Refinement](https://huggingface.co/papers/2606.11926) [Upvote: 66] Scientific progress depends on a repeated loop of exploration, experimentation, and abstraction. [Agents and Planning]
  ...
  - Submitted by: Yuyang Hu | Upvotes: 66 | Comments: 3
  - Links: [HF](https://huggingface.co/papers/2606.11926) / [arXiv](https://arxiv.org/pdf/2606.11926) / [Cool](https://papers.cool/arxiv/2606.11926)
  - <details>
    <summary>Abstract</summary>
...
- [TRACE: A Unified Rollout Budget Allocation Framework for Efficient Agentic Reinforcement Learning](https://huggingface.co/papers/2606.11119) [Upvote: 15] Reinforcement learning with verifiable rewards (RLVR) is a promising approach for enhancing reasoning and agentic behavior in large language models. [Agents and Planning]
  ...
  - Submitted by: Heming Zou | Upvotes: 15 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2606.11119) / [arXiv](https://arxiv.org/pdf/2606.11119) / [Cool](https://papers.cool/arxiv/2606.11119)
  - <details>
    <summary>Abstract</summary>
...
- [ReVision: Scaling Computer-Use Agents via Temporal Visual Redundancy Reduction](https://huggingface.co/papers/2605.11212) [Upvote: 1] Computer-use agents (CUAs) rely on visual observations of graphical user interfaces, where each screenshot is encoded into a large number of visual tokens. [Agents and Planning]
  - Authors: Amirhossein Abaskohi, Yuhang He, Peter West, Giuseppe Carenini, Pranit Chawla, Vibhav Vineet
  - Submitted by: Amirhossein Abaskohi | Upvotes: 1 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2605.11212) / [arXiv](https://arxiv.org/pdf/2605.11212) / [Cool](https://papers.cool/arxiv/2605.11212)
  - <details>
    <summary>Abstract</summary>
...
- [Claw-SWE-Bench: A Benchmark for Evaluating OpenClaw-style Agent Harnesses on Coding Tasks](https://huggingface.co/papers/2606.12344) [Upvote: 55] General-purpose agents such as OpenClaw are increasingly used as autonomous tool users, but their coding ability is difficult to measure under SWE-bench: a generic agent does not by itself satisfy the clean Docker… [Datasets and Benchmarks]
  ...
  - Submitted by: hankai | Upvotes: 55 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2606.12344) / [arXiv](https://arxiv.org/pdf/2606.12344) / [Cool](https://papers.cool/arxiv/2606.12344)
  - <details>
    <summary>Abstract</summary>
...
- [ComBench: A Benchmark for Rigorous Proof Reasoning and Constructive Realization in Olympiad-Level Combinatorics](https://huggingface.co/papers/2606.10479) [Upvote: 18] Combinatorics is central to Olympiad-level mathematical problem solving, requiring deep discrete reasoning, creative constructions, and rigorous structural insight. [Datasets and Benchmarks]
  ...
  - Submitted by: Haoran Zhang | Upvotes: 18 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2606.10479) / [arXiv](https://arxiv.org/pdf/2606.10479) / [Cool](https://papers.cool/arxiv/2606.10479)
  - <details>
    <summary>Abstract</summary>
...
- [τ-Rec: A Verifiable Benchmark for Agentic Recommender Systems](https://huggingface.co/papers/2606.10156) [Upvote: 1] As recommender systems transition toward agentic, multi-turn conversational interfaces, evaluation paradigms have struggled to keep pace. [Datasets and Benchmarks]
  - Authors: Bharath Sivaram Narasimhan, Karthik R Narasimhan
  - Submitted by: Bharath Sivaram Narasimhan | Upvotes: 1 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2606.10156) / [arXiv](https://arxiv.org/pdf/2606.10156) / [Cool](https://papers.cool/arxiv/2606.10156)
  - <details>
    <summary>Abstract</summary>
...
- [InternVideo3: Agentify Foundation Models with Multimodal Contextual Reasoning](https://huggingface.co/papers/2606.12195) [Upvote: 17] Recent progress in foundation models has shifted toward agentic behavior involving multi-step reasoning and tool use. [Multimodal Understanding and Vision]
  ...
  - Links: [HF](https://huggingface.co/papers/2606.12195) / [arXiv](https://arxiv.org/pdf/2606.12195) / [Cool](https://papers.cool/arxiv/2606.12195)
  - <details>
    <summary>Abstract</summary>
...
- [i1: A Simple and Fully Open Recipe for Strong Text-to-Image Models](https://huggingface.co/papers/2606.11289) [Upvote: 4] Diffusion models have consistently driven progress in text-to-image generation. [Multimodal Understanding and Vision]
  ...
  - Links: [HF](https://huggingface.co/papers/2606.11289) / [arXiv](https://arxiv.org/pdf/2606.11289) / [Cool](https://papers.cool/arxiv/2606.11289)
  - <details>
    <summary>Abstract</summary>
...
- [FlowLet: Conditional 3D Brain MRI Synthesis using Wavelet Flow Matching](https://huggingface.co/papers/2601.05212) [Upvote: 1] Brain Magnetic Resonance Imaging (MRI) plays a central role in studying neurological development, aging, and diseases. [Domain Applications]
  - Authors: Danilo Danese, Angela Lombardi, Matteo Attimonelli, Giuseppe Fasano, Tommaso Di Noia
  - Submitted by: Danilo Danese | Upvotes: 1 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2601.05212) / [arXiv](https://arxiv.org/pdf/2601.05212) / [Cool](https://papers.cool/arxiv/2601.05212)
  - <details>
    <summary>Abstract</summary>
...
- [World Pilot: Steering Vision-Language-Action Models with World-Action Priors](https://huggingface.co/papers/2606.12403) [Upvote: 22] Vision-Language-Action (VLA) models inherit semantic grounding from large-scale pretraining and perform competently across in-distribution manipulation tasks. [Multimodal Agents]
  - Authors: Zefu Lin, Rongxu Cui, Junjia Xu, Xiaojuan Jin, Wenling Li, Lue Fan, Zhaoxiang Zhang
  - Submitted by: Zefu Lin | Upvotes: 22 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2606.12403) / [arXiv](https://arxiv.org/pdf/2606.12403) / [Cool](https://papers.cool/arxiv/2606.12403)
  - <details>
    <summary>Abstract</summary>
...
- [Embodied-R1.5: Evolving Physical Intelligence via Embodied Foundation Models](https://huggingface.co/papers/2606.11324) [Upvote: 6] We introduce Embodied-R1.5, a unified Embodied Foundation Model (EFM) that integrates comprehensive embodied reasoning capabilities, spanning embodied cognition, task planning, correction, and pointing, within a… [Robotics and Embodied AI]
  ...
  - Links: [HF](https://huggingface.co/papers/2606.11324) / [arXiv](https://arxiv.org/pdf/2606.11324) / [Cool](https://papers.cool/arxiv/2606.11324)
  - <details>
    <summary>Abstract</summary>
