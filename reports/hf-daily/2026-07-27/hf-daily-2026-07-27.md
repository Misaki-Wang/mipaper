# Hugging Face Daily Papers Report (2026-07-27)

- Source: https://huggingface.co/papers/date/2026-07-27
- Classifier: rule
- Total Papers: 22
...
- Trend: Today's dominant clusters are Agents and Planning / Datasets and Benchmarks / LLMs and Language; this suggests that agent papers emphasize tool use, planning, and deployable workflows. The strongest visible attention is on “AREX: Towards a Recursively Self-Improving Agent for Deep Research” (135 upvotes).
...
- The highest-voted visible paper is “AREX: Towards a Recursively Self-Improving Agent for Deep Research”, currently at 135 votes.
- Today's dominant clusters are Agents and Planning / Datasets and Benchmarks / LLMs and Language; this suggests that agent papers emphasize tool use, planning, and deployable workflows. The strongest visible attention is on “AREX: Towards a Recursively Self-Improving Agent for Deep Research” (135 upvotes).

## Categorized Paper Briefs

### Agents and Planning (5 papers)

- [AREX: Towards a Recursively Self-Improving Agent for Deep Research](https://huggingface.co/papers/2607.21461) [Upvote: 135] Deep research requires agents to find answers that jointly satisfy multiple constraints. [Agents and Planning]
  ...
  - Submitted by: zhengliu | Upvotes: 135 | Comments: 2
...
- [NVIDIA-labs OO Agents: Native Python Object-Oriented Agents](https://huggingface.co/papers/2607.20709) [Upvote: 25] Traditional agent development is split across prompt templates, tool schemas, callback code, and workflow graphs. [Agents and Planning]
  ...
  - Submitted by: taesiri | Upvotes: 25 | Comments: 1
...
- [Sample-Efficient Learning from Agent Experience](https://huggingface.co/papers/2607.21051) [Upvote: 10] Real-world agent learning is often constrained by costly environment interactions, such as running time-consuming experiments or obtaining human feedback. [Agents and Planning]
  - Authors: Chenhui Gou, Haoqin Tu, Yunhao Fang, Jianfei Cai, Hamid Rezatofighi
  - Submitted by: Chenhui Gou | Upvotes: 10 | Comments: 4
...
- [Show, Don't Tell: Evaluating Spatial Cognition in Generative Pixels Rather Than LLM Text](https://huggingface.co/papers/2607.21072) [Upvote: 35] Spatial intelligence is essential for agents to move from static semantic understanding toward interacting with the physical world. [LLMs and Language]
  - Authors: Xu Wang, Kaixiang Yao, Miao Pan, Xiaohe Zhou, Xuanyu Liu, Wenqi Zhang, Xuhong Zhang
  - Submitted by: Wenqi Zhang | Upvotes: 35 | Comments: 2
...
- [LLMs Get Lost in Evolving User Intent](https://huggingface.co/papers/2607.20734) [Upvote: 19] As LLMs become more capable, they are increasingly deployed as collaborative agents, taking on user-delegated tasks through iterative interaction. [LLMs and Language]
  - Authors: Jihoon Tack, Philippe Laban, Jennifer Neville
  - Submitted by: Jihoon Tack | Upvotes: 19 | Comments: 4
...
- [Visual Contrastive Self-Distillation](https://huggingface.co/papers/2607.21556) [Upvote: 43] On-policy self-distillation (OPSD) is promising as it removes the external teacher required by on-policy distillation (OPD), yet it still needs asymmetric information between teacher and student to ensure that the… [Multimodal Understanding and Vision]
  - Authors: Yijun Liang, Yunjie Tian, Yijiang Li, Yuqi Jia, Furong Huang, Tianyi Zhou, Di Fu
  - Submitted by: Yijun Liang | Upvotes: 43 | Comments: 2
...
- [SANA-Video 2.0: Hybrid Linear Attention with Attention Residuals for Efficient Video Generation](https://huggingface.co/papers/2607.21553) [Upvote: 26] We introduce SANA-Video 2.0, a hybrid video diffusion transformer instantiated at 5B and 14B scales under a unified architecture. [Multimodal Understanding and Vision]
  ...
  - Submitted by: Chen | Upvotes: 26 | Comments: 3
...
- [Self-Supervised Learning of Structured Dynamics from Videos](https://huggingface.co/papers/2607.21576) [Upvote: 18] Understanding motion in video is a fundamental challenge for visual learning, as frame-to-frame change entangles two sources of dynamics: camera motion and object motion. [Learning, Optimization, and Theory]
  - Authors: Lukas Knobel, Andrew Zisserman, Yuki M. Asano
  - Submitted by: Lukas Knobel | Upvotes: 18 | Comments: 2
...
- [K12-KGraph: A Curriculum-Aligned Knowledge Graph for Benchmarking and Training Educational LLMs](https://huggingface.co/papers/2605.09635) [Upvote: 56] Large language models are increasingly used in K-12 education, but existing benchmarks mainly test exam question answering rather than understanding how curriculum knowledge is structured and visually presented. [Retrieval, Knowledge, and RAG]
  - Authors: Hao Liang, Qihan Lin, Zhaoyang Han, Xiaochen Ma, Zhen Hao Wong, Meiyi Qiang, Linzhuang Sun, Wentao Zhang
  - Submitted by: Hao Liang | Upvotes: 56 | Comments: 2
