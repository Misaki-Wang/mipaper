...
- LLMs and Language: 4 papers (23.53%); representative paper: DataPrep-Bench: Benchmarking LLMs as Training Data Preparators.
- Agents and Planning: 3 papers (17.65%); representative paper: Agentic Context Management: Solving Agent Memory and Cost by Treating Them as Lifecycle and Architecture Problems.
- Learning, Optimization, and Theory: 3 papers (17.65%); representative paper: Molt: A Scalable PyTorch-Native Training Framework for Agentic Reinforcement Learning.
- Trend: Today's dominant clusters are LLMs and Language / Agents and Planning / Learning, Optimization, and Theory; this suggests that agent papers emphasize tool use, planning, and deployable workflows. The strongest visible attention is on “DataPrep-Bench: Benchmarking LLMs as Training Data Preparators” (53 upvotes).
...
- LLMs and Language: 4 papers (23.53%)
- Agents and Planning: 3 papers (17.65%)
- Learning, Optimization, and Theory: 3 papers (17.65%)
- Multimodal Understanding and Vision: 3 papers (17.65%)
- Reasoning, Alignment, and Evaluation: 3 papers (17.65%)
- Other AI: 1 papers (5.88%)
...
- The top topic today is “LLMs and Language”, with 4 papers, accounting for 23.53%。
- The most active submitter is taesiri， with 5 papers。
- The highest-voted visible paper is “DataPrep-Bench: Benchmarking LLMs as Training Data Preparators”, currently at 53 votes.
- Today's dominant clusters are LLMs and Language / Agents and Planning / Learning, Optimization, and Theory; this suggests that agent papers emphasize tool use, planning, and deployable workflows. The strongest visible attention is on “DataPrep-Bench: Benchmarking LLMs as Training Data Preparators” (53 upvotes).

## Categorized Paper Briefs

### LLMs and Language (4 papers)

- [DataPrep-Bench: Benchmarking LLMs as Training Data Preparators](https://huggingface.co/papers/2607.20465) [Upvote: 53] The quality of training data fundamentally determines the capabilities of large language models (LLMs), yet no unified benchmark exists to measure how well LLMs, agents, and data-centric workflows actually prepare… [LLMs and Language]
  ...
  - Submitted by: Hao Liang | Upvotes: 53 | Comments: 2
...
- [Skill Self-Play: Pushing the Frontier of LLM Capability with Co-Evolving Skills](https://huggingface.co/papers/2607.22529) [Upvote: 47] LLM training is shifting from manual design and annotation to interaction-driven self-evolution. [LLMs and Language]
  ...
  - Submitted by: taesiri | Upvotes: 47 | Comments: 1
...
- [Multi-Head Latent Control: A Unified Interface for LLM Agent Decision Making](https://huggingface.co/papers/2607.14277) [Upvote: 10] Large language models are increasingly deployed as agents, but reliable agentic behavior requires more than next-token prediction. [LLMs and Language]
  - Authors: Amirhosein Ghasemabadi, Ruichen Chen, Bahador Rashidi, Di Niu
  - Submitted by: Amirhosein Ghasemabadi | Upvotes: 10 | Comments: 2
...
- [VisCo: Leveraging Large Language Models as Intrinsic Encoders for Visual Token Compression](https://huggingface.co/papers/2607.12756) [Upvote: 5] Vision-language models (VLMs) process large numbers of visual tokens, resulting in substantial inference latency and memory overhead. [LLMs and Language]
  - Authors: Yupeng Zheng, Kai Zou, Bin Liu, Nenghai Yu
  - Submitted by: ZhengYupeng | Upvotes: 5 | Comments: 3
...
- [Agentic Context Management: Solving Agent Memory and Cost by Treating Them as Lifecycle and Architecture Problems](https://huggingface.co/papers/2607.21503) [Upvote: 25] Production AI agents' failures are less often due to an inability to reason well and more often because they cannot manage what is in their reasoning context: conversation histories, large prompts, large tool… [Agents and Planning]
  - Authors: Gaurav Dadhich
  - Submitted by: Gaurav Dadhich | Upvotes: 25 | Comments: 4
...
- [IDEAgent: Agentic Quality-Diversity Search for Research Idea Generation](https://huggingface.co/papers/2607.22375) [Upvote: 9] Large Language Models (LLMs) have significantly automated the process of scientific discovery over the past few years. [Agents and Planning]
  - Authors: Varun Gumma, Navonil Majumder, Soumitra Sinhahajari, Soujanya Poria
  - Submitted by: Soujanya Poria | Upvotes: 9 | Comments: 2
...
- [SceneActBench: Can Agents Act on the 3D Scenes They See?](https://huggingface.co/papers/2607.22393) [Upvote: 7] Vision-language model (VLM) agents increasingly use tools to act on 3D scenes rather than only describe them. [Agents and Planning]
...
- [Molt: A Scalable PyTorch-Native Training Framework for Agentic Reinforcement Learning](https://huggingface.co/papers/2607.21653) [Upvote: 30] Agentic reinforcement learning research is constant algorithm modification, new estimators, new pipeline stages, new rollout schemes, and in mainstream frameworks each change threads through layers of trainer,… [Learning, Optimization, and Theory]
  ...
  - Submitted by: taesiri | Upvotes: 30 | Comments: 1
...
- [Interactive Training 2: Auditable Control Plane for Live Model Training](https://huggingface.co/papers/2607.18314) [Upvote: 20] Experiment trackers show how training is progressing, but changing a live run still usually requires trainer-specific code. [Learning, Optimization, and Theory]
  - Authors: Wentao Zhang, Xuanhe Pan, Han Zhou, Yang Lu, Yuntian Deng
  - Submitted by: Yuntian Deng | Upvotes: 20 | Comments: 2
...
- [Scaling Native Multimodal Pre-Training From Scratch](https://huggingface.co/papers/2607.22043) [Upvote: 28] Although large language models (LLMs) exhibit remarkable reasoning capabilities, their reliance on text-only pre-training restricts the perception of the multimodal physical world. [Multimodal Understanding and Vision]
...
- [ID-V2V: Identity-Preserving Video Restylization](https://huggingface.co/papers/2607.22830) [Upvote: 10] In visual storytelling, human performances are central to creative intent and narrative meaning. [Multimodal Understanding and Vision]
  - Authors: Yuancheng Xu, Mingming He, Pablo Salamanca, Li Ma, Yash Kant, Emmett Steven, Paul Debevec, Ning Yu
  - Submitted by: Yuancheng Xu | Upvotes: 10 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2607.22830) / [arXiv](https://arxiv.org/pdf/2607.22830) / [Cool](https://papers.cool/arxiv/2607.22830)
  - <details>
    <summary>Abstract</summary>
...
- [Multimodal Speaker Verification as a Threat to Speaker Anonymization](https://huggingface.co/papers/2607.19636) [Upvote: 2] Most automatic speaker verification (ASV) systems operate on individual utterances, despite real-world interactions typically consisting of multiple utterances. [Multimodal Understanding and Vision]
  - Authors: Ashi Garg, Cristina Aggazzotti, Leibny Paola García-Perera, Nicholas Andrews
  - Submitted by: Ashi Garg | Upvotes: 2 | Comments: 2
...
- [LAMAR: An Open Language-Aware Multilingual Alignment Reranker](https://huggingface.co/papers/2607.22042) [Upvote: 16] In multilingual retrieval augmented generation, a retriever can retrieve relevant documents written in multiple languages, which are subsequently reranked before answer generation. [Reasoning, Alignment, and Evaluation]
  - Authors: Seongtae Hong, Youngjoon Jang, Jungseob Lee, Seungyoon Lee, Heuiseok Lim
  - Submitted by: Seongtae Hong | Upvotes: 16 | Comments: 1
...
- [O-VAD: Industrial Video Anomaly Detection through Object-Centric Tracking and Reasoning](https://huggingface.co/papers/2607.18142) [Upvote: 11] Industrial Video Anomaly Detection (IVAD) aims to identify anomalous objects and events in an industrial process, which is crucial for modern manufacturing and quality control systems. [Reasoning, Alignment, and Evaluation]
  - Authors: Mei Yuan, Qi Long, Qifeng Wu, Zhenyang Li, Yizhou Zhao, Lei Wang, Yang Liu, Min Xu
  - Submitted by: yuanmei424 | Upvotes: 11 | Comments: 2
...
- [Spectral Prior for Reducing Exposure Bias in Diffusion Models](https://huggingface.co/papers/2607.22091) [Upvote: 6] Diffusion models typically suffer from error accumulation during iterative sampling, commonly referred to as exposure bias. [Reasoning, Alignment, and Evaluation]
  - Authors: Yuya Kobayashi, Masato Ishii, Yuhta Takida, Takashi Shibuya, Yuki Mitsufuji
  - Submitted by: YuyaKobayashi | Upvotes: 6 | Comments: 2
...
- [Three-Body Scattering for Generative Modeling](https://huggingface.co/papers/2607.18198) [Upvote: 16] Modern generative models typically rely on an adversarial critic, a prescribed noise-to-data path, or an autoregressive factorization. [Other AI]
  - Authors: Peng Sun, Zhenglin Cheng, Deyuan Liu, Jun Xie, Xinyi Shang, Tao Lin
  - Submitted by: Black Box | Upvotes: 16 | Comments: 2
