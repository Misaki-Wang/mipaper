...
- The highest-voted visible paper is “Weak-to-Strong Generalization via Direct On-Policy Distillation”, currently at 125 votes.
...
- [Latent-Identity Tuning in Text-to-Image Personalization Models](https://huggingface.co/papers/2607.11885) [Upvote: 10] Generating and editing a person's face demands high precision, as even minor modifications can significantly alter a subject's perceived identity. [Multimodal Understanding and Vision]
  - Authors: Daniel Garibi, Ronen Kamenetsky, Hadar Averbuch-Elor, Daniel Cohen-Or, Or Patashnik
  - Submitted by: Daniel Garibi | Upvotes: 10 | Comments: 1
...
- [CtrlVTON: Controllable Virtual Try-On via Visual-Instance-Prompt Segmentation](https://huggingface.co/papers/2607.09362) [Upvote: 8] Virtual try-on (VTO) has made significant progress in realistically transferring garments onto a target person. [Multimodal Understanding and Vision]
  - Authors: Seungyong Lee, Hyun Jun Jang, Sangoh Kim, Sungjoon Park
  - Submitted by: Seungyong Lee | Upvotes: 8 | Comments: 2
...
- [LATO.2: Factorized 3D Mesh Generation with Vertex and Topology Flow](https://huggingface.co/papers/2607.10623) [Upvote: 8] Flow matching over carefully designed latent representations has recently emerged as a powerful paradigm for topology-aware mesh generation. [Multimodal Understanding and Vision]
...
- [Evidence-Backed Video Question Answering](https://huggingface.co/papers/2607.11862) [Upvote: 5] Current Video Large Language Models (Video LLMs) excel in question answering (QA) but largely operate as black boxes, providing textual answers without verifiable visual grounding. [Multimodal Understanding and Vision]
  - Authors: Shijie Wang, Honglu Zhou, Ziyang Wang, Ran Xu, Caiming Xiong, Silvio Savarese, Chen Sun, Juan Carlos Niebles
  - Submitted by: Shijie Wang | Upvotes: 5 | Comments: 2
...
- [Metacognition in LLMs: Foundations, Progress, and Opportunities](https://huggingface.co/papers/2607.11881) [Upvote: 20] Metacognition is a foundational component of intelligence critical to effective learning, problem solving, decision-making, communication, and more. [LLMs and Language]
  - Authors: Gabrielle Kaili-May Liu, Areeb Gani, Jacqueline Lu, Jordan Thomas, Mark Steyvers, Arman Cohan
  - Submitted by: John Chih Liu | Upvotes: 20 | Comments: 3
...
- [Proxy Exploration and Reusable Guidance: A Modular LLM Post-Training Paradigm via Proxy-Guided Update Signals](https://huggingface.co/papers/2607.11505) [Upvote: 15] Post-training is essential for refining the domain-specific capabilities of large language models (LLMs), yet existing reward optimization and distribution matching methods tightly couple policy exploration with… [LLMs and Language]
  - Authors: Daocheng Fu, Rong Wu, Yu Yang, Xuemeng Yang, Jianbiao Mei, Licheng Wen, Pinlong Cai, Yong Liu, Botian Shi, Yu Qiao
  - Submitted by: Fu | Upvotes: 15 | Comments: 2
...
- [NeuroCogMap Reveals Cognitive Organization of Large Language Models](https://huggingface.co/papers/2607.00397) [Upvote: 9] Understanding how complex cognitive functions are organized within artificial systems is central to interpreting large language models (LLMs) and relating them to biological cognition. [LLMs and Language]
  ...
  - Submitted by: SunZX | Upvotes: 9 | Comments: 2
...
- [ABot-N1: Toward a General Visual Language Navigation Foundation Model](https://huggingface.co/papers/2607.10383) [Upvote: 95] Visual Language Navigation foundation models aim to unify deep reasoning for grounded spatial decisions with broad versatility for diverse embodied tasks. [Robotics and Embodied AI]
  ...
  - Submitted by: mingchenlin | Upvotes: 95 | Comments: 2
...
- [Xiaomi-Robotics-U0: Unified Embodied Synthesis with World Foundation Model](https://huggingface.co/papers/2607.11643) [Upvote: 38] Recent foundation image and video generation models offer strong generalization and controllability, but their direct application to embodied scenarios is limited by requirements for multi-view consistency, geometric… [Robotics and Embodied AI]
  ...
  - Submitted by: Niels Rogge | Upvotes: 38 | Comments: 2
...
- [EgoSteer: A Full-Stack System Towards Steerable Dexterous Manipulation from Egocentric Videos](https://huggingface.co/papers/2607.09701) [Upvote: 13] Steerability is a defining capability of generalist robot policies, yet remains largely absent in dexterous-hand systems for lack of large-scale, language-aligned, and action-accurate demonstration data. [Robotics and Embodied AI]
  ...
  - Submitted by: Yifan Zhong | Upvotes: 13 | Comments: 2
...
- [Weak-to-Strong Generalization via Direct On-Policy Distillation](https://huggingface.co/papers/2607.05394) [Upvote: 125] Reinforcement learning with verifiable rewards (RLVR) is a powerful recipe for improving language-model reasoning, but it is expensive to repeat on every new strong model because the target model must generate many… [Learning, Optimization, and Theory]
  ...
  - Submitted by: Huan-ang Gao | Upvotes: 125 | Comments: 3
...
- [A Theory of Contrastive Learning with Natural Images](https://huggingface.co/papers/2607.07470) [Upvote: 11] Why does contrastive learning with simple images and augmentations yield useful representations for downstream tasks? [Learning, Optimization, and Theory]
  - Authors: Antonio Torralba, Yair Weiss
  - Submitted by: Shaden | Upvotes: 11 | Comments: 2
...
- [4D Human-Scene Reconstruction from Low-Overlap Captures](https://huggingface.co/papers/2607.09125) [Upvote: 48] Existing volumetric capture of dynamic human performance achieves high fidelity with dense camera arrays. [Other AI]
  - Authors: Minhyuk Hwang, Sangmin Kim, Seunguk Do, Daneul Kim, Jaesik Park
  - Submitted by: Sangmin | Upvotes: 48 | Comments: 3
...
- [Motion4Motion: Motion Transfer Across Subjects at Inference](https://huggingface.co/papers/2607.11644) [Upvote: 8] This work explores the motion transfer from one video to another, which is crucial in animation for diverse characters. [Other AI]
...
- [Multi-Agent LLMs Fail to Explore Each Other](https://huggingface.co/papers/2607.11250) [Upvote: 12] Exploration is essential for reliable autonomy in multi-agent systems, yet it remains unclear whether large language model (LLM) agents can explore effectively when interacting with one another. [Agents and Planning]
  - Authors: Hyeong Kyu Choi, Jiatong Li, Wendi Li, Xin Eric Wang, Sharon Li
  - Submitted by: Hyeong Kyu (Froilan) Choi | Upvotes: 12 | Comments: 4
...
- [AdvancedMathBench: A Benchmark Suite for Advanced Mathematical Proof Generation and Verification](https://huggingface.co/papers/2607.11849) [Upvote: 30] Large language models (LLMs) have achieved remarkable performance on high-school and olympiad-style mathematics, yet their capabilities on advanced mathematics remain poorly understood. [Datasets and Benchmarks]
  ...
  - Submitted by: Yuzhe Gu | Upvotes: 30 | Comments: 2
...
- [ABot-AgentOS: A General Robotic Agent OS with Lifelong Multi-modal Memory](https://huggingface.co/papers/2607.10350) [Upvote: 78] Recent VLM and VLA systems have improved robotic perception and action prediction, yet long-horizon embodied agents still require a general runtime layer for reasoning, memory, tool use, verification, and… [Multimodal Agents]
  ...
  - Submitted by: Jiaheng Liu | Upvotes: 78 | Comments: 2
...
- [LightMem-Ego: Your AI Memory for Everyday Life](https://huggingface.co/papers/2607.11487) [Upvote: 43] Personal AI assistants on mobile and wearable devices continuously perceive users' daily lives through visual and audio streams. [Retrieval, Knowledge, and RAG]
  ...
  - Submitted by: Ningyu Zhang | Upvotes: 43 | Comments: 2
