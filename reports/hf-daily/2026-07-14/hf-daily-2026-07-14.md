...
- Multimodal Understanding and Vision: 4 papers (21.05%); representative paper: Latent-Identity Tuning in Text-to-Image Personalization Models.
- LLMs and Language: 3 papers (15.79%); representative paper: Metacognition in LLMs: Foundations, Progress, and Opportunities.
- Robotics and Embodied AI: 3 papers (15.79%); representative paper: ABot-N1: Toward a General Visual Language Navigation Foundation Model.
- Trend: Today's dominant clusters are Multimodal Understanding and Vision / LLMs and Language / Robotics and Embodied AI; this suggests several parallel trends: multimodal work is moving from isolated perception toward generation, agents, and action; embodied-AI work is increasingly tied to vision-language-action models and real-world control. The strongest visible attention is on “Weak-to-Strong Generalization via Direct On-Policy Distillation” (127 upvotes).
...
- Multimodal Understanding and Vision: 4 papers (21.05%)
- LLMs and Language: 3 papers (15.79%)
- Robotics and Embodied AI: 3 papers (15.79%)
- Learning, Optimization, and Theory: 2 papers (10.53%)
- Other AI: 2 papers (10.53%)
- Agents and Planning: 1 papers (5.26%)
- Datasets and Benchmarks: 1 papers (5.26%)
- Multimodal Agents: 1 papers (5.26%)
- Reasoning, Alignment, and Evaluation: 1 papers (5.26%)
...
- taesiri: 2 papers
- Ayoung Lee: 1 papers
- Daniel Garibi: 1 papers
- Fu: 1 papers
- Huan-ang Gao: 1 papers
- Hyeong Kyu (Froilan) Choi: 1 papers

## Brief Notes

- The top topic today is “Multimodal Understanding and Vision”, with 4 papers, accounting for 21.05%。
- The most active submitter is taesiri， with 2 papers。
- The highest-voted visible paper is “Weak-to-Strong Generalization via Direct On-Policy Distillation”, currently at 127 votes.
- Today's dominant clusters are Multimodal Understanding and Vision / LLMs and Language / Robotics and Embodied AI; this suggests several parallel trends: multimodal work is moving from isolated perception toward generation, agents, and action; embodied-AI work is increasingly tied to vision-language-action models and real-world control. The strongest visible attention is on “Weak-to-Strong Generalization via Direct On-Policy Distillation” (127 upvotes).

## Categorized Paper Briefs

### Multimodal Understanding and Vision (4 papers)

- [Latent-Identity Tuning in Text-to-Image Personalization Models](https://huggingface.co/papers/2607.11885) [Upvote: 11] Generating and editing a person's face demands high precision, as even minor modifications can significantly alter a subject's perceived identity. [Multimodal Understanding and Vision]
  - Authors: Daniel Garibi, Ronen Kamenetsky, Hadar Averbuch-Elor, Daniel Cohen-Or, Or Patashnik
  - Submitted by: Daniel Garibi | Upvotes: 11 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2607.11885) / [arXiv](https://arxiv.org/pdf/2607.11885) / [Cool](https://papers.cool/arxiv/2607.11885)
  - <details>
...
- [CtrlVTON: Controllable Virtual Try-On via Visual-Instance-Prompt Segmentation](https://huggingface.co/papers/2607.09362) [Upvote: 9] Virtual try-on (VTO) has made significant progress in realistically transferring garments onto a target person. [Multimodal Understanding and Vision]
  - Authors: Seungyong Lee, Hyun Jun Jang, Sangoh Kim, Sungjoon Park
  - Submitted by: Seungyong Lee | Upvotes: 9 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2607.09362) / [arXiv](https://arxiv.org/pdf/2607.09362) / [Cool](https://papers.cool/arxiv/2607.09362)
  - <details>
    <summary>Abstract</summary>
...
- [LATO.2: Factorized 3D Mesh Generation with Vertex and Topology Flow](https://huggingface.co/papers/2607.10623) [Upvote: 9] Flow matching over carefully designed latent representations has recently emerged as a powerful paradigm for topology-aware mesh generation. [Multimodal Understanding and Vision]
  ...
  - Links: [HF](https://huggingface.co/papers/2607.10623) / [arXiv](https://arxiv.org/pdf/2607.10623) / [Cool](https://papers.cool/arxiv/2607.10623)
  - <details>
    <summary>Abstract</summary>
...
- [Evidence-Backed Video Question Answering](https://huggingface.co/papers/2607.11862) [Upvote: 7] Current Video Large Language Models (Video LLMs) excel in question answering (QA) but largely operate as black boxes, providing textual answers without verifiable visual grounding. [Multimodal Understanding and Vision]
  - Authors: Shijie Wang, Honglu Zhou, Ziyang Wang, Ran Xu, Caiming Xiong, Silvio Savarese, Chen Sun, Juan Carlos Niebles
  - Submitted by: Shijie Wang | Upvotes: 7 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2607.11862) / [arXiv](https://arxiv.org/pdf/2607.11862) / [Cool](https://papers.cool/arxiv/2607.11862)
  - <details>
    <summary>Abstract</summary>
...
- [Metacognition in LLMs: Foundations, Progress, and Opportunities](https://huggingface.co/papers/2607.11881) [Upvote: 22] Metacognition is a foundational component of intelligence critical to effective learning, problem solving, decision-making, communication, and more. [LLMs and Language]
  - Authors: Gabrielle Kaili-May Liu, Areeb Gani, Jacqueline Lu, Jordan Thomas, Mark Steyvers, Arman Cohan
  - Submitted by: John Chih Liu | Upvotes: 22 | Comments: 3
  - Links: [HF](https://huggingface.co/papers/2607.11881) / [arXiv](https://arxiv.org/pdf/2607.11881) / [Cool](https://papers.cool/arxiv/2607.11881)
  - <details>
    <summary>Abstract</summary>
...
- [Proxy Exploration and Reusable Guidance: A Modular LLM Post-Training Paradigm via Proxy-Guided Update Signals](https://huggingface.co/papers/2607.11505) [Upvote: 16] Post-training is essential for refining the domain-specific capabilities of large language models (LLMs), yet existing reward optimization and distribution matching methods tightly couple policy exploration with… [LLMs and Language]
  - Authors: Daocheng Fu, Rong Wu, Yu Yang, Xuemeng Yang, Jianbiao Mei, Licheng Wen, Pinlong Cai, Yong Liu, Botian Shi, Yu Qiao
  - Submitted by: Fu | Upvotes: 16 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2607.11505) / [arXiv](https://arxiv.org/pdf/2607.11505) / [Cool](https://papers.cool/arxiv/2607.11505)
  - <details>
    <summary>Abstract</summary>
...
- [NeuroCogMap Reveals Cognitive Organization of Large Language Models](https://huggingface.co/papers/2607.00397) [Upvote: 11] Understanding how complex cognitive functions are organized within artificial systems is central to interpreting large language models (LLMs) and relating them to biological cognition. [LLMs and Language]
  ...
  - Submitted by: SunZX | Upvotes: 11 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2607.00397) / [arXiv](https://arxiv.org/pdf/2607.00397) / [Cool](https://papers.cool/arxiv/2607.00397)
  - <details>
    <summary>Abstract</summary>
...
- [ABot-N1: Toward a General Visual Language Navigation Foundation Model](https://huggingface.co/papers/2607.10383) [Upvote: 96] Visual Language Navigation foundation models aim to unify deep reasoning for grounded spatial decisions with broad versatility for diverse embodied tasks. [Robotics and Embodied AI]
  ...
  - Submitted by: mingchenlin | Upvotes: 96 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2607.10383) / [arXiv](https://arxiv.org/pdf/2607.10383) / [Cool](https://papers.cool/arxiv/2607.10383)
  - <details>
    <summary>Abstract</summary>
...
- [Xiaomi-Robotics-U0: Unified Embodied Synthesis with World Foundation Model](https://huggingface.co/papers/2607.11643) [Upvote: 39] Recent foundation image and video generation models offer strong generalization and controllability, but their direct application to embodied scenarios is limited by requirements for multi-view consistency, geometric… [Robotics and Embodied AI]
  ...
  - Submitted by: Niels Rogge | Upvotes: 39 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2607.11643) / [arXiv](https://arxiv.org/pdf/2607.11643) / [Cool](https://papers.cool/arxiv/2607.11643)
  - <details>
    <summary>Abstract</summary>
...
- [EgoSteer: A Full-Stack System Towards Steerable Dexterous Manipulation from Egocentric Videos](https://huggingface.co/papers/2607.09701) [Upvote: 14] Steerability is a defining capability of generalist robot policies, yet remains largely absent in dexterous-hand systems for lack of large-scale, language-aligned, and action-accurate demonstration data. [Robotics and Embodied AI]
  ...
  - Submitted by: Yifan Zhong | Upvotes: 14 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2607.09701) / [arXiv](https://arxiv.org/pdf/2607.09701) / [Cool](https://papers.cool/arxiv/2607.09701)
  - <details>
    <summary>Abstract</summary>
...
- [Weak-to-Strong Generalization via Direct On-Policy Distillation](https://huggingface.co/papers/2607.05394) [Upvote: 127] Reinforcement learning with verifiable rewards (RLVR) is a powerful recipe for improving language-model reasoning, but it is expensive to repeat on every new strong model because the target model must generate many… [Learning, Optimization, and Theory]
  ...
  - Submitted by: Huan-ang Gao | Upvotes: 127 | Comments: 3
  - Links: [HF](https://huggingface.co/papers/2607.05394) / [arXiv](https://arxiv.org/pdf/2607.05394) / [Cool](https://papers.cool/arxiv/2607.05394)
  - <details>
    <summary>Abstract</summary>
...
- [A Theory of Contrastive Learning with Natural Images](https://huggingface.co/papers/2607.07470) [Upvote: 13] Why does contrastive learning with simple images and augmentations yield useful representations for downstream tasks? [Learning, Optimization, and Theory]
  - Authors: Antonio Torralba, Yair Weiss
  - Submitted by: Shaden | Upvotes: 13 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2607.07470) / [arXiv](https://arxiv.org/pdf/2607.07470) / [Cool](https://papers.cool/arxiv/2607.07470)
  - <details>
    <summary>Abstract</summary>
...
- [4D Human-Scene Reconstruction from Low-Overlap Captures](https://huggingface.co/papers/2607.09125) [Upvote: 50] Existing volumetric capture of dynamic human performance achieves high fidelity with dense camera arrays. [Other AI]
  - Authors: Minhyuk Hwang, Sangmin Kim, Seunguk Do, Daneul Kim, Jaesik Park
  - Submitted by: Sangmin | Upvotes: 50 | Comments: 3
  - Links: [HF](https://huggingface.co/papers/2607.09125) / [arXiv](https://arxiv.org/pdf/2607.09125) / [Cool](https://papers.cool/arxiv/2607.09125)
  - <details>
    <summary>Abstract</summary>
...
- [Motion4Motion: Motion Transfer Across Subjects at Inference](https://huggingface.co/papers/2607.11644) [Upvote: 9] This work explores the motion transfer from one video to another, which is crucial in animation for diverse characters. [Other AI]
  - Authors: Ling-Hao Chen, Zixin Yin, Duomin Wang, Xianfang Zeng, Gang Yu
  - Submitted by: taesiri | Upvotes: 9 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2607.11644) / [arXiv](https://arxiv.org/pdf/2607.11644) / [Cool](https://papers.cool/arxiv/2607.11644)
  - <details>
    <summary>Abstract</summary>
...
- [Multi-Agent LLMs Fail to Explore Each Other](https://huggingface.co/papers/2607.11250) [Upvote: 13] Exploration is essential for reliable autonomy in multi-agent systems, yet it remains unclear whether large language model (LLM) agents can explore effectively when interacting with one another. [Agents and Planning]
  - Authors: Hyeong Kyu Choi, Jiatong Li, Wendi Li, Xin Eric Wang, Sharon Li
  - Submitted by: Hyeong Kyu (Froilan) Choi | Upvotes: 13 | Comments: 4
  - Links: [HF](https://huggingface.co/papers/2607.11250) / [arXiv](https://arxiv.org/pdf/2607.11250) / [Cool](https://papers.cool/arxiv/2607.11250)
  - <details>
    <summary>Abstract</summary>
...
- [AdvancedMathBench: A Benchmark Suite for Advanced Mathematical Proof Generation and Verification](https://huggingface.co/papers/2607.11849) [Upvote: 31] Large language models (LLMs) have achieved remarkable performance on high-school and olympiad-style mathematics, yet their capabilities on advanced mathematics remain poorly understood. [Datasets and Benchmarks]
  ...
  - Submitted by: Yuzhe Gu | Upvotes: 31 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2607.11849) / [arXiv](https://arxiv.org/pdf/2607.11849) / [Cool](https://papers.cool/arxiv/2607.11849)
  - <details>
    <summary>Abstract</summary>
...
- [ABot-AgentOS: A General Robotic Agent OS with Lifelong Multi-modal Memory](https://huggingface.co/papers/2607.10350) [Upvote: 80] Recent VLM and VLA systems have improved robotic perception and action prediction, yet long-horizon embodied agents still require a general runtime layer for reasoning, memory, tool use, verification, and… [Multimodal Agents]
  ...
  - Submitted by: Jiaheng Liu | Upvotes: 80 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2607.10350) / [arXiv](https://arxiv.org/pdf/2607.10350) / [Cool](https://papers.cool/arxiv/2607.10350)
  - <details>
    <summary>Abstract</summary>
...
- [MET: Theory-Grounded and Culture-Aware Multilingual Moral Reasoning](https://huggingface.co/papers/2607.11736) [Upvote: 10] Language models are increasingly used for moral decision-making across diverse linguistic and cultural contexts, yet existing work overlooks multilinguality on three aspects: 1) multilingual evaluation benchmarks use… [Reasoning, Alignment, and Evaluation]
  - Authors: Ayoung Lee, Ryan Kwon, Yunxiang Zhang, Yuxuan Liu, Peter Railton, Lu Wang
  - Submitted by: Ayoung Lee | Upvotes: 10 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2607.11736) / [arXiv](https://arxiv.org/pdf/2607.11736) / [Cool](https://papers.cool/arxiv/2607.11736)
  - <details>
    <summary>Abstract</summary>
...
- [LightMem-Ego: Your AI Memory for Everyday Life](https://huggingface.co/papers/2607.11487) [Upvote: 44] Personal AI assistants on mobile and wearable devices continuously perceive users' daily lives through visual and audio streams. [Retrieval, Knowledge, and RAG]
  ...
  - Submitted by: Ningyu Zhang | Upvotes: 44 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2607.11487) / [arXiv](https://arxiv.org/pdf/2607.11487) / [Cool](https://papers.cool/arxiv/2607.11487)
  - <details>
    <summary>Abstract</summary>
