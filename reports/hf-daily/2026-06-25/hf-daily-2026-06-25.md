# Hugging Face Daily Papers Report (2026-06-25)

- Source: https://huggingface.co/papers/date/2026-06-25
- Classifier: rule
- Total Papers: 25

## Today's Hotspots and Trend

- Agents and Planning: 8 papers (32.00%); representative paper: Qwen-AgentWorld: Language World Models for General Agents.
- Multimodal Agents: 3 papers (12.00%); representative paper: ReMMD: Realistic Multilingual Multi-Image Agentic Verification for Multimodal Misinformation Detection.
- Multimodal Understanding and Vision: 3 papers (12.00%); representative paper: Semantic Browsing: Controllable Diversity for Image Generation.
- Trend: Today's dominant clusters are Agents and Planning / Multimodal Agents / Multimodal Understanding and Vision; this suggests several parallel trends: multimodal work is moving from isolated perception toward generation, agents, and action; agent papers emphasize tool use, planning, and deployable workflows. The strongest visible attention is on “Qwen-AgentWorld: Language World Models for General Agents” (79 upvotes).

## Focus Topics

- Generative Foundations: 0 papers (0.00%)
- Multimodal Generative Modeling: 0 papers (0.00%)
- Multimodal Agents: 3 papers (12.00%)

## Topic Distribution

- Agents and Planning: 8 papers (32.00%)
- Multimodal Agents: 3 papers (12.00%)
- Multimodal Understanding and Vision: 3 papers (12.00%)
- Other AI: 3 papers (12.00%)
- Datasets and Benchmarks: 2 papers (8.00%)
- Retrieval, Knowledge, and RAG: 2 papers (8.00%)
- Robotics and Embodied AI: 2 papers (8.00%)
- Domain Applications: 1 papers (4.00%)
- Learning, Optimization, and Theory: 1 papers (4.00%)

## Top Submitters

- taesiri: 5 papers
- Chenhao Dang: 2 papers
- Guangyi Liu: 2 papers
- zhushiding: 2 papers
- Ganlin Yang: 1 papers
- Honglin Guo: 1 papers

## Brief Notes

- The top topic today is “Agents and Planning”, with 8 papers, accounting for 32.00%。
- The most active submitter is taesiri， with 5 papers。
- The highest-voted visible paper is “Qwen-AgentWorld: Language World Models for General Agents”, currently at 79 votes.
- Today's dominant clusters are Agents and Planning / Multimodal Agents / Multimodal Understanding and Vision; this suggests several parallel trends: multimodal work is moving from isolated perception toward generation, agents, and action; agent papers emphasize tool use, planning, and deployable workflows. The strongest visible attention is on “Qwen-AgentWorld: Language World Models for General Agents” (79 upvotes).

## Categorized Paper Briefs

### Agents and Planning (8 papers)

- [Qwen-AgentWorld: Language World Models for General Agents](https://huggingface.co/papers/2606.24597) [Upvote: 79] A world model predicts environment dynamics based on current observations and actions, serving as a core cognitive mechanism for reasoning and planning. [Agents and Planning]
  ...
  - Submitted by: taesiri | Upvotes: 79 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2606.24597) / [arXiv](https://arxiv.org/pdf/2606.24597) / [Cool](https://papers.cool/arxiv/2606.24597)
  - <details>
...
- [NatureBench: Can Coding Agents Match the Published SOTA of Nature-Family Papers?](https://huggingface.co/papers/2606.24530) [Upvote: 47] We introduce NatureBench, a cross-discipline benchmark of 90 tasks distilled from peer-reviewed Nature-family publications, designed to evaluate whether AI coding agents can move beyond reproduction toward discovery… [Agents and Planning]
  ...
  - Submitted by: Kaiyan Zhang | Upvotes: 47 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2606.24530) / [arXiv](https://arxiv.org/pdf/2606.24530) / [Cool](https://papers.cool/arxiv/2606.24530)
  - <details>
    <summary>Abstract</summary>
...
- [MobileForge: Annotation-Free Adaptation for Mobile GUI Agents with Hierarchical Feedback-Guided Policy Optimization](https://huggingface.co/papers/2606.19930) [Upvote: 34] MLLM-based mobile GUI agents have made substantial progress in UI understanding and action execution, but adapting them to real target apps remains costly because mobile apps are numerous, frequently updated, and hard… [Agents and Planning]
  ...
  - Submitted by: Guangyi Liu | Upvotes: 34 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2606.19930) / [arXiv](https://arxiv.org/pdf/2606.19930) / [Cool](https://papers.cool/arxiv/2606.19930)
  - <details>
    <summary>Abstract</summary>
...
- [MemGUI-Agent: An End-to-End Long-Horizon Mobile GUI Agent with Proactive Context Management](https://huggingface.co/papers/2606.19926) [Upvote: 33] MLLM-based mobile GUI agents have made substantial progress on short-horizon tasks, yet remain unreliable on long-horizon tasks that require retaining intermediate facts across many steps and app transitions. [Agents and Planning]
  - Authors: Guangyi Liu, Gao Wu, Congxiao Liu, Pengxiang Zhao, Liang Liu, Mading Li, Qi Zhang, Mengyan Wang, Liang Guo, Yong Liu
  - Submitted by: Guangyi Liu | Upvotes: 33 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2606.19926) / [arXiv](https://arxiv.org/pdf/2606.19926) / [Cool](https://papers.cool/arxiv/2606.19926)
  - <details>
    <summary>Abstract</summary>
...
- [AOHP: An Open-Source OS-Level Agent Harness for Personalized, Efficient and Secure Interaction](https://huggingface.co/papers/2606.23449) [Upvote: 25] AI agents are driving a new software paradigm, with the ability to autonomously call tools, extract information, manage memory, and complete tasks that span applications and data sources. [Agents and Planning]
  ...
  - Submitted by: Zhao Shanhui | Upvotes: 25 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2606.23449) / [arXiv](https://arxiv.org/pdf/2606.23449) / [Cool](https://papers.cool/arxiv/2606.23449)
  - <details>
    <summary>Abstract</summary>
...
- [LingxiDiagBench: A Multi-Agent Framework for Benchmarking LLMs in Chinese Psychiatric Consultation and Diagnosis](https://huggingface.co/papers/2602.09379) [Upvote: 19] Mental disorders are highly prevalent worldwide, but the shortage of psychiatrists and the inherent subjectivity of interview-based diagnosis create substantial barriers to timely and consistent mental-health assessment. [Agents and Planning]
  ...
  - Submitted by: Xu Shihao | Upvotes: 19 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2602.09379) / [arXiv](https://arxiv.org/pdf/2602.09379) / [Cool](https://papers.cool/arxiv/2602.09379)
  - <details>
    <summary>Abstract</summary>
...
- [OpenThoughts-Agent: Data Recipes for Agentic Models](https://huggingface.co/papers/2606.24855) [Upvote: 16] Agentic language models dramatically expand the applications of AI yet little is publicly known about how to curate training data for broadly capable agents. [Agents and Planning]
  ...
  - Submitted by: taesiri | Upvotes: 16 | Comments: 0
  - Links: [HF](https://huggingface.co/papers/2606.24855) / [arXiv](https://arxiv.org/pdf/2606.24855) / [Cool](https://papers.cool/arxiv/2606.24855)
  - <details>
    <summary>Abstract</summary>
...
- [Escaping the Self-Confirmation Trap: An Execute-Distill-Verify Paradigm for Agentic Experience Learning](https://huggingface.co/papers/2606.24428) [Upvote: 8] Experience-driven self-evolution is critical for large language model (LLM) agents to improve through open-world interaction. [Agents and Planning]
  - Authors: Shiding Zhu, Yudi Qi, Yajie Wang, Jiaze Li, Chao Song, Yaorui Shi, Yibo Miao, Hanqi Gao, Kai Zhang
  - Submitted by: zhushiding | Upvotes: 8 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2606.24428) / [arXiv](https://arxiv.org/pdf/2606.24428) / [Cool](https://papers.cool/arxiv/2606.24428)
  - <details>
    <summary>Abstract</summary>
...
- [ReMMD: Realistic Multilingual Multi-Image Agentic Verification for Multimodal Misinformation Detection](https://huggingface.co/papers/2606.24112) [Upvote: 1] Multimodal misinformation detection is increasingly important because viral posts now combine long multilingual narratives, several images, mixed provenance, and subtle text--image framing errors. [Multimodal Agents]
  - Authors: Chenhao Dang, Dantong Zhu, Jun Yang, Conghui He, Weijia Li
  - Submitted by: Chenhao Dang | Upvotes: 1 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2606.24112) / [arXiv](https://arxiv.org/pdf/2606.24112) / [Cool](https://papers.cool/arxiv/2606.24112)
  - <details>
    <summary>Abstract</summary>
...
- [FlowR2A: Learning Reward-to-Action Distribution for Multimodal Driving Planning](https://huggingface.co/papers/2606.24231) [Upvote: 1] Multimodal driving planning faces a long-standing tension between two paradigms: scoring-based methods benefit from dense reward supervision but are confined to a fixed action vocabulary, while anchor-based methods… [Multimodal Agents]
  - Authors: Xirui Li, Zhe Liu, Xiaoqing Ye, Wenhua Han, Yifeng Pan, Junyu Han, Hengshuang Zhao
  - Submitted by: Xirui Li | Upvotes: 1 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2606.24231) / [arXiv](https://arxiv.org/pdf/2606.24231) / [Cool](https://papers.cool/arxiv/2606.24231)
  - <details>
    <summary>Abstract</summary>
...
- [EventVLA: Event-Driven Visual Evidence Memory for Long-Horizon Vision-Language-Action Policies](https://huggingface.co/papers/2606.20092) [Upvote: 1] Memory remains a critical bottleneck for long-horizon robotic manipulation, as standard Vision-Language-Action (VLA) policies often fail when task-relevant cues become occluded or unobservable over time. [Multimodal Agents]
  ...
  - Submitted by: Ganlin Yang | Upvotes: 1 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2606.20092) / [arXiv](https://arxiv.org/pdf/2606.20092) / [Cool](https://papers.cool/arxiv/2606.20092)
  - <details>
    <summary>Abstract</summary>
...
- [Semantic Browsing: Controllable Diversity for Image Generation](https://huggingface.co/papers/2606.23679) [Upvote: 13] Modern text-to-image models excel in visual fidelity and prompt adherence. [Multimodal Understanding and Vision]
  - Authors: Sara Dorfman, Maya Vishnevsky, Omer Dahary, Or Patashnik, Daniel Cohen-Or
  - Submitted by: Omer Dahary | Upvotes: 13 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2606.23679) / [arXiv](https://arxiv.org/pdf/2606.23679) / [Cool](https://papers.cool/arxiv/2606.23679)
  - <details>
    <summary>Abstract</summary>
...
- [DiffusionBench: On Holistic Evaluation of Diffusion Transformers](https://huggingface.co/papers/2606.24888) [Upvote: 4] Diffusion transformer (DiT) research on image generation has converged to a single evaluation setup: class-conditional generation on ImageNet. [Multimodal Understanding and Vision]
  ...
  - Links: [HF](https://huggingface.co/papers/2606.24888) / [arXiv](https://arxiv.org/pdf/2606.24888) / [Cool](https://papers.cool/arxiv/2606.24888)
  - <details>
    <summary>Abstract</summary>
...
- [FLUX3D: High-Fidelity 3D Gaussian Generation with Diffusion-Aligned Sparse Representation](https://huggingface.co/papers/2606.24874) [Upvote: 0] Sparse voxel representation has emerged as a scalable foundation for image-to-3D Gaussian Splatting (3DGS) generation, yet current methods struggle to preserve high-frequency visual details of input images due to two… [Multimodal Understanding and Vision]
  - Authors: Haorui Ji, Weizhe Liu, Hongdong Li, Hengkai Guo
  - Submitted by: taesiri | Upvotes: 0 | Comments: 0
  - Links: [HF](https://huggingface.co/papers/2606.24874) / [arXiv](https://arxiv.org/pdf/2606.24874) / [Cool](https://papers.cool/arxiv/2606.24874)
  - <details>
    <summary>Abstract</summary>
...
- [FLAT: Feedforward Latent Triangle Splatting for Geometrically Accurate Scene Generation](https://huggingface.co/papers/2606.24876) [Upvote: 12] Generating explorable 3D scenes from a single image requires strong generative priors and accurate geometric representations suitable for downstream use. [Other AI]
  - Authors: Orest Kupyn, Goutam Bhat, Philipp Henzler, Fabian Manhardt, Christian Rupprecht, Federico Tombari
  - Submitted by: Orest Kupyn | Upvotes: 12 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2606.24876) / [arXiv](https://arxiv.org/pdf/2606.24876) / [Cool](https://papers.cool/arxiv/2606.24876)
  - <details>
    <summary>Abstract</summary>
...
- [FedOT: Ownership Verification and Leakage Tracing via Watermarks for Federated LDMs](https://huggingface.co/papers/2606.22875) [Upvote: 9] Training Latent Diffusion Models (LDMs) within Federated Learning (FL) has attracted increasing attention due to its ability to combine the powerful generative capacity of LDMs with the privacy-preserving properties… [Other AI]
  - Authors: Wenlong Cheng, Yuan Gan, Yunqiu Xu, Jiaxu Miao
  - Submitted by: Yunqiu Xu | Upvotes: 9 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2606.22875) / [arXiv](https://arxiv.org/pdf/2606.22875) / [Cool](https://papers.cool/arxiv/2606.22875)
  - <details>
    <summary>Abstract</summary>
...
- [Multi4D: High-Fidelity Dynamic Gaussian Splatting via Multi-Level Competitive Allocation](https://huggingface.co/papers/2606.22197) [Upvote: 0] Dynamic 3D Gaussian splatting faces a fundamental tension between motion consistency and visual fidelity. [Other AI]
  - Authors: Rui Wang, Quentin Lohmeyer, Siyu Tang, Mirko Meboldt
  - Submitted by: Ray | Upvotes: 0 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2606.22197) / [arXiv](https://arxiv.org/pdf/2606.22197) / [Cool](https://papers.cool/arxiv/2606.22197)
  - <details>
    <summary>Abstract</summary>
...
- [Are Text-to-Image Models Inductivist Turkeys? A Counterfactual Benchmark for Causal Reasoning](https://huggingface.co/papers/2606.24548) [Upvote: 5] Text-to-image (T2I) generation models have achieved remarkable progress in producing visually realistic images from natural language prompts. [Datasets and Benchmarks]
  ...
  - Submitted by: YuandongPu | Upvotes: 5 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2606.24548) / [arXiv](https://arxiv.org/pdf/2606.24548) / [Cool](https://papers.cool/arxiv/2606.24548)
  - <details>
    <summary>Abstract</summary>
...
- [AGORA: An Archive-Grounded Benchmark for Agentic Workplace Document Reasoning](https://huggingface.co/papers/2606.24526) [Upvote: 0] Large language models are increasingly deployed as agents that reason over documents rather than answer from parametric knowledge. [Datasets and Benchmarks]
  - Authors: Honglin Guo, Qi Zhang, Yu Zhang, Weijie Li, Rui Zheng, Zhikai Lei, Qiyuan Peng, Zhiheng Xi, Tao Gui, Qi Zhang
  - Submitted by: Honglin Guo | Upvotes: 0 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2606.24526) / [arXiv](https://arxiv.org/pdf/2606.24526) / [Cool](https://papers.cool/arxiv/2606.24526)
  - <details>
    <summary>Abstract</summary>
...
- [DREAM: Dense Retrieval Embeddings via Autoregressive Modeling](https://huggingface.co/papers/2606.24667) [Upvote: 1] Dense retrieval embedding models are a fundamental component of modern retrieval-based AI systems. [Retrieval, Knowledge, and RAG]
  - Authors: Yixuan Tang, Yi Yang
  - Submitted by: yixuan | Upvotes: 1 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2606.24667) / [arXiv](https://arxiv.org/pdf/2606.24667) / [Cool](https://papers.cool/arxiv/2606.24667)
  - <details>
    <summary>Abstract</summary>
...
- [ChartWalker: Benchmarking the Cross-Chart RAG Task](https://huggingface.co/papers/2606.23997) [Upvote: 1] Cross-Chart Retrieval-Augmented Generation (RAG) is critical for complex multi-modal analytical tasks in scientific, business, and political domains. [Retrieval, Knowledge, and RAG]
  - Authors: Ning Tang, Chenghan Xie, Hanyang Yuan, Yi Li, Renhong Huang, Qian Kou, Xiaofeng Shi, Hua Zhou, Jiarong Xu
  - Submitted by: XiaofengShi | Upvotes: 1 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2606.23997) / [arXiv](https://arxiv.org/pdf/2606.23997) / [Cool](https://papers.cool/arxiv/2606.23997)
  - <details>
    <summary>Abstract</summary>
...
- [World Value Models for Robotic Manipulation](https://huggingface.co/papers/2606.24742) [Upvote: 1] Generalist value models play a pivotal role in scaling robotic policy learning from large-scale, mixed-quality data. [Robotics and Embodied AI]
  ...
  - Links: [HF](https://huggingface.co/papers/2606.24742) / [arXiv](https://arxiv.org/pdf/2606.24742) / [Cool](https://papers.cool/arxiv/2606.24742)
  - <details>
    <summary>Abstract</summary>
...
- [An Efficient Method for the Optimal Control of Microgrids Under Uncertainties using Local Reduction](https://huggingface.co/papers/2606.12345) [Upvote: 0] The problem of optimal sizing and power scheduling in microgrids subject to uncertainties is well known to the control community. [Robotics and Embodied AI]
  - Authors: Edoardo Scaccia, Eric C. Kerrigan, Anna Sadowska
  - Submitted by: zhushiding | Upvotes: 0 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2606.12345) / [arXiv](https://arxiv.org/pdf/2606.12345) / [Cool](https://papers.cool/arxiv/2606.12345)
  - <details>
    <summary>Abstract</summary>
...
- [QG-MIL: A Gated Transformer Aggregator for Domain-Agnostic Multiple Instance Learning in Medical Imaging](https://huggingface.co/papers/2606.20027) [Upvote: 2] Attention-based Multiple Instance Learning aggregators in medical imaging are prone to attention concentration, producing overconfident and unstable predictions. [Domain Applications]
  ...
  - Submitted by: Luca Zedda | Upvotes: 2 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2606.20027) / [arXiv](https://arxiv.org/pdf/2606.20027) / [Cool](https://papers.cool/arxiv/2606.20027)
  - <details>
    <summary>Abstract</summary>
...
- [Holistic Data Scheduler for LLM Pre-training via Multi-Objective Reinforcement Learning](https://huggingface.co/papers/2606.24133) [Upvote: 2] The composition of training data, governed by the diversity of sources and their mixing strategy, is a cornerstone of Large Language Model (LLM) pre-training. [Learning, Optimization, and Theory]
  - Authors: Chenhao Dang, Jing Ma, Mingjie Liao
  - Submitted by: Chenhao Dang | Upvotes: 2 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2606.24133) / [arXiv](https://arxiv.org/pdf/2606.24133) / [Cool](https://papers.cool/arxiv/2606.24133)
  - <details>
    <summary>Abstract</summary>
