# Hugging Face Daily Papers Report (2026-07-06)

- Source: https://huggingface.co/papers/date/2026-07-06
- Classifier: rule
- Total Papers: 27

## Today's Hotspots and Trend

- Multimodal Understanding and Vision: 6 papers (22.22%); representative paper: Multi-Resolution Flow Matching: Training-Free Diffusion Acceleration via Staged Sampling.
- Agents and Planning: 5 papers (18.52%); representative paper: EvoPolicyGym: Evaluating Autonomous Policy Evolution in Interactive Environments.
- Learning, Optimization, and Theory: 4 papers (14.81%); representative paper: Morphing into Hybrid Attention Models.
- Trend: Today's dominant clusters are Multimodal Understanding and Vision / Agents and Planning / Learning, Optimization, and Theory; this suggests several parallel trends: multimodal work is moving from isolated perception toward generation, agents, and action; agent papers emphasize tool use, planning, and deployable workflows. The strongest visible attention is on “Program-as-Weights: A Programming Paradigm for Fuzzy Functions” (82 upvotes).
...
- Multimodal Understanding and Vision: 6 papers (22.22%)
- Agents and Planning: 5 papers (18.52%)
- Learning, Optimization, and Theory: 4 papers (14.81%)
- Retrieval, Knowledge, and RAG: 4 papers (14.81%)
- Other AI: 3 papers (11.11%)
- Datasets and Benchmarks: 2 papers (7.41%)
- LLMs and Language: 2 papers (7.41%)
...
- The top topic today is “Multimodal Understanding and Vision”, with 6 papers, accounting for 22.22%。
- The most active submitter is taesiri， with 5 papers。
- The highest-voted visible paper is “Program-as-Weights: A Programming Paradigm for Fuzzy Functions”, currently at 82 votes.
...
- [Multi-Resolution Flow Matching: Training-Free Diffusion Acceleration via Staged Sampling](https://huggingface.co/papers/2607.01642) [Upvote: 29] Hardware-agnostic strategies for accelerating text-to-image diffusion, such as timestep distillation and feature caching, can reduce inference time without custom kernels or system-level optimization. [Multimodal Understanding and Vision]
  - Authors: Xingyu Zheng, Xianglong Liu, Yifu Ding, Weilun Feng, Junqing Lin, Jinyang Guo, Haotong Qin
  - Submitted by: Xingyu Zheng | Upvotes: 29 | Comments: 2
...
- [InstanceControl: Controllable Complex Image Generation without Instance Labeling](https://huggingface.co/papers/2606.31924) [Upvote: 8] Controllable image generation methods, such as ControlNet, have demonstrated a remarkable capacity to introduce visual conditions(e.g., depth maps) to guide image generation. [Multimodal Understanding and Vision]
  ...
  - Submitted by: liuxiaoyu | Upvotes: 8 | Comments: 4
...
- [AnyGroundBench: A Specialized-Domain Benchmark for Video Grounding in Vision-Language Models](https://huggingface.co/papers/2607.02269) [Upvote: 7] Vision-Language Models (VLMs) have demonstrated immense promise in Spatio-Temporal Video Grounding (STVG). [Multimodal Understanding and Vision]
  ...
  - Submitted by: Ryo Hachiuma | Upvotes: 7 | Comments: 2
...
- [EvoPolicyGym: Evaluating Autonomous Policy Evolution in Interactive Environments](https://huggingface.co/papers/2607.02440) [Upvote: 43] Autonomous agents are increasingly expected to improve executable policies through feedback, yet existing evaluations often collapse this process into a final score or confound it with open-ended software-engineering… [Agents and Planning]
  ...
  - Submitted by: MikaStars39 | Upvotes: 43 | Comments: 2
...
- [SkillCoach: Self-Evolving Rubrics for Evaluating and Enhancing Agentic Skill-Use](https://huggingface.co/papers/2607.01874) [Upvote: 15] Skills are becoming a reusable operational layer for LLM agents, encoding SOPs, domain rules, tool workflows, scripts, and validation routines. [Agents and Planning]
...
- [PACE: A Proxy for Agentic Capability Evaluation](https://huggingface.co/papers/2607.02032) [Upvote: 7] Evaluating LLM agents on benchmarks like SWE-Bench and GAIA can be expensive, time-consuming, and requires complex infrastructure. [Agents and Planning]
...
- [DuoMem: Towards Capable On-Device Memory Agents via Dual-Space Distillation](https://huggingface.co/papers/2606.29961) [Upvote: 6] Large Language Model (LLM)-based agents can solve complex procedural tasks by interacting with environments over multiple turns, but this ability typically depends on large models, long contexts, and repeated… [Agents and Planning]
  ...
  - Submitted by: Ondrej Bohdal | Upvotes: 6 | Comments: 2
...
- [Morphing into Hybrid Attention Models](https://huggingface.co/papers/2606.30562) [Upvote: 37] Hybrid attention models improve long-context efficiency by retaining only a subset of full-attention layers and replacing the remaining layers with linear attention. [Learning, Optimization, and Theory]
  - Authors: Disen Lan, Jianbin Zheng, Yuxi Ren, Xin Xia, Xuanda Wang, Xuefeng Xiao, Xipeng Qiu, Yu Cheng
  - Submitted by: Disen Lan | Upvotes: 37 | Comments: 5
...
- [Denser neq Better: Limits of On-Policy Self-Distillation for Continual Post-Training](https://huggingface.co/papers/2607.01763) [Upvote: 5] Continual post-training enables foundation models to acquire new knowledge while preserving existing capabilities. [Learning, Optimization, and Theory]
  - Authors: Meng Wang, Haohan Zhao, Wenzhuo Liu, Lu Yang, Geng Liu, Haiyang Guo, Guo-Sen Xie, Gaofeng Meng, Hongbin Liu, Fei Zhu
  - Submitted by: Meng Wang | Upvotes: 5 | Comments: 2
...
- [WorldDirector: Building Controllable World Simulators with Persistent Dynamic Memory](https://huggingface.co/papers/2607.02517) [Upvote: 22] We present WorldDirector, a highly controllable video world model framework designed for persistent dynamic object memory and unrestricted viewpoint exploration. [Retrieval, Knowledge, and RAG]
...
- [Logit-Contribution Scoring Identifies Non-Literal Retrieval Heads](https://huggingface.co/papers/2607.01002) [Upvote: 15] In long-context use, large language models frequently synthesize answers from the meaning of a relevant context span rather than literally copy-pasting them. [Retrieval, Knowledge, and RAG]
  - Authors: Aryo Pradipta Gema, Beatrice Alex, Pasquale Minervini
  - Submitted by: Pasquale Minervini | Upvotes: 15 | Comments: 2
...
- [AutoMem: Automated Learning of Memory as a Cognitive Skill](https://huggingface.co/papers/2607.01224) [Upvote: 14] Memory expertise is a learned skill: knowing what to encode, when to retrieve, and how to organize knowledge--a capacity known in cognitive science as metamemory. [Retrieval, Knowledge, and RAG]
  - Authors: Shengguang Wu, Hao Zhu, Yuhui Zhang, Xiaohan Wang, Serena Yeung-Levy
  - Submitted by: Shengguang Wu | Upvotes: 14 | Comments: 3
...
- [Scaling Laws for Grid-Based Approximate Nearest Neighbor Search in High Dimensions](https://huggingface.co/papers/2607.01283) [Upvote: 1] Grid-based approaches to approximate nearest neighbor (ANN) search have been absent from modern scaling analyses. [Retrieval, Knowledge, and RAG]
  - Authors: Matthew J Liu, Wei Hang Zheng, Vidhan Purohit, Siqi Xie, Chieh-En Li, Jerry Li, Noah Flynn
  - Submitted by: Noah Flynn | Upvotes: 1 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2607.01283) / [arXiv](https://arxiv.org/pdf/2607.01283) / [Cool](https://papers.cool/arxiv/2607.01283)
  - <details>
    <summary>Abstract</summary>
...
- [From SRA to Self-Flow: Data Augmentation or Self-Supervision?](https://huggingface.co/papers/2607.02508) [Upvote: 10] Representation alignment has become an effective way to accelerate diffusion transformer training and improve generation quality. [Other AI]
  ...
  - Submitted by: Dengyang Jiang | Upvotes: 10 | Comments: 2
...
- [Parameter-Efficient Quantum-Inspired Fast Weight Programmers for Traffic-Matrix Forecasting](https://huggingface.co/papers/2606.27821) [Upvote: 3] Traffic matrices (TMs) capture network-wide origin-destination demand and are central to traffic engineering, yet accurate whole-matrix forecasting remains challenging when prediction must be performed under the… [Other AI]
  - Authors: Kuo-Chung Peng, Jiun-Cheng Jiang, Chun-Hua Lin, Tai-Yue Li, Nan-Yow Chen, Samuel Yen-Chi Chen
  - Submitted by: Jiun-Cheng Jiang | Upvotes: 3 | Comments: 2
...
- [AgenticDataBench: A Comprehensive Benchmark for Data Agents](https://huggingface.co/papers/2607.01647) [Upvote: 29] Data science aims to derive actionable insights from heterogeneous raw data, unlocking the value of the massive amounts of data generated in modern society. [Datasets and Benchmarks]
  ...
  - Submitted by: Zhaoyan Sun | Upvotes: 29 | Comments: 2
...
- [AGVBench: A Reliability-Oriented Benchmark of Data Augmentation for Vein Recognition](https://huggingface.co/papers/2607.02271) [Upvote: 13] Vein recognition is a secure biometric technology often constrained by limited annotated data and imaging variations. [Datasets and Benchmarks]
  - Authors: Haiyang Li, Yuming Fu, Qun Song, Hongchao Liao, Jing Chen, Mounim A. EI-Yacoubi, Xin Jin
  - Submitted by: Xin Jin | Upvotes: 13 | Comments: 2
...
- [AgenticSTS: A Bounded-Memory Testbed for Long-Horizon LLM Agents](https://huggingface.co/papers/2607.02255) [Upvote: 46] Memory for a long-horizon LLM agent is a contract about what each future decision is allowed to see. [LLMs and Language]
  ...
  - Submitted by: kaipeng | Upvotes: 46 | Comments: 3
...
- [Discrete Diffusion Language Models for Interactive Radiology Report Drafting](https://huggingface.co/papers/2607.01436) [Upvote: 4] Diffusion language models, which generate text by denoising a token canvas bidirectionally instead of emitting tokens left to right, have become competitive with autoregressive (AR) generation. [LLMs and Language]
  ...
  - Submitted by: Max Van Puyvelde | Upvotes: 4 | Comments: 2
...
- [Transferability for General Reasoning: An Automated Curriculum for Multi-Domain RLVR](https://huggingface.co/papers/2606.25178) [Upvote: 3] Reinforcement learning with verifiable rewards (RLVR) has been extended from single-domain training to multi-domain reasoning suites spanning mathematics, programming, and science. [Reasoning, Alignment, and Evaluation]
  ...
  - Submitted by: Yang Yongjin | Upvotes: 3 | Comments: 2
