...
- Multimodal Understanding and Vision: 3 papers (23.08%); representative paper: DataComp-VLM: Improved Open Datasets for Vision-Language Models.
- Other AI: 3 papers (23.08%); representative paper: VLA-Corrector: Lightweight Detect-and-Correct Inference for Adaptive Action Horizon.
- LLMs and Language: 2 papers (15.38%); representative paper: Measuring the Gap Between Human and LLM Research Ideas.
- Trend: Today's dominant clusters are Multimodal Understanding and Vision / Other AI / LLMs and Language; this suggests that multimodal work is moving from isolated perception toward generation, agents, and action. The strongest visible attention is on “The Mirage of Optimizing Training Policies: Monotonic Inference Policies as the Real Objective for LLM Reinforcement Learning” (161 upvotes).
...
- Multimodal Understanding and Vision: 3 papers (23.08%)
- Other AI: 3 papers (23.08%)
- LLMs and Language: 2 papers (15.38%)
- Agents and Planning: 1 papers (7.69%)
- Learning, Optimization, and Theory: 1 papers (7.69%)
- Reasoning, Alignment, and Evaluation: 1 papers (7.69%)
- Retrieval, Knowledge, and RAG: 1 papers (7.69%)
- Robotics and Embodied AI: 1 papers (7.69%)
...
- HOU XINYU: 1 papers
- Jing Liang: 1 papers
- Kartik Sharma: 1 papers
- Mahdi Naseri: 1 papers

## Brief Notes

- The top topic today is “Multimodal Understanding and Vision”, with 3 papers, accounting for 23.08%。
- The most active submitter is Borui Li， with 1 papers。
- The highest-voted visible paper is “The Mirage of Optimizing Training Policies: Monotonic Inference Policies as the Real Objective for LLM Reinforcement Learning”, currently at 161 votes.
- Today's dominant clusters are Multimodal Understanding and Vision / Other AI / LLMs and Language; this suggests that multimodal work is moving from isolated perception toward generation, agents, and action. The strongest visible attention is on “The Mirage of Optimizing Training Policies: Monotonic Inference Policies as the Real Objective for LLM Reinforcement Learning” (161 upvotes).

## Categorized Paper Briefs

### Multimodal Understanding and Vision (3 papers)

- [DataComp-VLM: Improved Open Datasets for Vision-Language Models](https://huggingface.co/papers/2606.28551) [Upvote: 49] Building performant Vision-Language Models (VLMs) requires carefully curating large-scale training datasets, yet the community lacks systematic benchmarks for evaluating such curation strategies. [Multimodal Understanding and Vision]
  ...
  - Submitted by: Selim Kuzucu | Upvotes: 49 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2606.28551) / [arXiv](https://arxiv.org/pdf/2606.28551) / [Cool](https://papers.cool/arxiv/2606.28551)
  - <details>
...
- [OrbitQuant: Data-Agnostic Quantization for Image and Video Diffusion Transformers](https://huggingface.co/papers/2607.02461) [Upvote: 39] Diffusion transformers (DiTs) achieve state-of-the-art image and video generation, but their multi-step sampling and growing parameter count make inference expensive. [Multimodal Understanding and Vision]
  - Authors: Donghyun Lee, Jitesh Chavan, Duy Nguyen, Sam Huang, Liming Jiang, Priyadarshini Panda, Timo Mertens, Saurabh Shukla
  - Submitted by: Saurabh Shukla | Upvotes: 39 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2607.02461) / [arXiv](https://arxiv.org/pdf/2607.02461) / [Cool](https://papers.cool/arxiv/2607.02461)
  - <details>
    <summary>Abstract</summary>
...
- [MultAttnAttrib: Training-Free Multimodal Attribution in Long Document Question Answering](https://huggingface.co/papers/2607.01420) [Upvote: 13] As grounded QA systems are increasingly deployed in AI assistants, accurately attributing generated answers to evidence is critical for user trust and model safety. [Multimodal Understanding and Vision]
  ...
  - Submitted by: Franck Dernoncourt | Upvotes: 13 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2607.01420) / [arXiv](https://arxiv.org/pdf/2607.01420) / [Cool](https://papers.cool/arxiv/2607.01420)
  - <details>
    <summary>Abstract</summary>
...
- [VLA-Corrector: Lightweight Detect-and-Correct Inference for Adaptive Action Horizon](https://huggingface.co/papers/2607.01804) [Upvote: 29] Vision-Language-Action (VLA) foundation models have recently achieved strong progress in embodied intelligence. [Other AI]
  ...
  - Submitted by: Wenqi Zhang | Upvotes: 29 | Comments: 4
  - Links: [HF](https://huggingface.co/papers/2607.01804) / [arXiv](https://arxiv.org/pdf/2607.01804) / [Cool](https://papers.cool/arxiv/2607.01804)
  - <details>
    <summary>Abstract</summary>
...
- [AnyBokeh: Physics-Guided Any-to-Any Bokeh Editing with Optical Fingerprint Transfer](https://huggingface.co/papers/2606.31959) [Upvote: 10] Depth-of-field control is a fundamental tool in photography, yet post-capture bokeh editing from a single image remains challenging. [Other AI]
  - Authors: Xinyu Hou, Xiaoming Li, Zongsheng Yue, Chen Change Loy
  - Submitted by: HOU XINYU | Upvotes: 10 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2606.31959) / [arXiv](https://arxiv.org/pdf/2606.31959) / [Cool](https://papers.cool/arxiv/2606.31959)
  - <details>
    <summary>Abstract</summary>
...
- [Generated Contents Enrichment](https://huggingface.co/papers/2405.03650) [Upvote: 7] We study Generated Contents Enrichment (GCE), a conditional image-generation task in which a sparse scene description is first enriched through an explicit scene representation and then rendered into semantically… [Other AI]
  - Authors: Mahdi Naseri, Jiayan Qiu, Zhou Wang
  - Submitted by: Mahdi Naseri | Upvotes: 7 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2405.03650) / [arXiv](https://arxiv.org/pdf/2405.03650) / [Cool](https://papers.cool/arxiv/2405.03650)
  - <details>
    <summary>Abstract</summary>
...
- [Measuring the Gap Between Human and LLM Research Ideas](https://huggingface.co/papers/2607.01233) [Upvote: 16] LLMs are increasingly used to brainstorm research ideas, but existing evaluations mostly judge individual ideas by novelty, feasibility, or expert preference. [LLMs and Language]
  - Authors: Ziyu Chen, Yilun Zhao, Arman Cohan
  - Submitted by: Ziyu | Upvotes: 16 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2607.01233) / [arXiv](https://arxiv.org/pdf/2607.01233) / [Cool](https://papers.cool/arxiv/2607.01233)
  - <details>
    <summary>Abstract</summary>
...
- [Teaching LLMs to Recommend and Defer in Underrepresented Epilepsy Care](https://huggingface.co/papers/2606.31036) [Upvote: 8] Specialist epilepsy expertise is scarce in resource-constrained settings, making LLM-based decision support attractive for frontline clinicians managing longitudinal treatment. [LLMs and Language]
  ...
  - Submitted by: Kartik Sharma | Upvotes: 8 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2606.31036) / [arXiv](https://arxiv.org/pdf/2606.31036) / [Cool](https://papers.cool/arxiv/2606.31036)
  - <details>
    <summary>Abstract</summary>
...
- [Securing the AI Agent: A Unified Framework for Multi-Layer Agent Red Teaming](https://huggingface.co/papers/2606.31227) [Upvote: 13] The fast growth of open-source AI infrastructure, from model serving engines and agent platforms to the Model Context Protocol (MCP) ecosystem and the language models themselves, has outpaced the security tooling… [Agents and Planning]
  - Authors: Yong Yang, Xing Zheng, Huiyu Wu, Huangsheng Cheng, Xiaorong Shi, Jing Guo, Bo Yang, Yi Zhou, Xiangfan Wu, Zonghao Ying
  - Submitted by: Zonghao Ying | Upvotes: 13 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2606.31227) / [arXiv](https://arxiv.org/pdf/2606.31227) / [Cool](https://papers.cool/arxiv/2606.31227)
  - <details>
    <summary>Abstract</summary>
...
- [The Mirage of Optimizing Training Policies: Monotonic Inference Policies as the Real Objective for LLM Reinforcement Learning](https://huggingface.co/papers/2606.29526) [Upvote: 161] Reinforcement learning (RL) has gained growing attention in large language model (LLM) post-training, yet RL training remains fragile and can suffer from instability or collapse. [Learning, Optimization, and Theory]
  ...
  - Submitted by: Jing Liang | Upvotes: 161 | Comments: 3
  - Links: [HF](https://huggingface.co/papers/2606.29526) / [arXiv](https://arxiv.org/pdf/2606.29526) / [Cool](https://papers.cool/arxiv/2606.29526)
  - <details>
    <summary>Abstract</summary>
...
- [Interpretation-Oriented Cloud Removal via Observation-Anchored Residual Flow with Geo-Contextual Alignment](https://huggingface.co/papers/2607.02471) [Upvote: 6] Cloud removal (CR) is essential for optical remote sensing, serving as a prerequisite for reliable downstream interpretation, such as semantic segmentation and change detection. [Reasoning, Alignment, and Evaluation]
  - Authors: Ziyao Wang, Maonan Wang, Yucheng He, Xianping Ma, Ziyi Wang, Hongyang Zhang, Yirong Cheng, Man-on Pun
  - Submitted by: WZY | Upvotes: 6 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2607.02471) / [arXiv](https://arxiv.org/pdf/2607.02471) / [Cool](https://papers.cool/arxiv/2607.02471)
  - <details>
    <summary>Abstract</summary>
...
- [AGE: Adaptive-masking for Graph Embedding in Graph Retrieval-Augmented Generation](https://huggingface.co/papers/2607.00052) [Upvote: 6] GraphRAG is an extension of retrieval-augmented generation (RAG) that supports large language models (LLMs) by referring to graph-structured data as external knowledge. [Retrieval, Knowledge, and RAG]
  - Authors: Bao Long Nguyen Huu, Atsushi Hashimoto
  - Submitted by: Nguyen Huu Bao Long | Upvotes: 6 | Comments: 4
  - Links: [HF](https://huggingface.co/papers/2607.00052) / [arXiv](https://arxiv.org/pdf/2607.00052) / [Cool](https://papers.cool/arxiv/2607.00052)
  - <details>
    <summary>Abstract</summary>
...
- [Embodied.cpp: A Portable Inference Runtime of Embodied AI Models on Heterogeneous Robots](https://huggingface.co/papers/2607.02501) [Upvote: 55] Embodied AI models now span vision-language-action (VLA) models and world-action models (WAMs), but practical deployment remains fragmented across model-specific Python stacks, backend assumptions, and robot-side glue… [Robotics and Embodied AI]
  - Authors: Ling Xu, Chuyu Han, Borui Li, Hao Wu, Shiqi Jiang, Ting Cao, Chuanyou Li, Sheng Zhong, Shuai Wang
  - Submitted by: Borui Li | Upvotes: 55 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2607.02501) / [arXiv](https://arxiv.org/pdf/2607.02501) / [Cool](https://papers.cool/arxiv/2607.02501)
  - <details>
    <summary>Abstract</summary>
