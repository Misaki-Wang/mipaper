...
- The highest-voted visible paper is “The Mirage of Optimizing Training Policies: Monotonic Inference Policies as the Real Objective for LLM Reinforcement Learning”, currently at 160 votes.
...
- [DataComp-VLM: Improved Open Datasets for Vision-Language Models](https://huggingface.co/papers/2606.28551) [Upvote: 45] Building performant Vision-Language Models (VLMs) requires carefully curating large-scale training datasets, yet the community lacks systematic benchmarks for evaluating such curation strategies. [Multimodal Understanding and Vision]
  ...
  - Submitted by: Selim Kuzucu | Upvotes: 45 | Comments: 2
...
- [OrbitQuant: Data-Agnostic Quantization for Image and Video Diffusion Transformers](https://huggingface.co/papers/2607.02461) [Upvote: 38] Diffusion transformers (DiTs) achieve state-of-the-art image and video generation, but their multi-step sampling and growing parameter count make inference expensive. [Multimodal Understanding and Vision]
  - Authors: Donghyun Lee, Jitesh Chavan, Duy Nguyen, Sam Huang, Liming Jiang, Priyadarshini Panda, Timo Mertens, Saurabh Shukla
  - Submitted by: Saurabh Shukla | Upvotes: 38 | Comments: 2
...
- [MultAttnAttrib: Training-Free Multimodal Attribution in Long Document Question Answering](https://huggingface.co/papers/2607.01420) [Upvote: 11] As grounded QA systems are increasingly deployed in AI assistants, accurately attributing generated answers to evidence is critical for user trust and model safety. [Multimodal Understanding and Vision]
  ...
  - Submitted by: Franck Dernoncourt | Upvotes: 11 | Comments: 2
...
- [VLA-Corrector: Lightweight Detect-and-Correct Inference for Adaptive Action Horizon](https://huggingface.co/papers/2607.01804) [Upvote: 28] Vision-Language-Action (VLA) foundation models have recently achieved strong progress in embodied intelligence. [Other AI]
  ...
  - Submitted by: Wenqi Zhang | Upvotes: 28 | Comments: 4
...
- [AnyBokeh: Physics-Guided Any-to-Any Bokeh Editing with Optical Fingerprint Transfer](https://huggingface.co/papers/2606.31959) [Upvote: 8] Depth-of-field control is a fundamental tool in photography, yet post-capture bokeh editing from a single image remains challenging. [Other AI]
  - Authors: Xinyu Hou, Xiaoming Li, Zongsheng Yue, Chen Change Loy
  - Submitted by: HOU XINYU | Upvotes: 8 | Comments: 2
...
- [Generated Contents Enrichment](https://huggingface.co/papers/2405.03650) [Upvote: 4] We study Generated Contents Enrichment (GCE), a conditional image-generation task in which a sparse scene description is first enriched through an explicit scene representation and then rendered into semantically… [Other AI]
  - Authors: Mahdi Naseri, Jiayan Qiu, Zhou Wang
  - Submitted by: Mahdi Naseri | Upvotes: 4 | Comments: 2
...
- [Measuring the Gap Between Human and LLM Research Ideas](https://huggingface.co/papers/2607.01233) [Upvote: 14] LLMs are increasingly used to brainstorm research ideas, but existing evaluations mostly judge individual ideas by novelty, feasibility, or expert preference. [LLMs and Language]
  - Authors: Ziyu Chen, Yilun Zhao, Arman Cohan
  - Submitted by: Ziyu | Upvotes: 14 | Comments: 2
...
- [Teaching LLMs to Recommend and Defer in Underrepresented Epilepsy Care](https://huggingface.co/papers/2606.31036) [Upvote: 6] Specialist epilepsy expertise is scarce in resource-constrained settings, making LLM-based decision support attractive for frontline clinicians managing longitudinal treatment. [LLMs and Language]
  ...
  - Submitted by: Kartik Sharma | Upvotes: 6 | Comments: 2
...
- [The Mirage of Optimizing Training Policies: Monotonic Inference Policies as the Real Objective for LLM Reinforcement Learning](https://huggingface.co/papers/2606.29526) [Upvote: 160] Reinforcement learning (RL) has gained growing attention in large language model (LLM) post-training, yet RL training remains fragile and can suffer from instability or collapse. [Learning, Optimization, and Theory]
  ...
  - Submitted by: Jing Liang | Upvotes: 160 | Comments: 3
...
- [Interpretation-Oriented Cloud Removal via Observation-Anchored Residual Flow with Geo-Contextual Alignment](https://huggingface.co/papers/2607.02471) [Upvote: 5] Cloud removal (CR) is essential for optical remote sensing, serving as a prerequisite for reliable downstream interpretation, such as semantic segmentation and change detection. [Reasoning, Alignment, and Evaluation]
  - Authors: Ziyao Wang, Maonan Wang, Yucheng He, Xianping Ma, Ziyi Wang, Hongyang Zhang, Yirong Cheng, Man-on Pun
  - Submitted by: WZY | Upvotes: 5 | Comments: 2
...
- [Embodied.cpp: A Portable Inference Runtime of Embodied AI Models on Heterogeneous Robots](https://huggingface.co/papers/2607.02501) [Upvote: 53] Embodied AI models now span vision-language-action (VLA) models and world-action models (WAMs), but practical deployment remains fragmented across model-specific Python stacks, backend assumptions, and robot-side glue… [Robotics and Embodied AI]
  - Authors: Ling Xu, Chuyu Han, Borui Li, Hao Wu, Shiqi Jiang, Ting Cao, Chuanyou Li, Sheng Zhong, Shuai Wang
  - Submitted by: Borui Li | Upvotes: 53 | Comments: 2
