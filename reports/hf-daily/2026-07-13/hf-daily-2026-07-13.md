# Hugging Face Daily Papers Report (2026-07-13)

- Source: https://huggingface.co/papers/date/2026-07-13
- Classifier: rule
- Total Papers: 23

## Today's Hotspots and Trend

- Multimodal Understanding and Vision: 9 papers (39.13%); representative paper: Vidu S1: A Real-Time Interactive Video Generation Model.
- Other AI: 4 papers (17.39%); representative paper: Why Can't I Open My Drawer? Mitigating Object-Driven Shortcuts in Zero-Shot Compositional Action Recognition.
- Learning, Optimization, and Theory: 3 papers (13.04%); representative paper: Linear Attention Architectures: Mechanisms, Trade-offs, and Cross-Layer Routing.
- Trend: Today's dominant clusters are Multimodal Understanding and Vision / Other AI / Learning, Optimization, and Theory; this suggests that multimodal work is moving from isolated perception toward generation, agents, and action. The strongest visible attention is on “Vidu S1: A Real-Time Interactive Video Generation Model” (121 upvotes).

## Focus Topics

- Generative Foundations: 0 papers (0.00%)
- Multimodal Generative Modeling: 1 papers (4.35%)
- Multimodal Agents: 0 papers (0.00%)

## Topic Distribution

- Multimodal Understanding and Vision: 9 papers (39.13%)
- Other AI: 4 papers (17.39%)
- Learning, Optimization, and Theory: 3 papers (13.04%)
- LLMs and Language: 2 papers (8.70%)
- Reasoning, Alignment, and Evaluation: 2 papers (8.70%)
- Agents and Planning: 1 papers (4.35%)
- Datasets and Benchmarks: 1 papers (4.35%)
- Multimodal Generative Modeling: 1 papers (4.35%)

## Top Submitters

- taesiri: 4 papers
- Ali Motahharynia: 1 papers
- Andrej Leban: 1 papers
- Chongyu Fan: 1 papers
- Diogo R. Ferreira: 1 papers
- GONG JIA: 1 papers

## Brief Notes

- The top topic today is “Multimodal Understanding and Vision”, with 9 papers, accounting for 39.13%。
- The most active submitter is taesiri， with 4 papers。
- The highest-voted visible paper is “Vidu S1: A Real-Time Interactive Video Generation Model”, currently at 121 votes.
...
- [Vidu S1: A Real-Time Interactive Video Generation Model](https://huggingface.co/papers/2607.03118) [Upvote: 121] We introduce Vidu S1, a real-time interactive video generation model supporting voice control of digital characters. [Multimodal Understanding and Vision]
  ...
  - Submitted by: Jintao Zhang | Upvotes: 121 | Comments: 7
  - Links: [HF](https://huggingface.co/papers/2607.03118) / [arXiv](https://arxiv.org/pdf/2607.03118) / [Cool](https://papers.cool/arxiv/2607.03118)
  - <details>
...
- [Video-Oasis: Rethinking Evaluation of Video Understanding](https://huggingface.co/papers/2603.29616) [Upvote: 51] The inherent complexity of video understanding makes it difficult to determine whether Video-LLM benchmark performance stems from visual perception, linguistic reasoning, or knowledge priors. [Multimodal Understanding and Vision]
  - Authors: Geuntaek Lim, Sungjune Park, Jaeyun Lee, Inwoong Lee, Taeoh Kim, Dongyoon Wee, Minho Shim, Yukyung Choi
  - Submitted by: Geuntaek Lim | Upvotes: 51 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2603.29616) / [arXiv](https://arxiv.org/pdf/2603.29616) / [Cool](https://papers.cool/arxiv/2603.29616)
  - <details>
    <summary>Abstract</summary>
...
- [LongE2V: Long-Horizon Event-based Video Reconstruction, Prediction, and Frame Interpolation with Video Diffusion Models](https://huggingface.co/papers/2607.08770) [Upvote: 27] Recovering high-quality video from sparse event streams is a challenging task. [Multimodal Understanding and Vision]
  - Authors: Cheng-De Fan, Chun-Wei Tuan Mu, Chen-Wei Chang, Chin-Yang Lin, Kun-Ru Wu, Yu-Chee Tseng, Yu-Lun Liu
  - Submitted by: Yu-Lun Liu | Upvotes: 27 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2607.08770) / [arXiv](https://arxiv.org/pdf/2607.08770) / [Cool](https://papers.cool/arxiv/2607.08770)
  - <details>
    <summary>Abstract</summary>
...
- [OpenCoF: Learning to Reason Through Video Generation](https://huggingface.co/papers/2607.08763) [Upvote: 12] Reasoning has become a core capability for large models, especially when reliable decisions require understanding logical consequences. [Multimodal Understanding and Vision]
  - Authors: Xinyan Chen, Ziyu Guo, Renrui Zhang, Dongzhi Jiang, Hongsheng Li
  - Submitted by: taesiri | Upvotes: 12 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2607.08763) / [arXiv](https://arxiv.org/pdf/2607.08763) / [Cool](https://papers.cool/arxiv/2607.08763)
  - <details>
    <summary>Abstract</summary>
...
- [ARDY: Autoregressive Diffusion with Hybrid Representation for Interactive Human Motion Generation](https://huggingface.co/papers/2607.08741) [Upvote: 6] Generating realistic 3D human motions in real-time within interactive applications is key for animation, simulation, and humanoid robotics. [Multimodal Understanding and Vision]
  ...
  - Links: [HF](https://huggingface.co/papers/2607.08741) / [arXiv](https://arxiv.org/pdf/2607.08741) / [Cool](https://papers.cool/arxiv/2607.08741)
  - <details>
    <summary>Abstract</summary>
...
- [SAM-MT: Real-Time Interactive Multi-Target Video Segmentation](https://huggingface.co/papers/2607.08688) [Upvote: 5] Modern Video Object Segmentation (VOS) involves tracking and segmenting user-specified targets. [Multimodal Understanding and Vision]
  - Authors: Ruiqi Shen, Chang Liu, Henghui Ding
  - Submitted by: Henghui Ding | Upvotes: 5 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2607.08688) / [arXiv](https://arxiv.org/pdf/2607.08688) / [Cool](https://papers.cool/arxiv/2607.08688)
  - <details>
    <summary>Abstract</summary>
...
- [PhyMRI-SR: Toward Physics-Aware MRI Image Super-Resolution](https://huggingface.co/papers/2607.06238) [Upvote: 4] Magnetic resonance imaging (MRI) super-resolution is vital for improving diagnostic accessibility, yet most methods treat it as a deterministic mapping from a fixed low-resolution input to a high-resolution target. [Multimodal Understanding and Vision]
  - Authors: Lihua Wei, Huatong Gao, Jia Gong, Zhiyu Tan, Hao Li, Jun Liu, Zhihua Ren
  - Submitted by: GONG JIA | Upvotes: 4 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2607.06238) / [arXiv](https://arxiv.org/pdf/2607.06238) / [Cool](https://papers.cool/arxiv/2607.06238)
  - <details>
    <summary>Abstract</summary>
...
- [Flash-BoN: Instant Drafts for Inference-Time Scaling in Diffusion Models](https://huggingface.co/papers/2607.04461) [Upvote: 4] Inference-time scaling for text-to-image generation has progressed from simple Best-of-N (BoN) sampling to guided search methods that verify and steer candidate trajectories at intermediate denoising steps. [Multimodal Understanding and Vision]
  - Authors: Ruchit Rawal, Reza Shirkavand, Sayak Paul, Yuxin Wen, Heng Huang, Yizheng Chen, Tom Goldstein, Gowthami Somepalli
  - Submitted by: Sayak Paul | Upvotes: 4 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2607.04461) / [arXiv](https://arxiv.org/pdf/2607.04461) / [Cool](https://papers.cool/arxiv/2607.04461)
  - <details>
    <summary>Abstract</summary>
...
- [A Quantized Native Runtime for On-Device Semantic Audio Generation](https://huggingface.co/papers/2607.08526) [Upvote: 3] Semantic audio applications increasingly require controllable generation on commodity and embedded hardware rather than through framework-heavy datacenter stacks. [Multimodal Understanding and Vision]
  - Authors: Matteo Spanio, Antonio Rodà
  - Submitted by: Matteo Spanio | Upvotes: 3 | Comments: 4
  - Links: [HF](https://huggingface.co/papers/2607.08526) / [arXiv](https://arxiv.org/pdf/2607.08526) / [Cool](https://papers.cool/arxiv/2607.08526)
  - <details>
    <summary>Abstract</summary>
...
- [Why Can't I Open My Drawer? Mitigating Object-Driven Shortcuts in Zero-Shot Compositional Action Recognition](https://huggingface.co/papers/2601.16211) [Upvote: 48] Zero-Shot Compositional Action Recognition (ZS-CAR) requires recognizing novel verb-object combinations composed of previously observed primitives. [Other AI]
  - Authors: Geo Ahn, Inwoong Lee, Taeoh Kim, Minho Shim, Dongyoon Wee, Jinwoo Choi
  - Submitted by: Geo Ahn | Upvotes: 48 | Comments: 3
  - Links: [HF](https://huggingface.co/papers/2601.16211) / [arXiv](https://arxiv.org/pdf/2601.16211) / [Cool](https://papers.cool/arxiv/2601.16211)
  - <details>
    <summary>Abstract</summary>
...
- [Enhancing In-context Panoramic Generation via Geometric-aware Pretraining](https://huggingface.co/papers/2607.08765) [Upvote: 17] In this work, we present Canvas360, a two-stage framework for in-context panoramic generation that combines geometry-aware pretraining with downstream task-specific fine-tuning. [Other AI]
  - Authors: Haoran Feng, Ruiyang Zhang, Longyi Zhang, Dizhe Zhang, Lu Qi
  - Submitted by: Haoran Feng | Upvotes: 17 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2607.08765) / [arXiv](https://arxiv.org/pdf/2607.08765) / [Cool](https://papers.cool/arxiv/2607.08765)
  - <details>
    <summary>Abstract</summary>
...
- [Jet-Long: Efficient Long-Context Extension with Dynamic Bifocal RoPE](https://huggingface.co/papers/2607.07740) [Upvote: 14] Modern LLMs are increasingly deployed in long-context applications such as retrieval-augmented generation, repository-level coding, and agentic workflows whose accumulated reasoning and tool traces routinely push the… [Other AI]
  - Authors: Haozhan Tang, Zerui Wang, Yuxian Gu, Song Han, Han Cai
  - Submitted by: taesiri | Upvotes: 14 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2607.07740) / [arXiv](https://arxiv.org/pdf/2607.07740) / [Cool](https://papers.cool/arxiv/2607.07740)
  - <details>
    <summary>Abstract</summary>
...
- [PAST-TIDE: Prototype-Anchored Statement Tuning with Topic-Invariant Normalization for Stance Detection](https://huggingface.co/papers/2607.04690) [Upvote: 1] We introduce PAST-TIDE, our stance detection system addressing both subtasks of the StanceNakba Shared Task at NakbaNLP@LREC-COLING 2026. [Other AI]
  - Authors: Md. Shakhoyat Rahman Shujon, MD Jahid Hasan Jim, Md. Milon Islam, Md Rezwanul Haque, Fakhri Karray
  - Submitted by: Md Rezwanul Haque | Upvotes: 1 | Comments: 3
  - Links: [HF](https://huggingface.co/papers/2607.04690) / [arXiv](https://arxiv.org/pdf/2607.04690) / [Cool](https://papers.cool/arxiv/2607.04690)
  - <details>
    <summary>Abstract</summary>
...
- [Linear Attention Architectures: Mechanisms, Trade-offs, and Cross-Layer Routing](https://huggingface.co/papers/2607.07953) [Upvote: 11] Self-attention lets each token retrieve information from the full context, but its quadratic cost in sequence length limits training and inference at long context. [Learning, Optimization, and Theory]
  - Authors: Tommaso Cerruti, Tim Rieder, George Rowlands, Lingfeng Jin, Imanol Schlag
  - Submitted by: Tommaso Cerruti | Upvotes: 11 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2607.07953) / [arXiv](https://arxiv.org/pdf/2607.07953) / [Cool](https://papers.cool/arxiv/2607.07953)
  - <details>
    <summary>Abstract</summary>
...
- [UP: Unbounded Positive Asymmetric Optimization for Breaking the Exploration-Stability Dilemma](https://huggingface.co/papers/2607.06987) [Upvote: 7] Reinforcement learning (RL) has become the standard paradigm for enhancing the complex reasoning capabilities of large language models (LLMs). [Learning, Optimization, and Theory]
  - Authors: Chongyu Fan, Pengfei Liu, Jingjia Huang, Sijia Liu, Yi Lin
  - Submitted by: Chongyu Fan | Upvotes: 7 | Comments: 3
  - Links: [HF](https://huggingface.co/papers/2607.06987) / [arXiv](https://arxiv.org/pdf/2607.06987) / [Cool](https://papers.cool/arxiv/2607.06987)
  - <details>
    <summary>Abstract</summary>
...
- [A Sparse and Truncated State Vector Simulator for Peaked Circuits](https://huggingface.co/papers/2607.07816) [Upvote: 5] In a class of quantum circuits known as peaked circuits, the goal is to predict the most probable bit string at the output of the circuit. [Learning, Optimization, and Theory]
  - Authors: Diogo R. Ferreira
  - Submitted by: Diogo R. Ferreira | Upvotes: 5 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2607.07816) / [arXiv](https://arxiv.org/pdf/2607.07816) / [Cool](https://papers.cool/arxiv/2607.07816)
  - <details>
    <summary>Abstract</summary>
...
- [DrugGen 2: A disease-aware language model for enhancing drug discovery](https://huggingface.co/papers/2607.08404) [Upvote: 16] Current computational approaches for drug design typically focus on generating molecules conditioned on specific targets or general molecular properties, often neglecting the influence of disease context on target… [LLMs and Language]
  ...
  - Submitted by: Ali Motahharynia | Upvotes: 16 | Comments: 3
  - Links: [HF](https://huggingface.co/papers/2607.08404) / [arXiv](https://arxiv.org/pdf/2607.08404) / [Cool](https://papers.cool/arxiv/2607.08404)
  - <details>
    <summary>Abstract</summary>
...
- [Can Dialects Be Steered Like Languages? Sparse Neurons and Distributed Directions in Arabic LLMs](https://huggingface.co/papers/2607.03936) [Upvote: 3] A key challenge in Arabic NLP is the scarcity of dialectal data relative to Modern Standard Arabic (MSA), causing LLMs to overproduce MSA and struggle with dialectally accurate generation. [LLMs and Language]
  - Authors: Kareem Elozeiri, Mervat Abassy, Omar Kallas, Fahim Dalvi, Preslav Nakov, Kentaro Inui, Nadir Durrani
  - Submitted by: Kareem Elozeiri | Upvotes: 3 | Comments: 3
  - Links: [HF](https://huggingface.co/papers/2607.03936) / [arXiv](https://arxiv.org/pdf/2607.03936) / [Cool](https://papers.cool/arxiv/2607.03936)
  - <details>
    <summary>Abstract</summary>
...
- [Ideas Have Genomes: Benchmarking Scientific Lineage Reasoning and Lineage-Grounded Idea Generation](https://huggingface.co/papers/2607.08758) [Upvote: 30] Scientific ideas rarely start from a blank page. [Reasoning, Alignment, and Evaluation]
  ...
  - Submitted by: taesiri | Upvotes: 30 | Comments: 4
  - Links: [HF](https://huggingface.co/papers/2607.08758) / [arXiv](https://arxiv.org/pdf/2607.08758) / [Cool](https://papers.cool/arxiv/2607.08758)
  - <details>
    <summary>Abstract</summary>
...
- [CausalDS: Benchmarking Causal Reasoning in Data-Science Agents](https://huggingface.co/papers/2607.08093) [Upvote: 3] Large language models (LLMs) increasingly act as integrated data-science agents, combining abstract reasoning with advanced tool use. [Reasoning, Alignment, and Evaluation]
  - Authors: Andrej Leban, Yuekai Sun
  - Submitted by: Andrej Leban | Upvotes: 3 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2607.08093) / [arXiv](https://arxiv.org/pdf/2607.08093) / [Cool](https://papers.cool/arxiv/2607.08093)
  - <details>
    <summary>Abstract</summary>
...
- [Remember When It Matters: Proactive Memory Agent for Long-Horizon Agents](https://huggingface.co/papers/2607.08716) [Upvote: 9] In long-horizon tasks, decision-relevant state is often scattered across an expanding trajectory, while the action agent must surface it and act. [Agents and Planning]
  - Authors: Yifan Wu, Lizhu Zhang, Yuhang Zhou, Mingyi Wang, Bo Peng, Serena Li, Xiangjun Fan, Zhuokai Zhao
  - Submitted by: Yifan Wu | Upvotes: 9 | Comments: 5
  - Links: [HF](https://huggingface.co/papers/2607.08716) / [arXiv](https://arxiv.org/pdf/2607.08716) / [Cool](https://papers.cool/arxiv/2607.08716)
  - <details>
    <summary>Abstract</summary>
...
- [UniClawBench: A Universal Benchmark for Proactive Agents on Real-World Tasks](https://huggingface.co/papers/2607.08768) [Upvote: 27] The rapid development of large language models and multimodal large language models has accelerated the emergence of proactive agents capable of operating everyday tools and assisting users in real-world environments. [Datasets and Benchmarks]
  - Authors: Zhekai Chen, Chengqi Duan, Kaiyue Sun, Bohao Li, Yuqing Wang, Manyuan Zhang, Xihui Liu
  - Submitted by: zhekai chen | Upvotes: 27 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2607.08768) / [arXiv](https://arxiv.org/pdf/2607.08768) / [Cool](https://papers.cool/arxiv/2607.08768)
  - <details>
    <summary>Abstract</summary>
...
- [CineMobile: On-Device Image-to-Video Diffusion for Cinematic Camera Motion Generation](https://huggingface.co/papers/2607.03803) [Upvote: 12] The growing demand for image-to-video creation on mobile devices has increasingly focused on cinematic motion effects like bullet time, dolly zoom, slow motion, etc. [Multimodal Generative Modeling]
  - Authors: Xuyao Huang, Zelai Deng, Xu Wang, Xizhong Xiao, Zhijie Deng
  - Submitted by: Huang Xuyao | Upvotes: 12 | Comments: 3
  - Links: [HF](https://huggingface.co/papers/2607.03803) / [arXiv](https://arxiv.org/pdf/2607.03803) / [Cool](https://papers.cool/arxiv/2607.03803)
  - <details>
    <summary>Abstract</summary>
