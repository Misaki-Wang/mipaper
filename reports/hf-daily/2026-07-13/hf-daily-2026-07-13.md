...
- The highest-voted visible paper is “Video Generation Models are General-Purpose Vision Learners”, currently at 74 votes.
...
- [Video Generation Models are General-Purpose Vision Learners](https://huggingface.co/papers/2607.09024) [Upvote: 74] Driven by next-token prediction, NLP shifted from task-specific models into powerful generalist foundation models. [Multimodal Understanding and Vision]
  ...
  - Submitted by: taesiri | Upvotes: 74 | Comments: 1
...
- [Scalable Visual Pretraining for Language Intelligence](https://huggingface.co/papers/2607.09657) [Upvote: 54] The rapid progress of large foundation models has been driven predominantly by pretraining on large-scale text corpora. [Multimodal Understanding and Vision]
  ...
  - Submitted by: taesiri | Upvotes: 54 | Comments: 1
...
- [From RGB Generation to Dense Field Readout: Pixel-Space Dense Prediction with Text-to-Image Models](https://huggingface.co/papers/2607.06553) [Upvote: 16] Large-scale text-to-image models are attractive backbones for dense prediction because RGB generation pretraining learns rich semantic, structural, and geometric priors. [Multimodal Understanding and Vision]
  - Authors: Zanyi Wang, Xin Lin, Haodong Li, Dengyang Jiang, Yijiang Li
  - Submitted by: Dengyang Jiang | Upvotes: 16 | Comments: 2
...
- [MedPMC: A Systematic Framework for Scaling High-Fidelity Medical Multimodal Data for Foundation Models](https://huggingface.co/papers/2607.07673) [Upvote: 9] Medicine is inherently multimodal, requiring clinicians to synthesize information across diverse data streams. [Multimodal Understanding and Vision]
  - Authors: Hyunjae Kim, Dain Kim, Pan Xiao, Serina S. Applebaum, Younjoon Chung, Xuguang Ai, Yu Yin, Roy Jiang, Yuexi Du, Yawen Wei, Yiming Kong, Tuo Guo, Zhiyuan Cao, Mengmeng Du, Yuelei Fu, Yan Hu, Rui Shi, Gui Yang, Kevin W. Jin, Yuntian Liu, Yuxuan Tian, Jonathan Marquez, Zhen Chen, Sheng Zhang, Hoifung Poon, Hua Xu, Jaewoo Kang, Qingyu Chen
  - Submitted by: Hyunjae Kim | Upvotes: 9 | Comments: 2
...
- [KronQ: LLM Quantization via Kronecker-Factored Hessian](https://huggingface.co/papers/2607.07964) [Upvote: 29] Post-training quantization (PTQ) is a widely adopted technique for compressing large language models (LLMs) without retraining. [LLMs and Language]
  - Authors: Donghyun Lee, Yuhang Li, Ruokai Yin, Priyadarshini Panda
  - Submitted by: Donghyun Lee | Upvotes: 29 | Comments: 4
...
- [PanoWorld: Real-World Panoramic Generation](https://huggingface.co/papers/2607.09661) [Upvote: 12] In this work, we aim to address the challenge of long-range memory in panoramic world models by exploiting the rotation-equivariant property of omnidirectional representations, where rotation can be treated as an… [Other AI]
  ...
  - Submitted by: Insta360-Research | Upvotes: 12 | Comments: 2
...
- [VaseMuseum: Digital Intelligent Museum for Ancient Greek Pottery](https://huggingface.co/papers/2607.06374) [Upvote: 6] Vision-language models (VLMs) have made interactive digital museums increasingly feasible by connecting 3D digitization with natural-language artifact exploration. [Other AI]
  - Authors: Jiazi Wang, Nonghai Zhang, Qiushi Xie, Zeyu Zhang, Yufeng Chen, Yang Zhao, Ling Shao, Hao Tang
  - Submitted by: Zeyu Zhang | Upvotes: 6 | Comments: 2
...
- [A Sovereign, Open-Source Foundation Model for German and English](https://huggingface.co/papers/2607.09424) [Upvote: 6] We present Soofi S 30B-A3B, a sovereign, open-source Mixture-of-Experts (MoE) hybrid Mamba Transformer foundation model for German and English. [Other AI]
...
- [Long-Horizon-Terminal-Bench: Testing the Limits of Agents on Long-Horizon Terminal Tasks with Dense Reward-Based Grading](https://huggingface.co/papers/2607.08964) [Upvote: 72] AI agents have become capable of autonomously completing short, well-specified tasks. [Agents and Planning]
  ...
  - Submitted by: LZX | Upvotes: 72 | Comments: 3
...
- [Flow-ERD: Agent-type Aware Flow Matching with Entropy-Regularized Distillation for Diverse Traffic Simulation](https://huggingface.co/papers/2607.06957) [Upvote: 9] Realistic and diverse traffic simulation is essential to autonomous driving development. [Agents and Planning]
  - Authors: Seulbin Hwang, Kiyoung Om, Daejung Kim, Jinhan Lee
  - Submitted by: seulbin hwang | Upvotes: 9 | Comments: 3
...
- [Phone Segmentation and Recognition through Phonological Activation Mapping](https://huggingface.co/papers/2607.09020) [Upvote: 7] Phone segmentation and recognition are inherently related tasks, yet modern approaches typically model them separately. [Learning, Optimization, and Theory]
  ...
  - Submitted by: Shikhar Bharadwaj | Upvotes: 7 | Comments: 3
...
- [Trust Region Policy Distillation](https://huggingface.co/papers/2607.04751) [Upvote: 29] Big goals are hard to achieve all at once; breaking them into small steps is wiser. [Reasoning, Alignment, and Evaluation]
  - Authors: Zhengpeng Xie, Li Lyna Zhang, Zeke Xie, Mao Yang
  - Submitted by: Zhengpeng Xie | Upvotes: 29 | Comments: 3
