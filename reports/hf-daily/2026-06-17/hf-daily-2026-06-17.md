# Hugging Face Daily Papers Report (2026-06-17)

- Source: https://huggingface.co/papers/date/2026-06-17
- Classifier: rule
- Total Papers: 31

## Today's Hotspots and Trend

- Agents and Planning: 5 papers (16.13%); representative paper: GameCraft-Bench: Can Agents Build Playable Games End-to-End in a Real Game Engine?.
- LLMs and Language: 5 papers (16.13%); representative paper: Learning from the Self-future: On-policy Self-distillation for dLLMs.
- Other AI: 5 papers (16.13%); representative paper: LoopCoder-v2: Only Loop Once for Efficient Test-Time Computation Scaling.
- Trend: Today's dominant clusters are Agents and Planning / LLMs and Language / Other AI; this suggests that agent papers emphasize tool use, planning, and deployable workflows. The strongest visible attention is on “LoopCoder-v2: Only Loop Once for Efficient Test-Time Computation Scaling” (138 upvotes).

## Focus Topics

- Generative Foundations: 1 papers (3.23%)
- Multimodal Generative Modeling: 1 papers (3.23%)
- Multimodal Agents: 3 papers (9.68%)

## Topic Distribution

- Agents and Planning: 5 papers (16.13%)
- LLMs and Language: 5 papers (16.13%)
- Other AI: 5 papers (16.13%)
- Learning, Optimization, and Theory: 3 papers (9.68%)
- Multimodal Agents: 3 papers (9.68%)
- Multimodal Understanding and Vision: 3 papers (9.68%)
- Datasets and Benchmarks: 2 papers (6.45%)
- Reasoning, Alignment, and Evaluation: 2 papers (6.45%)
- Generative Foundations: 1 papers (3.23%)
- Multimodal Generative Modeling: 1 papers (3.23%)
- Retrieval, Knowledge, and RAG: 1 papers (3.23%)
...
- The top topic today is “Agents and Planning”, with 5 papers, accounting for 16.13%。
- The most active submitter is taesiri， with 5 papers。
- The highest-voted visible paper is “LoopCoder-v2: Only Loop Once for Efficient Test-Time Computation Scaling”, currently at 138 votes.
- Today's dominant clusters are Agents and Planning / LLMs and Language / Other AI; this suggests that agent papers emphasize tool use, planning, and deployable workflows. The strongest visible attention is on “LoopCoder-v2: Only Loop Once for Efficient Test-Time Computation Scaling” (138 upvotes).

## Categorized Paper Briefs

### Agents and Planning (5 papers)

- [GameCraft-Bench: Can Agents Build Playable Games End-to-End in a Real Game Engine?](https://huggingface.co/papers/2606.17861) [Upvote: 45] Game generation is an emerging application of coding agents, requiring models to transform natural-language specifications into playable interactive systems. [Agents and Planning]
  ...
  - Submitted by: Tongxu Luo | Upvotes: 45 | Comments: 5
...
- [LectūraAgents: A Multi-Agent Framework for Adaptive Personalized AI-Assisted Learning and Embodied Teaching](https://huggingface.co/papers/2606.16428) [Upvote: 37] Effective personalized AI-assisted learning demands systems that can not only generate accurate learner-specific educational materials, but also dynamically adapt their instruction to diverse learners. [Agents and Planning]
  - Authors: Jaward Sesay, Yue Yu, Siwei Dong, Yemin Shi, Guangyao Chen, Börje F. Karlsson
  - Submitted by: Börje Karlsson | Upvotes: 37 | Comments: 2
...
- [OPD-Evolver: Cultivating Holistic Agent Evolver via On-Policy Distillation](https://huggingface.co/papers/2606.17628) [Upvote: 26] Memory has become a standard substrate for self-evolving agents, yet retaining experience is not the same as learning how to evolve through it. [Agents and Planning]
  - Authors: Guibin Zhang, Xun Xu, Yanwei Yue, Zikun Su, Wangchunshu Zhou, Xiaobin Hu, Shuicheng Yan
  - Submitted by: gbz | Upvotes: 26 | Comments: 1
...
- [Beyond Monolingual Deep Research: Evaluating Agents and Retrievers with Cross-Lingual BrowseComp-Plus](https://huggingface.co/papers/2606.15345) [Upvote: 12] Deep research agents are increasingly evaluated on their ability to search for evidence, reason over retrieved sources, and produce grounded answers. [Agents and Planning]
  - Authors: Yuheng Lu, Qingcheng Zeng, Heli Qi, Puxuan Yu, Fuheng Zhao, Rui Yang, Hitomi Yanaka, Naoto Yokoya, Weihao Xuan
  - Submitted by: Qingcheng Zeng | Upvotes: 12 | Comments: 2
...
- [Learning from the Self-future: On-policy Self-distillation for dLLMs](https://huggingface.co/papers/2606.18195) [Upvote: 70] On-policy self-distillation (OPSD) has proven effective for post-training large language models (LLMs), yet its application to diffusion LLMs (dLLMs) remains unexplored. [LLMs and Language]
  - Authors: Yifu Luo, Zeyu Chen, Haoyu Wang, Xinhao Hu, Yuxuan Zhang, Zhizhou Sha, Shiwei Liu
  - Submitted by: Liu | Upvotes: 70 | Comments: 2
...
- [Variable-Width Transformers](https://huggingface.co/papers/2606.18246) [Upvote: 6] Scaling model size, specifically depth and width, has driven significant progress in transformer-based language models. [LLMs and Language]
...
- [Aligning Quantum Operators with Large Language Models](https://huggingface.co/papers/2606.13811) [Upvote: 3] Can Large Language Models (LLMs) understand and reason about quantum operators? [LLMs and Language]
  - Authors: Rogerio Feris, Yunchao Liu, Pengyuan Li, Hang Hua, David Kremer
  - Submitted by: HangHua | Upvotes: 3 | Comments: 3
...
- [Beyond Scalar Distances: Semantic Attribute Gradients from Frozen MLLMs for Visual Embeddings](https://huggingface.co/papers/2606.15134) [Upvote: 2] Vision encoders for retrieval are typically trained with class-label supervision: each training pair reduces to a scalar that uniformly pushes the embedding apart or pulls it together, as if every visual attribute… [LLMs and Language]
  - Authors: Shubhang Bhatnagar, Dheeraj Baiju, Narendra Ahuja
  - Submitted by: Shubhang Bhatnagar | Upvotes: 2 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2606.15134) / [arXiv](https://arxiv.org/pdf/2606.15134) / [Cool](https://papers.cool/arxiv/2606.15134)
  - <details>
    <summary>Abstract</summary>
...
- [LoopCoder-v2: Only Loop Once for Efficient Test-Time Computation Scaling](https://huggingface.co/papers/2606.18023) [Upvote: 138] Looped Transformers scale latent computation by repeatedly applying shared blocks, but sequential looping increases latency and KV-cache memory with the loop count. [Other AI]
  ...
  - Submitted by: taesiri | Upvotes: 138 | Comments: 3
...
- [Looped World Models](https://huggingface.co/papers/2606.18208) [Upvote: 137] Current world models face a fundamental tension: faithful long-horizon simulation demands deep computation, but deeper models are expensive to deploy and prone to compounding errors. [Other AI]
  ...
  - Submitted by: lu | Upvotes: 137 | Comments: 1
...
- [ProCUA-SFT Technical Report](https://huggingface.co/papers/2606.17321) [Upvote: 6] Training computer-use agents (CUAs) -- models that interact with graphical desktops through screenshots and keyboard/mouse actions -- requires large-scale, diverse trajectory data collected in full desktop environments. [Other AI]
...
- [Zone of Proximal Policy Optimization: Teacher in Prompts, Not Gradients](https://huggingface.co/papers/2606.18216) [Upvote: 50] Knowledge distillation transfers a teacher's competence to a small student but is brittle in the small-student regime: forcing the student to imitate logits from a much larger teacher concentrates it on the teacher's… [Learning, Optimization, and Theory]
  ...
  - Submitted by: Byung-Kwan Lee | Upvotes: 50 | Comments: 2
...
- [Rethinking the Role of Efficient Attention in Hybrid Architectures](https://huggingface.co/papers/2606.15378) [Upvote: 14] Modern language models increasingly adopt hybrid architectures that combine full attention with efficient attention modules, such as sliding-window attention (SWA) and recurrent sequence mixers. [Learning, Optimization, and Theory]
  - Authors: Ziqing Qiao, Yinuo Xu, Chaojun Xiao, Zhou Su, Zihan Zhou, Yingfa Chen, Xiaoyue Xu, Xu Han, Zhiyuan Liu
  - Submitted by: Chaojun XIAO | Upvotes: 14 | Comments: 3
...
- [A Gradient Perspective on RLVR Stability and Winner Advantage Policy Optimization](https://huggingface.co/papers/2606.16154) [Upvote: 6] Reinforcement learning with verifiable rewards (RLVR) improves language-model reasoning, but GRPO-style optimization remains prone to collapse. [Learning, Optimization, and Theory]
  ...
  - Submitted by: Jesse Cresswell | Upvotes: 6 | Comments: 2
...
- [ACE-Ego-0: Unifying Egocentric Human and Robotic Data for VLA Pretraining](https://huggingface.co/papers/2606.17200) [Upvote: 43] Vision-Language-Action (VLA) models benefit from large-scale and diverse embodied data, yet scaling robot trajectory collection is costly and labor-intensive. [Multimodal Agents]
  ...
  - Submitted by: Siyuan | Upvotes: 43 | Comments: 3
...
- [Visual-Seeker: Towards Visual-Native Multimodal Agentic Search via Active Visual Reasoning](https://huggingface.co/papers/2606.15231) [Upvote: 3] Multimodal large language models (MLLMs) have demonstrated impressive capabilities in many visual tasks, but they often struggle with factual grounding when confronted with complex, open-world scenarios. [Multimodal Agents]
  ...
  - Submitted by: Bo | Upvotes: 3 | Comments: 3
...
- [MotionVLA: Vision-Language-Action Model for Humanoid Motion](https://huggingface.co/papers/2606.15142) [Upvote: 2] Generating realistic humanoid motion from scene images and text involves both low-frequency pose semantics and high-frequency physical dynamics. [Multimodal Agents]
  - Authors: Nonghai Zhang, Siyu Zhai, Yanjun Li, Zeyu Zhang, Zhihan Yin, Yandong Guo, Boxin Shi, Hao Tang
  - Submitted by: Zeyu Zhang | Upvotes: 2 | Comments: 2
...
- [Show the Signal, Hide the Noise: Spectral Forcing for Pixel-Space Diffusion](https://huggingface.co/papers/2606.15236) [Upvote: 18] Pixel-space diffusion models are trained on full-bandwidth noisy images, yet the useful signal available to the denoiser is strongly frequency dependent. [Multimodal Understanding and Vision]
  - Authors: Weichen Fan, Haiwen Diao, Penghao Wu, Ziwei Liu
  - Submitted by: weichenfan | Upvotes: 18 | Comments: 3
...
- [Text-Vision Co-Instructed Image Editing](https://huggingface.co/papers/2606.16767) [Upvote: 17] Existing image editing methods can be generally categorized into textual instruction-based and visual prompt-based ones. [Multimodal Understanding and Vision]
  - Authors: Chenxi Xie, Yuhui Wu, Qiaosi Yi, Lei Zhang
  - Submitted by: PolyU_VCLab | Upvotes: 17 | Comments: 4
...
- [Self-Evolving Visual Questioner](https://huggingface.co/papers/2606.13929) [Upvote: 13] Vision-language models (VLMs) are typically trained as passive answerers, while their ability to actively ask diverse, non-trivial, visual-centric and grounded questions remains underexplored. [Multimodal Understanding and Vision]
  - Authors: Yijun Liang, Hengguang Zhou, Ming Li, Lichen Li, Cho-Jui Hsieh, Tianyi Zhou
  - Submitted by: Joanna Liang | Upvotes: 13 | Comments: 2
...
- [Dr-DCI: Scaling Direct Corpus Interaction via Dynamic Workspace Expansion](https://huggingface.co/papers/2606.14885) [Upvote: 10] Agentic search over large corpora relies on retriever-mediated interfaces (e.g., BM25 or ColBERT) for scalable candidate discovery. [Datasets and Benchmarks]
  - Authors: Yi Lu, Zhuofeng Li, Ping Nie, Haoxiang Zhang, Yuyu Zhang, Kai Zou, Wenhu Chen, Jimmy Lin, Dongfu Jiang, Yu Zhang
  - Submitted by: Tom Lu | Upvotes: 10 | Comments: 2
...
- [TRIAGE: Dialectical Reasoning for Explainable Risk Prediction on Irregularly Sampled Medical Time Series with LLMs](https://huggingface.co/papers/2606.09030) [Upvote: 29] Clinical early warning systems built on electronic health records, in which clinical observations are recorded as irregularly sampled medical time series (ISMTS), must deliver both calibrated risk scores for patient… [Reasoning, Alignment, and Evaluation]
  - Authors: Hyeongwon Jang, Gyouk Chu, Changhun Kim, Joonhyung Park, Hangyul Yoon, Eunho Yang
  - Submitted by: Jang | Upvotes: 29 | Comments: 3
...
- [ChLogic: Evaluating Robustness of Logical Reasoning in Chinese Expressions](https://huggingface.co/papers/2606.17905) [Upvote: 7] Large language models perform increasingly well on standardized logical reasoning benchmarks, but whether this ability remains robust beyond English is unclear. [Reasoning, Alignment, and Evaluation]
  - Authors: Peixian Zhou, Yuxu Chen, Chaorui Zhang, Wei Han, Bo Bai, Xueyan Niu
  - Submitted by: Xueyan Niu | Upvotes: 7 | Comments: 3
...
- [Speaking the Language of Science: Toward a General-Purpose Generative Foundation Model for the Natural Sciences](https://huggingface.co/papers/2606.16905) [Upvote: 5] In this report, we present LOGOS (Language Of Generative Objects in Science), a scientific generative language model that unifies heterogeneous tasks across the natural sciences within a single autoregressive… [Generative Foundations]
  - Authors: Mingyang Li, Yurou Liu, Jieping Ye, Bing Su, Ji-Rong Wen, Zheng Wang
  - Submitted by: Yurou Liu | Upvotes: 5 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2606.16905) / [arXiv](https://arxiv.org/pdf/2606.16905) / [Cool](https://papers.cool/arxiv/2606.16905)
  - <details>
    <summary>Abstract</summary>
...
- [Unified Multimodal Autoregressive Modeling with Shared Context-Visual Tokenizer is Key to Unification](https://huggingface.co/papers/2606.18249) [Upvote: 12] Unified Multimodal Modeling aims to integrate visual understanding and generation within a single system. [Multimodal Generative Modeling]
...
- [ActWorld: From Explorable to Interactive World Model via Action-Aware Memory](https://huggingface.co/papers/2606.17730) [Upvote: 6] Interactive world models aim to simulate environment dynamics under real-time user actions. [Retrieval, Knowledge, and RAG]
