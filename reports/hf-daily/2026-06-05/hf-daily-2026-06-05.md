# Hugging Face Daily Papers Report (2026-06-05)

- Source: https://huggingface.co/papers/date/2026-06-05
- Classifier: rule
- Total Papers: 50
...
- The highest-voted visible paper is “Code2LoRA: Hypernetwork-Generated Adapters for Code Language Models under Software Evolution”, currently at 62 votes.
...
- [Code2LoRA: Hypernetwork-Generated Adapters for Code Language Models under Software Evolution](https://huggingface.co/papers/2606.06492) [Upvote: 62] Code language models need repository-level context to resolve imports, APIs, and project conventions. [LLMs and Language]
  - Authors: Liliana Hotsko, Yinxi Li, Yuntian Deng, Pengyu Nie
  - Submitted by: Liliana | Upvotes: 62 | Comments: 2
...
- [Rethinking Continual Experience Internalization for Self-Evolving LLM Agents](https://huggingface.co/papers/2606.04703) [Upvote: 17] Experience internalization converts contextual experience from past interactions into reusable parametric capability, offering a promising path toward continual learning in large language models (LLMs). [LLMs and Language]
  - Authors: Jingwen Chen, Wenkai Yang, Shengda Fan, Wenbo Nie, Chenxing Sun, Shaodong Zheng, Yangen Hu, Lu Pan, Ke Zeng, Yankai Lin
  - Submitted by: Wenkai Yang | Upvotes: 17 | Comments: 2
...
- [MAOAM: Unified Object and Material Selection with Vision-Language Models](https://huggingface.co/papers/2606.04880) [Upvote: 7] Selection is a core operation in interactive image editing. [LLMs and Language]
  ...
  - Submitted by: Jaden Park | Upvotes: 7 | Comments: 1
...
- [LLMs Can Leak Training Data But Do They Want To? A Propensity-Aware Evaluation of Memorization in LLMs](https://huggingface.co/papers/2606.06286) [Upvote: 7] Large language models can reproduce training data, but existing memorization evaluations mostly measure whether models can be forced to do so, rather than whether they do so under ordinary use. [LLMs and Language]
  - Authors: Gianluca Barmina, Peter Schneider-Kamp, Lukas Galke Poech
  - Submitted by: Gianluca Barmina | Upvotes: 7 | Comments: 1
...
- [The Shape of Addition: Geometric Structures of Arithmetic in Large Language Models](https://huggingface.co/papers/2606.03645) [Upvote: 3] Large Language Models exhibit paradoxical fragility in fundamental arithmetic, implying a disconnect between internal computation and discrete output. [LLMs and Language]
  - Authors: Liuyuan Wen, Xun Zhu, Lihao Huang, Wenbin Li, Yang Gao
  - Submitted by: Liuyuan Wen | Upvotes: 3 | Comments: 2
...
- [Towards Truly Multilingual ASR: Generalizing Code-Switching ASR to Unseen Language Pairs](https://huggingface.co/papers/2606.05846) [Upvote: 3] Automatic Speech Recognition (ASR) has become a key technology for human--AI interaction. [LLMs and Language]
  ...
  - Submitted by: Gio Paik | Upvotes: 3 | Comments: 1
...
- [Learning Geometric Representations from Videos for Spatial Intelligent Multimodal Large Language Models](https://huggingface.co/papers/2606.05833) [Upvote: 3] Multimodal Large Language Models (MLLMs) excel at 2D semantic understanding but lack intrinsic 3D awareness, resulting in representations that fail to maintain geometric and spatial consistency across video frames. [LLMs and Language]
  ...
  - Submitted by: WANG HAIBO | Upvotes: 3 | Comments: 1
...
- [Absorbing Complexity: An Interaction-Native Knowledge Harness for Financial LLM Agents](https://huggingface.co/papers/2606.01886) [Upvote: 2] Financial AI agents often fail for a simple reason: they make users carry the complexity. [LLMs and Language]
  ...
  - Submitted by: Sofia | Upvotes: 2 | Comments: 2
...
- [Revising Context, Shifting Simulated Stance: Auditing LLM-Based Stance Simulation in Online Discussions](https://huggingface.co/papers/2606.06443) [Upvote: 2] Large language models are increasingly used to simulate social media users and infer how individuals may respond to online discussions. [LLMs and Language]
  ...
  - Submitted by: BruceLyu | Upvotes: 2 | Comments: 1
...
- [AURA: Intent-Directed Probing for Implicit-Need Surfacing in Situated LLM Agents](https://huggingface.co/papers/2606.05557) [Upvote: 1] A situated query like "where is Lin Wei?" often encodes more than its literal content: the user may also want to know whether Lin Wei is free, in a good mood, or worth interrupting now. [LLMs and Language]
  ...
  - Submitted by: Yang Lee | Upvotes: 1 | Comments: 1
...
- [Complexity-Balanced Diffusion Splitting](https://huggingface.co/papers/2606.06477) [Upvote: 16] Standard continuous-time generative models rely on monolithic architectures that must navigate vastly different signal regimes, from isotropic noise to intricate data distributions. [Multimodal Understanding and Vision]
  ...
  - Submitted by: Noam Issachar | Upvotes: 16 | Comments: 1
...
- [Imagine Before You Predict: Interleaved Latent Visual Reasoning for Video Event Prediction](https://huggingface.co/papers/2606.05769) [Upvote: 5] Video event prediction (VEP) requires models to infer unobserved future states from partial video evidence. [Multimodal Understanding and Vision]
  ...
  - Submitted by: Tianxiang Jiang | Upvotes: 5 | Comments: 1
...
- [MechVQA: Benchmarking and Enhancing Multimodal LLMs on Comprehensive Mechanical Drawing Understanding](https://huggingface.co/papers/2605.30794) [Upvote: 3] Multimodal Large Language Models (MLLMs) have demonstrated significant achievements in general visual question answering (VQA) tasks. [Multimodal Understanding and Vision]
  ...
  - Submitted by: XiaofengShi | Upvotes: 3 | Comments: 2
...
- [Video2LoRA: Parametric Video Internalization for Vision-Language Models](https://huggingface.co/papers/2606.04351) [Upvote: 1] Processing video in vision-language models is expensive: each frame occupies hundreds of tokens, and inference cost scales with every frame and every repeated query. [Multimodal Understanding and Vision]
  - Authors: Manan Suri, Sarvesh Baskar, Dinesh Manocha
  - Submitted by: Manan Suri | Upvotes: 1 | Comments: 2
...
- [BRepCLIP: Contrastive Multimodal Pretraining on BRep Primitives for CAD Understanding](https://huggingface.co/papers/2606.05515) [Upvote: 0] Learning representations of CAD models is a largely open problem. [Multimodal Understanding and Vision]
  - Authors: Muhammad Usama, Didier Stricker, Mohammad Sadil Khan, Muhammad Zeshan Afzal
  - Submitted by: Mohammad Sadil Khan | Upvotes: 0 | Comments: 1
...
- [ArcANE: Do Role-Playing Language Agents Stay in Character at the Right Time?](https://huggingface.co/papers/2606.05553) [Upvote: 42] Role-playing language agents (RPLAs) should play characters whose values and behavior evolve as the story progresses, not maintain a fixed persona. [Agents and Planning]
  - Authors: Woojung Song, Nalim Kim, Sangjun Song, Chaewon Heo, Jongwon Lim, Yohan Jo
  - Submitted by: Jongwon Lim | Upvotes: 42 | Comments: 3
...
- [AdaPlanBench: Evaluating Adaptive Planning in Large Language Model Agents under World and User Constraints](https://huggingface.co/papers/2606.05622) [Upvote: 36] Planning for real-world problems by language models often involves both world and user constraints, which may not be fully specified upfront and are progressively disclosed through interaction. [Agents and Planning]
  ...
  - Submitted by: Jeff | Upvotes: 36 | Comments: 3
...
- [Personal AI Agent for Camera Roll VQA](https://huggingface.co/papers/2606.05275) [Upvote: 18] We study the personal camera roll visual question answering setting. [Agents and Planning]
  - Authors: Thao Nguyen, Krishna Kumar Singh, Donghyun Kim, Yong Jae Lee, Yuheng Li
  - Submitted by: Thao Nguyen | Upvotes: 18 | Comments: 1
...
- [Unsupervised Skill Discovery for Agentic Data Analysis](https://huggingface.co/papers/2606.06416) [Upvote: 10] Inference-time skill augmentation provides a lightweight way to improve data-analytic agents by injecting reusable procedural knowledge without updating model parameters. [Agents and Planning]
  - Authors: Zhisong Qiu, Kangqi Song, Shengwei Tang, Shuofei Qiao, Lei Liang, Huajun Chen, Shumin Deng
  - Submitted by: Shumin Deng | Upvotes: 10 | Comments: 1
...
- [TIDE: Proactive Multi-Problem Discovery via Template-Guided Iteration](https://huggingface.co/papers/2606.04743) [Upvote: 37] Agents are widely deployed as assistants over documents, tools, and code. [Other AI]
  - Authors: Soyeong Jeong, Jinheon Baek, Minki Kang, Sung Ju Hwang
  - Submitted by: Soyeong | Upvotes: 37 | Comments: 4
...
- [RobotValues: Evaluating Household Robots When Human Values Conflict](https://huggingface.co/papers/2606.03312) [Upvote: 23] While household robots are often evaluated based on task completion, everyday domestic environments involve value-conflicting situations in which robots are expected to choose actions that prioritize other values than… [Other AI]
  - Authors: Jongwook Han, Hyeongjin Kim, Yohan Jo
  - Submitted by: Jongwon Lim | Upvotes: 23 | Comments: 5
...
- [SEAOTTER: Sensor Embedded Autoencoding with One-Time Transcode for Efficient Reconstruction](https://huggingface.co/papers/2606.03940) [Upvote: 4] In robotics systems, vast amounts of visual data are easily captured at high resolution using low-cost, low-power hardware. [Other AI]
  ...
  - Submitted by: Dan Jacobellis | Upvotes: 4 | Comments: 2
...
- [Flash-WAM: Modality-Aware Distillation for World Action Models](https://huggingface.co/papers/2606.05254) [Upvote: 4] World-action models (WAMs) jointly generate future video and robot actions through iterative diffusion, achieving strong performance on manipulation benchmarks but requiring tens of denoising steps, a cost that… [Other AI]
...
- [Regret Minimization with Adaptive Opponents in Repeated Games](https://huggingface.co/papers/2606.06486) [Upvote: 1] In this paper, we study regret minimization in repeated games with adaptive opponents who can respond based on histories of play. [Other AI]
  ...
  - Submitted by: Mingyang Liu | Upvotes: 1 | Comments: 1
...
- [VideoKR: Towards Knowledge- and Reasoning-Intensive Video Understanding](https://huggingface.co/papers/2606.05259) [Upvote: 34] We introduce VideoKR, the first large-scale training corpus specifically designed to strengthen knowledge- and reasoning-intensive video understanding. [Reasoning, Alignment, and Evaluation]
  ...
  - Submitted by: Tingyu Song | Upvotes: 34 | Comments: 1
...
- [Latent Reasoning with Normalizing Flows](https://huggingface.co/papers/2606.06447) [Upvote: 5] Large language models often improve reasoning by generating explicit chain-of-thought (CoT), demonstrating the importance of intermediate computation. [Reasoning, Alignment, and Evaluation]
...
- [World-Language-Action Model for Unified World Modeling, Language Reasoning, and Action Synthesis](https://huggingface.co/papers/2606.05979) [Upvote: 5] We propose world-language-action (WLA) models as a new class of embodied foundation models. [Reasoning, Alignment, and Evaluation]
...
- [Trust Region Q Adjoint Matching](https://huggingface.co/papers/2605.27079) [Upvote: 3] Off-policy reinforcement learning of pretrained flow policies remains challenging due to the instability of optimization arising from the multi-step sampling process. [Reasoning, Alignment, and Evaluation]
  ...
  - Submitted by: Yonghoon Dong | Upvotes: 3 | Comments: 2
...
- [Reinforcement Learning Elicits Contextual Learning of Unseen Language Translation](https://huggingface.co/papers/2606.06428) [Upvote: 23] Prior work has shown that large language models (LLMs) can translate unseen or low-resource languages by undergoing continued training or even by encoding a grammar book in their context. [Learning, Optimization, and Theory]
  ...
  - Submitted by: Hanxu Hu | Upvotes: 23 | Comments: 2
...
- [OPRD: On-Policy Representation Distillation](https://huggingface.co/papers/2606.06021) [Upvote: 6] On-policy distillation (OPD) supervises the student only in output space by matching next-token probabilities. [Learning, Optimization, and Theory]
  ...
  - Submitted by: Shenzhi Yang | Upvotes: 6 | Comments: 1
...
- [Benchmark Everything Everywhere All at Once](https://huggingface.co/papers/2606.06462) [Upvote: 2] Benchmarks are fundamental for evaluating and advancing LLMs and MLLMs by providing standardized and explicit measures of performance. [Datasets and Benchmarks]
  ...
  - Submitted by: Shiyun Xiong | Upvotes: 2 | Comments: 1
...
- [Is This Edit Correct? A Multi-Dimensional Benchmark for Reasoning-Aware Image Editing](https://huggingface.co/papers/2606.05172) [Upvote: 1] Diffusion-based image editing has achieved strong visual fidelity under natural language instructions, yet most existing systems still operate at the level of surface instruction following, without reasoning about the… [Datasets and Benchmarks]
  ...
  - Submitted by: ding | Upvotes: 1 | Comments: 1
...
- [The Road Ahead in Autonomous Driving: The KITScenes Multimodal Dataset](https://huggingface.co/papers/2606.02956) [Upvote: 14] Existing autonomous driving datasets have enabled major progress, but fall short in sensor fidelity, map completeness, or geographic diversity. [Multimodal Agents]
  ...
  - Submitted by: Fabian Immel | Upvotes: 14 | Comments: 3
...
- [AffordanceVLA: A Vision-Language-Action Model Empowering Action Generation through Affordance-Aware Understanding](https://huggingface.co/papers/2606.06155) [Upvote: 6] Vision-Language-Action (VLA) models leverage the rich world knowledge of pretrained vision-language models (VLMs) to enable instruction-following robotic manipulation. [Multimodal Agents]
  ...
  - Submitted by: Qize Yu | Upvotes: 6 | Comments: 2
...
- [LoomVideo: Unifying Multimodal Inputs into Video Generation and Editing](https://huggingface.co/papers/2606.06042) [Upvote: 21] Developing unified video generation and editing models capable of interpreting interleaved multimodal inputs is a promising yet challenging frontier field. [Multimodal Generative Modeling]
  ...
  - Submitted by: Jianzong Wu | Upvotes: 21 | Comments: 1
...
- [Towards One-to-Many Temporal Grounding](https://huggingface.co/papers/2606.06294) [Upvote: 4] Temporal Grounding (TG) aims to localize video segments corresponding to a textual query. [Retrieval, Knowledge, and RAG]
  - Authors: Qi Xu, Yue Tan, Shihao Chen, Jiahao Meng, Anna Wang, Shunping Ji, Hao Fei, Jason Li
  - Submitted by: XuQi | Upvotes: 4 | Comments: 2
...
- [Dream.exe: Can Video Generation Models Dream Executable Robot Manipulation?](https://huggingface.co/papers/2606.04811) [Upvote: 15] Video generation models have made impressive strides in synthesizing visually compelling content, yet their outputs remain confined to the virtual domain. [Robotics and Embodied AI]
  ...
  - Submitted by: Rui Zhao | Upvotes: 15 | Comments: 2
