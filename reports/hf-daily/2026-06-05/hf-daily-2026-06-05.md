...
- LLMs and Language: 16 papers (34.04%); representative paper: Rethinking Continual Experience Internalization for Self-Evolving LLM Agents.
- Agents and Planning: 6 papers (12.77%); representative paper: ArcANE: Do Role-Playing Language Agents Stay in Character at the Right Time?.
- Multimodal Understanding and Vision: 6 papers (12.77%); representative paper: Complexity-Balanced Diffusion Splitting.
- Trend: Today's dominant clusters are LLMs and Language / Agents and Planning / Multimodal Understanding and Vision; this suggests several parallel trends: multimodal work is moving from isolated perception toward generation, agents, and action; agent papers emphasize tool use, planning, and deployable workflows. The strongest visible attention is on “ArcANE: Do Role-Playing Language Agents Stay in Character at the Right Time?” (40 upvotes).

## Focus Topics

- Generative Foundations: 0 papers (0.00%)
- Multimodal Generative Modeling: 1 papers (2.13%)
- Multimodal Agents: 1 papers (2.13%)

## Topic Distribution

- LLMs and Language: 16 papers (34.04%)
- Agents and Planning: 6 papers (12.77%)
- Multimodal Understanding and Vision: 6 papers (12.77%)
- Reasoning, Alignment, and Evaluation: 5 papers (10.64%)
- Other AI: 4 papers (8.51%)
- Learning, Optimization, and Theory: 3 papers (6.38%)
- Datasets and Benchmarks: 2 papers (4.26%)
- Domain Applications: 1 papers (2.13%)
- Multimodal Agents: 1 papers (2.13%)
- Multimodal Generative Modeling: 1 papers (2.13%)
- Retrieval, Knowledge, and RAG: 1 papers (2.13%)
- Robotics and Embodied AI: 1 papers (2.13%)
...
- Franck Dernoncourt: 1 papers

## Brief Notes

- The top topic today is “LLMs and Language”, with 16 papers, accounting for 34.04%。
- The most active submitter is taesiri， with 5 papers。
- The highest-voted visible paper is “ArcANE: Do Role-Playing Language Agents Stay in Character at the Right Time?”, currently at 40 votes.
- Today's dominant clusters are LLMs and Language / Agents and Planning / Multimodal Understanding and Vision; this suggests several parallel trends: multimodal work is moving from isolated perception toward generation, agents, and action; agent papers emphasize tool use, planning, and deployable workflows. The strongest visible attention is on “ArcANE: Do Role-Playing Language Agents Stay in Character at the Right Time?” (40 upvotes).

## Categorized Paper Briefs

### LLMs and Language (16 papers)

- [Rethinking Continual Experience Internalization for Self-Evolving LLM Agents](https://huggingface.co/papers/2606.04703) [Upvote: 15] Experience internalization converts contextual experience from past interactions into reusable parametric capability, offering a promising path toward continual learning in large language models (LLMs). [LLMs and Language]
  - Authors: Jingwen Chen, Wenkai Yang, Shengda Fan, Wenbo Nie, Chenxing Sun, Shaodong Zheng, Yangen Hu, Lu Pan, Ke Zeng, Yankai Lin
  - Submitted by: Wenkai Yang | Upvotes: 15 | Comments: 1
...
- [Code2LoRA: Hypernetwork-Generated Adapters for Code Language Models under Software Evolution](https://huggingface.co/papers/2606.06492) [Upvote: 11] Code language models need repository-level context to resolve imports, APIs, and project conventions. [LLMs and Language]
  - Authors: Liliana Hotsko, Yinxi Li, Yuntian Deng, Pengyu Nie
  - Submitted by: Liliana | Upvotes: 11 | Comments: 1
...
- [MAOAM: Unified Object and Material Selection with Vision-Language Models](https://huggingface.co/papers/2606.04880) [Upvote: 6] Selection is a core operation in interactive image editing. [LLMs and Language]
  ...
  - Submitted by: Jaden Park | Upvotes: 6 | Comments: 1
...
- [Meta-Cognitive Memory Policy Optimization for Long-Horizon LLM Agents](https://huggingface.co/papers/2605.30159) [Upvote: 5] Memory-augmented LLM agents tackle complex long-horizon tasks by recursively summarizing interaction trajectories into compact memory. [LLMs and Language]
  - Authors: Ziyan Liu, Zhezheng Hao, Yeqiu Chen, Hong Wang, Jingren Hou, Ruiyi Ding, Yongkang Yang, Wence Ji, Wei Xia, Feng Liu
  - Submitted by: liu | Upvotes: 5 | Comments: 1
...
- [AdaCodec: A Predictive Visual Code for Video MLLMs](https://huggingface.co/papers/2606.02569) [Upvote: 3] Video is temporally redundant: adjacent frames usually share most objects, background, and layout. [LLMs and Language]
  ...
  - Submitted by: Jiaqi Wang | Upvotes: 3 | Comments: 1
...
- [The Shape of Addition: Geometric Structures of Arithmetic in Large Language Models](https://huggingface.co/papers/2606.03645) [Upvote: 1] Large Language Models exhibit paradoxical fragility in fundamental arithmetic, implying a disconnect between internal computation and discrete output. [LLMs and Language]
  - Authors: Liuyuan Wen, Xun Zhu, Lihao Huang, Wenbin Li, Yang Gao
  - Submitted by: Liuyuan Wen | Upvotes: 1 | Comments: 1
...
- [Learning Geometric Representations from Videos for Spatial Intelligent Multimodal Large Language Models](https://huggingface.co/papers/2606.05833) [Upvote: 1] Multimodal Large Language Models (MLLMs) excel at 2D semantic understanding but lack intrinsic 3D awareness, resulting in representations that fail to maintain geometric and spatial consistency across video frames. [LLMs and Language]
  - Authors: Haibo Wang, Lifu Huang
  - Submitted by: WANG HAIBO | Upvotes: 1 | Comments: 1
...
- [LLM Anonymization Against Agentic Re-Identification](https://huggingface.co/papers/2605.30848) [Upvote: 1] Agentic LLMs with web search change the threat model for text anonymization: weak contextual cues can become cross-referenceable evidence for re-identification, yet those same details also carry downstream analytic… [LLMs and Language]
  ...
  - Submitted by: Ziwen Li | Upvotes: 1 | Comments: 1
...
- [Combinatorial Synthesis: Scaling Code RLVR via Atomic Decomposition and Recombination](https://huggingface.co/papers/2605.31058) [Upvote: 1] Reinforcement Learning with Verifiable Rewards (RLVR) has recently emerged as the cornerstone for shaping the remarkable coding abilities of Large Language Models (LLMs). [LLMs and Language]
  ...
  - Submitted by: Boxi Cao | Upvotes: 1 | Comments: 1
...
- [Absorbing Complexity: An Interaction-Native Knowledge Harness for Financial LLM Agents](https://huggingface.co/papers/2606.01886) [Upvote: 1] Financial AI agents often fail for a simple reason: they make users carry the complexity. [LLMs and Language]
  - Authors: Ailiya Borjigin, Igor Stadnyk, Ben Bilski, Maksym Chikita, Dmytro Kyrylenko, Sofiia Pidturkina, Julia Stadnyk
  - Submitted by: Sofia | Upvotes: 1 | Comments: 1
...
- [SABER: Benchmarking Operational Safety of LLM Coding Agents in Stateful Project Workspaces](https://huggingface.co/papers/2606.01317) [Upvote: 0] Large language models are increasingly deployed as coding agents, shifting safety from individual responses to action sequences. [LLMs and Language]
  ...
  - Submitted by: Qi HU | Upvotes: 0 | Comments: 1
...
- [ForeSci: Evaluating LLM Agents for Forward-Looking AI Research Judgment](https://huggingface.co/papers/2606.00644) [Upvote: 0] AI research often requires decisions before future evidence exists: which bottleneck to attack, which direction to pursue, or where a project should be positioned. [LLMs and Language]
  ...
  - Submitted by: BruceLyu | Upvotes: 0 | Comments: 1
...
- [ArcANE: Do Role-Playing Language Agents Stay in Character at the Right Time?](https://huggingface.co/papers/2606.05553) [Upvote: 40] Role-playing language agents (RPLAs) should play characters whose values and behavior evolve as the story progresses, not maintain a fixed persona. [Agents and Planning]
  - Authors: Woojung Song, Nalim Kim, Sangjun Song, Chaewon Heo, Jongwon Lim, Yohan Jo
  - Submitted by: Jongwon Lim | Upvotes: 40 | Comments: 2
...
- [AdaPlanBench: Evaluating Adaptive Planning in Large Language Model Agents under World and User Constraints](https://huggingface.co/papers/2606.05622) [Upvote: 30] Planning for real-world problems by language models often involves both world and user constraints, which may not be fully specified upfront and are progressively disclosed through interaction. [Agents and Planning]
  ...
  - Submitted by: Jeff | Upvotes: 30 | Comments: 1
...
- [Personal AI Agent for Camera Roll VQA](https://huggingface.co/papers/2606.05275) [Upvote: 16] We study the personal camera roll visual question answering setting. [Agents and Planning]
  - Authors: Thao Nguyen, Krishna Kumar Singh, Donghyun Kim, Yong Jae Lee, Yuheng Li
  - Submitted by: Thao Nguyen | Upvotes: 16 | Comments: 1
...
- [SePO: Self-Evolving Prompt Agent for System Prompt Optimization](https://huggingface.co/papers/2606.04465) [Upvote: 3] System prompt optimization improves agent behavior without modifying the underlying model, yielding human-readable, model-agnostic instructions. [Agents and Planning]
  - Authors: Wangcheng Tao, Han Wu, Weng-Fai Wong
  - Submitted by: Tao Wangcheng | Upvotes: 3 | Comments: 1
...
- [EvoDS: Self-Evolving Autonomous Data Science Agent with Skill Learning and Context Management](https://huggingface.co/papers/2606.03841) [Upvote: 2] Recent progress in Large Language Model (LLM) agents has enabled promising advances in automated data science. [Agents and Planning]
  ...
  - Submitted by: Zherui Yang | Upvotes: 2 | Comments: 1
...
- [Complexity-Balanced Diffusion Splitting](https://huggingface.co/papers/2606.06477) [Upvote: 15] Standard continuous-time generative models rely on monolithic architectures that must navigate vastly different signal regimes, from isotropic noise to intricate data distributions. [Multimodal Understanding and Vision]
  - Authors: Noam Issachar, Dani Lischinski, Raanan Fattal
  - Submitted by: Noam Issachar | Upvotes: 15 | Comments: 1
...
- [MechVQA: Benchmarking and Enhancing Multimodal LLMs on Comprehensive Mechanical Drawing Understanding](https://huggingface.co/papers/2605.30794) [Upvote: 3] Multimodal Large Language Models (MLLMs) have demonstrated significant achievements in general visual question answering (VQA) tasks. [Multimodal Understanding and Vision]
  ...
  - Submitted by: XiaofengShi | Upvotes: 3 | Comments: 1
...
- [Video2LoRA: Parametric Video Internalization for Vision-Language Models](https://huggingface.co/papers/2606.04351) [Upvote: 1] Processing video in vision-language models is expensive: each frame occupies hundreds of tokens, and inference cost scales with every frame and every repeated query. [Multimodal Understanding and Vision]
  ...
  - Submitted by: Manan Suri | Upvotes: 1 | Comments: 1
...
- [VideoKR: Towards Knowledge- and Reasoning-Intensive Video Understanding](https://huggingface.co/papers/2606.05259) [Upvote: 28] We introduce VideoKR, the first large-scale training corpus specifically designed to strengthen knowledge- and reasoning-intensive video understanding. [Reasoning, Alignment, and Evaluation]
  - Authors: Lin Fu, Zheyuan Yang, Yang Wang, Tingyu Song, Arman Cohan, Yilun Zhao
  - Submitted by: Tingyu Song | Upvotes: 28 | Comments: 1
...
- [The Shadow Price of Reasoning: Economic Perspective on Optimal Budget Allocation for LLMs](https://huggingface.co/papers/2606.03092) [Upvote: 6] Inference-time scaling has emerged as a critical avenue for enhancing Large Language Models' performance, yet real-world deployment is constrained by strict computational budgets. [Reasoning, Alignment, and Evaluation]
  ...
  - Submitted by: XuWan | Upvotes: 6 | Comments: 1
...
- [Latent Reasoning with Normalizing Flows](https://huggingface.co/papers/2606.06447) [Upvote: 2] Large language models often improve reasoning by generating explicit chain-of-thought (CoT), demonstrating the importance of intermediate computation. [Reasoning, Alignment, and Evaluation]
...
- [Trust Region Q Adjoint Matching](https://huggingface.co/papers/2605.27079) [Upvote: 1] Off-policy reinforcement learning of pretrained flow policies remains challenging due to the instability of optimization arising from the multi-step sampling process. [Reasoning, Alignment, and Evaluation]
  - Authors: Yonghoon Dong, Kyungmin Lee, Changyeon Kim, Jaehyuk Kim, Jinwoo Shin
  - Submitted by: Yonghoon Dong | Upvotes: 1 | Comments: 1
...
- [TIDE: Proactive Multi-Problem Discovery via Template-Guided Iteration](https://huggingface.co/papers/2606.04743) [Upvote: 35] Agents are widely deployed as assistants over documents, tools, and code. [Other AI]
  - Authors: Soyeong Jeong, Jinheon Baek, Minki Kang, Sung Ju Hwang
  - Submitted by: Soyeong | Upvotes: 35 | Comments: 2
...
- [RobotValues: Evaluating Household Robots When Human Values Conflict](https://huggingface.co/papers/2606.03312) [Upvote: 22] While household robots are often evaluated based on task completion, everyday domestic environments involve value-conflicting situations in which robots are expected to choose actions that prioritize other values than… [Other AI]
  - Authors: Jongwook Han, Hyeongjin Kim, Yohan Jo
  - Submitted by: Jongwon Lim | Upvotes: 22 | Comments: 4
...
- [SEAOTTER: Sensor Embedded Autoencoding with One-Time Transcode for Efficient Reconstruction](https://huggingface.co/papers/2606.03940) [Upvote: 3] In robotics systems, vast amounts of visual data are easily captured at high resolution using low-cost, low-power hardware. [Other AI]
  - Authors: Dan Jacobellis, Neeraja J. Yadwadkar
  - Submitted by: Dan Jacobellis | Upvotes: 3 | Comments: 1
...
- [Flash-WAM: Modality-Aware Distillation for World Action Models](https://huggingface.co/papers/2606.05254) [Upvote: 3] World-action models (WAMs) jointly generate future video and robot actions through iterative diffusion, achieving strong performance on manipulation benchmarks but requiring tens of denoising steps, a cost that… [Other AI]
...
- [Benchmark Everything Everywhere All at Once](https://huggingface.co/papers/2606.06462) [Upvote: 1] Benchmarks are fundamental for evaluating and advancing LLMs and MLLMs by providing standardized and explicit measures of performance. [Datasets and Benchmarks]
  - Authors: Shiyun Xiong, Dongming Wu, Peiwen Sun, Yuang Ai, Bokang Yang, Wencheng Han, Xiao-Hui Li, Xiangyu Yue
  - Submitted by: Shiyun Xiong | Upvotes: 1 | Comments: 1
...
- [Quality-Guided Semi-Supervised Learning for Medical Image Segmentation](https://huggingface.co/papers/2606.01753) [Upvote: 0] Training accurate medical image segmentation models requires large amounts of densely annotated data, which is costly and time-consuming to obtain. [Domain Applications]
  - Authors: Kumar Abhishek, Ghassan Hamarneh
  - Submitted by: Kumar Abhishek | Upvotes: 0 | Comments: 1
...
- [AffordanceVLA: A Vision-Language-Action Model Empowering Action Generation through Affordance-Aware Understanding](https://huggingface.co/papers/2606.06155) [Upvote: 3] Vision-Language-Action (VLA) models leverage the rich world knowledge of pretrained vision-language models (VLMs) to enable instruction-following robotic manipulation. [Multimodal Agents]
  ...
  - Submitted by: Qize Yu | Upvotes: 3 | Comments: 2
...
- [LoomVideo: Unifying Multimodal Inputs into Video Generation and Editing](https://huggingface.co/papers/2606.06042) [Upvote: 16] Developing unified video generation and editing models capable of interpreting interleaved multimodal inputs is a promising yet challenging frontier field. [Multimodal Generative Modeling]
  ...
  - Submitted by: Jianzong Wu | Upvotes: 16 | Comments: 1
...
- [Towards One-to-Many Temporal Grounding](https://huggingface.co/papers/2606.06294) [Upvote: 4] Temporal Grounding (TG) aims to localize video segments corresponding to a textual query. [Retrieval, Knowledge, and RAG]
  ...
  - Submitted by: XuQi | Upvotes: 4 | Comments: 1
...
- [Dream.exe: Can Video Generation Models Dream Executable Robot Manipulation?](https://huggingface.co/papers/2606.04811) [Upvote: 12] Video generation models have made impressive strides in synthesizing visually compelling content, yet their outputs remain confined to the virtual domain. [Robotics and Embodied AI]
  - Authors: Rui Zhao, Kaiming Yang, Jifeng Zhu, Siyang Chen, Ziqi Wang, Weijia Wu, Kevin Qinghong Lin, Heng Wang, Mike Zheng Shou
  - Submitted by: Rui Zhao | Upvotes: 12 | Comments: 2
