# Hugging Face Daily Papers Report (2026-08-04)

- Source: https://huggingface.co/papers/date/2026-08-04
- Classifier: rule
- Total Papers: 25

## Today's Hotspots and Trend

- LLMs and Language: 5 papers (20.00%); representative paper: From RLVR to RLSVR: Task Transformation Induces Self-Verifiable Rewards for Open-Ended LLM Self-Improvement.
- Other AI: 5 papers (20.00%); representative paper: Mental World Modeling.
- Agents and Planning: 3 papers (12.00%); representative paper: EMBL AI Librarian: Life-Sciences Knowledge Layer for AI Agents.
- Trend: Today's dominant clusters are LLMs and Language / Other AI / Agents and Planning; this suggests that agent papers emphasize tool use, planning, and deployable workflows. The strongest visible attention is on “From RLVR to RLSVR: Task Transformation Induces Self-Verifiable Rewards for Open-Ended LLM Self-Improvement” (69 upvotes).

## Focus Topics

- Generative Foundations: 0 papers (0.00%)
- Multimodal Generative Modeling: 0 papers (0.00%)
- Multimodal Agents: 1 papers (4.00%)

## Topic Distribution

- LLMs and Language: 5 papers (20.00%)
- Other AI: 5 papers (20.00%)
- Agents and Planning: 3 papers (12.00%)
...
- taesiri: 3 papers
- Yuan Gao: 2 papers
- Alan Gazzaev: 1 papers
- Derek Tan Ming Siang: 1 papers
- Dstate: 1 papers
- Hao Fei: 1 papers

## Brief Notes

- The top topic today is “LLMs and Language”, with 5 papers, accounting for 20.00%。
- The most active submitter is taesiri， with 3 papers。
- The highest-voted visible paper is “From RLVR to RLSVR: Task Transformation Induces Self-Verifiable Rewards for Open-Ended LLM Self-Improvement”, currently at 69 votes.
- Today's dominant clusters are LLMs and Language / Other AI / Agents and Planning; this suggests that agent papers emphasize tool use, planning, and deployable workflows. The strongest visible attention is on “From RLVR to RLSVR: Task Transformation Induces Self-Verifiable Rewards for Open-Ended LLM Self-Improvement” (69 upvotes).

## Categorized Paper Briefs

### LLMs and Language (5 papers)

- [From RLVR to RLSVR: Task Transformation Induces Self-Verifiable Rewards for Open-Ended LLM Self-Improvement](https://huggingface.co/papers/2607.23802) [Upvote: 69] Reinforcement Learning with Verifiable Rewards (RLVR) has driven recent progress in reasoning-oriented large language models (LLMs) by enabling large-scale optimization. [LLMs and Language]
  ...
  - Submitted by: Wang | Upvotes: 69 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2607.23802) / [arXiv](https://arxiv.org/pdf/2607.23802) / [Cool](https://papers.cool/arxiv/2607.23802)
  - <details>
...
- [N_0-VTLA: Scaling Vision-Tactile-Language-Action Model with Latent Tactile Tokens](https://huggingface.co/papers/2607.23782) [Upvote: 49] We present N_0-VTLA, a vision-tactile-language-action (VTLA) foundation model capable of (1) fine-grained contact-rich manipulation with tactile perception and tactile-feedback control, and (2) offline policy… [LLMs and Language]
  - Authors: NeoteAI Team, Fudan TEAI Team
  - Submitted by: Zhou Heng | Upvotes: 49 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2607.23782) / [arXiv](https://arxiv.org/pdf/2607.23782) / [Cool](https://papers.cool/arxiv/2607.23782)
  - <details>
    <summary>Abstract</summary>
...
- [AISPA: User-Centric System Prompt Auditing for Large Language Model Applications](https://huggingface.co/papers/2607.28617) [Upvote: 29] System prompts are instructions configured by developers to govern the behaviors of foundation models in AI applications. [LLMs and Language]
  - Authors: Xiangning Lin, Shenzhe Zhu, Shu Yang, Zhenyu Zhang, Haoqian Zhang, Yipeng Zhao, Chengxuan Qian, Tianwei Wang, Ziheng Zhang, Zhenlong Yuan, Dingcheng Wang, Juncheng Wu, Yuan Si, Jiaxin Liu, Baolong Bi, Robert Mahari, Tobin South, Dazza Greenwood, Zexue He, Rishi Bommasani, Sophia Kazinnik, Andreas Haupt, Samuele Marro, Erik Brynjolfsson, Alex Pentland, Jiaxin Pei
  - Submitted by: Shenzhe Zhu | Upvotes: 29 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2607.28617) / [arXiv](https://arxiv.org/pdf/2607.28617) / [Cool](https://papers.cool/arxiv/2607.28617)
  - <details>
    <summary>Abstract</summary>
...
- [Fewer Clarifications, Better Code: Benchmarking Cross-Session Personalized Ambiguity Adaptation in Coding Assistants](https://huggingface.co/papers/2607.26611) [Upvote: 19] AI-assisted coding increasingly translates informal user intent into executable software, yet coding requests often contain ambiguities that recur in user-specific ways across tasks and sessions. [LLMs and Language]
  - Authors: Zijian Xu, Wenshuo Zhang, Zisen Qin, Rui Sheng, Yushi Sun, Huamin Qu, Chuhan Shi
  - Submitted by: Yushi SUN | Upvotes: 19 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2607.26611) / [arXiv](https://arxiv.org/pdf/2607.26611) / [Cool](https://papers.cool/arxiv/2607.26611)
  - <details>
    <summary>Abstract</summary>
...
- [Beyond Feeling Better: Capability-Sustaining Emotional Dialogue as a Longitudinal Research Paradigm](https://huggingface.co/papers/2607.27851) [Upvote: 2] Emotional dialogue research includes two influential strategy traditions. [LLMs and Language]
  - Authors: Ming Wang, Jiaqi Wu Young, Wenfang Wu, Daling Wang, Shi Feng
  - Submitted by: Ming Wang | Upvotes: 2 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2607.27851) / [arXiv](https://arxiv.org/pdf/2607.27851) / [Cool](https://papers.cool/arxiv/2607.27851)
  - <details>
    <summary>Abstract</summary>
...
- [Mental World Modeling](https://huggingface.co/papers/2607.27201) [Upvote: 52] World models enable a predictive substrate for planning and action, yet existing formulations merely answer a physical question: what/where it is, and how will it evolve. [Other AI]
  - Authors: Hao Fei, Yiran Zhao
  - Submitted by: Hao Fei | Upvotes: 52 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2607.27201) / [arXiv](https://arxiv.org/pdf/2607.27201) / [Cool](https://papers.cool/arxiv/2607.27201)
  - <details>
    <summary>Abstract</summary>
...
- [Meshy T2: Fast Native Mesh Generation with Flow Matching](https://huggingface.co/papers/2607.28675) [Upvote: 40] Polygonal meshes are the standard surface representation of modern 3D pipelines, and generating high-quality meshes with artist-style topology is essential for film, gaming, and interactive 3D applications. [Other AI]
  ...
  - Links: [HF](https://huggingface.co/papers/2607.28675) / [arXiv](https://arxiv.org/pdf/2607.28675) / [Cool](https://papers.cool/arxiv/2607.28675)
  - <details>
    <summary>Abstract</summary>
...
- [SAF-OPD: Stable Advantage Fusion for On-Policy Distillation](https://huggingface.co/papers/2607.29209) [Upvote: 23] Reinforcement learning with verifiable rewards (RLVR) broadcasts a single response-level reward to every token, while on-policy distillation (OPD) scores each token against a stronger teacher for a dense advantage but… [Other AI]
  ...
  - Submitted by: dingyi | Upvotes: 23 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2607.29209) / [arXiv](https://arxiv.org/pdf/2607.29209) / [Cool](https://papers.cool/arxiv/2607.29209)
  - <details>
    <summary>Abstract</summary>
...
- [QQWorld: Quantile-Quantile Matching for World Model Regularization](https://huggingface.co/papers/2607.28415) [Upvote: 23] Latent world models enable efficient planning by predicting future states in a compact representation space, but their performance depends critically on the quality of the learned latent distribution. [Other AI]
  - Authors: Zhoushun Yu, Xiaoyu Hu, Xiangyu Xu
  - Submitted by: Xiangyu Xu | Upvotes: 23 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2607.28415) / [arXiv](https://arxiv.org/pdf/2607.28415) / [Cool](https://papers.cool/arxiv/2607.28415)
  - <details>
    <summary>Abstract</summary>
...
- [Enhancing Rubric-based RL via Self-Distillation](https://huggingface.co/papers/2607.18082) [Upvote: 15] Rubric-based RL has recently shown promise in improving LLMs on open-ended tasks. [Other AI]
  ...
  - Submitted by: Mingxuan Xia | Upvotes: 15 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2607.18082) / [arXiv](https://arxiv.org/pdf/2607.18082) / [Cool](https://papers.cool/arxiv/2607.18082)
  - <details>
    <summary>Abstract</summary>
...
- [EMBL AI Librarian: Life-Sciences Knowledge Layer for AI Agents](https://huggingface.co/papers/2607.28229) [Upvote: 4] The web is increasingly accessed by AI agents rather than humans. [Agents and Planning]
  ...
  - Submitted by: Luigi Sigillo | Upvotes: 4 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2607.28229) / [arXiv](https://arxiv.org/pdf/2607.28229) / [Cool](https://papers.cool/arxiv/2607.28229)
  - <details>
    <summary>Abstract</summary>
...
- [In the Driver's Seat: A Multi-Company Study on the Reality of Autonomous Driving System Testing](https://huggingface.co/papers/2607.15820) [Upvote: 1] Autonomous driving systems (ADS) are rapidly advancing and increasingly deployed in real-world applications. [Agents and Planning]
  - Authors: Qunying Song, Yuan Gao, Johannes Betz, Dietmar Pfahl, Mohammad Reza Mousavi, Federica Sarro
  - Submitted by: Yuan Gao | Upvotes: 1 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2607.15820) / [arXiv](https://arxiv.org/pdf/2607.15820) / [Cool](https://papers.cool/arxiv/2607.15820)
  - <details>
    <summary>Abstract</summary>
...
- [SGTP: Sampling-based Game-Theoretic Planning for Real-Time Multi-Vehicle Autonomous Racing](https://huggingface.co/papers/2607.25388) [Upvote: 0] Autonomous multi-vehicle racing requires real-time planning of diverse competitive behaviors in intense interactions. [Agents and Planning]
  ...
  - Links: [HF](https://huggingface.co/papers/2607.25388) / [arXiv](https://arxiv.org/pdf/2607.25388) / [Cool](https://papers.cool/arxiv/2607.25388)
  - <details>
    <summary>Abstract</summary>
...
- [Scaling Properties of Text Conditioning in Visual Generation](https://huggingface.co/papers/2607.29679) [Upvote: 23] We study empirical scaling properties for text conditioning in visual generation. [Multimodal Understanding and Vision]
  - Authors: Zilong Chen, Chaorui Deng, Kunchang Li, Hongyi Yuan, Haoqi Fan
  - Submitted by: Zilong Chen | Upvotes: 23 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2607.29679) / [arXiv](https://arxiv.org/pdf/2607.29679) / [Cool](https://papers.cool/arxiv/2607.29679)
  - <details>
    <summary>Abstract</summary>
...
- [Evaluation-Verification Reward for Consistent Multi-Reference Image Editing](https://huggingface.co/papers/2607.29025) [Upvote: 11] While recent image editing models have made rapid progress, multi-reference editing remains challenging, particularly in maintaining visual consistency across references and ensuring overall visual harmony. [Multimodal Understanding and Vision]
  ...
  - Links: [HF](https://huggingface.co/papers/2607.29025) / [arXiv](https://arxiv.org/pdf/2607.29025) / [Cool](https://papers.cool/arxiv/2607.29025)
  - <details>
    <summary>Abstract</summary>
...
- [Toward Robust and 3D-Aware RGB-NIR Imaging in the Dark](https://huggingface.co/papers/2607.29684) [Upvote: 2] Robust low-light imaging remains challenging for the community. [Multimodal Understanding and Vision]
  - Authors: Muyao Niu, Mingze Ma, Yifan Zhan, Qingtian Zhu, Zhihang Zhong, Wei Guo, Chang Wen Chen, Yinqiang Zheng
  - Submitted by: Muyao Niu | Upvotes: 2 | Comments: 3
  - Links: [HF](https://huggingface.co/papers/2607.29684) / [arXiv](https://arxiv.org/pdf/2607.29684) / [Cool](https://papers.cool/arxiv/2607.29684)
  - <details>
    <summary>Abstract</summary>
...
- [Not All Tokens Deserve Equal Credit: Counterfactual Sensitivity Credit Reallocation for Long-CoT Reasoning](https://huggingface.co/papers/2607.27888) [Upvote: 2] Reinforcement learning with verifiable rewards (RLVR) is central to improving long-CoT reasoning in large language models. [Reasoning, Alignment, and Evaluation]
  - Authors: Qiangqiang He, Zhongheng Wu, ZiJian Wang
  - Submitted by: he | Upvotes: 2 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2607.27888) / [arXiv](https://arxiv.org/pdf/2607.27888) / [Cool](https://papers.cool/arxiv/2607.27888)
  - <details>
    <summary>Abstract</summary>
...
- [Safeguards Based on Copyable Context Cannot Provide Reliable Safety for LLMs](https://huggingface.co/papers/2607.27951) [Upvote: 1] Large language model safeguards decide whether to answer before seeing how an answer will be used. [Reasoning, Alignment, and Evaluation]
  - Authors: Pingyu Wu, Lingyao Zhu, Weiming Zhang, Nenghai Yu
  - Submitted by: pingyu wu | Upvotes: 1 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2607.27951) / [arXiv](https://arxiv.org/pdf/2607.27951) / [Cool](https://papers.cool/arxiv/2607.27951)
  - <details>
    <summary>Abstract</summary>
...
- [Would You Walk to the Car Wash? Revealing the Salience Bias of Large Language Models in Commonsense Reasoning](https://huggingface.co/papers/2607.28478) [Upvote: 0] As large language models (LLMs) continue to advance in complex reasoning tasks, they have learned to heavily prioritize explicit conditions provided in the input. [Reasoning, Alignment, and Evaluation]
  - Authors: Zheng Wu, Chenhao Xue, Shijie Zheng, Yijie Lu, Cheng Yang, Zhuosheng Zhang
  - Submitted by: Zheng Wu | Upvotes: 0 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2607.28478) / [arXiv](https://arxiv.org/pdf/2607.28478) / [Cool](https://papers.cool/arxiv/2607.28478)
  - <details>
    <summary>Abstract</summary>
...
- [ExtractBench: A Benchmark for Schema-Guided Enterprise Document Extraction](https://huggingface.co/papers/2607.29677) [Upvote: 13] Enterprise workflows increasingly rely on agents for schema-guided extraction: given a document and a user-defined schema, the agent faithfully follows the schema to produce the correct output with source evidence as… [Datasets and Benchmarks]
  - Authors: Boyang Zhang, Adrian Lyjak, Eli Stewart, Zhaoqi Li, Simon Suo
  - Submitted by: taesiri | Upvotes: 13 | Comments: 0
  - Links: [HF](https://huggingface.co/papers/2607.29677) / [arXiv](https://arxiv.org/pdf/2607.29677) / [Cool](https://papers.cool/arxiv/2607.29677)
  - <details>
    <summary>Abstract</summary>
...
- [SULAND v2: A Refined RGB Dataset and Deep Learning Object Detection Benchmark for UAV/UGV-Based SUrface LANDmine Detection Under Domain Shift](https://huggingface.co/papers/2607.28996) [Upvote: 2] RGB imagery offers a practical, low-cost option for Unmanned Aerial/Ground Vehicle (UAV/UGV) survey support in surface-landmine detection, but object detectors remain underexplored in this safety-critical domain. [Datasets and Benchmarks]
  - Authors: Sagar Lekhak, Prasanna Reddy Pulakurthi, Lalit Joshi, Ramesh Bhatta, Emmett J. Ientilucci
  - Submitted by: Prasanna Reddy Pulakurthi | Upvotes: 2 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2607.28996) / [arXiv](https://arxiv.org/pdf/2607.28996) / [Cool](https://papers.cool/arxiv/2607.28996)
  - <details>
    <summary>Abstract</summary>
...
- [N_0-TWAM: Scaling Tactile-Native World-Action Model for Contact-Rich Manipulation](https://huggingface.co/papers/2607.23783) [Upvote: 26] We present N_0-TWAM, a tactile-native world-action model for contact-rich manipulation that predicts both future vision and future contact. [Robotics and Embodied AI]
  - Authors: NeoteAI Team, Fudan TEAI Team
  - Submitted by: Li Kang | Upvotes: 26 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2607.23783) / [arXiv](https://arxiv.org/pdf/2607.23783) / [Cool](https://papers.cool/arxiv/2607.23783)
  - <details>
    <summary>Abstract</summary>
...
- [One Future, Every Robot: Label-Efficient Collective-State Prediction with Decentralized JEPA](https://huggingface.co/papers/2607.28443) [Upvote: 3] Can every robot in a swarm predict the same future collective state from only local observations and bandwidth-limited messages? [Robotics and Embodied AI]
  - Authors: Alan-Barsag Gazzaev, Alexey Garvilov, Sergey Muravyov
  - Submitted by: Alan Gazzaev | Upvotes: 3 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2607.28443) / [arXiv](https://arxiv.org/pdf/2607.28443) / [Cool](https://papers.cool/arxiv/2607.28443)
  - <details>
    <summary>Abstract</summary>
...
- [ODEWorld: A Continuous Predictive Architecture via Physical-Time Flow](https://huggingface.co/papers/2607.27924) [Upvote: 7] In the physical world we inhabit, space and time are fundamentally continuous. [Learning, Optimization, and Theory]
  - Authors: Dongxiu Liu, Haoyi Niu, Peng Cheng, Yuan Gao, Xirui Kang, Sangli Teng, Koushil Sreenath, Xianyuan Zhan
  - Submitted by: Dstate | Upvotes: 7 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2607.27924) / [arXiv](https://arxiv.org/pdf/2607.27924) / [Cool](https://papers.cool/arxiv/2607.27924)
  - <details>
    <summary>Abstract</summary>
...
- [RL^2-VLA: Adaptive RL Latent Compositional Steering with Test-Time Scaling for Vision-Language-Action Models](https://huggingface.co/papers/2607.26991) [Upvote: 4] Despite the impressive visuomotor capabilities enabled by Vision-Language-Action (VLA) models, their performance often degrades on challenging and out-of-domain tasks. [Multimodal Agents]
  ...
  - Submitted by: Derek Tan Ming Siang | Upvotes: 4 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2607.26991) / [arXiv](https://arxiv.org/pdf/2607.26991) / [Cool](https://papers.cool/arxiv/2607.26991)
  - <details>
    <summary>Abstract</summary>
