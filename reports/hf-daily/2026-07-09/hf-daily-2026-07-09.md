...
- The highest-voted visible paper is “Accurate, Interdisciplinary and Transparent Structure-property Understanding with Deep Native Structural Reasoning”, currently at 83 votes.
...
- [OPSD-V: On-Policy Self-Distillation for Post-Training Few-Step Autoregressive Video Generators](https://huggingface.co/papers/2607.08766) [Upvote: 8] We propose OPSD-V, an on-policy self-distillation paradigm for post-training few-step autoregressive (AR) video diffusion models. [Multimodal Understanding and Vision]
  - Authors: Hongyu Liu, Chun Wang, Feng Gao, Xuanhua He, Yue Ma, Ziyu Wan, Yong Zhang, Xiaoming Wei, Qifeng Chen
  - Submitted by: Hongyu LIU | Upvotes: 8 | Comments: 3
...
- [Infinite Worlds with Versatile Interactions](https://huggingface.co/papers/2607.07534) [Upvote: 28] We present LingBot-World 2.0 (also known as LingBot-World-Infinity), an advanced iteration of LingBot-World featuring four distinct upgrades. (1) Our model achieves an unbounded interaction horizon while maintaining… [Other AI]
  ...
  - Submitted by: taesiri | Upvotes: 28 | Comments: 1
...
- [WildCity: A Real-World City-Scale Testbed for Rendering, Simulation, and Spatial Intelligence](https://huggingface.co/papers/2607.06838) [Upvote: 8] Humans can navigate an unfamiliar city and gradually form a coherent spatial mental map spanning tens of square kilometers. [Other AI]
...
- [TESSERA v2: Scaling Pixel-wise Earth Foundation Models](https://huggingface.co/papers/2607.03949) [Upvote: 2] Pixel-wise Earth-observation (EO) foundation models are now achieving state-of-the-art performance via generated spatial embeddings. [Other AI]
  ...
  - Submitted by: Frank Feng | Upvotes: 2 | Comments: 2
...
- [Scaling Mixture-of-Experts Video Pretraining for Embodied Intelligence](https://huggingface.co/papers/2607.07675) [Upvote: 45] Despite the recent promise in robot control, video generative models suffer from a domain mismatch due to their primary focus on content creation. [Robotics and Embodied AI]
  ...
  - Submitted by: taesiri | Upvotes: 45 | Comments: 1
...
- [RoboDojo: A Unified Sim-and-Real Benchmark for Comprehensive Evaluation of Generalist Robot Manipulation Policies](https://huggingface.co/papers/2607.04434) [Upvote: 11] Generalist robot manipulation policies have advanced rapidly, yet existing benchmarks remain limited in systematically evaluating their capabilities. [Robotics and Embodied AI]
  ...
  - Submitted by: Tianxing Chen | Upvotes: 11 | Comments: 2
...
- [RoboTALES: Learning Reasoning-Guided Robot Policies via Task-Aligned Simulated Futures](https://huggingface.co/papers/2607.06018) [Upvote: 4] Pretrained video generative models are promising backbones for visuomotor control, but their imagined futures often drift from task intent and are not reliably action-conditional. [Robotics and Embodied AI]
  - Authors: Hanan Gani, Tejal Kulkarni, Madhoolika Chodavarapu, Nicklas Hansen, Manmohan Chandraker
  - Submitted by: Hanan Gani | Upvotes: 4 | Comments: 2
...
- [Automating the Design of Embodied Agent Architectures](https://huggingface.co/papers/2606.30111) [Upvote: 9] Embodied agents are typically built as hand-designed compositions of perception, memory, planning, and action modules. [Agents and Planning]
  - Authors: Jian Zhou, Sihao Lin, Jin Li, Shuai Fu, Gengze Zhou, Qi Wu
  - Submitted by: Zhou | Upvotes: 9 | Comments: 2
...
- [AgentLens: Production-Assessed Trajectory Reviews for Coding Agent Evaluation](https://huggingface.co/papers/2607.06624) [Upvote: 7] We present AgentLens, a production-assessed benchmark for interactive code agents. [Agents and Planning]
  - Authors: Andrey Podivilov, Vadim Lomshakov, Sergey Savin, Matvei Startsev, Roman Pozharskiy, Maksim Parshin, Sergey Nikolenko
  - Submitted by: Vadim Lo | Upvotes: 7 | Comments: 2
...
- [Accurate, Interdisciplinary and Transparent Structure-property Understanding with Deep Native Structural Reasoning](https://huggingface.co/papers/2607.07708) [Upvote: 83] Structure-property relationships are foundational to biology, chemistry and materials science, where function, reactivity and physical response emerge from spatial, chemical and periodic organization. [Reasoning, Alignment, and Evaluation]
  ...
  - Submitted by: Jianyu Wu | Upvotes: 83 | Comments: 2
...
- [Wake up for Touch! Mask-isolated Tactile Alignment Learning in MLLMs](https://huggingface.co/papers/2607.00302) [Upvote: 2] Touch supplies the physical grounding needed to perceive intrinsic material properties, such as friction and compliance, that vision alone often cannot resolve. [Reasoning, Alignment, and Evaluation]
  - Authors: Yoonhyung Park, Minji Kim, Sungwon Moon, Jiyoung Lee
  - Submitted by: 김민지 | Upvotes: 2 | Comments: 2
...
- [Teaching LLMs a Low-Resource Language: Enhancing Code Completion in Pharo](https://huggingface.co/papers/2607.04939) [Upvote: 5] Large Language Models (LLMs) unlocked new possibilities in automated code writing, becoming the backbone of most code completion tools. [LLMs and Language]
  ...
  - Submitted by: Alessandro | Upvotes: 5 | Comments: 2
...
- [Single-Rollout Asynchronous Optimization for Agentic Reinforcement Learning](https://huggingface.co/papers/2607.07508) [Upvote: 13] Reinforcement learning (RL) is becoming increasingly important for post-training large language models (LLMs). [Learning, Optimization, and Theory]
...
- [Sparse Delta Memory: Scaling the State of Linear RNNs through Sparsity](https://huggingface.co/papers/2607.07386) [Upvote: 10] Linear attention models allow a fixed state size and a fixed amount of compute per token. [Retrieval, Knowledge, and RAG]
  ...
  - Submitted by: Niels Rogge | Upvotes: 10 | Comments: 2
