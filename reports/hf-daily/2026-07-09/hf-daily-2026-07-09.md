# Hugging Face Daily Papers Report (2026-07-09)

- Source: https://huggingface.co/papers/date/2026-07-09
- Classifier: rule
- Total Papers: 18

## Today's Hotspots and Trend

- Multimodal Understanding and Vision: 3 papers (16.67%); representative paper: OPSD-V: On-Policy Self-Distillation for Post-Training Few-Step Autoregressive Video Generators.
- Other AI: 3 papers (16.67%); representative paper: Infinite Worlds with Versatile Interactions.
- Robotics and Embodied AI: 3 papers (16.67%); representative paper: Scaling Mixture-of-Experts Video Pretraining for Embodied Intelligence.
- Trend: Today's dominant clusters are Multimodal Understanding and Vision / Other AI / Robotics and Embodied AI; this suggests several parallel trends: multimodal work is moving from isolated perception toward generation, agents, and action; embodied-AI work is increasingly tied to vision-language-action models and real-world control. The strongest visible attention is on “Accurate, Interdisciplinary and Transparent Structure-property Understanding with Deep Native Structural Reasoning” (76 upvotes).

## Focus Topics

- Generative Foundations: 0 papers (0.00%)
- Multimodal Generative Modeling: 0 papers (0.00%)
- Multimodal Agents: 1 papers (5.56%)

## Topic Distribution

- Multimodal Understanding and Vision: 3 papers (16.67%)
- Other AI: 3 papers (16.67%)
- Robotics and Embodied AI: 3 papers (16.67%)
- Agents and Planning: 2 papers (11.11%)
- Reasoning, Alignment, and Evaluation: 2 papers (11.11%)
- Domain Applications: 1 papers (5.56%)
- LLMs and Language: 1 papers (5.56%)
- Learning, Optimization, and Theory: 1 papers (5.56%)
- Multimodal Agents: 1 papers (5.56%)
- Retrieval, Knowledge, and RAG: 1 papers (5.56%)

## Top Submitters

- taesiri: 3 papers
- Niels Rogge: 2 papers
- Alessandro: 1 papers
- Aysan Ghayouri: 1 papers
- Finn Rasmus Schäfer: 1 papers
- Frank Feng: 1 papers

## Brief Notes

- The top topic today is “Multimodal Understanding and Vision”, with 3 papers, accounting for 16.67%。
- The most active submitter is taesiri， with 3 papers。
- The highest-voted visible paper is “Accurate, Interdisciplinary and Transparent Structure-property Understanding with Deep Native Structural Reasoning”, currently at 76 votes.
- Today's dominant clusters are Multimodal Understanding and Vision / Other AI / Robotics and Embodied AI; this suggests several parallel trends: multimodal work is moving from isolated perception toward generation, agents, and action; embodied-AI work is increasingly tied to vision-language-action models and real-world control. The strongest visible attention is on “Accurate, Interdisciplinary and Transparent Structure-property Understanding with Deep Native Structural Reasoning” (76 upvotes).

## Categorized Paper Briefs

### Multimodal Understanding and Vision (3 papers)

- [OPSD-V: On-Policy Self-Distillation for Post-Training Few-Step Autoregressive Video Generators](https://huggingface.co/papers/2607.08766) [Upvote: 5] We propose OPSD-V, an on-policy self-distillation paradigm for post-training few-step autoregressive (AR) video diffusion models. [Multimodal Understanding and Vision]
  - Authors: Hongyu Liu, Chun Wang, Feng Gao, Xuanhua He, Yue Ma, Ziyu Wan, Yong Zhang, Xiaoming Wei, Qifeng Chen
  - Submitted by: Hongyu LIU | Upvotes: 5 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2607.08766) / [arXiv](https://arxiv.org/pdf/2607.08766) / [Cool](https://papers.cool/arxiv/2607.08766)
  - <details>
...
- [OmniTacTune: Policy-Agnostic Real-World RL for Tactile Residual Adaptation of Visual Policies](https://huggingface.co/papers/2607.03723) [Upvote: 4] Visual policies learned from human videos, teleoperation, and robot demonstrations offer scalable motion priors, but often fail in contact-rich manipulation, where success significantly depends on local force and… [Multimodal Understanding and Vision]
  - Authors: Kelin Yu, Haode Zhang, Harish Ravichandar, Yunhai Han, Ruohan Gao
  - Submitted by: Kelin Yu | Upvotes: 4 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2607.03723) / [arXiv](https://arxiv.org/pdf/2607.03723) / [Cool](https://papers.cool/arxiv/2607.03723)
  - <details>
    <summary>Abstract</summary>
...
- [Token-Based Dual-view Fusion and Adaptation of Large Vision Models for Breast Cancer Classification](https://huggingface.co/papers/2607.06309) [Upvote: 1] Accurate breast cancer classification from mammography requires effective integration of complementary information from craniocaudal (CC) and mediolateral oblique (MLO) views, which provide a more complete… [Multimodal Understanding and Vision]
  - Authors: Aysan Ghayouri Pirsoltan, Shima Babakordi, Mohammad Reza Mohammadi
  - Submitted by: Aysan Ghayouri | Upvotes: 1 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2607.06309) / [arXiv](https://arxiv.org/pdf/2607.06309) / [Cool](https://papers.cool/arxiv/2607.06309)
  - <details>
    <summary>Abstract</summary>
...
- [Infinite Worlds with Versatile Interactions](https://huggingface.co/papers/2607.07534) [Upvote: 24] We present LingBot-World 2.0 (also known as LingBot-World-Infinity), an advanced iteration of LingBot-World featuring four distinct upgrades. (1) Our model achieves an unbounded interaction horizon while maintaining… [Other AI]
  ...
  - Links: [HF](https://huggingface.co/papers/2607.07534) / [arXiv](https://arxiv.org/pdf/2607.07534) / [Cool](https://papers.cool/arxiv/2607.07534)
  - <details>
    <summary>Abstract</summary>
...
- [WildCity: A Real-World City-Scale Testbed for Rendering, Simulation, and Spatial Intelligence](https://huggingface.co/papers/2607.06838) [Upvote: 5] Humans can navigate an unfamiliar city and gradually form a coherent spatial mental map spanning tens of square kilometers. [Other AI]
  ...
  - Links: [HF](https://huggingface.co/papers/2607.06838) / [arXiv](https://arxiv.org/pdf/2607.06838) / [Cool](https://papers.cool/arxiv/2607.06838)
  - <details>
    <summary>Abstract</summary>
...
- [TESSERA v2: Scaling Pixel-wise Earth Foundation Models](https://huggingface.co/papers/2607.03949) [Upvote: 1] Pixel-wise Earth-observation (EO) foundation models are now achieving state-of-the-art performance via generated spatial embeddings. [Other AI]
  ...
  - Submitted by: Frank Feng | Upvotes: 1 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2607.03949) / [arXiv](https://arxiv.org/pdf/2607.03949) / [Cool](https://papers.cool/arxiv/2607.03949)
  - <details>
    <summary>Abstract</summary>
...
- [Scaling Mixture-of-Experts Video Pretraining for Embodied Intelligence](https://huggingface.co/papers/2607.07675) [Upvote: 40] Despite the recent promise in robot control, video generative models suffer from a domain mismatch due to their primary focus on content creation. [Robotics and Embodied AI]
  ...
  - Submitted by: taesiri | Upvotes: 40 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2607.07675) / [arXiv](https://arxiv.org/pdf/2607.07675) / [Cool](https://papers.cool/arxiv/2607.07675)
  - <details>
    <summary>Abstract</summary>
...
- [RoboDojo: A Unified Sim-and-Real Benchmark for Comprehensive Evaluation of Generalist Robot Manipulation Policies](https://huggingface.co/papers/2607.04434) [Upvote: 8] Generalist robot manipulation policies have advanced rapidly, yet existing benchmarks remain limited in systematically evaluating their capabilities. [Robotics and Embodied AI]
  ...
  - Submitted by: Tianxing Chen | Upvotes: 8 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2607.04434) / [arXiv](https://arxiv.org/pdf/2607.04434) / [Cool](https://papers.cool/arxiv/2607.04434)
  - <details>
    <summary>Abstract</summary>
...
- [RoboTALES: Learning Reasoning-Guided Robot Policies via Task-Aligned Simulated Futures](https://huggingface.co/papers/2607.06018) [Upvote: 3] Pretrained video generative models are promising backbones for visuomotor control, but their imagined futures often drift from task intent and are not reliably action-conditional. [Robotics and Embodied AI]
  - Authors: Hanan Gani, Tejal Kulkarni, Madhoolika Chodavarapu, Nicklas Hansen, Manmohan Chandraker
  - Submitted by: Hanan Gani | Upvotes: 3 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2607.06018) / [arXiv](https://arxiv.org/pdf/2607.06018) / [Cool](https://papers.cool/arxiv/2607.06018)
  - <details>
    <summary>Abstract</summary>
...
- [Automating the Design of Embodied Agent Architectures](https://huggingface.co/papers/2606.30111) [Upvote: 7] Embodied agents are typically built as hand-designed compositions of perception, memory, planning, and action modules. [Agents and Planning]
  - Authors: Jian Zhou, Sihao Lin, Jin Li, Shuai Fu, Gengze Zhou, Qi Wu
  - Submitted by: Zhou | Upvotes: 7 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2606.30111) / [arXiv](https://arxiv.org/pdf/2606.30111) / [Cool](https://papers.cool/arxiv/2606.30111)
  - <details>
    <summary>Abstract</summary>
...
- [AgentLens: Production-Assessed Trajectory Reviews for Coding Agent Evaluation](https://huggingface.co/papers/2607.06624) [Upvote: 6] We present AgentLens, a production-assessed benchmark for interactive code agents. [Agents and Planning]
  - Authors: Andrey Podivilov, Vadim Lomshakov, Sergey Savin, Matvei Startsev, Roman Pozharskiy, Maksim Parshin, Sergey Nikolenko
  - Submitted by: Vadim Lo | Upvotes: 6 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2607.06624) / [arXiv](https://arxiv.org/pdf/2607.06624) / [Cool](https://papers.cool/arxiv/2607.06624)
  - <details>
    <summary>Abstract</summary>
...
- [Accurate, Interdisciplinary and Transparent Structure-property Understanding with Deep Native Structural Reasoning](https://huggingface.co/papers/2607.07708) [Upvote: 76] Structure-property relationships are foundational to biology, chemistry and materials science, where function, reactivity and physical response emerge from spatial, chemical and periodic organization. [Reasoning, Alignment, and Evaluation]
  ...
  - Submitted by: Jianyu Wu | Upvotes: 76 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2607.07708) / [arXiv](https://arxiv.org/pdf/2607.07708) / [Cool](https://papers.cool/arxiv/2607.07708)
  - <details>
    <summary>Abstract</summary>
...
- [Wake up for Touch! Mask-isolated Tactile Alignment Learning in MLLMs](https://huggingface.co/papers/2607.00302) [Upvote: 1] Touch supplies the physical grounding needed to perceive intrinsic material properties, such as friction and compliance, that vision alone often cannot resolve. [Reasoning, Alignment, and Evaluation]
  - Authors: Yoonhyung Park, Minji Kim, Sungwon Moon, Jiyoung Lee
  - Submitted by: 김민지 | Upvotes: 1 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2607.00302) / [arXiv](https://arxiv.org/pdf/2607.00302) / [Cool](https://papers.cool/arxiv/2607.00302)
  - <details>
    <summary>Abstract</summary>
...
- [Imagined Rollouts are Kinematic, Not Dynamic: A Diagnosis of Long-Horizon World-Model Failure](https://huggingface.co/papers/2607.05966) [Upvote: 1] Long-horizon failure in world models is conventionally attributed to compounding error, a generic framing that does not distinguish what kind of error compounds. [Domain Applications]
  - Authors: Finn Rasmus Schäfer, Korbinian Moller, Yuan Gao, Christian Oefinger, Sebastian Schmidt, Johannes Betz
  - Submitted by: Finn Rasmus Schäfer | Upvotes: 1 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2607.05966) / [arXiv](https://arxiv.org/pdf/2607.05966) / [Cool](https://papers.cool/arxiv/2607.05966)
  - <details>
    <summary>Abstract</summary>
...
- [Teaching LLMs a Low-Resource Language: Enhancing Code Completion in Pharo](https://huggingface.co/papers/2607.04939) [Upvote: 2] Large Language Models (LLMs) unlocked new possibilities in automated code writing, becoming the backbone of most code completion tools. [LLMs and Language]
  ...
  - Submitted by: Alessandro | Upvotes: 2 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2607.04939) / [arXiv](https://arxiv.org/pdf/2607.04939) / [Cool](https://papers.cool/arxiv/2607.04939)
  - <details>
    <summary>Abstract</summary>
...
- [Single-Rollout Asynchronous Optimization for Agentic Reinforcement Learning](https://huggingface.co/papers/2607.07508) [Upvote: 9] Reinforcement learning (RL) is becoming increasingly important for post-training large language models (LLMs). [Learning, Optimization, and Theory]
  - Authors: Zhenyu Hou, Yujiang Li, Jie Tang, Yuxiao Dong
  - Submitted by: Niels Rogge | Upvotes: 9 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2607.07508) / [arXiv](https://arxiv.org/pdf/2607.07508) / [Cool](https://papers.cool/arxiv/2607.07508)
  - <details>
    <summary>Abstract</summary>
...
- [Dual Latent Memory in Vision-Language-Action Models for Robotic Manipulation](https://huggingface.co/papers/2607.07608) [Upvote: 48] Mainstream Vision-Language-Action (VLA) models predict actions primarily from the current observation under a Markovian assumption, thus struggling with long-horizon, temporally dependent tasks. [Multimodal Agents]
  - Authors: Hongyu Qu, Jianzhe Gao, Xiaobin Hu, Shaohuan Yang, Xinlei Yu, Rui Yan, Wenguan Wang, Xiangbo Shu, Shuicheng Yan
  - Submitted by: neil yu | Upvotes: 48 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2607.07608) / [arXiv](https://arxiv.org/pdf/2607.07608) / [Cool](https://papers.cool/arxiv/2607.07608)
  - <details>
    <summary>Abstract</summary>
...
- [Sparse Delta Memory: Scaling the State of Linear RNNs through Sparsity](https://huggingface.co/papers/2607.07386) [Upvote: 7] Linear attention models allow a fixed state size and a fixed amount of compute per token. [Retrieval, Knowledge, and RAG]
  ...
  - Links: [HF](https://huggingface.co/papers/2607.07386) / [arXiv](https://arxiv.org/pdf/2607.07386) / [Cool](https://papers.cool/arxiv/2607.07386)
  - <details>
    <summary>Abstract</summary>
