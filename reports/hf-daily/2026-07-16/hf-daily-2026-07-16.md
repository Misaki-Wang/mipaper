# Hugging Face Daily Papers Report (2026-07-16)

- Source: https://huggingface.co/papers/date/2026-07-16
- Classifier: rule
- Total Papers: 24

## Today's Hotspots and Trend

- Agents and Planning: 6 papers (25.00%); representative paper: Harness Handbook: Making Evolving Agent Harnesses Readable,Navigable, and Editable.
- Other AI: 6 papers (25.00%); representative paper: OvisOCR2 Technical Report.
- Multimodal Understanding and Vision: 5 papers (20.83%); representative paper: Boogu-Image-0.1: Boosting Open-Source Unified Multimodal Understanding and Generation.
- Trend: Today's dominant clusters are Agents and Planning / Other AI / Multimodal Understanding and Vision; this suggests several parallel trends: multimodal work is moving from isolated perception toward generation, agents, and action; agent papers emphasize tool use, planning, and deployable workflows. The strongest visible attention is on “Harness Handbook: Making Evolving Agent Harnesses Readable,Navigable, and Editable” (186 upvotes).
...
- Agents and Planning: 6 papers (25.00%)
- Other AI: 6 papers (25.00%)
- Multimodal Understanding and Vision: 5 papers (20.83%)
- LLMs and Language: 2 papers (8.33%)
- Robotics and Embodied AI: 2 papers (8.33%)
- Learning, Optimization, and Theory: 1 papers (4.17%)
- Reasoning, Alignment, and Evaluation: 1 papers (4.17%)
- Retrieval, Knowledge, and RAG: 1 papers (4.17%)

## Top Submitters

- taesiri: 2 papers
- Bryce: 1 papers
- Hongbo Wang: 1 papers
- Hongru Cai: 1 papers
- JeffWang: 1 papers
- Jiahang Xu: 1 papers
...
- The top topic today is “Agents and Planning”, with 6 papers, accounting for 25.00%。
- The most active submitter is taesiri， with 2 papers。
- The highest-voted visible paper is “Harness Handbook: Making Evolving Agent Harnesses Readable,Navigable, and Editable”, currently at 186 votes.
- Today's dominant clusters are Agents and Planning / Other AI / Multimodal Understanding and Vision; this suggests several parallel trends: multimodal work is moving from isolated perception toward generation, agents, and action; agent papers emphasize tool use, planning, and deployable workflows. The strongest visible attention is on “Harness Handbook: Making Evolving Agent Harnesses Readable,Navigable, and Editable” (186 upvotes).

## Categorized Paper Briefs

### Agents and Planning (6 papers)

- [Harness Handbook: Making Evolving Agent Harnesses Readable,Navigable, and Editable](https://huggingface.co/papers/2607.13285) [Upvote: 186] The capability of a modern AI agent depends not only on its foundation model but also on its harness, which constructs prompts, manages state, invokes tools, and coordinates execution. [Agents and Planning]
  ...
  - Submitted by: taesiri | Upvotes: 186 | Comments: 4
  - Links: [HF](https://huggingface.co/papers/2607.13285) / [arXiv](https://arxiv.org/pdf/2607.13285) / [Cool](https://papers.cool/arxiv/2607.13285)
  - <details>
...
- [AgentCompass: A Unified Evaluation Infrastructure for Agent Capabilities](https://huggingface.co/papers/2607.13705) [Upvote: 34] As Large Language Models (LLMs) evolve into autonomous agents, the need for unified evaluation infrastructure becomes critical. [Agents and Planning]
  ...
  - Submitted by: Shufan Jiang | Upvotes: 34 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2607.13705) / [arXiv](https://arxiv.org/pdf/2607.13705) / [Cool](https://papers.cool/arxiv/2607.13705)
  - <details>
    <summary>Abstract</summary>
...
- [Self-Improvements in Modern Agentic Systems: A Survey](https://huggingface.co/papers/2607.13104) [Upvote: 21] Self-improving autonomous agents are moving from research prototypes to deployed systems. [Agents and Planning]
  ...
  - Submitted by: Zhe Ren | Upvotes: 21 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2607.13104) / [arXiv](https://arxiv.org/pdf/2607.13104) / [Cool](https://papers.cool/arxiv/2607.13104)
  - <details>
    <summary>Abstract</summary>
...
- [Tracing Agentic Failure from the Flow of Success](https://huggingface.co/papers/2607.12747) [Upvote: 12] Failure attribution for LLM-based agentic systems, i.e., identifying which steps in a failure trajectory caused the task to fail, is critical for debugging and improving these systems. [Agents and Planning]
  - Authors: Samuel Yeh, Yiwen Zhu, Shaleen Deep, Sharon Li
  - Submitted by: Min-Hsuan Yeh | Upvotes: 12 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2607.12747) / [arXiv](https://arxiv.org/pdf/2607.12747) / [Cool](https://papers.cool/arxiv/2607.12747)
  - <details>
    <summary>Abstract</summary>
...
- [PalmClaw: A Native On-Device Agent Framework for Mobile Phones](https://huggingface.co/papers/2607.13027) [Upvote: 8] Large Language Model (LLM) agents have moved beyond generating responses to executing multi-step tasks by calling tools, observing the results, and iteratively deciding the next action. [Agents and Planning]
  - Authors: Hongru Cai, Yongqi Li, Ran Wei, Wenjie Li
  - Submitted by: Hongru Cai | Upvotes: 8 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2607.13027) / [arXiv](https://arxiv.org/pdf/2607.13027) / [Cool](https://papers.cool/arxiv/2607.13027)
  - <details>
    <summary>Abstract</summary>
...
- [From Controlled to the Wild: Evaluation of Pentesting Agents for the Real-World](https://huggingface.co/papers/2605.10834) [Upvote: 4] AI pentesting agents are increasingly credible as offensive security systems, but current benchmarks still provide limited guidance on which will perform best in real-world targets. [Agents and Planning]
  - Authors: Pedro Conde, Henrique Branquinho, Valerio Mazzone, Bruno Mendes, André Baptista, Nuno Moniz
  - Submitted by: Pedro Conde | Upvotes: 4 | Comments: 3
  - Links: [HF](https://huggingface.co/papers/2605.10834) / [arXiv](https://arxiv.org/pdf/2605.10834) / [Cool](https://papers.cool/arxiv/2605.10834)
  - <details>
    <summary>Abstract</summary>
...
- [OvisOCR2 Technical Report](https://huggingface.co/papers/2607.13639) [Upvote: 46] We introduce OvisOCR2, a 0.8B document parsing model. [Other AI]
  ...
  - Submitted by: taesiri | Upvotes: 46 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2607.13639) / [arXiv](https://arxiv.org/pdf/2607.13639) / [Cool](https://papers.cool/arxiv/2607.13639)
  - <details>
    <summary>Abstract</summary>
...
- [MetaView: Monocular Novel View Synthesis with Scale-Aware Implicit Geometry Priors](https://huggingface.co/papers/2607.12000) [Upvote: 29] Current visual generation models are capable of producing high-quality content, yet they lack a coherent perception of the spatial structure. [Other AI]
  - Authors: Yufei Cai, Xuesong Niu, Hao Lu, Kun Gai, Kai Wu, Guosheng Lin
  - Submitted by: Wu Kai | Upvotes: 29 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2607.12000) / [arXiv](https://arxiv.org/pdf/2607.12000) / [Cool](https://papers.cool/arxiv/2607.12000)
  - <details>
    <summary>Abstract</summary>
...
- [GigaWorld-Policy-0.5: A Faster and Stronger WAM Empowered by AutoResearch](https://huggingface.co/papers/2607.13960) [Upvote: 25] World Action Models (WAMs) improve robot policy learning by jointly modeling actions and future visual observations, using future scene evolution as dense supervision for physically grounded action generation. [Other AI]
  ...
  - Submitted by: JeffWang | Upvotes: 25 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2607.13960) / [arXiv](https://arxiv.org/pdf/2607.13960) / [Cool](https://papers.cool/arxiv/2607.13960)
  - <details>
    <summary>Abstract</summary>
...
- [Vinci2: Providing Proactive Assistance in Continuous Egocentric Videos](https://huggingface.co/papers/2607.11523) [Upvote: 10] When should an intelligent assistant speak up without being asked? [Other AI]
  - Authors: Gong Sitong, Tianyu Yan, Caixin Kang, Bo Zheng, Xiang Ruan, Huchuan Lu, Kaipeng Zhang, Yoichi Sato, Yifei Huang
  - Submitted by: Tim Kang | Upvotes: 10 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2607.11523) / [arXiv](https://arxiv.org/pdf/2607.11523) / [Cool](https://papers.cool/arxiv/2607.11523)
  - <details>
    <summary>Abstract</summary>
...
- [Length Penalties Make Chain-of-Thought Less Monitorable](https://huggingface.co/papers/2607.09786) [Upvote: 6] Length-penalized reinforcement learning can shorten chain-of-thought reasoning while hiding an influence that drives the model's answer. [Other AI]
  - Authors: Bryce Little
  - Submitted by: Bryce | Upvotes: 6 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2607.09786) / [arXiv](https://arxiv.org/pdf/2607.09786) / [Cool](https://papers.cool/arxiv/2607.09786)
  - <details>
    <summary>Abstract</summary>
...
- [AffectFlow-DINO: Uncertainty-Aware Multi-Task Affect Estimation via Conditional Rectified Flow](https://huggingface.co/papers/2607.13250) [Upvote: 3] We present AffectFlow-DINO, a multi-task learning system for the 11th ABAW challenge that extends a standard deterministic architecture with a conditional rectified-flow head to model the inherent ambiguity of… [Other AI]
  - Authors: Salah Eddine Bekhouche, Abdellah Zakaria Sellam, Fadi Dornaika, Abdenour Hadid
  - Submitted by: Salah Eddine Bekhouche | Upvotes: 3 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2607.13250) / [arXiv](https://arxiv.org/pdf/2607.13250) / [Cool](https://papers.cool/arxiv/2607.13250)
  - <details>
    <summary>Abstract</summary>
...
- [Boogu-Image-0.1: Boosting Open-Source Unified Multimodal Understanding and Generation](https://huggingface.co/papers/2607.13125) [Upvote: 122] We introduce Boogu-Image-0.1, an open-source unified multimodal understanding and generation model family, comprising Base, Turbo, Edit, and Edit-Turbo variants. [Multimodal Understanding and Vision]
  ...
  - Submitted by: X | Upvotes: 122 | Comments: 3
  - Links: [HF](https://huggingface.co/papers/2607.13125) / [arXiv](https://arxiv.org/pdf/2607.13125) / [Cool](https://papers.cool/arxiv/2607.13125)
  - <details>
    <summary>Abstract</summary>
...
- [PolicyShiftGuard: Benchmarking and Improving Policy-Adaptive Image Guardrails](https://huggingface.co/papers/2607.05910) [Upvote: 35] Image guardrails are typically trained and evaluated under a fixed safety policy, implicitly treating safety as an intrinsic property of an image. [Multimodal Understanding and Vision]
  - Authors: Mingyang Song, Luxin Xu, Haoyu Sun, Minzhou Pan, Yu Cheng, Bo Li
  - Submitted by: Mingyang Song | Upvotes: 35 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2607.05910) / [arXiv](https://arxiv.org/pdf/2607.05910) / [Cool](https://papers.cool/arxiv/2607.05910)
  - <details>
    <summary>Abstract</summary>
...
- [Registers Matter for Pixel-Space Diffusion Transformers](https://huggingface.co/papers/2605.16147) [Upvote: 21] Vision Transformers (ViTs) are known to exhibit high-norm patch-token outliers that degrade feature map quality, a problem effectively mitigated by register tokens. [Multimodal Understanding and Vision]
  - Authors: Nikita Starodubcev, Ilia Sudakov, Ilya Drobyshevskiy, Artem Babenko, Dmitry Baranchuk
  - Submitted by: nikita | Upvotes: 21 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2605.16147) / [arXiv](https://arxiv.org/pdf/2605.16147) / [Cool](https://papers.cool/arxiv/2605.16147)
  - <details>
    <summary>Abstract</summary>
...
- [Hallo4D: Multi-Modal Hallucination Mitigation for Consistent Spatio-Temporal Generation](https://huggingface.co/papers/2607.12752) [Upvote: 14] While recent advances in 3D generation have enabled impressive visual synthesis, existing methods often rely on 2D diffusion supervision without explicit mechanisms for geometric consistency, leading to spatial… [Multimodal Understanding and Vision]
  - Authors: Hongbo Wang, Huaibo Huang, Jie Cao, Jin Liu, Haoyang Tong, Ran He
  - Submitted by: Hongbo Wang | Upvotes: 14 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2607.12752) / [arXiv](https://arxiv.org/pdf/2607.12752) / [Cool](https://papers.cool/arxiv/2607.12752)
  - <details>
    <summary>Abstract</summary>
...
- [Discrete Diffusion Models: A Unified Framework from Tokenization to Generation](https://huggingface.co/papers/2607.13431) [Upvote: 13] Discrete denoising diffusion models (DDMs) have recently emerged as a compelling alternative to autoregressive (AR) modeling for discrete data, offering parallel generation and iterative global refinement capabilities. [Multimodal Understanding and Vision]
  ...
  - Submitted by: Ye Yuan | Upvotes: 13 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2607.13431) / [arXiv](https://arxiv.org/pdf/2607.13431) / [Cool](https://papers.cool/arxiv/2607.13431)
  - <details>
    <summary>Abstract</summary>
...
- [ShortOPD: Recovering Pruned LLMs with Short-to-Long On-Policy Distillation](https://huggingface.co/papers/2607.13124) [Upvote: 15] Structured pruning is a hardware-friendly way to compress LLMs, but it is mostly validated on multiple-choice recognition tasks, while the same compressed checkpoints can collapse on the free-form generation that… [LLMs and Language]
  - Authors: Qingyu Zhang, Qianhao Yuan, Hongyu Lin, Yaojie Lu, Xianpei Han, Le Sun, Xiang Li, Ming Xu, Jiarui Li, Xiuyin Zhao
  - Submitted by: Qingyu Zhang | Upvotes: 15 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2607.13124) / [arXiv](https://arxiv.org/pdf/2607.13124) / [Cool](https://papers.cool/arxiv/2607.13124)
  - <details>
    <summary>Abstract</summary>
...
- [Generative Compilation: On-the-Fly Compiler Feedback as AI Generates Code](https://huggingface.co/papers/2607.13921) [Upvote: 4] Languages with rich static semantics, such as Rust, provide stronger guarantees for AI-generated code, but their strictness makes generation more difficult. [LLMs and Language]
  - Authors: Niels Mündler-Sasahara, Hristo Venev, Dawn Song, Martin Vechev, Jingxuan He
  - Submitted by: Niels | Upvotes: 4 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2607.13921) / [arXiv](https://arxiv.org/pdf/2607.13921) / [Cool](https://papers.cool/arxiv/2607.13921)
  - <details>
    <summary>Abstract</summary>
...
- [Self in Space: Benchmarking Self-Awareness and Spatial Cognition in UAV Embodied Intelligence](https://huggingface.co/papers/2607.12477) [Upvote: 6] Autonomous UAV systems increasingly rely on multimodal large language models (MLLMs) to operate in complex real-world environments. [Robotics and Embodied AI]
  - Authors: Zhishan Zou, Guoyan Sun, Zhiwei Wei, Jiancheng Pan, Yujie Li, Mugen Peng, Wenjia Xu
  - Submitted by: choucisan | Upvotes: 6 | Comments: 5
  - Links: [HF](https://huggingface.co/papers/2607.12477) / [arXiv](https://arxiv.org/pdf/2607.12477) / [Cool](https://papers.cool/arxiv/2607.12477)
  - <details>
    <summary>Abstract</summary>
...
- [SPEAR: A Simulator for Photorealistic Embodied AI Research](https://huggingface.co/papers/2607.06701) [Upvote: 5] Interactive simulators have become powerful tools for training embodied agents and generating synthetic visual data, but existing photorealistic simulators suffer from limited generality, programmability, and… [Robotics and Embodied AI]
  ...
  - Submitted by: Mike Roberts | Upvotes: 5 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2607.06701) / [arXiv](https://arxiv.org/pdf/2607.06701) / [Cool](https://papers.cool/arxiv/2607.06701)
  - <details>
    <summary>Abstract</summary>
...
- [From Noisy Traces to Root Causes: Structural Trajectory Analysis and Causal Extraction for Agent Optimization](https://huggingface.co/papers/2607.07702) [Upvote: 7] The optimization of long-horizon agents increasingly relies on reflection-based mechanisms, where a large language model (LLM) acts as an optimizer to diagnose agent failures and improve agent policies. [Learning, Optimization, and Theory]
  - Authors: Ying Chang, Jiahang Xu, Xuan Feng, Chenyuan Yang, Peng Cheng, Yuqing Yang
  - Submitted by: Jiahang Xu | Upvotes: 7 | Comments: 3
  - Links: [HF](https://huggingface.co/papers/2607.07702) / [arXiv](https://arxiv.org/pdf/2607.07702) / [Cool](https://papers.cool/arxiv/2607.07702)
  - <details>
    <summary>Abstract</summary>
...
- [Ring-Zero: Scaling Zero RL to a Trillion Parameters for Emergent Reasoning](https://huggingface.co/papers/2607.12395) [Upvote: 84] Reinforcement learning with verifiable rewards without human-annotated data, often referred to as zero RL, has emerged as a powerful paradigm for eliciting chain-of-thought reasoning. [Reasoning, Alignment, and Evaluation]
  ...
  - Submitted by: txy | Upvotes: 84 | Comments: 3
  - Links: [HF](https://huggingface.co/papers/2607.12395) / [arXiv](https://arxiv.org/pdf/2607.12395) / [Cool](https://papers.cool/arxiv/2607.12395)
  - <details>
    <summary>Abstract</summary>
...
- [KnowAct-GUIClaw: Know Deeply, Act Perfectly, Personal GUI Assistant with Self-Evolving Memory and Skill](https://huggingface.co/papers/2607.12625) [Upvote: 52] OpenClaw has emerged as a leading agent framework for complex task automation, yet it faces insufficient cross-platform GUI interaction support and a well-built self-evolution mechanism. [Retrieval, Knowledge, and RAG]
  ...
  - Submitted by: Yunxin Li | Upvotes: 52 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2607.12625) / [arXiv](https://arxiv.org/pdf/2607.12625) / [Cool](https://papers.cool/arxiv/2607.12625)
  - <details>
    <summary>Abstract</summary>
