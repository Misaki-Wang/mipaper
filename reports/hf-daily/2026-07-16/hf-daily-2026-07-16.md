...
- The highest-voted visible paper is “Harness Handbook: Making Evolving Agent Harnesses Readable,Navigable, and Editable”, currently at 193 votes.
...
- [Harness Handbook: Making Evolving Agent Harnesses Readable,Navigable, and Editable](https://huggingface.co/papers/2607.13285) [Upvote: 193] The capability of a modern AI agent depends not only on its foundation model but also on its harness, which constructs prompts, manages state, invokes tools, and coordinates execution. [Agents and Planning]
  ...
  - Submitted by: taesiri | Upvotes: 193 | Comments: 4
...
- [AgentCompass: A Unified Evaluation Infrastructure for Agent Capabilities](https://huggingface.co/papers/2607.13705) [Upvote: 37] As Large Language Models (LLMs) evolve into autonomous agents, the need for unified evaluation infrastructure becomes critical. [Agents and Planning]
  ...
  - Submitted by: Shufan Jiang | Upvotes: 37 | Comments: 2
...
- [Self-Improvements in Modern Agentic Systems: A Survey](https://huggingface.co/papers/2607.13104) [Upvote: 23] Self-improving autonomous agents are moving from research prototypes to deployed systems. [Agents and Planning]
  ...
  - Submitted by: Zhe Ren | Upvotes: 23 | Comments: 2
...
- [Tracing Agentic Failure from the Flow of Success](https://huggingface.co/papers/2607.12747) [Upvote: 13] Failure attribution for LLM-based agentic systems, i.e., identifying which steps in a failure trajectory caused the task to fail, is critical for debugging and improving these systems. [Agents and Planning]
  - Authors: Samuel Yeh, Yiwen Zhu, Shaleen Deep, Sharon Li
  - Submitted by: Min-Hsuan Yeh | Upvotes: 13 | Comments: 2
...
- [From Controlled to the Wild: Evaluation of Pentesting Agents for the Real-World](https://huggingface.co/papers/2605.10834) [Upvote: 5] AI pentesting agents are increasingly credible as offensive security systems, but current benchmarks still provide limited guidance on which will perform best in real-world targets. [Agents and Planning]
  - Authors: Pedro Conde, Henrique Branquinho, Valerio Mazzone, Bruno Mendes, André Baptista, Nuno Moniz
  - Submitted by: Pedro Conde | Upvotes: 5 | Comments: 3
...
- [OvisOCR2 Technical Report](https://huggingface.co/papers/2607.13639) [Upvote: 48] We introduce OvisOCR2, a 0.8B document parsing model. [Other AI]
  ...
  - Submitted by: taesiri | Upvotes: 48 | Comments: 1
...
- [MetaView: Monocular Novel View Synthesis with Scale-Aware Implicit Geometry Priors](https://huggingface.co/papers/2607.12000) [Upvote: 31] Current visual generation models are capable of producing high-quality content, yet they lack a coherent perception of the spatial structure. [Other AI]
  - Authors: Yufei Cai, Xuesong Niu, Hao Lu, Kun Gai, Kai Wu, Guosheng Lin
  - Submitted by: Wu Kai | Upvotes: 31 | Comments: 2
...
- [GigaWorld-Policy-0.5: A Faster and Stronger WAM Empowered by AutoResearch](https://huggingface.co/papers/2607.13960) [Upvote: 26] World Action Models (WAMs) improve robot policy learning by jointly modeling actions and future visual observations, using future scene evolution as dense supervision for physically grounded action generation. [Other AI]
  ...
  - Submitted by: JeffWang | Upvotes: 26 | Comments: 2
...
- [Vinci2: Providing Proactive Assistance in Continuous Egocentric Videos](https://huggingface.co/papers/2607.11523) [Upvote: 11] When should an intelligent assistant speak up without being asked? [Other AI]
  - Authors: Gong Sitong, Tianyu Yan, Caixin Kang, Bo Zheng, Xiang Ruan, Huchuan Lu, Kaipeng Zhang, Yoichi Sato, Yifei Huang
  - Submitted by: Tim Kang | Upvotes: 11 | Comments: 2
...
- [Length Penalties Make Chain-of-Thought Less Monitorable](https://huggingface.co/papers/2607.09786) [Upvote: 7] Length-penalized reinforcement learning can shorten chain-of-thought reasoning while hiding an influence that drives the model's answer. [Other AI]
  - Authors: Bryce Little
  - Submitted by: Bryce | Upvotes: 7 | Comments: 2
...
- [Boogu-Image-0.1: Boosting Open-Source Unified Multimodal Understanding and Generation](https://huggingface.co/papers/2607.13125) [Upvote: 125] We introduce Boogu-Image-0.1, an open-source unified multimodal understanding and generation model family, comprising Base, Turbo, Edit, and Edit-Turbo variants. [Multimodal Understanding and Vision]
  ...
  - Submitted by: X | Upvotes: 125 | Comments: 3
...
- [Registers Matter for Pixel-Space Diffusion Transformers](https://huggingface.co/papers/2605.16147) [Upvote: 24] Vision Transformers (ViTs) are known to exhibit high-norm patch-token outliers that degrade feature map quality, a problem effectively mitigated by register tokens. [Multimodal Understanding and Vision]
  - Authors: Nikita Starodubcev, Ilia Sudakov, Ilya Drobyshevskiy, Artem Babenko, Dmitry Baranchuk
  - Submitted by: nikita | Upvotes: 24 | Comments: 1
...
- [Hallo4D: Multi-Modal Hallucination Mitigation for Consistent Spatio-Temporal Generation](https://huggingface.co/papers/2607.12752) [Upvote: 17] While recent advances in 3D generation have enabled impressive visual synthesis, existing methods often rely on 2D diffusion supervision without explicit mechanisms for geometric consistency, leading to spatial… [Multimodal Understanding and Vision]
  - Authors: Hongbo Wang, Huaibo Huang, Jie Cao, Jin Liu, Haoyang Tong, Ran He
  - Submitted by: Hongbo Wang | Upvotes: 17 | Comments: 2
...
- [Discrete Diffusion Models: A Unified Framework from Tokenization to Generation](https://huggingface.co/papers/2607.13431) [Upvote: 15] Discrete denoising diffusion models (DDMs) have recently emerged as a compelling alternative to autoregressive (AR) modeling for discrete data, offering parallel generation and iterative global refinement capabilities. [Multimodal Understanding and Vision]
  ...
  - Submitted by: Ye Yuan | Upvotes: 15 | Comments: 2
...
- [Generative Compilation: On-the-Fly Compiler Feedback as AI Generates Code](https://huggingface.co/papers/2607.13921) [Upvote: 5] Languages with rich static semantics, such as Rust, provide stronger guarantees for AI-generated code, but their strictness makes generation more difficult. [LLMs and Language]
  - Authors: Niels Mündler-Sasahara, Hristo Venev, Dawn Song, Martin Vechev, Jingxuan He
  - Submitted by: Niels | Upvotes: 5 | Comments: 2
...
- [Self in Space: Benchmarking Self-Awareness and Spatial Cognition in UAV Embodied Intelligence](https://huggingface.co/papers/2607.12477) [Upvote: 8] Autonomous UAV systems increasingly rely on multimodal large language models (MLLMs) to operate in complex real-world environments. [Robotics and Embodied AI]
  - Authors: Zhishan Zou, Guoyan Sun, Zhiwei Wei, Jiancheng Pan, Yujie Li, Mugen Peng, Wenjia Xu
  - Submitted by: OneThree | Upvotes: 8 | Comments: 5
...
- [SPEAR: A Simulator for Photorealistic Embodied AI Research](https://huggingface.co/papers/2607.06701) [Upvote: 6] Interactive simulators have become powerful tools for training embodied agents and generating synthetic visual data, but existing photorealistic simulators suffer from limited generality, programmability, and… [Robotics and Embodied AI]
  ...
  - Submitted by: Mike Roberts | Upvotes: 6 | Comments: 2
...
- [From Noisy Traces to Root Causes: Structural Trajectory Analysis and Causal Extraction for Agent Optimization](https://huggingface.co/papers/2607.07702) [Upvote: 8] The optimization of long-horizon agents increasingly relies on reflection-based mechanisms, where a large language model (LLM) acts as an optimizer to diagnose agent failures and improve agent policies. [Learning, Optimization, and Theory]
  - Authors: Ying Chang, Jiahang Xu, Xuan Feng, Chenyuan Yang, Peng Cheng, Yuqing Yang
  - Submitted by: Jiahang Xu | Upvotes: 8 | Comments: 3
...
- [Ring-Zero: Scaling Zero RL to a Trillion Parameters for Emergent Reasoning](https://huggingface.co/papers/2607.12395) [Upvote: 88] Reinforcement learning with verifiable rewards without human-annotated data, often referred to as zero RL, has emerged as a powerful paradigm for eliciting chain-of-thought reasoning. [Reasoning, Alignment, and Evaluation]
  ...
  - Submitted by: txy | Upvotes: 88 | Comments: 3
...
- [KnowAct-GUIClaw: Know Deeply, Act Perfectly, Personal GUI Assistant with Self-Evolving Memory and Skill](https://huggingface.co/papers/2607.12625) [Upvote: 53] OpenClaw has emerged as a leading agent framework for complex task automation, yet it faces insufficient cross-platform GUI interaction support and a well-built self-evolution mechanism. [Retrieval, Knowledge, and RAG]
  ...
  - Submitted by: Yunxin Li | Upvotes: 53 | Comments: 2
