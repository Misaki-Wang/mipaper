...
- Agents and Planning: 7 papers (30.43%); representative paper: OPID: On-Policy Skill Distillation for Agentic Reinforcement Learning.
- Other AI: 6 papers (26.09%); representative paper: DanceOPD: On-Policy Generative Field Distillation.
- Reasoning, Alignment, and Evaluation: 4 papers (17.39%); representative paper: LISA: Likelihood Score Alignment for Visual-condition Controllable Generation.
- Trend: Today's dominant clusters are Agents and Planning / Other AI / Reasoning, Alignment, and Evaluation; this suggests that agent papers emphasize tool use, planning, and deployable workflows. The strongest visible attention is on “DanceOPD: On-Policy Generative Field Distillation” (52 upvotes).
...
- Reasoning, Alignment, and Evaluation: 4 papers (17.39%)
...
- Robotics and Embodied AI: 1 papers (4.35%)
...
- The highest-voted visible paper is “DanceOPD: On-Policy Generative Field Distillation”, currently at 52 votes.
- Today's dominant clusters are Agents and Planning / Other AI / Reasoning, Alignment, and Evaluation; this suggests that agent papers emphasize tool use, planning, and deployable workflows. The strongest visible attention is on “DanceOPD: On-Policy Generative Field Distillation” (52 upvotes).

## Categorized Paper Briefs

### Agents and Planning (7 papers)

- [OPID: On-Policy Skill Distillation for Agentic Reinforcement Learning](https://huggingface.co/papers/2606.26790) [Upvote: 32] Outcome-based reinforcement learning provides a stable optimization backbone for language agents, but its sparse trajectory-level rewards provide little guidance on which intermediate decisions should be reinforced or… [Agents and Planning]
  ...
  - Submitted by: Jinyang Wu | Upvotes: 32 | Comments: 1
...
- [Qwen-Image-Agent: Bridging the Context Gap in Real-World Image Generation](https://huggingface.co/papers/2606.26907) [Upvote: 32] While text-to-image (T2I) models have achieved remarkable progress, they struggle with real-world requests that are often underspecified, implicit, or dependent on up-to-date knowledge. [Agents and Planning]
  ...
  - Submitted by: taesiri | Upvotes: 32 | Comments: 0
...
- [The Verification Horizon: No Silver Bullet for Coding Agent Rewards](https://huggingface.co/papers/2606.26300) [Upvote: 30] A classical intuition holds that verifying a solution is easier than producing one. [Agents and Planning]
  ...
  - Submitted by: zjj | Upvotes: 30 | Comments: 3
...
- [Running the Gauntlet: Re-evaluating the Capabilities of Agents Beyond Familiar Environments](https://huggingface.co/papers/2606.14397) [Upvote: 9] As agentic systems continue to evolve and are widely deployed in real-world scenarios, there is a growing demand to faithfully evaluate their capabilities. [Agents and Planning]
  ...
  - Submitted by: Runqi Lin | Upvotes: 9 | Comments: 1
...
- [OpenBioRQ: Unsolved Biomedical Research Questions for Agents](https://huggingface.co/papers/2606.21959) [Upvote: 1] A working citation looks like proof -- but the fact that a link resolves does not mean the cited paper supports the claim. [Agents and Planning]
  - Authors: Minbyul Jeong
  - Submitted by: Minbyul Jeong | Upvotes: 1 | Comments: 1
...
- [DanceOPD: On-Policy Generative Field Distillation](https://huggingface.co/papers/2606.27377) [Upvote: 52] Modern image generation demands a single model that unifies diverse capabilities, including text-to-image (T2I), local editing, and global editing. [Other AI]
  ...
  - Submitted by: taesiri | Upvotes: 52 | Comments: 2
...
- [JetSpec: Breaking the Scaling Ceiling of Speculative Decoding with Parallel Tree Drafting](https://huggingface.co/papers/2606.18394) [Upvote: 19] Speculative decoding (SD) accelerates autoregressive Large Language Models (LLMs) by drafting multiple tokens and verifying them in parallel, but it faces a scaling limitation: increasing the draft budget improves… [Other AI]
  ...
  - Submitted by: Lanxiang Hu | Upvotes: 19 | Comments: 1
...
- [Fast LeWorldModel](https://huggingface.co/papers/2606.26217) [Upvote: 10] Joint-Embedding Predictive Architectures (JEPAs), including recent LeWorldModel (LeWM), have become a promising foundation for reconstruction-free visual world models. [Other AI]
...
- [Discretizing Reward Models](https://huggingface.co/papers/2606.21795) [Upvote: 3] Despite their widespread use, the role of reward models in shaping reinforcement learning is poorly understood. [Other AI]
  - Authors: Vijay Viswanathan, Shiqi Wang, Devamanyu Hazarika, Chirag Nagpal, Tongshuang Wu, Graham Neubig, Yuning Mao
  - Submitted by: Vijay Viswanathan | Upvotes: 3 | Comments: 1
...
- [EO-WM: A Physically Informed World Model for Probabilistic Earth Observation Forecasting](https://huggingface.co/papers/2606.27277) [Upvote: 1] Earth Observation (EO) forecasting aims to predict future Earth surface dynamics from satellite observations under changing meteorological conditions. [Other AI]
  - Authors: Junwei Luo, Shuai Yuan, Zhenya Yang, Yansheng Li, Zhe Liu, Hengshuang Zhao
  - Submitted by: Junwei Luo | Upvotes: 1 | Comments: 1
...
- [COrigami: An AI Pipeline for Co-Designing Flat-Foldable Visually Recognisable Origami](https://huggingface.co/papers/2606.26299) [Upvote: 1] While generative AI has achieved remarkable success in solving problems with verifiable solutions, generating physical art that satisfies both strict geometric constraints and subjective visual aesthetics remains a… [Other AI]
...
- [LISA: Likelihood Score Alignment for Visual-condition Controllable Generation](https://huggingface.co/papers/2606.27192) [Upvote: 8] The prevalent dual-branch paradigm, i.e., training a side network to encode visual conditions and fusing its intermediate-layer features to a frozen pretrained main network, has shown remarkable success in… [Reasoning, Alignment, and Evaluation]
  - Authors: Yanghao Wang, Hongxu Chen, Jiazhen Liu, Zhenqi He, Rui Liu, Zhen Wang, Long Chen
  - Submitted by: Wang Yanghao | Upvotes: 8 | Comments: 1
...
- [Hallucination in World Models is Predictable and Preventable](https://huggingface.co/papers/2606.27326) [Upvote: 2] Modern generative world models render increasingly realistic action-controllable futures, yet they frequently hallucinate: rollouts remain visually fluent while drifting from the ground-truth dynamics. [Reasoning, Alignment, and Evaluation]
  - Authors: Nicklas Hansen, Xiaolong Wang
  - Submitted by: Nicklas Hansen | Upvotes: 2 | Comments: 1
...
- [How Post-Training Shapes Biological Reasoning Models](https://huggingface.co/papers/2606.16517) [Upvote: 0] Scientific reasoning models for biology combine language models with foundation models trained on multimodal biological data, including DNA, RNA, and proteins. [Reasoning, Alignment, and Evaluation]
  - Authors: Lukas Fesser, Hanlin Zhang, Michelle M. Li, Eric Wang, Bryan Perozzi, Shekoofeh Azizi, Sham M. Kakade, Marinka Zitnik
  - Submitted by: hlzhang109 | Upvotes: 0 | Comments: 1
...
- [Why Multi-Step Tool-Use Reinforcement Learning Collapses and How Supervisory Signals Fix It](https://huggingface.co/papers/2606.26027) [Upvote: 10] Tool use enables large language models (LLMs) to perform complex tasks, and recent agentic reinforcement learning (RL) methods show promise for enhancing model capabilities. [Learning, Optimization, and Theory]
  - Authors: Yupu Hao, Zhuoran Jin, Huanxuan Liao, Kang Liu, Jun Zhao
  - Submitted by: Zhuoran Jin | Upvotes: 10 | Comments: 1
...
- [PhysiFormer: Learning to Simulate Mechanics in World Space](https://huggingface.co/papers/2606.27364) [Upvote: 2] We present PhysiFormer, a diffusion transformer for physically-plausible 3D object motion. [Learning, Optimization, and Theory]
...
- [ViQ: Text-Aligned Visual Quantized Representations at Any Resolution](https://huggingface.co/papers/2606.27313) [Upvote: 34] A unified representation for text and vision is a natural pursuit, as it enables simpler multimodal modeling and more efficient training. [Multimodal Understanding and Vision]
  - Authors: Xumin Yu, Zuyan Liu, Zhenyu Yang, Yuhao Dong, Shengsheng Qian, Jiwen Lu, Han Hu, Yongming Rao
  - Submitted by: liuzuyan | Upvotes: 34 | Comments: 1
...
- [Confidence-Aware Tool Orchestration for Robust Video Understanding](https://huggingface.co/papers/2606.26904) [Upvote: 6] Video reasoning language models implicitly assume that every input frame is equally reliable. [Multimodal Understanding and Vision]
  - Authors: Yangfan He, Yujin Choi, Jaehong Yoon
  - Submitted by: Jaehong Yoon | Upvotes: 6 | Comments: 1
...
- [When Does Combining Language Models Help? A Co-Failure Ceiling on Routing, Voting, and Mixture-of-Agents Across 67 Frontier Models](https://huggingface.co/papers/2606.27288) [Upvote: 1] Multi-model LLM systems such as routing, voting, cascades, fusion, and mixture-of-agents are used to beat single-model accuracy. [LLMs and Language]
  - Authors: Josef Chen
  - Submitted by: Josef Chen | Upvotes: 1 | Comments: 1
