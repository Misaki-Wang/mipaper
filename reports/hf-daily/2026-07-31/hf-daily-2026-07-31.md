# Hugging Face Daily Papers Report (2026-07-31)

- Source: https://huggingface.co/papers/date/2026-07-31
- Classifier: rule
- Total Papers: 22

## Today's Hotspots and Trend

- Agents and Planning: 7 papers (31.82%); representative paper: SkillRise: Agentic Reinforcement Learning for Cross-Task Skill Evolution.
- LLMs and Language: 6 papers (27.27%); representative paper: HumanCLAW: Can Vision-Language Models Act Through a Body?.
- Other AI: 3 papers (13.64%); representative paper: StatePlay: State-Aware Game World Models for Mechanics-Consistent Generation.
...
- Multimodal Agents: 1 papers (4.55%)

## Topic Distribution

- Agents and Planning: 7 papers (31.82%)
- LLMs and Language: 6 papers (27.27%)
- Other AI: 3 papers (13.64%)
- Multimodal Understanding and Vision: 2 papers (9.09%)
- Learning, Optimization, and Theory: 1 papers (4.55%)
- Multimodal Agents: 1 papers (4.55%)
...
- The top topic today is “Agents and Planning”, with 7 papers, accounting for 31.82%。
- The most active submitter is taesiri， with 3 papers。
- The highest-voted visible paper is “TurboVLA: Real-Time Vision-Language-Action Model at 32 Hz on an RTX 4090 with <1 GB VRAM”, currently at 118 votes.
- Today's dominant clusters are Agents and Planning / LLMs and Language / Other AI; this suggests that agent papers emphasize tool use, planning, and deployable workflows. The strongest visible attention is on “TurboVLA: Real-Time Vision-Language-Action Model at 32 Hz on an RTX 4090 with <1 GB VRAM” (118 upvotes).

## Categorized Paper Briefs

### Agents and Planning (7 papers)

- [SkillRise: Agentic Reinforcement Learning for Cross-Task Skill Evolution](https://huggingface.co/papers/2607.26784) [Upvote: 18] Large language model agents often encounter related yet distinct tasks that share reusable solution patterns. [Agents and Planning]
  ...
  - Submitted by: Zhengxi Lu | Upvotes: 18 | Comments: 1
...
- [Can AI agents conduct open-ended AI research? Early evidence from two case studies](https://huggingface.co/papers/2607.27191) [Upvote: 11] Forecasts of explosive AI progress hinge on AI agents automating AI research. [Agents and Planning]
...
- [StealthBench: Measuring Operational Stealth in Autonomous Offensive-Security Agents](https://huggingface.co/papers/2607.26314) [Upvote: 2] Stealth, the discipline of achieving an objective without revealing your presence, capabilities, or collected intelligence, is what separates sophisticated operators from detectable ones. [Agents and Planning]
  ...
  - Submitted by: Ads Dawson | Upvotes: 2 | Comments: 1
...
- [Grading the Narrators: An Isnad-Rijal Framework for Claim-Level Provenance in Multi-Agent Knowledge Systems](https://huggingface.co/papers/2607.24117) [Upvote: 2] Modern multi-agent knowledge systems increasingly accumulate knowledge through chains of autonomous transformations rather than direct retrieval. [Agents and Planning]
  ...
  - Submitted by: Ali Zahid Raja | Upvotes: 2 | Comments: 1
...
- [SecRespond: Benchmarking AI Agents for Real-World Post-Compromise Incident Response](https://huggingface.co/papers/2607.26791) [Upvote: 1] Large Language Model (LLM) agents are increasingly adopted in real-world security operations with access to host artifacts and command-line interfaces (CLIs), making it critical to thoroughly assess their security… [Agents and Planning]
  ...
  - Submitted by: boli | Upvotes: 1 | Comments: 1
...
- [HumanCLAW: Can Vision-Language Models Act Through a Body?](https://huggingface.co/papers/2607.27180) [Upvote: 65] Evaluating whether a vision-language model (VLM) can act through a physical body is challenging. [LLMs and Language]
  ...
  - Submitted by: Jiawei Gu | Upvotes: 65 | Comments: 4
...
- [DecoEvo: Score-Decoupled Co-Evolution of Solver and Rubric-Generator Skills in Text Space](https://huggingface.co/papers/2607.25675) [Upvote: 54] Text-space optimization adapts large language models (LLMs) by editing external natural-language artifacts rather than model weights, so the optimized artifacts remain inspectable and the model can be treated as a… [LLMs and Language]
  ...
  - Submitted by: chenjiangwang | Upvotes: 54 | Comments: 2
...
- [CAST: Game Solvers as Turn-Level Teachers for LLM Agents](https://huggingface.co/papers/2607.25308) [Upvote: 27] Training large language models (LLMs) to act in long-horizon games is a promising step toward generalist decision-making, yet reinforcement learning with verifiable rewards (RLVR) relies on sparse final rewards that… [LLMs and Language]
  ...
  - Submitted by: Yu Wang | Upvotes: 27 | Comments: 1
...
- [MindForge: Teaching Small Language Models Whole-Life-Cycle Software Engineering via Source-Free Program Synthesis](https://huggingface.co/papers/2607.27146) [Upvote: 17] Coding agents have made substantial progress on software engineering tasks that modify existing codebases, including bug fixing and feature implementation. [LLMs and Language]
  - Authors: Yihao Chen, Shi Chang, Khaled Chawa, Feng Lin, Boyuan Chen, Shaowei Wang, Ahmed E. Hassan
  - Submitted by: Boyuan Chen | Upvotes: 17 | Comments: 1
...
- [OmegaUse-OfficeVal: Benchmarking LLM Agents on Long-Horizon Office-Suite Tasks with Economic Grounding](https://huggingface.co/papers/2607.27155) [Upvote: 7] Large language model (LLM) agents are increasingly expected to assist users in completing tasks. [LLMs and Language]
...
- [Memory for Large Language Models](https://huggingface.co/papers/2607.25380) [Upvote: 4] Memory has evolved into a foundational architectural dimension in large language models (LLMs), shifting from an implicit byproduct of computation to a spectrum of explicit, controllable mechanisms. [LLMs and Language]
  - Authors: Sining Zhoubian, Dan Zhang, Evgeny Kharlamov, Jie Tang
  - Submitted by: Sining Zhoubian | Upvotes: 4 | Comments: 1
...
- [StatePlay: State-Aware Game World Models for Mechanics-Consistent Generation](https://huggingface.co/papers/2607.26754) [Upvote: 12] Recent game world models can generate visually realistic and interactive environments conditioned on player actions. [Other AI]
  - Authors: Zijun Lin, Zeqing Wang, Cheston Tan, Bihan Wen, Yeying Jin
  - Submitted by: ZIJUN LIN | Upvotes: 12 | Comments: 1
...
- [πR^2: Reactive Real-time Flow Policies](https://huggingface.co/papers/2607.26055) [Upvote: 2] Generalist manipulation policies increasingly take the form of action-chunking flow policies built on large pretrained backbones. [Other AI]
  ...
  - Submitted by: Sungjae Park | Upvotes: 2 | Comments: 1
...
- [CoRT: Counterfactual Replay for Token-Level Rubric-Guided Policy Optimization](https://huggingface.co/papers/2607.25659) [Upvote: 73] Rubric-based reinforcement learning enriches language model training by evaluating model outputs against explicit criteria. [Learning, Optimization, and Theory]
  - Authors: Bo-Wen Zhang, Junwei He, Wen Wang, Song-Lin Lv, Wentao Ma, Rongyi Lin, Shuhan Zhong, Lan-Zhe Guo
  - Submitted by: quinn | Upvotes: 73 | Comments: 2
...
- [CADENCE: Closing the Reasoning Gap via Coverage-Adaptive On-Policy Distillation](https://huggingface.co/papers/2607.16955) [Upvote: 4] On-policy knowledge distillation transfers reasoning from large teachers to compact students, but existing approaches suffer three compounding failure modes: (i) cold-start collapse, where a fresh student assigns… [Reasoning, Alignment, and Evaluation]
  ...
  - Submitted by: Satyam Kumar | Upvotes: 4 | Comments: 1
...
- [CLBench-V: Evaluating Multimodal Context Learning from Grounding to Knowledge Acquisition](https://huggingface.co/papers/2607.25294) [Upvote: 40] Real-world tasks often require models to learn from task-specific context rather than relying only on pre-trained knowledge. [Retrieval, Knowledge, and RAG]
  - Authors: Lai Wei, Chengqi Li, Jiapeng Li, Ruina Hu, Yue Wang, Weiran Huang
  - Submitted by: Lai Wei | Upvotes: 40 | Comments: 1
