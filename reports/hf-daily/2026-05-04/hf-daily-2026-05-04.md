# Hugging Face Daily Papers Report (2026-05-04)

- Source: https://huggingface.co/papers/date/2026-05-04
- Classifier: rule
- Total Papers: 21

## Today's Hotspots and Trend

- Multimodal Understanding and Vision: 8 papers (38.10%); representative paper: Map2World: Segment Map Conditioned Text to 3D World Generation.
- Learning, Optimization, and Theory: 6 papers (28.57%); representative paper: Odysseus: Scaling VLMs to 100+ Turn Decision-Making in Games via Reinforcement Learning.
- LLMs and Language: 3 papers (14.29%); representative paper: Stable-GFlowNet: Toward Diverse and Robust LLM Red-Teaming via Contrastive Trajectory Balance.
- Trend: Today's dominant clusters are Multimodal Understanding and Vision / Learning, Optimization, and Theory / LLMs and Language; this suggests that multimodal work is moving from isolated perception toward generation, agents, and action. The strongest visible attention is on “UniVidX: A Unified Multimodal Framework for Versatile Video Generation via Diffusion Priors” (70 upvotes).

## Focus Topics

- Generative Foundations: 0 papers (0.00%)
- Multimodal Generative Modeling: 1 papers (4.76%)
- Multimodal Agents: 0 papers (0.00%)

## Topic Distribution

- Multimodal Understanding and Vision: 8 papers (38.10%)
- Learning, Optimization, and Theory: 6 papers (28.57%)
- LLMs and Language: 3 papers (14.29%)
- Agents and Planning: 2 papers (9.52%)
- Multimodal Generative Modeling: 1 papers (4.76%)
- Robotics and Embodied AI: 1 papers (4.76%)

## Top Submitters

- taesiri: 4 papers
- Dongyoon Han: 1 papers
- Etai Sella: 1 papers
- Hongzhan Lin: 1 papers
- HuichiZhou: 1 papers
- Indraneil Paul: 1 papers

## Brief Notes

- The top topic today is “Multimodal Understanding and Vision”, with 8 papers, accounting for 38.10%。
- The most active submitter is taesiri， with 4 papers。
- The highest-voted visible paper is “UniVidX: A Unified Multimodal Framework for Versatile Video Generation via Diffusion Priors”, currently at 70 votes.
- Today's dominant clusters are Multimodal Understanding and Vision / Learning, Optimization, and Theory / LLMs and Language; this suggests that multimodal work is moving from isolated perception toward generation, agents, and action. The strongest visible attention is on “UniVidX: A Unified Multimodal Framework for Versatile Video Generation via Diffusion Priors” (70 upvotes).

## Categorized Paper Briefs

### Multimodal Understanding and Vision (8 papers)

- [Map2World: Segment Map Conditioned Text to 3D World Generation](https://huggingface.co/papers/2605.00781) [Upvote: 16] 3D world generation is essential for applications such as immersive content creation or autonomous driving simulation. [Multimodal Understanding and Vision]
  - Authors: Jaeyoung Chung, Suyoung Lee, Jianfeng Xiang, Jiaolong Yang, Kyoung Mu Lee
  - Submitted by: taesiri | Upvotes: 16 | Comments: 3
  - Links: [HF](https://huggingface.co/papers/2605.00781) / [arXiv](https://arxiv.org/pdf/2605.00781) / [Cool](https://papers.cool/arxiv/2605.00781)
  - <details>
...
- [Prox-E: Fine-Grained 3D Shape Editing via Primitive-Based Abstractions](https://huggingface.co/papers/2604.23774) [Upvote: 13] Text-based 2D image editing models have recently reached an impressive level of maturity, motivating a growing body of work that heavily depends on these models to drive 3D edits. [Multimodal Understanding and Vision]
  - Authors: Etai Sella, Hao Phung, Nitay Amiel, Or Litany, Or Patashnik, Hadar Averbuch-Elor
  - Submitted by: Etai Sella | Upvotes: 13 | Comments: 4
  - Links: [HF](https://huggingface.co/papers/2604.23774) / [arXiv](https://arxiv.org/pdf/2604.23774) / [Cool](https://papers.cool/arxiv/2604.23774)
  - <details>
    <summary>Abstract</summary>
...
- [Let ViT Speak: Generative Language-Image Pre-training](https://huggingface.co/papers/2605.00809) [Upvote: 12] In this paper, we present Generative Language-Image Pre-training (GenLIP), a minimalist generative pretraining framework for Vision Transformers (ViTs) designed for multimodal large language models (MLLMs). [Multimodal Understanding and Vision]
  ...
  - Links: [HF](https://huggingface.co/papers/2605.00809) / [arXiv](https://arxiv.org/pdf/2605.00809) / [Cool](https://papers.cool/arxiv/2605.00809)
  - <details>
    <summary>Abstract</summary>
...
- [When Do Diffusion Models learn to Generate Multiple Objects?](https://huggingface.co/papers/2605.00273) [Upvote: 5] Text-to-image diffusion models achieve impressive visual fidelity, yet they remain unreliable in multi-object generation. [Multimodal Understanding and Vision]
  - Authors: Yujin Jeong, Arnas Uselis, Iro Laina, Seong Joon Oh, Anna Rohrbach
  - Submitted by: Jeong | Upvotes: 5 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2605.00273) / [arXiv](https://arxiv.org/pdf/2605.00273) / [Cool](https://papers.cool/arxiv/2605.00273)
  - <details>
    <summary>Abstract</summary>
...
- [Trees to Flows and Back: Unifying Decision Trees and Diffusion Models](https://huggingface.co/papers/2605.00414) [Upvote: 5] Decision trees and diffusion models are ostensibly disparate model classes, one discrete and hierarchical, the other continuous and dynamic. [Multimodal Understanding and Vision]
  - Authors: Sai Niranjan Ramachandran, Suvrit Sra
  - Submitted by: Sai Niranjan | Upvotes: 5 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2605.00414) / [arXiv](https://arxiv.org/pdf/2605.00414) / [Cool](https://papers.cool/arxiv/2605.00414)
  - <details>
    <summary>Abstract</summary>
...
- [End-to-End Autoregressive Image Generation with 1D Semantic Tokenizer](https://huggingface.co/papers/2605.00503) [Upvote: 4] Autoregressive image modeling relies on visual tokenizers to compress images into compact latent representations. [Multimodal Understanding and Vision]
  ...
  - Links: [HF](https://huggingface.co/papers/2605.00503) / [arXiv](https://arxiv.org/pdf/2605.00503) / [Cool](https://papers.cool/arxiv/2605.00503)
  - <details>
    <summary>Abstract</summary>
...
- [Talker-T2AV: Joint Talking Audio-Video Generation with Autoregressive Diffusion Modeling](https://huggingface.co/papers/2604.23586) [Upvote: 1] Joint audio-video generation models have shown that unified generation yields stronger cross-modal coherence than cascaded approaches. [Multimodal Understanding and Vision]
  ...
  - Submitted by: Hongzhan Lin | Upvotes: 1 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2604.23586) / [arXiv](https://arxiv.org/pdf/2604.23586) / [Cool](https://papers.cool/arxiv/2604.23586)
  - <details>
    <summary>Abstract</summary>
...
- [Soft Anisotropic Diagrams for Differentiable Image Representation](https://huggingface.co/papers/2604.21984) [Upvote: 0] We introduce Soft Anisotropic Diagrams (SAD), an explicit and differentiable image representation parameterized by a set of adaptive sites in the image plane. [Multimodal Understanding and Vision]
  - Authors: Laki Iinbor, Zhiyang Dou, Wojciech Matusik
  - Submitted by: Zhiyang Dou | Upvotes: 0 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2604.21984) / [arXiv](https://arxiv.org/pdf/2604.21984) / [Cool](https://papers.cool/arxiv/2604.21984)
  - <details>
    <summary>Abstract</summary>
...
- [Odysseus: Scaling VLMs to 100+ Turn Decision-Making in Games via Reinforcement Learning](https://huggingface.co/papers/2605.00347) [Upvote: 8] Given the rapidly growing capabilities of vision-language models (VLMs), extending them to interactive decision-making tasks such as video games has emerged as a promising frontier. [Learning, Optimization, and Theory]
  ...
  - Submitted by: Seth Karten | Upvotes: 8 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2605.00347) / [arXiv](https://arxiv.org/pdf/2605.00347) / [Cool](https://papers.cool/arxiv/2605.00347)
  - <details>
    <summary>Abstract</summary>
...
- [Better Models, Faster Training: Sigmoid Attention for single-cell Foundation Models](https://huggingface.co/papers/2604.27124) [Upvote: 3] Training stable biological foundation models requires rethinking attention mechanisms: we find that using sigmoid attention as a drop in replacement for softmax attention a) produces better learned representations: on… [Learning, Optimization, and Theory]
  - Authors: Vijay Sadashivaiah, Georgios Dasoulas, Judith Mueller, Soumya Ghosh
  - Submitted by: Vijay Sadashivaiah | Upvotes: 3 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2604.27124) / [arXiv](https://arxiv.org/pdf/2604.27124) / [Cool](https://papers.cool/arxiv/2604.27124)
  - <details>
    <summary>Abstract</summary>
...
- [Themis: Training Robust Multilingual Code Reward Models for Flexible Multi-Criteria Scoring](https://huggingface.co/papers/2605.00754) [Upvote: 2] Reward models (RMs) have become an indispensable fixture of the language model (LM) post-training playbook, enabling policy alignment and test-time scaling. [Learning, Optimization, and Theory]
  - Authors: Indraneil Paul, Glavaš Glavas, Iryna Gurevych
  - Submitted by: Indraneil Paul | Upvotes: 2 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2605.00754) / [arXiv](https://arxiv.org/pdf/2605.00754) / [Cool](https://papers.cool/arxiv/2605.00754)
  - <details>
    <summary>Abstract</summary>
...
- [MASCing: Configurable Mixture-of-Experts Behavior via Activation Steering Masks](https://huggingface.co/papers/2604.27818) [Upvote: 2] Mixture-of-Experts (MoE) architectures in Large Language Models (LLMs) have significantly reduced inference costs through sparse activation. [Learning, Optimization, and Theory]
  - Authors: Jona te Lintelo, Lichao Wu, Marina Krček, Sengim Karayalçin, Stjepan Picek
  - Submitted by: Jona te Lintelo | Upvotes: 2 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2604.27818) / [arXiv](https://arxiv.org/pdf/2604.27818) / [Cool](https://papers.cool/arxiv/2604.27818)
  - <details>
    <summary>Abstract</summary>
...
- [Learning to Act and Cooperate for Distributed Black-Box Consensus Optimization](https://huggingface.co/papers/2605.00691) [Upvote: 2] Distributed blackbox consensus optimization is a fundamental problem in multi-agent systems, where agents must improve a global objective using only local objective queries and limited neighbor communication. [Learning, Optimization, and Theory]
  - Authors: Zi-Bo Qin, Feng-Feng Wei, Tai-You Chen, Wei-Neng Chen
  - Submitted by: Rajkumar rawal | Upvotes: 2 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2605.00691) / [arXiv](https://arxiv.org/pdf/2605.00691) / [Cool](https://papers.cool/arxiv/2605.00691)
  - <details>
    <summary>Abstract</summary>
...
- [AnalogRetriever: Learning Cross-Modal Representations for Analog Circuit Retrieval](https://huggingface.co/papers/2604.23195) [Upvote: 2] Analog circuit design relies heavily on reusing existing intellectual property (IP), yet searching across heterogeneous representations such as SPICE netlists, schematics, and functional descriptions remains challenging. [Learning, Optimization, and Theory]
  - Authors: Yihan Wang, Lei Li, Yao Lai, Jing Wang, Yan Lu
  - Submitted by: Lei Li | Upvotes: 2 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2604.23195) / [arXiv](https://arxiv.org/pdf/2604.23195) / [Cool](https://papers.cool/arxiv/2604.23195)
  - <details>
    <summary>Abstract</summary>
...
- [Stable-GFlowNet: Toward Diverse and Robust LLM Red-Teaming via Contrastive Trajectory Balance](https://huggingface.co/papers/2605.00553) [Upvote: 10] Large Language Model (LLM) Red-Teaming, which proactively identifies vulnerabilities of LLMs, is an essential process for ensuring safety. [LLMs and Language]
  - Authors: Minchan Kwon, Sunghyun Baek, Minseo Kim, Jaemyung Yu, Dongyoon Han, Junmo Kim
  - Submitted by: Dongyoon Han | Upvotes: 10 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2605.00553) / [arXiv](https://arxiv.org/pdf/2605.00553) / [Cool](https://papers.cool/arxiv/2605.00553)
  - <details>
    <summary>Abstract</summary>
...
- [Online Self-Calibration Against Hallucination in Vision-Language Models](https://huggingface.co/papers/2605.00323) [Upvote: 2] Large Vision-Language Models (LVLMs) often suffer from hallucinations, generating descriptions that include visual details absent from the input image. [LLMs and Language]
  - Authors: Minghui Chen, Chenxu Yang, Hengjie Zhu, Dayan Wu, Zheng Lin, Qingyi Si
  - Submitted by: steven young | Upvotes: 2 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2605.00323) / [arXiv](https://arxiv.org/pdf/2605.00323) / [Cool](https://papers.cool/arxiv/2605.00323)
  - <details>
    <summary>Abstract</summary>
...
- [LASE: Language-Adversarial Speaker Encoding for Indic Cross-Script Identity Preservation](https://huggingface.co/papers/2605.00777) [Upvote: 1] A speaker encoder used in multilingual voice cloning should treat the same speaker identically regardless of which script the audio was uttered in. [LLMs and Language]
  - Authors: Venkata Pushpak Teja Menta
  - Submitted by: Venkata Pushpak Teja Menta | Upvotes: 1 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2605.00777) / [arXiv](https://arxiv.org/pdf/2605.00777) / [Cool](https://papers.cool/arxiv/2605.00777)
  - <details>
    <summary>Abstract</summary>
...
- [Web2BigTable: A Bi-Level Multi-Agent LLM System for Internet-Scale Information Search and Extraction](https://huggingface.co/papers/2604.27221) [Upvote: 27] Agentic web search increasingly faces two distinct demands: deep reasoning over a single target, and structured aggregation across many entities and heterogeneous sources. [Agents and Planning]
  - Authors: Yuxuan Huang, Yihang Chen, Zhiyuan He, Yuxiang Chen, Ka Yiu Lee, Huichi Zhou, Weilin Luo, Meng Fang, Jun Wang
  - Submitted by: HuichiZhou | Upvotes: 27 | Comments: 5
  - Links: [HF](https://huggingface.co/papers/2604.27221) / [arXiv](https://arxiv.org/pdf/2604.27221) / [Cool](https://papers.cool/arxiv/2604.27221)
  - <details>
    <summary>Abstract</summary>
...
- [From Skill Text to Skill Structure: The Scheduling-Structural-Logical Representation for Agent Skills](https://huggingface.co/papers/2604.24026) [Upvote: 11] LLM agents increasingly rely on reusable skills, capability packages that combine instructions, control flow, constraints, and tool calls. [Agents and Planning]
  - Authors: Qiliang Liang, Hansi Wang, Zhong Liang, Yang Liu
  - Submitted by: Liang Qiliang | Upvotes: 11 | Comments: 4
  - Links: [HF](https://huggingface.co/papers/2604.24026) / [arXiv](https://arxiv.org/pdf/2604.24026) / [Cool](https://papers.cool/arxiv/2604.24026)
  - <details>
    <summary>Abstract</summary>
...
- [UniVidX: A Unified Multimodal Framework for Versatile Video Generation via Diffusion Priors](https://huggingface.co/papers/2605.00658) [Upvote: 70] Recent progress has shown that video diffusion models (VDMs) can be repurposed for diverse multimodal graphics tasks. [Multimodal Generative Modeling]
  ...
  - Submitted by: taesiri | Upvotes: 70 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2605.00658) / [arXiv](https://arxiv.org/pdf/2605.00658) / [Cool](https://papers.cool/arxiv/2605.00658)
  - <details>
    <summary>Abstract</summary>
...
- [Learning while Deploying: Fleet-Scale Reinforcement Learning for Generalist Robot Policies](https://huggingface.co/papers/2605.00416) [Upvote: 10] Generalist robot policies increasingly benefit from large-scale pretraining, but offline data alone is insufficient for robust real-world deployment. [Robotics and Embodied AI]
  ...
  - Submitted by: Jianlan Luo | Upvotes: 10 | Comments: 3
  - Links: [HF](https://huggingface.co/papers/2605.00416) / [arXiv](https://arxiv.org/pdf/2605.00416) / [Cool](https://papers.cool/arxiv/2605.00416)
  - <details>
    <summary>Abstract</summary>
