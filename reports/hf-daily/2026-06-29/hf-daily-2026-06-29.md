...
- Agents and Planning: 7 papers (28.00%); representative paper: OPID: On-Policy Skill Distillation for Agentic Reinforcement Learning.
- Other AI: 6 papers (24.00%); representative paper: DanceOPD: On-Policy Generative Field Distillation.
- Reasoning, Alignment, and Evaluation: 4 papers (16.00%); representative paper: LISA: Likelihood Score Alignment for Visual-condition Controllable Generation.
- Trend: Today's dominant clusters are Agents and Planning / Other AI / Reasoning, Alignment, and Evaluation; this suggests that agent papers emphasize tool use, planning, and deployable workflows. The strongest visible attention is on “DanceOPD: On-Policy Generative Field Distillation” (69 upvotes).
...
- Agents and Planning: 7 papers (28.00%)
- Other AI: 6 papers (24.00%)
- Reasoning, Alignment, and Evaluation: 4 papers (16.00%)
- Multimodal Understanding and Vision: 3 papers (12.00%)
- LLMs and Language: 2 papers (8.00%)
- Learning, Optimization, and Theory: 2 papers (8.00%)
- Robotics and Embodied AI: 1 papers (4.00%)

## Top Submitters

- taesiri: 5 papers
- Changdae Oh: 1 papers
- Issa Sugiura: 1 papers
- Jaehong Yoon: 1 papers
- Jinyang Wu: 1 papers
- Josef Chen: 1 papers

## Brief Notes

- The top topic today is “Agents and Planning”, with 7 papers, accounting for 28.00%。
- The most active submitter is taesiri， with 5 papers。
- The highest-voted visible paper is “DanceOPD: On-Policy Generative Field Distillation”, currently at 69 votes.
- Today's dominant clusters are Agents and Planning / Other AI / Reasoning, Alignment, and Evaluation; this suggests that agent papers emphasize tool use, planning, and deployable workflows. The strongest visible attention is on “DanceOPD: On-Policy Generative Field Distillation” (69 upvotes).

## Categorized Paper Briefs

### Agents and Planning (7 papers)

- [OPID: On-Policy Skill Distillation for Agentic Reinforcement Learning](https://huggingface.co/papers/2606.26790) [Upvote: 45] Outcome-based reinforcement learning provides a stable optimization backbone for language agents, but its sparse trajectory-level rewards provide little guidance on which intermediate decisions should be reinforced or… [Agents and Planning]
  ...
  - Submitted by: Jinyang Wu | Upvotes: 45 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2606.26790) / [arXiv](https://arxiv.org/pdf/2606.26790) / [Cool](https://papers.cool/arxiv/2606.26790)
  - <details>
...
- [Qwen-Image-Agent: Bridging the Context Gap in Real-World Image Generation](https://huggingface.co/papers/2606.26907) [Upvote: 41] While text-to-image (T2I) models have achieved remarkable progress, they struggle with real-world requests that are often underspecified, implicit, or dependent on up-to-date knowledge. [Agents and Planning]
  ...
  - Submitted by: taesiri | Upvotes: 41 | Comments: 3
  - Links: [HF](https://huggingface.co/papers/2606.26907) / [arXiv](https://arxiv.org/pdf/2606.26907) / [Cool](https://papers.cool/arxiv/2606.26907)
  - <details>
    <summary>Abstract</summary>
...
- [The Verification Horizon: No Silver Bullet for Coding Agent Rewards](https://huggingface.co/papers/2606.26300) [Upvote: 40] A classical intuition holds that verifying a solution is easier than producing one. [Agents and Planning]
  ...
  - Submitted by: zjj | Upvotes: 40 | Comments: 3
  - Links: [HF](https://huggingface.co/papers/2606.26300) / [arXiv](https://arxiv.org/pdf/2606.26300) / [Cool](https://papers.cool/arxiv/2606.26300)
  - <details>
    <summary>Abstract</summary>
...
- [GUI vs. CLI: Execution Bottlenecks in Screen-Only and Skill-Mediated Computer-Use Agents](https://huggingface.co/papers/2606.24551) [Upvote: 27] Computer-use agents can execute software tasks through either graphical interfaces or programmatic command interfaces, but existing evaluations confound interaction modality with differences in tasks, initial states,… [Agents and Planning]
  - Authors: Xiao Zhou, Siyue Zhang, Yilun Zhao, Jinbiao Wei, Tingyu Song, Arman Cohan, Chen Zhao
  - Submitted by: Xiao Zhou | Upvotes: 27 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2606.24551) / [arXiv](https://arxiv.org/pdf/2606.24551) / [Cool](https://papers.cool/arxiv/2606.24551)
  - <details>
    <summary>Abstract</summary>
...
- [Running the Gauntlet: Re-evaluating the Capabilities of Agents Beyond Familiar Environments](https://huggingface.co/papers/2606.14397) [Upvote: 16] As agentic systems continue to evolve and are widely deployed in real-world scenarios, there is a growing demand to faithfully evaluate their capabilities. [Agents and Planning]
  ...
  - Submitted by: Runqi Lin | Upvotes: 16 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2606.14397) / [arXiv](https://arxiv.org/pdf/2606.14397) / [Cool](https://papers.cool/arxiv/2606.14397)
  - <details>
    <summary>Abstract</summary>
...
- [CoffeeBench: Benchmarking Long-Horizon LLM Agents in Heterogeneous Multi-Agent Economies](https://huggingface.co/papers/2606.16613) [Upvote: 8] As LLM agents become capable of increasingly long-horizon tasks, evaluating their performance in economic systems is becoming increasingly important. [Agents and Planning]
  - Authors: Issa Sugiura, Daichi Hattori, Kazuo Araragi, Keita Ogawa, Shota Onose, Taro Makino, Teppei Usuki, Takashi Ishida
  - Submitted by: Issa Sugiura | Upvotes: 8 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2606.16613) / [arXiv](https://arxiv.org/pdf/2606.16613) / [Cool](https://papers.cool/arxiv/2606.16613)
  - <details>
    <summary>Abstract</summary>
...
- [OpenBioRQ: Unsolved Biomedical Research Questions for Agents](https://huggingface.co/papers/2606.21959) [Upvote: 3] A working citation looks like proof -- but the fact that a link resolves does not mean the cited paper supports the claim. [Agents and Planning]
  - Authors: Minbyul Jeong
  - Submitted by: Minbyul Jeong | Upvotes: 3 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2606.21959) / [arXiv](https://arxiv.org/pdf/2606.21959) / [Cool](https://papers.cool/arxiv/2606.21959)
  - <details>
    <summary>Abstract</summary>
...
- [DanceOPD: On-Policy Generative Field Distillation](https://huggingface.co/papers/2606.27377) [Upvote: 69] Modern image generation demands a single model that unifies diverse capabilities, including text-to-image (T2I), local editing, and global editing. [Other AI]
  ...
  - Submitted by: taesiri | Upvotes: 69 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2606.27377) / [arXiv](https://arxiv.org/pdf/2606.27377) / [Cool](https://papers.cool/arxiv/2606.27377)
  - <details>
    <summary>Abstract</summary>
...
- [JetSpec: Breaking the Scaling Ceiling of Speculative Decoding with Parallel Tree Drafting](https://huggingface.co/papers/2606.18394) [Upvote: 31] Speculative decoding (SD) accelerates autoregressive Large Language Models (LLMs) by drafting multiple tokens and verifying them in parallel, but it faces a scaling limitation: increasing the draft budget improves… [Other AI]
  ...
  - Submitted by: Lanxiang Hu | Upvotes: 31 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2606.18394) / [arXiv](https://arxiv.org/pdf/2606.18394) / [Cool](https://papers.cool/arxiv/2606.18394)
  - <details>
    <summary>Abstract</summary>
...
- [Fast LeWorldModel](https://huggingface.co/papers/2606.26217) [Upvote: 23] Joint-Embedding Predictive Architectures (JEPAs), including recent LeWorldModel (LeWM), have become a promising foundation for reconstruction-free visual world models. [Other AI]
  - Authors: Yuntian Gao, Xiangyu Xu
  - Submitted by: taesiri | Upvotes: 23 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2606.26217) / [arXiv](https://arxiv.org/pdf/2606.26217) / [Cool](https://papers.cool/arxiv/2606.26217)
  - <details>
    <summary>Abstract</summary>
...
- [Discretizing Reward Models](https://huggingface.co/papers/2606.21795) [Upvote: 9] Despite their widespread use, the role of reward models in shaping reinforcement learning is poorly understood. [Other AI]
  - Authors: Vijay Viswanathan, Shiqi Wang, Devamanyu Hazarika, Chirag Nagpal, Tongshuang Wu, Graham Neubig, Yuning Mao
  - Submitted by: Vijay Viswanathan | Upvotes: 9 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2606.21795) / [arXiv](https://arxiv.org/pdf/2606.21795) / [Cool](https://papers.cool/arxiv/2606.21795)
  - <details>
    <summary>Abstract</summary>
...
- [COrigami: An AI Pipeline for Co-Designing Flat-Foldable Visually Recognisable Origami](https://huggingface.co/papers/2606.26299) [Upvote: 4] While generative AI has achieved remarkable success in solving problems with verifiable solutions, generating physical art that satisfies both strict geometric constraints and subjective visual aesthetics remains a… [Other AI]
  ...
  - Links: [HF](https://huggingface.co/papers/2606.26299) / [arXiv](https://arxiv.org/pdf/2606.26299) / [Cool](https://papers.cool/arxiv/2606.26299)
  - <details>
    <summary>Abstract</summary>
...
- [EO-WM: A Physically Informed World Model for Probabilistic Earth Observation Forecasting](https://huggingface.co/papers/2606.27277) [Upvote: 2] Earth Observation (EO) forecasting aims to predict future Earth surface dynamics from satellite observations under changing meteorological conditions. [Other AI]
  - Authors: Junwei Luo, Shuai Yuan, Zhenya Yang, Yansheng Li, Zhe Liu, Hengshuang Zhao
  - Submitted by: Junwei Luo | Upvotes: 2 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2606.27277) / [arXiv](https://arxiv.org/pdf/2606.27277) / [Cool](https://papers.cool/arxiv/2606.27277)
  - <details>
    <summary>Abstract</summary>
...
- [LISA: Likelihood Score Alignment for Visual-condition Controllable Generation](https://huggingface.co/papers/2606.27192) [Upvote: 13] The prevalent dual-branch paradigm, i.e., training a side network to encode visual conditions and fusing its intermediate-layer features to a frozen pretrained main network, has shown remarkable success in… [Reasoning, Alignment, and Evaluation]
  - Authors: Yanghao Wang, Hongxu Chen, Jiazhen Liu, Zhenqi He, Rui Liu, Zhen Wang, Long Chen
  - Submitted by: Wang Yanghao | Upvotes: 13 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2606.27192) / [arXiv](https://arxiv.org/pdf/2606.27192) / [Cool](https://papers.cool/arxiv/2606.27192)
  - <details>
    <summary>Abstract</summary>
...
- [Information-Aware KV Cache Compression for Long Reasoning](https://huggingface.co/papers/2606.26875) [Upvote: 9] Reasoning capability has advanced rapidly in large language models (LLMs), leading to an increasing size of key-value (KV) cache in both prefilling and decoding stages. [Reasoning, Alignment, and Evaluation]
  - Authors: Jushi Kai, Zhuiri Xiao, Alexandra Birch, Zhouhan Lin
  - Submitted by: kai | Upvotes: 9 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2606.26875) / [arXiv](https://arxiv.org/pdf/2606.26875) / [Cool](https://papers.cool/arxiv/2606.26875)
  - <details>
    <summary>Abstract</summary>
...
- [Hallucination in World Models is Predictable and Preventable](https://huggingface.co/papers/2606.27326) [Upvote: 8] Modern generative world models render increasingly realistic action-controllable futures, yet they frequently hallucinate: rollouts remain visually fluent while drifting from the ground-truth dynamics. [Reasoning, Alignment, and Evaluation]
  - Authors: Nicklas Hansen, Xiaolong Wang
  - Submitted by: Nicklas Hansen | Upvotes: 8 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2606.27326) / [arXiv](https://arxiv.org/pdf/2606.27326) / [Cool](https://papers.cool/arxiv/2606.27326)
  - <details>
    <summary>Abstract</summary>
...
- [How Post-Training Shapes Biological Reasoning Models](https://huggingface.co/papers/2606.16517) [Upvote: 3] Scientific reasoning models for biology combine language models with foundation models trained on multimodal biological data, including DNA, RNA, and proteins. [Reasoning, Alignment, and Evaluation]
  - Authors: Lukas Fesser, Hanlin Zhang, Michelle M. Li, Eric Wang, Bryan Perozzi, Shekoofeh Azizi, Sham M. Kakade, Marinka Zitnik
  - Submitted by: hlzhang109 | Upvotes: 3 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2606.16517) / [arXiv](https://arxiv.org/pdf/2606.16517) / [Cool](https://papers.cool/arxiv/2606.16517)
  - <details>
    <summary>Abstract</summary>
...
- [ViQ: Text-Aligned Visual Quantized Representations at Any Resolution](https://huggingface.co/papers/2606.27313) [Upvote: 38] A unified representation for text and vision is a natural pursuit, as it enables simpler multimodal modeling and more efficient training. [Multimodal Understanding and Vision]
  - Authors: Xumin Yu, Zuyan Liu, Zhenyu Yang, Yuhao Dong, Shengsheng Qian, Jiwen Lu, Han Hu, Yongming Rao
  - Submitted by: liuzuyan | Upvotes: 38 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2606.27313) / [arXiv](https://arxiv.org/pdf/2606.27313) / [Cool](https://papers.cool/arxiv/2606.27313)
  - <details>
    <summary>Abstract</summary>
...
- [Confidence-Aware Tool Orchestration for Robust Video Understanding](https://huggingface.co/papers/2606.26904) [Upvote: 9] Video reasoning language models implicitly assume that every input frame is equally reliable. [Multimodal Understanding and Vision]
  - Authors: Yangfan He, Yujin Choi, Jaehong Yoon
  - Submitted by: Jaehong Yoon | Upvotes: 9 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2606.26904) / [arXiv](https://arxiv.org/pdf/2606.26904) / [Cool](https://papers.cool/arxiv/2606.26904)
  - <details>
    <summary>Abstract</summary>
...
- [ABACUS: Adapting Unified Foundation Model for Bridging Image Count Understanding and Generation](https://huggingface.co/papers/2606.23835) [Upvote: 3] ABACUS is a unified vision-language model that handles object counting, crowd counting, referring-expression counting, and count-faithful image generation without any benchmark-specific training required. [Multimodal Understanding and Vision]
  - Authors: Anindya Mondal, Sauradip Nag, Anjan Dutta
  - Submitted by: Sauradip Nag | Upvotes: 3 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2606.23835) / [arXiv](https://arxiv.org/pdf/2606.23835) / [Cool](https://papers.cool/arxiv/2606.23835)
  - <details>
    <summary>Abstract</summary>
...
- [Neglected Free Lunch from Post-training: Progress Advantage for LLM Agents](https://huggingface.co/papers/2606.26080) [Upvote: 7] Process reward models enable fine-grained, step-level evaluation of LLMs, yet building them for agentic settings remains prohibitively difficult: long-horizon interactions, irreversible actions, and stochastic… [LLMs and Language]
  - Authors: Changdae Oh, Wendi Li, Seongheon Park, Samuel Yeh, Tanwi Mallick, Sharon Li
  - Submitted by: Changdae Oh | Upvotes: 7 | Comments: 1
  - Links: [HF](https://huggingface.co/papers/2606.26080) / [arXiv](https://arxiv.org/pdf/2606.26080) / [Cool](https://papers.cool/arxiv/2606.26080)
  - <details>
    <summary>Abstract</summary>
...
- [When Does Combining Language Models Help? A Co-Failure Ceiling on Routing, Voting, and Mixture-of-Agents Across 67 Frontier Models](https://huggingface.co/papers/2606.27288) [Upvote: 3] Multi-model LLM systems such as routing, voting, cascades, fusion, and mixture-of-agents are used to beat single-model accuracy. [LLMs and Language]
  - Authors: Josef Chen
  - Submitted by: Josef Chen | Upvotes: 3 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2606.27288) / [arXiv](https://arxiv.org/pdf/2606.27288) / [Cool](https://papers.cool/arxiv/2606.27288)
  - <details>
    <summary>Abstract</summary>
...
- [Why Multi-Step Tool-Use Reinforcement Learning Collapses and How Supervisory Signals Fix It](https://huggingface.co/papers/2606.26027) [Upvote: 15] Tool use enables large language models (LLMs) to perform complex tasks, and recent agentic reinforcement learning (RL) methods show promise for enhancing model capabilities. [Learning, Optimization, and Theory]
  - Authors: Yupu Hao, Zhuoran Jin, Huanxuan Liao, Kang Liu, Jun Zhao
  - Submitted by: Zhuoran Jin | Upvotes: 15 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2606.26027) / [arXiv](https://arxiv.org/pdf/2606.26027) / [Cool](https://papers.cool/arxiv/2606.26027)
  - <details>
    <summary>Abstract</summary>
...
- [PhysiFormer: Learning to Simulate Mechanics in World Space](https://huggingface.co/papers/2606.27364) [Upvote: 9] We present PhysiFormer, a diffusion transformer for physically-plausible 3D object motion. [Learning, Optimization, and Theory]
  - Authors: Yiming Chen, Yushi Lan, Andrea Vedaldi
  - Submitted by: taesiri | Upvotes: 9 | Comments: 0
  - Links: [HF](https://huggingface.co/papers/2606.27364) / [arXiv](https://arxiv.org/pdf/2606.27364) / [Cool](https://papers.cool/arxiv/2606.27364)
  - <details>
    <summary>Abstract</summary>
...
- [In-Context World Modeling for Robotic Control](https://huggingface.co/papers/2606.26025) [Upvote: 49] Modern Vision-Language-Action (VLA) models often fail to generalize to novel setups, such as altered camera viewpoints or robot morphologies, because they are typically conditioned only on current observations and… [Robotics and Embodied AI]
  - Authors: Siyin Wang, Junhao Shi, Senyu Fei, Zhaoyang Fu, Li Ji, Jingjing Gong, Xipeng Qiu
  - Submitted by: Siyin Wang (SII) | Upvotes: 49 | Comments: 2
  - Links: [HF](https://huggingface.co/papers/2606.26025) / [arXiv](https://arxiv.org/pdf/2606.26025) / [Cool](https://papers.cool/arxiv/2606.26025)
  - <details>
    <summary>Abstract</summary>
