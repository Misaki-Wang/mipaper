# Hugging Face Daily Papers Report (2026-06-09)

- Source: https://huggingface.co/papers/date/2026-06-09
- Classifier: rule
- Total Papers: 42

## Today's Hotspots and Trend

- Other AI: 12 papers (28.57%); representative paper: GENEB: Why Genomic Models Are Hard to Compare.
- LLMs and Language: 10 papers (23.81%); representative paper: Your UnEmbedding Matrix is Secretly a Feature Lens for Text Embeddings.
- Multimodal Understanding and Vision: 6 papers (14.29%); representative paper: Direct 3D-Aware Object Insertion via Decomposed Visual Proxies.
- Trend: Today's dominant clusters are Other AI / LLMs and Language / Multimodal Understanding and Vision; this suggests that multimodal work is moving from isolated perception toward generation, agents, and action. The strongest visible attention is on “Your UnEmbedding Matrix is Secretly a Feature Lens for Text Embeddings” (69 upvotes).
...
- Other AI: 12 papers (28.57%)
- LLMs and Language: 10 papers (23.81%)
- Multimodal Understanding and Vision: 6 papers (14.29%)
- Agents and Planning: 5 papers (11.90%)
- Datasets and Benchmarks: 3 papers (7.14%)
- Reasoning, Alignment, and Evaluation: 3 papers (7.14%)
- Learning, Optimization, and Theory: 1 papers (2.38%)
- Retrieval, Knowledge, and RAG: 1 papers (2.38%)
- Robotics and Embodied AI: 1 papers (2.38%)
...
- Cheng Tan: 1 papers
- Chenming Zhu: 1 papers

## Brief Notes

- The top topic today is “Other AI”, with 12 papers, accounting for 28.57%。
- The most active submitter is taesiri， with 5 papers。
- The highest-voted visible paper is “Your UnEmbedding Matrix is Secretly a Feature Lens for Text Embeddings”, currently at 69 votes.
...
- [GENEB: Why Genomic Models Are Hard to Compare](https://huggingface.co/papers/2606.04525) [Upvote: 41] Progress in genomic foundation models is difficult to assess due to fragmented benchmarks, incompatible evaluation protocols, and task-specific reporting. [Other AI]
  - Authors: Daria Ledneva, Mikhail Nuridinov, Denis Kuznetsov
  - Submitted by: Daria Ledneva | Upvotes: 41 | Comments: 1
...
- [Robots Need More than VLA and World Models](https://huggingface.co/papers/2606.06556) [Upvote: 18] Generalist robot intelligence is often framed as a policy-scaling problem: collect more robot demonstrations, train larger Vision-Language-Action (VLA) models, and expect broader generalisation. [Other AI]
  ...
  - Submitted by: Haitham Bou Ammar | Upvotes: 18 | Comments: 1
...
- [dots.tts Technical Report](https://huggingface.co/papers/2606.07080) [Upvote: 12] We present dots.tts, a 2B-parameter continuous autoregressive text-to-speech (TTS) foundation model that models speech in a continuous latent space. [Other AI]
...
- [LIMMT: Less is More for Motion Tracking](https://huggingface.co/papers/2606.06953) [Upvote: 12] We argue that high-quality motion data can steer tracking policies toward better optimization trajectories early in training. [Other AI]
  - Authors: Yu Guan, Zekun Qi, Chenghuai Lin, Xuchuan Chen, Dairu Liu, Wenyao Zhang, Jilong Wang, Xinqiang Yu, He Wang, Li Yi
  - Submitted by: Zekun Qi | Upvotes: 12 | Comments: 1
...
- [SIA: Self Improving AI with Harness & Weight Updates](https://huggingface.co/papers/2605.27276) [Upvote: 8] Humans are the bottleneck in building and improving AI. [Other AI]
  - Authors: Prannay Hebbar, Yogendra Manawat, Samuel Verboomen, Alesia Ivanova, Selvam Palanimalai, Kunal Bhatia, Vignesh Baskaran
  - Submitted by: Vignesh Baskaran | Upvotes: 8 | Comments: 1
...
- [PaperFlow: Profiling, Recommending, and Adapting Across Daily Paper Streams](https://huggingface.co/papers/2606.07454) [Upvote: 8] Scientific paper recommendation is typically evaluated as static ranking over a fixed candidate set, yet real scientific reading unfolds as a daily, longitudinal process in which interests shift and feedback accumulates. [Other AI]
  ...
  - Submitted by: Cheng Tan | Upvotes: 8 | Comments: 1
...
- [SPACENUM: Revisiting Spatial Numerical Understanding in VLMs](https://huggingface.co/papers/2605.23898) [Upvote: 5] Vision-Language Models (VLMs) are increasingly deployed in embodied environments, where they need produce numerical outputs such as action magnitudes and spatial coordinates. [Other AI]
  - Authors: Jianshu Zhang, Yijiang Li, Huifeixin Chen, Haoran Lu, Letian Xue, Bingyang Wang, Han Liu
  - Submitted by: Jianshu Zhang | Upvotes: 5 | Comments: 1
...
- [Entropy as a Structural Prior: How a Log-Barrier on DiT Belief Space Drives Musical Diversity and Development](https://huggingface.co/papers/2606.07207) [Upvote: 2] Confidence-based loss weighting is usually avoided in generative models because it accelerates errors when the model is confidently wrong, but this intuition breaks down in supervised diffusion training. [Other AI]
  - Authors: Zixi Li, Youzhen Li
  - Submitted by: Zixi "Oz" Li | Upvotes: 2 | Comments: 1
...
- [Measuring Model Robustness via Fisher Information: Spectral Bounds, Theoretical Guarantees, and Practical Algorithms](https://huggingface.co/papers/2606.04767) [Upvote: 1] The robustness of deep neural networks is crucial for safety-critical deployments, yet existing evaluation methods are often attack-dependent and lack interpretability. [Other AI]
  ...
  - Submitted by: FranzChang | Upvotes: 1 | Comments: 1
...
- [Parametric Social Identity Injection and Diversification in Public Opinion Simulation](https://huggingface.co/papers/2603.16142) [Upvote: 0] Large language models (LLMs) have recently been adopted as synthetic agents for public opinion simulation, offering a promising alternative to costly and slow human surveys. [Other AI]
  - Authors: Hexi Wang, Yujia Zhou, Bangde Du, Qingyao Ai, Yiqun Liu
  - Submitted by: Wang Hexi | Upvotes: 0 | Comments: 1
...
- [How Far Can Chord-Symbol Time-Series Adaptation Carry Genre Identity? Capabilities and Boundaries in Multi-Genre Chord-Symbol Modeling](https://huggingface.co/papers/2606.07334) [Upvote: 0] Harmony is a compact symbolic layer where mathematical pitch relations, acoustic consonance, and musical convention meet. [Other AI]
  - Authors: Jinju Lee
  - Submitted by: Jin Ju Lee | Upvotes: 0 | Comments: 1
...
### LLMs and Language (10 papers)

- [Your UnEmbedding Matrix is Secretly a Feature Lens for Text Embeddings](https://huggingface.co/papers/2606.07502) [Upvote: 69] Large language models exhibit impressive zero-shot capabilities across a wide range of downstream tasks. [LLMs and Language]
  - Authors: Songhao Wu, Zhongxin Chen, Yuxuan Liu, Heng Cui, Cong Li, Rui Yan
  - Submitted by: Songhao Wu | Upvotes: 69 | Comments: 3
...
- [SoCRATES: Towards Reliable Automated Evaluation of Proactive LLM Mediation across Domains and Socio-cognitive Variations](https://huggingface.co/papers/2606.05563) [Upvote: 42] Evaluating LLM mediators remains challenging, as mediation unfolds as a real-time trajectory shaped by disputants' shifting emotions, intentions, and context. [LLMs and Language]
  - Authors: Taewon Yun, Hyeonseong Park, Jeonghwan Choi, Hayoon Park, Yeeun Choi, Hwanjun Song
  - Submitted by: ytaewon | Upvotes: 42 | Comments: 2
...
- [When Tools Fail: Benchmarking Dynamic Replanning and Anomaly Recovery in LLM Agents](https://huggingface.co/papers/2606.05806) [Upvote: 18] Existing benchmarks evaluate Tool-Integrated Reasoning (TIR) in LLMs on idealized ''happy paths'', largely overlooking real-world tool failures. [LLMs and Language]
  - Authors: Dongsheng Zhu, Xuchen Ma, Yucheng Shen, Xiang Li, Yukun Zhao, Shuaiqiang Wang, Lingyong Yan, Dawei Yin
  - Submitted by: dongsheng zhu | Upvotes: 18 | Comments: 1
...
- [OpenSkill: Open-World Self-Evolution for LLM Agents](https://huggingface.co/papers/2606.06741) [Upvote: 17] Self-evolving agents requires adaptation after deployment, but existing approaches assume a usable learning loop, such as curated skills, successful trajectories, or verifier signals. [LLMs and Language]
  ...
  - Submitted by: taesiri | Upvotes: 17 | Comments: 1
...
- [Watch, Remember, Reason: Human-View Video Understanding with MLLMs](https://huggingface.co/papers/2606.07433) [Upvote: 12] Video understanding is being rapidly transformed by multimodal large language models (MLLMs), as research moves from short clips to long, multimodal, and knowledge-intensive video scenarios. [LLMs and Language]
  ...
  - Submitted by: Jiahao Meng | Upvotes: 12 | Comments: 1
...
- [LLM Explainability with Counterfactual Chains and Causal Graphs](https://huggingface.co/papers/2606.05972) [Upvote: 10] Causal graphs provide a high-level language for making mechanisms transparent. [LLMs and Language]
  - Authors: Nirit Nussbaum-Hoffer, Nitay Calderon, Liat Ein-Dor, Roi Reichart
  - Submitted by: Nitay Calderon | Upvotes: 10 | Comments: 1
...
- [When Gradients Collide: Failure Modes of Multi-Objective Prompt Optimization for LLM Judges](https://huggingface.co/papers/2605.26046) [Upvote: 3] Customizing an LLM judge to a specific task or domain often involves optimizing its prompt across multiple evaluation criteria simultaneously. [LLMs and Language]
  ...
  - Submitted by: Abhishek Divekar | Upvotes: 3 | Comments: 1
...
- [LayerRoute: Input-Conditioned Adaptive Layer Skipping via LoRA Fine-Tuning for Agentic Language Models](https://huggingface.co/papers/2606.01838) [Upvote: 2] Agentic language model systems alternate between two structurally distinct step types: structured tool calls (short, deterministic, low perplexity) and open-ended planning/reasoning steps (long, complex, high… [LLMs and Language]
  ...
  - Submitted by: Prateek Sikdar | Upvotes: 2 | Comments: 1
...
- [Imaginative Perception Tokens Enhance Spatial Reasoning in Multimodal Language Models](https://huggingface.co/papers/2606.03988) [Upvote: 1] Vision language models (VLMs) excel at many tasks but still struggle with spatial reasoning when critical information is not directly observable. [LLMs and Language]
  ...
  - Submitted by: Weikai Huang | Upvotes: 1 | Comments: 1
...
- [Data-Efficient Autoregressive-to-Diffusion Language Models via On-Policy Distillation](https://huggingface.co/papers/2606.06712) [Upvote: 1] We study the transformation of autoregressive models (ARLMs) into diffusion language models (DLMs). [LLMs and Language]
  ...
  - Submitted by: Shubham Parashar | Upvotes: 1 | Comments: 1
...
- [Direct 3D-Aware Object Insertion via Decomposed Visual Proxies](https://huggingface.co/papers/2606.06601) [Upvote: 22] Object insertion aims to seamlessly composite a reference object into a specified region of a background image. [Multimodal Understanding and Vision]
  - Authors: Jingbo Gong, Yikai Wang, Yushi Lan, Yuhao Wan, Ziheng Ouyang, Rui Zhao, Ming-Ming Cheng, Qibin Hou, Chen Change Loy
  - Submitted by: Jingbo Gong | Upvotes: 22 | Comments: 2
...
- [Physics in 2-Steps: Locking Motion Priors Before Visual Refinement Erases Them](https://huggingface.co/papers/2606.06361) [Upvote: 12] Image-to-Video diffusion models leverage input images to generate visually stunning content, yet frequently produce motion that violates physical laws. [Multimodal Understanding and Vision]
  - Authors: Woojung Han, Seil Kang, Youngjun Jun, Min-Hung Chen, Fu-En Yang, Seong Jae Hwang
  - Submitted by: Woojung Han | Upvotes: 12 | Comments: 1
...
- [Stream3D-VLM: Online 3D Spatial Understanding with Incremental Geometry Priors](https://huggingface.co/papers/2606.06891) [Upvote: 4] Despite advances in 3D scene understanding, existing 3D Large Multimodal Models operate in offline settings, requiring complete scene observations or predefined video clips. [Multimodal Understanding and Vision]
  ...
  - Submitted by: Hanxun Yu | Upvotes: 4 | Comments: 1
...
- [A Cookbook of 3D Vision: Data, Learning Paradigms, and Application](https://huggingface.co/papers/2606.04291) [Upvote: 2] 3D vision has rapidly evolved, driven by increasingly diverse data representations, learning paradigms, and modeling strategies. [Multimodal Understanding and Vision]
  ...
  - Submitted by: LZX | Upvotes: 2 | Comments: 1
...
- [WorldBench: A Challenging and Visually Diverse Multimodal Reasoning Benchmark](https://huggingface.co/papers/2606.06538) [Upvote: 0] In real-world applications, models are expected to perform reliably across diverse settings. [Multimodal Understanding and Vision]
  ...
  - Submitted by: taesiri | Upvotes: 0 | Comments: 1
...
- [Socratic-SWE: Self-Evolving Coding Agents via Trace-Derived Agent Skills](https://huggingface.co/papers/2606.07412) [Upvote: 8] LLM-driven software engineering agents have become a central testbed for real-world language-model capability, yet their training remains limited by the availability of high-quality SWE tasks. [Agents and Planning]
...
- [HarnessForge: Joint Harness and Policy Evolution for Adaptive Agent Systems](https://huggingface.co/papers/2606.01779) [Upvote: 4] LLM agents are increasingly expected to operate across heterogeneous task regimes that require distinct execution paradigms. [Agents and Planning]
  - Authors: Mingju Chen, Can Lv, Guibin Zhang, Heng Chang, Shiji Zhou
  - Submitted by: Chen Mingju | Upvotes: 4 | Comments: 1
...
- [Towards Retrieving Interaction Spaces for Agentic Search](https://huggingface.co/papers/2606.06880) [Upvote: 1] Retrieval for search agents is still inherited from non-agentic information retrieval: a retriever ranks the corpus and the agent reads a small set of returned documents. [Agents and Planning]
  - Authors: Shengyao Zhuang, Yuansheng Ni, Hengxin Fun, Jimmy Lin, Xueguang Ma
  - Submitted by: Shengyao Zhuang | Upvotes: 1 | Comments: 1
...
- [Towards Human-Like Interactive Speech Recognition With Agentic Correction and Semantic Evaluation](https://huggingface.co/papers/2605.29430) [Upvote: 1] Automatic speech recognition (ASR) is a core component of human--computer interaction and an increasingly important front-end for LLM-based assistants and agents. [Agents and Planning]
  ...
  - Submitted by: Zixuan Jiang | Upvotes: 1 | Comments: 1
...
- [Critic-R: Improving Agentic Search using Instruction-tuned Retrievers with Natural Language Introspective Feedback](https://huggingface.co/papers/2606.00590) [Upvote: 0] Agentic search systems iteratively interact with retrieval models to answer complex queries. [Agents and Planning]
  ...
  - Submitted by: Md Zarif Ul Alam | Upvotes: 0 | Comments: 1
...
- [MMAE: A Massive Multitask Audio Editing Benchmark](https://huggingface.co/papers/2606.07229) [Upvote: 38] We introduce MMAE, a Massive Multitask Audio Editing benchmark, serving as the first comprehensive evaluation testbed designed for general-purpose instruction-based audio editing. [Datasets and Benchmarks]
  ...
  - Submitted by: Ziyang Ma | Upvotes: 38 | Comments: 2
...
- [SubtleMemory: A Benchmark for Fine-Grained Relational Memory Discrimination in Long-Horizon AI Agents](https://huggingface.co/papers/2606.05761) [Upvote: 16] Persistent AI assistants, such as OpenClaw, accumulate large collections of related memories over long-term interactions. [Datasets and Benchmarks]
  - Authors: Wenxuan Wang, Haoyu Sun, Fukuan Hou, Mingyang Song, Weinan Zhang, Yu Cheng, Yang Yang
  - Submitted by: WangWenxuan | Upvotes: 16 | Comments: 1
...
- [UnpredictaBench: A Benchmark for Evaluating Distributional Randomness in LLMs](https://huggingface.co/papers/2606.06622) [Upvote: 8] We introduce UnpredictaBench, an evaluation that tests the ability of large language models (LLMs) to capture true underlying distributions. [Datasets and Benchmarks]
  ...
  - Submitted by: Amirhossein Abaskohi | Upvotes: 8 | Comments: 1
...
- [Compress-Distill: Reasoning Trace Compression for Efficient Knowledge Distillation](https://huggingface.co/papers/2606.05988) [Upvote: 1] Reasoning models produce long chain-of-thought traces that are costly to distill and encourage verbose student outputs. [Reasoning, Alignment, and Evaluation]
  - Authors: Maxime Griot, Paul Steven Scotti, Tanishq Mathew Abraham
  - Submitted by: Maxime Griot | Upvotes: 1 | Comments: 1
...
- [CORE: Contrastive Reflection Enables Rapid Improvements in Reasoning](https://huggingface.co/papers/2605.28742) [Upvote: 0] Language models can use verifiable rewards to improve at a wide variety of reasoning tasks. [Reasoning, Alignment, and Evaluation]
  - Authors: Linas Nasvytis, Simon Jerome Han, Ben Prystawski, Satchel Grant, Noah D. Goodman, Judith E. Fan
  - Submitted by: Linas Nasvytis | Upvotes: 0 | Comments: 1
...
- [Reinforcement Learning from Rich Feedback with Distributional DAgger](https://huggingface.co/papers/2606.05152) [Upvote: 1] Reasoning models have advanced rapidly, but the dominant reinforcement learning from verifiable rewards (RLVR) recipe remains surprisingly narrow: sample many responses and reward each with a single bit indicating… [Learning, Optimization, and Theory]
  - Authors: Rishabh Agrawal, Jacob Fein-Ashley, Paria Rashidinejad
  - Submitted by: Rishabh Agrawal | Upvotes: 1 | Comments: 1
...
- [Augmenting Attention with Exponentially Decaying Memory Improves Query-Aware KV Sparsity](https://huggingface.co/papers/2605.28640) [Upvote: 0] Efficient inference is critical for long-context language models, where attention computation and KV-cache access dominate the cost. [Retrieval, Knowledge, and RAG]
  ...
  - Submitted by: XiuyingWei | Upvotes: 0 | Comments: 1
...
- [AnchorWorld: Embodied Egocentric World Simulation with View-based Evolution Customization](https://huggingface.co/papers/2606.07326) [Upvote: 24] Despite being a pivotal frontier, interactive world modeling remains underexplored in terms of the versatile controllability required by practical scenarios. [Robotics and Embodied AI]
  ...
  - Submitted by: yu li | Upvotes: 24 | Comments: 1
