...
- Multimodal Understanding and Vision: 5 papers (17.86%); representative paper: PerceptionRubrics: Calibrating Multimodal Evaluation to Human Perception.
- Other AI: 5 papers (17.86%); representative paper: ELDR: Expert-Locality-Aware Decode Routing for PD-Disaggregated MoE Serving.
- Agents and Planning: 4 papers (14.29%); representative paper: MemSyco-Bench: Benchmarking Sycophancy in Agent Memory.
- Trend: Today's dominant clusters are Multimodal Understanding and Vision / Other AI / Agents and Planning; this suggests several parallel trends: multimodal work is moving from isolated perception toward generation, agents, and action; agent papers emphasize tool use, planning, and deployable workflows. The strongest visible attention is on “PerceptionRubrics: Calibrating Multimodal Evaluation to Human Perception” (32 upvotes).

## Focus Topics

- Generative Foundations: 0 papers (0.00%)
- Multimodal Generative Modeling: 1 papers (3.57%)
- Multimodal Agents: 0 papers (0.00%)

## Topic Distribution

- Multimodal Understanding and Vision: 5 papers (17.86%)
- Other AI: 5 papers (17.86%)
- Agents and Planning: 4 papers (14.29%)
- Datasets and Benchmarks: 3 papers (10.71%)
- Learning, Optimization, and Theory: 3 papers (10.71%)
- LLMs and Language: 2 papers (7.14%)
- Reasoning, Alignment, and Evaluation: 2 papers (7.14%)
- Robotics and Embodied AI: 2 papers (7.14%)
- Domain Applications: 1 papers (3.57%)
- Multimodal Generative Modeling: 1 papers (3.57%)
...
- Hang Yu: 1 papers
- Hongxing Li: 1 papers

## Brief Notes

- The top topic today is “Multimodal Understanding and Vision”, with 5 papers, accounting for 17.86%。
- The most active submitter is taesiri， with 5 papers。
- The highest-voted visible paper is “PerceptionRubrics: Calibrating Multimodal Evaluation to Human Perception”, currently at 32 votes.
...
- [PerceptionRubrics: Calibrating Multimodal Evaluation to Human Perception](https://huggingface.co/papers/2606.28322) [Upvote: 32] We introduce PerceptionRubrics, a rubric-based evaluation framework that addresses the gap between saturated benchmark scores and real-world brittleness. [Multimodal Understanding and Vision]
  ...
  - Submitted by: Yana Wei | Upvotes: 32 | Comments: 2
...
- [NoPA: Non-Parametric Online 3D Scene Graph Generation](https://huggingface.co/papers/2607.00529) [Upvote: 2] Classic 3D scene graph generation approaches fail to work in real-time due to the heavy computational cost of environment mapping and the need to generate intermediate point-cloud representations. [Multimodal Understanding and Vision]
  - Authors: Qi Xun Yeo, Seungjun Lee, Yan Li, Gim Hee Lee
  - Submitted by: Seungjun Lee | Upvotes: 2 | Comments: 1
...
- [CogSENet: Blind Image Deblurring with Blur-Conditioned Semantic Routing and Explicit Frequency Fusion](https://huggingface.co/papers/2606.30030) [Upvote: 1] Blind image deblurring demands the recovery of high-fidelity details and coherent structures from complex, unknown degradations. [Multimodal Understanding and Vision]
  - Authors: Pan Wang, Yihao Hu, Xiujin Liu
  - Submitted by: Deyuan Liu | Upvotes: 1 | Comments: 1
...
- [ELDR: Expert-Locality-Aware Decode Routing for PD-Disaggregated MoE Serving](https://huggingface.co/papers/2607.00466) [Upvote: 19] In prefill-decode (PD) disaggregated LLM serving, each request is assigned to a decode worker after prefill. [Other AI]
  - Authors: Sangjin Choi, Sukmin Cho, Yifan Xiong, Ziyue Yang, Youngjin Kwon, Peng Cheng
  - Submitted by: Sukmin Cho | Upvotes: 19 | Comments: 2
...
- [Seed2.0 Model Card: Towards Intelligence Frontier for Real-World Complexity](https://huggingface.co/papers/2607.00248) [Upvote: 14] We present Seed2.0, a model series that takes a meaningful step toward solving complex, real-world tasks. [Other AI]
...
- [The State-Prediction Separation Hypothesis](https://huggingface.co/papers/2607.01218) [Upvote: 7] Transformers use the same forward computation stream to both predict the next token and store useful state for future token predictions. [Other AI]
  - Authors: Giovanni Monea, Nathan Godey, Kianté Brantley, Yoav Artzi
  - Submitted by: Nathan Godey | Upvotes: 7 | Comments: 1
...
- [AI translation of literary texts is "fine", but readers still prefer human translations](https://huggingface.co/papers/2606.26040) [Upvote: 3] AI translation of literary works is increasingly common. [Other AI]
  - Authors: Yves Ferstler, Adam Podoxin, Ty Brassington, Roman Grundkiewicz, Maite Taboada, Marzena Karpinska
  - Submitted by: Yves Ferstler | Upvotes: 3 | Comments: 1
...
- [MemSyco-Bench: Benchmarking Sycophancy in Agent Memory](https://huggingface.co/papers/2607.01071) [Upvote: 18] Memory has emerged as a cornerstone of modern LLM-based agents, supporting their evolution from single-turn assistants to long-term collaborators. [Agents and Planning]
  - Authors: Zhishang Xiang, Zerui Chen, Yunbo Tang, Zhimin Wei, Ruqin Ning, Yujie Lin, Qinggang Zhang, Jinsong Su
  - Submitted by: tangyunbo | Upvotes: 18 | Comments: 1
...
- [BioInsight: Multi-Agent Orchestration for Interactive Biomedical Knowledge Discovery](https://huggingface.co/papers/2606.20997) [Upvote: 6] Biomedical researchers increasingly use AI-generated analyses and reports to interpret protein-level signals, but static outputs are often insufficient for research decision-making, where users need to inspect… [Agents and Planning]
  ...
  - Submitted by: Wang | Upvotes: 6 | Comments: 1
...
- [Personalization as Inverse Planning: Learning Latent Design Intents for Agentic Slide Generation via Structural Denoising](https://huggingface.co/papers/2607.00407) [Upvote: 3] Slide design requires personalizing both deck themes and page layouts. [Agents and Planning]
...
- [Autonomous Scientific Discovery via Iterative Meta-Reflection](https://huggingface.co/papers/2607.01131) [Upvote: 3] Autonomous scientific discovery systems offer the potential to accelerate research by automating the process of hypothesis generation and validation. [Agents and Planning]
...
- [SciIR: A Large-scale Training Dataset and Benchmark for Scientific Image Reasoning Generation](https://huggingface.co/papers/2606.30124) [Upvote: 3] While Text-to-Image (T2I) models have shown remarkable success in generating photorealistic visual content, they still struggle with the rigorous semantic alignment and logical reasoning required for scientific imagery. [Datasets and Benchmarks]
  - Authors: Zhiyuan Ma, Zhengfeng Shi, Yuning An, Peize Li, Jiabao Wei, Ruijie Li, Junhao Xiao, Jianjun Li, Bowen Zhou
  - Submitted by: Zhiyuan Ma | Upvotes: 3 | Comments: 1
...
- [Are Performance-Optimization Benchmarks Reliably Measuring Coding Agents?](https://huggingface.co/papers/2607.01211) [Upvote: 3] Repository-level performance-optimization benchmarks such as GSO, SWE-Perf and SWE-fficiency evaluate coding agents by applying patches to real repositories and comparing runtime against unoptimized baselines and… [Datasets and Benchmarks]
  - Authors: Zhi Chen, Zhensu Sun, Yuling Shi, David Lo, Lingxiao Jiang
  - Submitted by: Chen Zhi | Upvotes: 3 | Comments: 1
...
- [CausalMix: Data Mixture as Causal Inference for Language Model Training](https://huggingface.co/papers/2607.01104) [Upvote: 14] In Large Language Model (LLM) training, data mixing plays a pivotal role in determining model performance. [Learning, Optimization, and Theory]
  - Authors: Zinan Tang, Yukun Zhang, Shaomian Zheng, Zhuoshi Pan, Qizhi Pei, Dingnan Jin, Jun Zhou, Yujun Wang, Biqing Huang
  - Submitted by: Zinan Tang | Upvotes: 14 | Comments: 1
...
- [Cross-Domain Generalization Failure in Lightweight Intrusion Detection Models for IIoT Networks](https://huggingface.co/papers/2607.00553) [Upvote: 5] Lightweight machine learning models are increasingly proposed for intrusion detection in Industrial Internet of Things (IIoT) networks due to their suitability for resource-constrained edge deployment. [Learning, Optimization, and Theory]
  - Authors: MD Azizul Hakim, Md Shihab Uddin, Talha Ibne Anis
  - Submitted by: Md.Azizul Hakim | Upvotes: 5 | Comments: 1
...
- [Graph-Native Reinforcement Learning Enables Traceable Scientific Hypothesis Generation through Conceptual Recombination](https://huggingface.co/papers/2607.00924) [Upvote: 4] Accelerating materials discovery requires AI systems that can generate scientifically valid hypotheses through multi-step, domain-grounded reasoning. [Learning, Optimization, and Theory]
  - Authors: Subhadeep Pal, Shashwat Sourav, Tirthankar Ghosal, Markus J. Buehler
  - Submitted by: Markus Buehler | Upvotes: 4 | Comments: 1
...
- [When LLMs Read Tables Carelessly: Measuring and Reducing Data Referencing Errors](https://huggingface.co/papers/2606.32029) [Upvote: 4] While large language models (LLMs) perform well on table tasks, they still make data referencing errors (DREs), i.e., incorrectly citing or omitting table values, despite understanding the table structure. [LLMs and Language]
  - Authors: Yuqing Yang, Qi Zhu, Zhen Han, Boran Han, Zhengyuan Shen, Shuai Wang, Vassilis N. Ioannidis, Huzefa Rangwala
  - Submitted by: Yuqing Yang | Upvotes: 4 | Comments: 1
...
- [Perceive-to-Reason: Decoupling Perception and Reasoning for Fine-Grained Visual Reasoning](https://huggingface.co/papers/2607.01191) [Upvote: 11] Fine-grained visual reasoning remains challenging for vision-language models, especially when small but critical visual cues are buried in high-resolution images. [Reasoning, Alignment, and Evaluation]
  ...
  - Submitted by: Hongxing Li | Upvotes: 11 | Comments: 1
...
- [PixelEyes: Decoupling Perception and Reasoning for Pinpoint Visual Evidence Seeking](https://huggingface.co/papers/2607.00115) [Upvote: 2] This paper explores multi-turn visual reasoning and observes that MLLMs repeatedly fail to localize the target, leading to long, redundant trajectories. [Reasoning, Alignment, and Evaluation]
  ...
  - Submitted by: GongDengxian | Upvotes: 2 | Comments: 2
...
- [ASPIRE: Agentic /Skills Discovery for Robotics](https://huggingface.co/papers/2607.00272) [Upvote: 11] Traditional robot programming is challenging: it requires orchestrating multimodal perception, managing physical contact dynamics, and handling diverse configurations and execution failures. [Robotics and Embodied AI]
  ...
  - Submitted by: taesiri | Upvotes: 11 | Comments: 0
...
- [ABot-M0.5: Unified Mobility-and-Manipulation World Action Model](https://huggingface.co/papers/2607.00678) [Upvote: 10] Mobile manipulation is a key capability for general-purpose robots, yet remains challenging for current embodied learning methods. [Robotics and Embodied AI]
...
- [AtomiMed: Hierarchical Atomic Fact-Checking for Universal Clinical-Aware Medical Report Evaluation](https://huggingface.co/papers/2606.31292) [Upvote: 4] Traditional metrics for Medical Report Generation (MRG) predominantly rely on surface-level n-gram overlap, which fails to capture clinical factual accuracy and often overlooks catastrophic diagnostic errors. [Domain Applications]
  ...
  - Submitted by: WANG | Upvotes: 4 | Comments: 1
...
- [Multimodal Continuous Reasoning via Asymmetric Mutual Variational Learning](https://huggingface.co/papers/2607.00461) [Upvote: 16] Multimodal Large Language Models (MLLMs) are often constrained by a language-space bottleneck, forcing complex visual reasoning into discrete tokens which can lose perceptual nuance. [Multimodal Generative Modeling]
  - Authors: Shijie Li, Yilin Gao, Siyuan Yang, Tieyuan Chen, Chaofan Gan, Zhihao He, Zicheng Zhao, Yuyu Guo, Weiyao Lin, Hang Yu
  - Submitted by: Hang Yu | Upvotes: 16 | Comments: 3
