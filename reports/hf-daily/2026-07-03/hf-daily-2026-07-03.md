...
- The highest-voted visible paper is “Program-as-Weights: A Programming Paradigm for Fuzzy Functions”, currently at 68 votes.
...
- [Multi-Resolution Flow Matching: Training-Free Diffusion Acceleration via Staged Sampling](https://huggingface.co/papers/2607.01642) [Upvote: 26] Hardware-agnostic strategies for accelerating text-to-image diffusion, such as timestep distillation and feature caching, can reduce inference time without custom kernels or system-level optimization. [Multimodal Understanding and Vision]
  - Authors: Xingyu Zheng, Xianglong Liu, Yifu Ding, Weilun Feng, Junqing Lin, Jinyang Guo, Haotong Qin
  - Submitted by: Xingyu Zheng | Upvotes: 26 | Comments: 2
...
- [EvoPolicyGym: Evaluating Autonomous Policy Evolution in Interactive Environments](https://huggingface.co/papers/2607.02440) [Upvote: 41] Autonomous agents are increasingly expected to improve executable policies through feedback, yet existing evaluations often collapse this process into a final score or confound it with open-ended software-engineering… [Agents and Planning]
  ...
  - Submitted by: MikaStars39 | Upvotes: 41 | Comments: 2
...
- [SkillCoach: Self-Evolving Rubrics for Evaluating and Enhancing Agentic Skill-Use](https://huggingface.co/papers/2607.01874) [Upvote: 14] Skills are becoming a reusable operational layer for LLM agents, encoding SOPs, domain rules, tool workflows, scripts, and validation routines. [Agents and Planning]
...
- [PACE: A Proxy for Agentic Capability Evaluation](https://huggingface.co/papers/2607.02032) [Upvote: 6] Evaluating LLM agents on benchmarks like SWE-Bench and GAIA can be expensive, time-consuming, and requires complex infrastructure. [Agents and Planning]
...
- [DuoMem: Towards Capable On-Device Memory Agents via Dual-Space Distillation](https://huggingface.co/papers/2606.29961) [Upvote: 4] Large Language Model (LLM)-based agents can solve complex procedural tasks by interacting with environments over multiple turns, but this ability typically depends on large models, long contexts, and repeated… [Agents and Planning]
  ...
  - Submitted by: Ondrej Bohdal | Upvotes: 4 | Comments: 2
...
- [Morphing into Hybrid Attention Models](https://huggingface.co/papers/2606.30562) [Upvote: 36] Hybrid attention models improve long-context efficiency by retaining only a subset of full-attention layers and replacing the remaining layers with linear attention. [Learning, Optimization, and Theory]
  - Authors: Disen Lan, Jianbin Zheng, Yuxi Ren, Xin Xia, Xuanda Wang, Xuefeng Xiao, Xipeng Qiu, Yu Cheng
  - Submitted by: Disen Lan | Upvotes: 36 | Comments: 5
...
- [Denser neq Better: Limits of On-Policy Self-Distillation for Continual Post-Training](https://huggingface.co/papers/2607.01763) [Upvote: 4] Continual post-training enables foundation models to acquire new knowledge while preserving existing capabilities. [Learning, Optimization, and Theory]
  ...
  - Submitted by: Meng Wang | Upvotes: 4 | Comments: 2
...
- [WorldDirector: Building Controllable World Simulators with Persistent Dynamic Memory](https://huggingface.co/papers/2607.02517) [Upvote: 20] We present WorldDirector, a highly controllable video world model framework designed for persistent dynamic object memory and unrestricted viewpoint exploration. [Retrieval, Knowledge, and RAG]
  ...
  - Submitted by: taesiri | Upvotes: 20 | Comments: 2
...
- [Logit-Contribution Scoring Identifies Non-Literal Retrieval Heads](https://huggingface.co/papers/2607.01002) [Upvote: 14] In long-context use, large language models frequently synthesize answers from the meaning of a relevant context span rather than literally copy-pasting them. [Retrieval, Knowledge, and RAG]
  - Authors: Aryo Pradipta Gema, Beatrice Alex, Pasquale Minervini
  - Submitted by: Pasquale Minervini | Upvotes: 14 | Comments: 2
...
- [AutoMem: Automated Learning of Memory as a Cognitive Skill](https://huggingface.co/papers/2607.01224) [Upvote: 12] Memory expertise is a learned skill: knowing what to encode, when to retrieve, and how to organize knowledge--a capacity known in cognitive science as metamemory. [Retrieval, Knowledge, and RAG]
  - Authors: Shengguang Wu, Hao Zhu, Yuhui Zhang, Xiaohan Wang, Serena Yeung-Levy
  - Submitted by: Shengguang Wu | Upvotes: 12 | Comments: 3
...
- [Parameter-Efficient Quantum-Inspired Fast Weight Programmers for Traffic-Matrix Forecasting](https://huggingface.co/papers/2606.27821) [Upvote: 2] Traffic matrices (TMs) capture network-wide origin-destination demand and are central to traffic engineering, yet accurate whole-matrix forecasting remains challenging when prediction must be performed under the… [Other AI]
  - Authors: Kuo-Chung Peng, Jiun-Cheng Jiang, Chun-Hua Lin, Tai-Yue Li, Nan-Yow Chen, Samuel Yen-Chi Chen
  - Submitted by: Jiun-Cheng Jiang | Upvotes: 2 | Comments: 2
...
- [AgenticDataBench: A Comprehensive Benchmark for Data Agents](https://huggingface.co/papers/2607.01647) [Upvote: 25] Data science aims to derive actionable insights from heterogeneous raw data, unlocking the value of the massive amounts of data generated in modern society. [Datasets and Benchmarks]
  ...
  - Submitted by: Zhaoyan Sun | Upvotes: 25 | Comments: 2
...
- [AgenticSTS: A Bounded-Memory Testbed for Long-Horizon LLM Agents](https://huggingface.co/papers/2607.02255) [Upvote: 43] Memory for a long-horizon LLM agent is a contract about what each future decision is allowed to see. [LLMs and Language]
  ...
  - Submitted by: kaipeng | Upvotes: 43 | Comments: 3
