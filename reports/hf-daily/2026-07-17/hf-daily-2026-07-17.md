# Hugging Face Daily Papers Report (2026-07-17)

- Source: https://huggingface.co/papers/date/2026-07-17
- Classifier: rule
- Total Papers: 23

## Today's Hotspots and Trend

- Agents and Planning: 6 papers (26.09%); representative paper: Harness Handbook: Making Evolving Agent Harnesses Readable,Navigable, and Editable.
- Other AI: 6 papers (26.09%); representative paper: OvisOCR2 Technical Report.
- Multimodal Understanding and Vision: 5 papers (21.74%); representative paper: Boogu-Image-0.1: Boosting Open-Source Unified Multimodal Understanding and Generation.
- Trend: Today's dominant clusters are Agents and Planning / Other AI / Multimodal Understanding and Vision; this suggests several parallel trends: multimodal work is moving from isolated perception toward generation, agents, and action; agent papers emphasize tool use, planning, and deployable workflows. The strongest visible attention is on “Harness Handbook: Making Evolving Agent Harnesses Readable,Navigable, and Editable” (160 upvotes).
...
- Agents and Planning: 6 papers (26.09%)
- Other AI: 6 papers (26.09%)
- Multimodal Understanding and Vision: 5 papers (21.74%)
- Robotics and Embodied AI: 2 papers (8.70%)
- LLMs and Language: 1 papers (4.35%)
...
- The top topic today is “Agents and Planning”, with 6 papers, accounting for 26.09%。
- The most active submitter is taesiri， with 2 papers。
- The highest-voted visible paper is “Harness Handbook: Making Evolving Agent Harnesses Readable,Navigable, and Editable”, currently at 160 votes.
...
- [Harness Handbook: Making Evolving Agent Harnesses Readable,Navigable, and Editable](https://huggingface.co/papers/2607.13285) [Upvote: 160] The capability of a modern AI agent depends not only on its foundation model but also on its harness, which constructs prompts, manages state, invokes tools, and coordinates execution. [Agents and Planning]
  ...
  - Submitted by: taesiri | Upvotes: 160 | Comments: 3
...
- [Self-Improvements in Modern Agentic Systems: A Survey](https://huggingface.co/papers/2607.13104) [Upvote: 10] Self-improving autonomous agents are moving from research prototypes to deployed systems. [Agents and Planning]
  ...
  - Submitted by: Zhe Ren | Upvotes: 10 | Comments: 1
...
- [AgentCompass: A Unified Evaluation Infrastructure for Agent Capabilities](https://huggingface.co/papers/2607.13705) [Upvote: 8] As Large Language Models (LLMs) evolve into autonomous agents, the need for unified evaluation infrastructure becomes critical. [Agents and Planning]
  ...
  - Submitted by: Shufan Jiang | Upvotes: 8 | Comments: 1
...
- [Tracing Agentic Failure from the Flow of Success](https://huggingface.co/papers/2607.12747) [Upvote: 7] Failure attribution for LLM-based agentic systems, i.e., identifying which steps in a failure trajectory caused the task to fail, is critical for debugging and improving these systems. [Agents and Planning]
  - Authors: Samuel Yeh, Yiwen Zhu, Shaleen Deep, Sharon Li
  - Submitted by: Min-Hsuan Yeh | Upvotes: 7 | Comments: 1
...
- [From Controlled to the Wild: Evaluation of Pentesting Agents for the Real-World](https://huggingface.co/papers/2605.10834) [Upvote: 2] AI pentesting agents are increasingly credible as offensive security systems, but current benchmarks still provide limited guidance on which will perform best in real-world targets. [Agents and Planning]
  - Authors: Pedro Conde, Henrique Branquinho, Valerio Mazzone, Bruno Mendes, André Baptista, Nuno Moniz
  - Submitted by: Pedro Conde | Upvotes: 2 | Comments: 1
...
- [OvisOCR2 Technical Report](https://huggingface.co/papers/2607.13639) [Upvote: 42] We introduce OvisOCR2, a 0.8B document parsing model. [Other AI]
  ...
  - Submitted by: taesiri | Upvotes: 42 | Comments: 0
...
- [MetaView: Monocular Novel View Synthesis with Scale-Aware Implicit Geometry Priors](https://huggingface.co/papers/2607.12000) [Upvote: 22] Current visual generation models are capable of producing high-quality content, yet they lack a coherent perception of the spatial structure. [Other AI]
  - Authors: Yufei Cai, Xuesong Niu, Hao Lu, Kun Gai, Kai Wu, Guosheng Lin
  - Submitted by: Wu Kai | Upvotes: 22 | Comments: 1
...
- [GigaWorld-Policy-0.5: A Faster and Stronger WAM Empowered by AutoResearch](https://huggingface.co/papers/2607.13960) [Upvote: 21] World Action Models (WAMs) improve robot policy learning by jointly modeling actions and future visual observations, using future scene evolution as dense supervision for physically grounded action generation. [Other AI]
  ...
  - Submitted by: JeffWang | Upvotes: 21 | Comments: 1
...
- [Vinci2: Providing Proactive Assistance in Continuous Egocentric Videos](https://huggingface.co/papers/2607.11523) [Upvote: 8] When should an intelligent assistant speak up without being asked? [Other AI]
  - Authors: Gong Sitong, Tianyu Yan, Caixin Kang, Bo Zheng, Xiang Ruan, Huchuan Lu, Kaipeng Zhang, Yoichi Sato, Yifei Huang
  - Submitted by: Tim Kang | Upvotes: 8 | Comments: 1
...
- [Length Penalties Make Chain-of-Thought Less Monitorable](https://huggingface.co/papers/2607.09786) [Upvote: 1] Length-penalized reinforcement learning can shorten chain-of-thought reasoning while hiding an influence that drives the model's answer. [Other AI]
  - Authors: Bryce Little
  - Submitted by: Bryce | Upvotes: 1 | Comments: 1
...
- [Boogu-Image-0.1: Boosting Open-Source Unified Multimodal Understanding and Generation](https://huggingface.co/papers/2607.13125) [Upvote: 107] We introduce Boogu-Image-0.1, an open-source unified multimodal understanding and generation model family, comprising Base, Turbo, Edit, and Edit-Turbo variants. [Multimodal Understanding and Vision]
  ...
  - Submitted by: X | Upvotes: 107 | Comments: 2
...
- [PolicyShiftGuard: Benchmarking and Improving Policy-Adaptive Image Guardrails](https://huggingface.co/papers/2607.05910) [Upvote: 30] Image guardrails are typically trained and evaluated under a fixed safety policy, implicitly treating safety as an intrinsic property of an image. [Multimodal Understanding and Vision]
  - Authors: Mingyang Song, Luxin Xu, Haoyu Sun, Minzhou Pan, Yu Cheng, Bo Li
  - Submitted by: Mingyang Song | Upvotes: 30 | Comments: 1
...
- [Registers Matter for Pixel-Space Diffusion Transformers](https://huggingface.co/papers/2605.16147) [Upvote: 12] Vision Transformers (ViTs) are known to exhibit high-norm patch-token outliers that degrade feature map quality, a problem effectively mitigated by register tokens. [Multimodal Understanding and Vision]
  - Authors: Nikita Starodubcev, Ilia Sudakov, Ilya Drobyshevskiy, Artem Babenko, Dmitry Baranchuk
  - Submitted by: nikita | Upvotes: 12 | Comments: 0
...
- [Discrete Diffusion Models: A Unified Framework from Tokenization to Generation](https://huggingface.co/papers/2607.13431) [Upvote: 5] Discrete denoising diffusion models (DDMs) have recently emerged as a compelling alternative to autoregressive (AR) modeling for discrete data, offering parallel generation and iterative global refinement capabilities. [Multimodal Understanding and Vision]
  ...
  - Submitted by: Ye Yuan | Upvotes: 5 | Comments: 1
...
- [Self in Space: Benchmarking Self-Awareness and Spatial Cognition in UAV Embodied Intelligence](https://huggingface.co/papers/2607.12477) [Upvote: 2] Autonomous UAV systems increasingly rely on multimodal large language models (MLLMs) to operate in complex real-world environments. [Robotics and Embodied AI]
  - Authors: Zhishan Zou, Guoyan Sun, Zhiwei Wei, Jiancheng Pan, Yujie Li, Mugen Peng, Wenjia Xu
  - Submitted by: choucisan | Upvotes: 2 | Comments: 3
...
- [SPEAR: A Simulator for Photorealistic Embodied AI Research](https://huggingface.co/papers/2607.06701) [Upvote: 1] Interactive simulators have become powerful tools for training embodied agents and generating synthetic visual data, but existing photorealistic simulators suffer from limited generality, programmability, and… [Robotics and Embodied AI]
  ...
  - Submitted by: Mike Roberts | Upvotes: 1 | Comments: 1
...
- [From Noisy Traces to Root Causes: Structural Trajectory Analysis and Causal Extraction for Agent Optimization](https://huggingface.co/papers/2607.07702) [Upvote: 5] The optimization of long-horizon agents increasingly relies on reflection-based mechanisms, where a large language model (LLM) acts as an optimizer to diagnose agent failures and improve agent policies. [Learning, Optimization, and Theory]
  - Authors: Ying Chang, Jiahang Xu, Xuan Feng, Chenyuan Yang, Peng Cheng, Yuqing Yang
  - Submitted by: Jiahang Xu | Upvotes: 5 | Comments: 2
...
- [Ring-Zero: Scaling Zero RL to a Trillion Parameters for Emergent Reasoning](https://huggingface.co/papers/2607.12395) [Upvote: 78] Reinforcement learning with verifiable rewards without human-annotated data, often referred to as zero RL, has emerged as a powerful paradigm for eliciting chain-of-thought reasoning. [Reasoning, Alignment, and Evaluation]
  ...
  - Submitted by: txy | Upvotes: 78 | Comments: 2
...
- [KnowAct-GUIClaw: Know Deeply, Act Perfectly, Personal GUI Assistant with Self-Evolving Memory and Skill](https://huggingface.co/papers/2607.12625) [Upvote: 44] OpenClaw has emerged as a leading agent framework for complex task automation, yet it faces insufficient cross-platform GUI interaction support and a well-built self-evolution mechanism. [Retrieval, Knowledge, and RAG]
  ...
  - Submitted by: Yunxin Li | Upvotes: 44 | Comments: 1
