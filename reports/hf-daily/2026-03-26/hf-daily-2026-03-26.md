...
- Multimodal Generative Modeling: 1 papers (4.55%)
- Multimodal Agents: 2 papers (9.09%)

## Topic Distribution

- Multimodal Understanding and Vision: 6 papers (27.27%)
...
- The top topic today is “Multimodal Understanding and Vision”, with 6 papers, accounting for 27.27%。
...
- [LagerNVS: Latent Geometry for Fully Neural Real-time Novel View Synthesis](https://huggingface.co/papers/2603.20176) [Multimodal Understanding and Vision]
...
- [Why Does Self-Distillation (Sometimes) Degrade the Reasoning Capability of LLMs?](https://huggingface.co/papers/2603.24472) [Reasoning, Alignment, and Evaluation]
  ...
  - Submitted by: JeonghyeKim | Upvotes: 38 | Comments: 6
