...
- Generative Foundations: 4 papers (16.00%)
- Multimodal Generative Modeling: 4 papers (16.00%)
...
- Generative Foundations: 4 papers (16.00%)
- Multimodal Generative Modeling: 4 papers (16.00%)
- Multimodal Understanding and Vision: 4 papers (16.00%)
- LLMs and Language: 3 papers (12.00%)
- Reasoning, Alignment, and Evaluation: 3 papers (12.00%)
- Agents and Planning: 2 papers (8.00%)
- Robotics and Embodied AI: 2 papers (8.00%)
- Learning, Optimization, and Theory: 1 papers (4.00%)
- Multimodal Agents: 1 papers (4.00%)
- Retrieval, Knowledge, and RAG: 1 papers (4.00%)
...
- The top topic today is “Generative Foundations”, with 4 papers, accounting for 16.00%。
- The most active submitter is taesiri， with 5 papers。
- The highest-voted visible paper is “Penguin-VL: Exploring the Efficiency Limits of VLM with LLM-based Vision Encoders”, currently at 64 votes.
...
- [Layer by layer, module by module: Choose both for optimal OOD probing of ViT](https://huggingface.co/papers/2603.05280) [Multimodal Understanding and Vision]
...
- [IF-RewardBench: Benchmarking Judge Models for Instruction-Following Evaluation](https://huggingface.co/papers/2603.04738) [Reasoning, Alignment, and Evaluation]
...
- [RoboMME: Benchmarking and Understanding Memory for Robotic Generalist Policies](https://huggingface.co/papers/2603.04639) [Robotics and Embodied AI]
